...
In the previous tutorial, we set up SigNoz to send the data collected by OpenTelemetry to it.
...
<Figure src="/img/opentelemetry/2024/06/opentelemetry-python-autoinstrumentation-cover.webp" alt="d" caption="" />
...
<Figure src="/public/img/opentelemetry/2024/06/application-monitored.png" alt="https://www.notion.so../static/images/application-monitored.png" caption="https://www.notion.so../static/images/application-monitored.png" />
