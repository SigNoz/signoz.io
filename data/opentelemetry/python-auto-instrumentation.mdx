...
meta_title: OpenTelemetry Python Auto-Instrumentation
published_date: 2024-06-20
updated_date: 2026-06-16
tags: [OpenTelemetry]
authors: [srikanth]
description: Set up automatic traces, metrics, and logs in a Python (Flask) app with OpenTelemetry (no code changes). A step-by-step auto-instrumentation tutorial.
