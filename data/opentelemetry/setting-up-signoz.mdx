...
meta_title: "Setting up SigNoz: Cloud and Self-Host Options"
published_date: 2024-06-19
tags: [OpenTelemetry]
authors: [ankit_anand]
description: "Set up SigNoz to receive OpenTelemetry data, using either SigNoz Cloud or a self-hosted installation."
...
In this tutorial series, we will be using SigNoz Cloud to visualize everything that we collect from our applications with [OpenTelemetry](https://signoz.io/opentelemetry/).
