...
<figure data-zoomable align='center'>
  <img className="box-shadowed-image" alt="SigNoz ingestion settings showing the endpoint and ingestion key for a project" src="/img/blog/2024/06/autoinstrumented-tracing-nodejs-setup-signoz.webp" />
</figure>
...
<figure data-zoomable align='center'>
  <img className="box-shadowed-image" alt="SigNoz traces view showing request flows across services" src="/img/blog/2024/06/autoinstrumented-tracing-nodejs-visualizing-traces.webp" />
</figure>
