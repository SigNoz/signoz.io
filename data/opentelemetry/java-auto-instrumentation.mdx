...
meta_title: "OpenTelemetry Java - Complete Auto-Instrumentation Guide"
published_date: 2021-08-17
updated_date: 2025-09-25
tags: [java-monitoring]
authors: [ankit_anand]
description: "Learn how OpenTelemetry auto-instruments Java applications with the Java agent, including setup steps and configuration."
...
OTEL_EXPORTER_OTLP_ENDPOINT=<IP of SigNoz Backend>:4318
...
```
OTEL_EXPORTER_OTLP_ENDPOINT="http://<IP of SigNoz>:4318"
