...
<ArticleSeriesTop seriesKey="opentelemetry-nodejs" currentSlug="add-manual-span-to-traces-nodejs" />
...
<ArticleSeriesBottom seriesKey="opentelemetry-nodejs" currentSlug="add-manual-span-to-traces-nodejs" />
