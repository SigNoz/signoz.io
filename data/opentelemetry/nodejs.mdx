---
title: Getting started with OpenTelemetry and Nodejs
slug: nodejs
date: 2025-12-01
tags: [javascript-monitoring, auto-instrumentation, manual-instrumentation]
...
- [SigNoz Cloud account](https://signoz.io/teams/) (required to retrieve your Ingestion Key)

## Quick Start

To avoid manual setup, clone the [**sample Node.js app repository**](https://github.com/SigNoz/sample-nodejs-app), which is contains a sample node.js app. You can refer to [README.md](https://github.com/SigNoz/sample-nodejs-app/blob/master/README.md) for setup.
