...
These environment variables are applicable for SigNoz cloud. You don't need Ingestion key if you're using self-hosted SigNoz. For self-hosted SigNoz, please refer to instructions at [SigNoz Self-host Guide](https://signoz.io/docs/instrumentation/opentelemetry-javascript/).
