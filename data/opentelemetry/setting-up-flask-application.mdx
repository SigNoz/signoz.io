...
<link rel="canonical" href="[https://signoz.io/opentelemetry/setting-up-flask-application/](https://signoz.io/opentelemetry/python-overview/)"/>
...
Sample Flask To-so application running on local host
...
OpenTelemetry Auto-Instrumentation of Python application