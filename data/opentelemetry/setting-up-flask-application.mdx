...
meta_title: "Set Up a Flask App - OpenTelemetry Python Tutorial"
published_date: 2024-06-19
tags: [OpenTelemetry]
authors: [srikanth]
description: "Build a basic Flask to-do app with MongoDB as the sample application for the OpenTelemetry Python tutorial series."
