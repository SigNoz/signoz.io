...
meta_title: "OpenTelemetry Java Agent: Zero-Code Observability"
published_date: 2024-05-07
updated_date: 2026-06-16
tags: [java-monitoring]
authors: [ankit_anand]
description: The OpenTelemetry Java agent auto-captures telemetry from Java apps with zero code changes. Learn how it works, how to attach it, and supported libraries.
...
[OpenTelemetry](https://signoz.io/opentelemetry/) is a collection of code - a set of APIs, SDKs, tooling, and integrations that help you generate and manage telemetry data. It helps you generate, emit, collect, process, and export telemetry data.
...
OpenTelemetry has a very handy Java JAR agent that can be attached to any Java 8+ application for [instrumenting Java applications](https://signoz.io/blog/opentelemetry-java/). The Java JAR agent can detect a number of popular libraries and frameworks and instrument it right out of the box for generating telemetry data.
...
The supported libraries and frameworks supported by [OpenTelemetry Java agent](https://signoz.io/docs/instrumentation/java/opentelemetry-java/) for [automatic instrumentation](https://signoz.io/opentelemetry/java-auto-instrumentation/) includes:
...
<figure data-zoomable align='center'>
  <img className="box-shadowed-image" alt="SigNoz UI showing RED metrics" src="/img/blog/common/signoz_charts_application_metrics.webp" />
...
<figure data-zoomable align='center'>
  <img className="box-shadowed-image" alt="SigNoz UI showing RED metrics" src="/img/blog/common/signoz_flamegraphs.webp" />
