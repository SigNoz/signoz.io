...
The supported libraries and frameworks supported by [OpenTelemetry Java agent](https://signoz.io/docs/instrumentation/java/opentelemetry-java/) for automatic instrumentation includes:
