...
authors: [yuvraj]
description: "Learn how to send structured Node.js logs to SigNoz using Pino and the OpenTelemetry Collector, with a logs pipeline for microservices."
keywords: 
  - opentelemetry
...
Pino is a high-performance JSON-based logging library for Node.js. It's particularly well-suited for production environments due to its low overhead.<br />
...
Now, let's look at the steps for integration to understand how Node.js looging works:
...
<figure data-zoomable align='center'>
  <img className="box-shadowed-image" alt="SigNoz logs dashboard opened from the navigation menu" src="/img/blog/2024/06/logging-nodejs-logmenu.webp" />
</figure>
...
<figure data-zoomable align='center'>
  <img className="box-shadowed-image" alt="SigNoz query builder filtering logs for a service" src="/img/blog/2024/06/logging-nodejslogslist.webp" />
</figure>
...
<figure data-zoomable align='center'>
  <img className="box-shadowed-image" alt="SigNoz related signals view linking logs, traces, and metrics" src="/img/blog/2024/06/logging-nodejs-correlated.webp" />
</figure>
