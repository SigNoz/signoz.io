---
title: "Correlating Traces, Logs, and Metrics in OpenTelemetry Node.js"
meta_title: "Correlate Traces, Logs & Metrics in OTel Node.js"
published_date: 2024-06-05
updated_date: 2026-07-06
tags: [opentelemetry-tutorials]
authors: [yuvraj]
description: "Learn how to correlate structured logs with trace and metric data in a Node.js app using OpenTelemetry and SigNoz for full-signal observability."
keywords: 
  - opentelemetry
...
Correlating traces and logs enhances debugging capabilities by providing a unified view of distributed transactions. It simplifies the identification of issues and improves the monitoring of microservices by offering a holistic view of application performance and behavior.<br />
...
<figure data-zoomable align='center'>
  <img className="box-shadowed-image" alt="SigNoz logs pipelines page" src="/img/blog/2024/06/correlating-traces-logs-metrics-nodejs-logs-pipeline.webp" />
</figure>
...
<figure data-zoomable align='center'>
  <img className="box-shadowed-image" alt="SigNoz form for creating a new logs pipeline" src="/img/blog/2024/06/correlating-traces-logs-metrics-nodejs-new-pipeline.webp" />
</figure>
...
<figure data-zoomable align='center'>
  <img className="box-shadowed-image" alt="SigNoz logs pipeline configuration for the order-service logs" src="/img/blog/2024/06/correlating-traces-logs-metrics-nodejs-complete-the-setup.webp" />
</figure>
...
<figure data-zoomable align='center'>
  <img className="box-shadowed-image" alt="SigNoz logs pipeline add processor menu" src="/img/blog/2024/06/correlating-traces-logs-metrics-nodejs-add-processor.webp" />
</figure>
...
<figure data-zoomable align='center'>
  <img className="box-shadowed-image" alt="SigNoz processor configuration for extracting trace fields from logs" src="/img/blog/2024/06/correlating-traces-logs-metrics-nodejs-complete-the-setup.webp" />
</figure>
...
<figure data-zoomable align='center'>
  <img className="box-shadowed-image" alt="SigNoz logs pipeline simulation screen" src="/img/blog/2024/06/correlating-traces-logs-metrics-nodejs-simulate.webp" />
</figure>
...
<figure data-zoomable align='center'>
  <img className="box-shadowed-image" alt="SigNoz logs view showing extracted span_id and trace_id fields" src="/img/blog/2024/06/correlating-traces-logs-metrics-nodejs-verify.webp" />
</figure>
...
<Admonition type="info">
Kudos on completing the entire [OpenTelemetry NodeJS series](https://signoz.io/opentelemetry/nodejs-tutorial-overview/).
