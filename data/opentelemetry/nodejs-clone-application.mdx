...
meta_title: "Clone the Sample App - OpenTelemetry Node.js"
published_date: 2024-06-05
tags: [opentelemetry-tutorials]
authors: [yuvraj]
description: "Clone and run the Node.js microservices sample application used throughout the OpenTelemetry Node.js tutorial series."
...
The `main` branch of the repository contains the fully instrumented code with [OpenTelemetry](https://signoz.io/opentelemetry/), which you can refer to for the final implementation.
...
<figure data-zoomable align='center'>
  <img className="box-shadowed-image" alt="Response showing the list of products returned by the Product service" src="/img/blog/2024/06/nodejs-clone-application-productdata.webp" />
</figure>
...
<figure data-zoomable align='center'>
  <img className="box-shadowed-image" alt="Architecture diagram of the e-commerce microservices application with order, payment, product, and user services" src="/img/blog/2024/06/nodejs-clone-application-architecture-overview.webp" />
</figure>
