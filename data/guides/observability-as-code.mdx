...
related_articles: ['/guides/alerts-as-code', '/blog/claude-code-monitoring-with-opentelemetry', '/guides/what-is-observability', '/blog/observability-vs-monitoring']
...
<Figure src="/img/guides/2024/12/observability-as-code-image 1.webp" alt="Why is Observability as Code Important?" caption="Why is Observability as Code Important?" />
...
- Open Standards: Built on [OpenTelemetry](https://signoz.io/opentelemetry/), making it future-proof and vendor-neutral.
