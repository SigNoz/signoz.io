...
AI log analysis helps by turning noisy log data into faster investigation paths. It can include simple pattern matching and anomaly detection to LLM-based workflows that summarize incidents, correlate events, and let engineers ask questions in natural language.
...
| Dashboards and alerts  | Support customizable dashboards, intelligent alerts, alert grouping, and workflow integrations.                                        |
