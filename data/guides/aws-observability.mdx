...
Follow the steps in the SigNoz Cloud section of this [tutorial](https://signoz.io/docs/opentelemetry-collection-agents/vm/install/) to get your OTel Collector agent up and running.
