...
1. Setup [OpenTelemetry](https://signoz.io/blog/what-is-opentelemetry/) Binary as an agent:
Follow the steps in the SigNoz Cloud section of this [tutorial](https://signoz.io/docs/tutorial/opentelemetry-binary-usage-in-virtual-machine/) to get your [Otel](https://signoz.io/blog/opentelemetry-vs-datadog/) [Collector agent](https://signoz.io/comparisons/opentelemetry-collector-vs-agent/) up and running.
