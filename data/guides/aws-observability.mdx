...
Follow the steps in the SigNoz Cloud section of this [tutorial](https://signoz.io/docs/tutorial/opentelemetry-binary-usage-in-virtual-machine/) to get your [OTel](https://signoz.io/blog/what-is-opentelemetry/) [Collector agent](https://signoz.io/comparisons/opentelemetry-collector-vs-agent/) up and running.
