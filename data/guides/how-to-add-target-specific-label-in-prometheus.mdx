  ...
  <script
    ...
    dangerouslySetInnerHTML={{
      __html: JSON.stringify({
        ...
        keywords:
          'Prometheus, target-specific labels, metric organization, service discovery, relabeling, monitoring',
        ...
        about: [
          ...
          },
          {
            ...
            name: 'Monitoring',
            description:
              'The process of continuously observing and checking the performance and behavior of a system.',
          },
          {
            '@type': 'Thing',
