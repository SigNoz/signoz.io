...
related_articles: ['/guides/how-can-i-group-labels-in-a-prometheus-query', '/guides/how-to-write-a-prometheus-query-that-returns-the-value-of-the-label', '/guides/what-are-prometheus-labels', '/blog/prometheus-query', '/guides/how-to-get-all-the-metrics-of-an-instance-with-prometheus-api', '/guides/how-can-i-join-two-metrics-in-a-prometheus-query']
---
