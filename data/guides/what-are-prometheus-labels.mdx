  ...
  <script
    ...
    dangerouslySetInnerHTML={{
      __html: JSON.stringify({
        ...
        keywords:
          'Prometheus labels, metric characterization, monitoring, data model, cardinality, relabeling, PromQL, best practices',
        ...
        about: [
          {
            ...
            description:
              'Key-value pairs attached to metrics that provide context and additional information for organizing and querying data.',
          },
          {
            '@type': 'Thing',
            name: 'Metric Characterization',
            description:
              'The process of adding descriptive information to metrics to enhance their value and usability in monitoring systems.',
          },
          {
            '@type': 'Thing',
            name: 'Monitoring',
            description:
              'The practice of observing and checking the progress or quality of a system over a period of time.',
          },
          {
            '@type': 'Thing',
            name: 'Data Model',
            description:
              'A conceptual framework for organizing and defining the structure of data, often used in databases and monitoring systems.',
          },
        ],
        mentions: [
          {
