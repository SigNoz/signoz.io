...
<Admonition defaultCollapsed="true" title="Already have ActiveMQ running?">
...
<Admonition defaultCollapsed="true" title="JAR version must match the OTel Collector Version" >
...
<Admonition defaultCollapsed="true" title="YAML breakdown">
