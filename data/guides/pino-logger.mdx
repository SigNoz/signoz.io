...
<InlineCTA message="Collect and analyze your Pino logs with OpenTelemetry and SigNoz — structured JSON logs, full-text search, and correlation with traces." ctaText="Learn How to Send Node.js Logs to SigNoz" ctaLink="/docs/instrumentation/javascript/opentelemetry-nodejs/" />
...
- **[OpenTelemetry](https://signoz.io/opentelemetry/) Native**: Seamless integration with modern observability standards
