...
<InlineCTA message="Collect and analyze your Pino logs with OpenTelemetry and SigNoz — structured JSON logs, full-text search, and correlation with traces." ctaText="Go to Docs" ctaLink="/docs/instrumentation/javascript/opentelemetry-nodejs/" />
