...
<Figure src="/img/guides/2024/07/pino-logger-Screenshot_2024-07-04_at_11.48.01_PM.webp" alt="Installing Pino via npm" caption="Installing Pino via npm" />
...
<Figure src="/img/guides/2024/07/pino-logger-Screenshot_2024-07-05_at_12.35.45_AM.webp" alt="Custom Serializers in Pino - Output" caption="Custom Serializers in Pino - Output" />
...
Access the SigNoz dashboard to view, search, and analyze your logs alongside metrics and traces.
    ...
    <Figure src="/img/guides/2024/07/pino-logger-Untitled.webp" alt="Viewing Logs in Signoz" caption="Viewing Logs in Signoz" />
...
<Figure src="/img/guides/2024/07/pino-logger-Screenshot_2024-07-05_at_2.53.31_AM.webp" alt="Running The Server" caption="Running The Server" />

Running The Server

<Figure src="/img/guides/2024/07/pino-logger-Screenshot_2024-07-05_at_2.50.15_AM.webp" alt="Verifying Server in localhost" caption="Verifying Server in localhost" />
