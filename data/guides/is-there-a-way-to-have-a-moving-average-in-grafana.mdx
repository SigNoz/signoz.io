...
1. Open your Grafana dashboard and edit the panel where you want to add a moving average.
   ...
   <Figure
     src="/img/guides/2024/10/is-there-a-way-to-have-a-moving-average-in-grafana-image.webp"
     alt="Editing panels in Grafana Dashboard"
     caption="Editing panels in Grafana Dashboard"
   />
...
<Figure
  src="/img/guides/2024/10/is-there-a-way-to-have-a-moving-average-in-grafana-image%201.webp"
  alt="Moving average with Prometheus as data source"
  caption="Moving average with Prometheus as data source"
/>
...
<Figure
  src="/img/guides/2024/10/is-there-a-way-to-have-a-moving-average-in-grafana-image%202.webp"
  alt="Moving Averages with InfluxDB in Grafana"
  caption="Moving Averages with InfluxDB in Grafana"
/>
...
<Figure
  src="/img/guides/2024/10/is-there-a-way-to-have-a-moving-average-in-grafana-image%203.webp"
  alt="Exponential Moving Average (EMA) with InfluxDB in Grafana dashboard"
  caption="Exponential Moving Average (EMA) with InfluxDB in Grafana dashboard"
/>
...
<Figure
  src="/img/guides/2024/10/is-there-a-way-to-have-a-moving-average-in-grafana-image%204.webp"
  alt="Moving Averages with MySQL"
  caption="Moving Averages with MySQL"
/>
...
<Figure
  src="/img/guides/2024/10/is-there-a-way-to-have-a-moving-average-in-grafana-image%205.webp"
  alt="Exponential Moving Average (EMA) in MySQL"
  caption="Exponential Moving Average (EMA) in MySQL"
/>
...
2. Combining Moving Averages with Statistical Functions:
   ...
   <Figure
     src="/img/guides/2024/10/is-there-a-way-to-have-a-moving-average-in-grafana-image%206.webp"
     alt="Combining Moving Averages with Statistical Functions"
     caption="Combining Moving Averages with Statistical Functions"
   />
...
<Figure
  src="/img/guides/2024/10/is-there-a-way-to-have-a-moving-average-in-grafana-image%207.webp"
  alt="Export Grafana moving average calculations for further analysis"
  caption="Export Grafana moving average calculations for further analysis"
/>
