...
authors:
  - simran_kumari
description: >-
  Learn how to implement moving averages in Grafana dashboards. This guide
  covers built-in features, transformations, and advanced techniques for data
  analysis.
keywords:
  - Grafana
  - moving averages
...
<Figure src="/img/guides/2024/10/is-there-a-way-to-have-a-moving-average-in-grafana-image 1.webp" alt="Moving average with Prometheus as data source" caption="Moving average with Prometheus as data source" />
...
<Figure src="/img/guides/2024/10/is-there-a-way-to-have-a-moving-average-in-grafana-image 2.webp" alt="Moving Averages with InfluxDB in Grafana" caption="Moving Averages with InfluxDB in Grafana" />
...
<Figure src="/img/guides/2024/10/is-there-a-way-to-have-a-moving-average-in-grafana-image 3.webp" alt="Exponential Moving Average (EMA) with InfluxDB in Grafana dashboard" caption="Exponential Moving Average (EMA) with InfluxDB in Grafana dashboard" />
...
<Figure src="/img/guides/2024/10/is-there-a-way-to-have-a-moving-average-in-grafana-image 4.webp" alt="Moving Averages with MySQL" caption="Moving Averages with MySQL" />
...
<Figure src="/img/guides/2024/10/is-there-a-way-to-have-a-moving-average-in-grafana-image 5.webp" alt="Exponential Moving Average (EMA) in MySQL" caption="Exponential Moving Average (EMA) in MySQL" />
...
2. Combining Moving Averages with Statistical Functions:
    ...
    <Figure src="/img/guides/2024/10/is-there-a-way-to-have-a-moving-average-in-grafana-image 6.webp" alt="Combining Moving Averages with Statistical Functions" caption="Combining Moving Averages with Statistical Functions" />
...
<Figure src="/img/guides/2024/10/is-there-a-way-to-have-a-moving-average-in-grafana-image 7.webp" alt="Export Grafana moving average calculations for further analysis" caption="Export Grafana moving average calculations for further analysis" />
