...
<Figure
  src="/img/guides/2024/12/divide-two-metrics-in-prometheus-image.webp"
  alt="Average request rate: HTTP requests divided by total duration"
  caption="Average request rate: HTTP requests divided by total duration"
/>
...
1. Implementing Complex Calculations:
   ...
   <Figure
     src="/img/guides/2024/12/divide-two-metrics-in-prometheus-image%201.webp"
     alt="Ratio of requests with latency ≤2.5s to total requests"
     caption="Ratio of requests with latency ≤2.5s to total requests"
   />
...
2. Use Subqueries for Time-based Comparisons:
   ...
   <Figure
     src="/img/guides/2024/12/divide-two-metrics-in-prometheus-image%202.webp"
     alt="15-minute avg request rate vs 1-hour rate for traffic stability"
     caption="15-minute avg request rate vs 1-hour rate for traffic stability"
   />
...
3. Apply Mathematical Functions to Division Results:
   ...
   <Figure
     src="/img/guides/2024/12/divide-two-metrics-in-prometheus-image%203.webp"
     alt="Rounding up requests per second for precise performance analysis."
     caption="Rounding up requests per second for precise performance analysis."
   />
...
<Figure
  src="/img/guides/2024/12/divide-two-metrics-in-prometheus-image%204.webp"
  alt="Success rate calculation with zero-division protection using clamp_min"
  caption="Success rate calculation with zero-division protection using clamp_min"
/>
...
1. Set up Prometheus as a Data Source in Grafana
   - Navigate to Connections → Data Sources → Add data source in the left side panel.
     {' '}
     <Figure
       src="/img/guides/2024/12/divide-two-metrics-in-prometheus-image%205.webp"
       alt="Adding a data source in Grafana"
       caption="Adding a data source in Grafana"
     />
   - Enter the Prometheus server URL in the configuration field.
     {' '}
     <Figure
       src="/img/guides/2024/12/divide-two-metrics-in-prometheus-image%206.webp"
       alt="Enter Prometheus server URL in the config field"
       caption="Enter Prometheus server URL in the config field"
     />
...
2. Create a New Dashboard and Panel
   - Navigate to Dashboards → New Dashboard → Click on the Add Visualization button
     {' '}
     <Figure
       src="/img/guides/2024/12/divide-two-metrics-in-prometheus-image%207.webp"
       alt="Create a new dashboard and add a visualization"
       caption="Create a new dashboard and add a visualization"
     />
   - Select Prometheus from the data source dropdown
     {' '}
     <Figure
       src="/img/guides/2024/12/divide-two-metrics-in-prometheus-image%208.webp"
       alt="Select Prometheus as the data source"
       caption="Select Prometheus as the data source"
     />
...
3. Input Your PromQL Expression
   - In the query editor, enter your metric division expression. For example, to calculate the average request duration:
     ...
     {' '}
     <Figure
       src="/img/guides/2024/12/divide-two-metrics-in-prometheus-image%209.webp"
       alt="Visualizing the 5-minute error rate."
       caption="Visualizing the 5-minute error rate."
     />
4. Configure Visualization Options
   ...
   - Use appropriate graph types (Time series for trends, Gauge for current ratios)
     {' '}
     <Figure
       src="/img/guides/2024/12/divide-two-metrics-in-prometheus-image%2010.webp"
       alt="Enhance Visualization with Histogram Transformation for Performance Trends"
       caption="Enhance Visualization with Histogram Transformation for Performance Trends"
     />
...
- Native PromQL support
  ...
  {' '}
  <Figure
    src="/img/guides/2024/12/divide-two-metrics-in-prometheus-image%2011.webp"
    alt="Leveraging PromQL Query for custom dashboard generation"
    caption="Leveraging PromQL Query for custom dashboard generation"
  />
- Visualizing Divided Metrics
  ...
  {' '}
  <Figure
    src="/img/guides/2024/12/divide-two-metrics-in-prometheus-image%2012.webp"
    alt="Tracking CPU Load Trends: 5-Min vs. 1-Min Average Ratio"
    caption="Tracking CPU Load Trends: 5-Min vs. 1-Min Average Ratio"
  />
- Proactive Alerts Based on Divided Metrics
  ...
  {' '}
  <Figure
    src="/img/guides/2024/12/divide-two-metrics-in-prometheus-image%2013.webp"
    alt="Custom Alerts Based on PromQL Queries for CPU Load Monitoring"
    caption="Custom Alerts Based on PromQL Queries for CPU Load Monitoring"
  />
