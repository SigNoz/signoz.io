...
<Figure
  src="/img/guides/2024/10/prometheus-instant-vector-vs-range-vector-image.webp"
  alt="Components of Prometheus time series"
  caption="Components of Prometheus time series"
/>
...
1. Simple metric selection:
   ...
   <Figure
     src="/img/guides/2024/10/prometheus-instant-vector-vs-range-vector-image%201.webp"
     alt="Simple metric selection using instant vector"
     caption="Simple metric selection using instant vector"
   />
...
2. Label matching:
   ...
   <Figure
     src="/img/guides/2024/10/prometheus-instant-vector-vs-range-vector-image%202.webp"
     alt="Label matching using instant vector"
     caption="Label matching using instant vector"
   />
...
3. Applying functions:
   ...
   <Figure
     src="/img/guides/2024/10/prometheus-instant-vector-vs-range-vector-image%203.webp"
     alt="Applying functions using instant vector"
     caption="Applying functions using instant vector"
   />
...
<Figure
  src="/img/guides/2024/10/prometheus-instant-vector-vs-range-vector-image%204.webp"
  alt="Range Vectors in Prometheus"
  caption="Range Vectors in Prometheus"
/>
...
1. Calculating rates:
   ...
   <Figure
     src="/img/guides/2024/10/prometheus-instant-vector-vs-range-vector-image%205.webp"
     alt="Calculating rates using range vector"
     caption="Calculating rates using range vector"
   />
...
2. Detecting anomalies:
   ...
   <Figure
     src="/img/guides/2024/10/prometheus-instant-vector-vs-range-vector-image%206.webp"
     alt="Detecting anomalies using range vector"
     caption="Detecting anomalies using range vector"
   />

   <Figure
     src="/img/guides/2024/10/prometheus-instant-vector-vs-range-vector-image%207.webp"
     alt=""
     caption=""
   />
   3. Aggregating data:
   ...
   <Figure
     src="/img/guides/2024/10/prometheus-instant-vector-vs-range-vector-image%208.webp"
     alt="Aggregating data using range vector"
     caption="Aggregating data using range vector"
   />
...
- Enhanced Visualization: SigNoz offers out-of-the-box dashboards that improve the readability of vector-based queries.
  {' '}
  <Figure
    src="/img/guides/2024/10/prometheus-instant-vector-vs-range-vector-image%209.webp"
    alt="Enhanced Visualization of vectors using SigNoz"
    caption="Enhanced Visualization of vectors using SigNoz"
  />
...
- Traceability and Context: SigNoz provides a holistic view of your application by integrating traces, logs, and metrics. This enables you to correlate metrics from Prometheus with traces to identify the root cause of performance issues more efficiently.
  {' '}
  <Figure
    src="/img/guides/2024/10/prometheus-instant-vector-vs-range-vector-image%2010.webp"
    alt="Holistic view of traces, logs and metrics using SigNoz"
    caption="Holistic view of traces, logs and metrics using SigNoz"
  />
- Customizable Alerts: SigNoz allows for setting up advanced alerting mechanisms based on your vector queries, ensuring that you receive timely notifications about any anomalies or performance degradation in your application.
  {' '}
  <Figure
    src="/img/guides/2024/10/prometheus-instant-vector-vs-range-vector-07a00ed9-5e18-447b-85c3-e257142e8abf.webp"
    alt="Customizable Alerts in SigNoz"
    caption="Customizable Alerts in SigNoz"
  />
