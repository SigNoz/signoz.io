...
2. Detecting anomalies:
    ...
    <Figure src="/img/guides/2024/10/prometheus-instant-vector-vs-range-vector-image%207.webp" alt="Prometheus range vector example showing aggregated request rate by method" caption="" />3. Aggregating data:
