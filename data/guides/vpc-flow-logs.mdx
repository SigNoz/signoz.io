...
authors:
  ...
  - yuvraj
description: >-
  Deep dive into VPC Flow Logs architecture. Understand capture mechanisms,
  aggregation intervals, record format versions and troubleshooting patterns.
keywords:
  - vpc flow logs
  - aws vpc flow logs
  - flow logs format
  - vpc flow logs architecture
  - flow logs record format
