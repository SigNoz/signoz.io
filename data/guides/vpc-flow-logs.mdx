  ...
  <script
    ...
    dangerouslySetInnerHTML={{
      __html: JSON.stringify({
        ...
        alternativeHeadline:
          'Understanding, Implementing, and Analyzing VPC Flow Logs for Network Monitoring and Security',
        author: {
          '@type': 'Person',
          name: 'Daniel',
        },
        ...
        description:
          'VPC flow logs are a network monitoring feature that captures detailed information about the IP traffic entering and leaving your Virtual Private Cloud (VPC). This includes details such as source/destination IP addresses, ports, protocols, and data volume.',
        keywords: 'logs, log monitoring, vpc, signoz',
        ...
        about: [
          {
            ...
            name: 'VPC Flow Logs',
            description:
              'A feature that captures information about IP traffic going to and from network interfaces in a VPC',
          },
          {
            '@type': 'Thing',
          ...
          },
          {
            ...
            name: 'Cloud Security',
            description:
              'Measures and controls that protect data, applications, and infrastructure associated with cloud computing',
          },
        ],
        mentions: [
          {
