...
If you want to [get started](https://signoz.io/docs/infrastructure-monitoring/hostmetrics/) quickly with PostgreSQL monitoring, you can [load](https://github.com/SigNoz/dashboards/tree/main/postgresql) this JSON  dashboard config in the SigNoz dashboard UI.
