...
meta_title: "Database Monitoring: Metrics and Setup"
published_date: 2024-08-07
updated_date: 2026-06-29
tags: [monitoring]
authors: [eromosele]
description: "Database monitoring in 2026: track query performance, connections, and resource metrics with OpenTelemetry and SigNoz. Metrics, setup, and best practices."
...
On collection, the modern, vendor-neutral path is the [OpenTelemetry Collector](https://signoz.io/blog/opentelemetry-collector-complete-guide/), which ships dedicated receivers for major engines (PostgreSQL, MySQL, MongoDB, Redis, and more) to gather query, connection, and resource metrics and forward them over [OTLP](https://signoz.io/blog/what-is-otlp/) to a backend like SigNoz, rather than running a separate agent per database.
...
- Ensure that an [OTEL collector](https://signoz.io/blog/opentelemetry-collector-complete-guide/) is running in your deployment environment
    ...
    If needed, please [install an OTEL Collector](https://signoz.io/docs/opentelemetry-collection-agents/vm/install/), if already installed, ensure that the collector version is v0.116.0 or newer.
...
Once the above setup is done, you will be able to access the metrics in the SigNoz dashboard. Go to the `Dashboards` tab in the SigNoz UI and try adding a new panel. You can learn how to create dashboards in SigNoz [here](https://signoz.io/docs/userguide/manage-dashboards/). When you begin to load your database, the metrics will be automatically generated, allowing you to monitor your database metrics in real-time.

PostgreSQL Metrics

<Figure src="/img/guides/2024/08/database-monitoring-Untitled 1.webp" alt="SigNoz Panel PostgreSQL Metrics to add on Dashboard" caption="SigNoz Panel PostgreSQL Metrics to add on Dashboard" />

If you want to [get started](https://signoz.io/docs/infrastructure-monitoring/user-guides/hostmetrics/) quickly with PostgreSQL monitoring, you can [load](https://github.com/SigNoz/dashboards/tree/main/postgresql) this JSON  dashboard config in the SigNoz dashboard UI.

PostgreSQL Basic Metrics Dashboard

<Figure src="/img/guides/2024/08/database-monitoring-Untitled 2.webp" alt="SigNoz PostgreSQL Dashboard" caption="SigNoz PostgreSQL Dashboard" />
...
For further reading, check out the following: [database monitoring tools](https://signoz.io/comparisons/database-monitoring-tools/), [Cassandra monitoring](https://signoz.io/guides/cassandra-monitoring/), [PostgreSQL monitoring](https://signoz.io/blog/postgresql-monitoring/), [APM tools](https://signoz.io/blog/apm-tools/), and [MongoDB monitoring](https://signoz.io/blog/mongodb-monitoring/).
