...
<Figure
  src="/img/guides/2024/08/database-monitoring-Untitled.webp"
  alt="You can find ingestion details in the SigNoz dashboard"
  caption="You can find ingestion details in the SigNoz dashboard"
/>
...
<Figure
  src="/img/guides/2024/08/database-monitoring-Untitled%201.webp"
  alt="SigNoz Panel PostgreSQL Metrics to add on Dashboard"
  caption="SigNoz Panel PostgreSQL Metrics to add on Dashboard"
/>
...
<Figure
  src="/img/guides/2024/08/database-monitoring-Untitled%202.webp"
  alt="SigNoz PostgreSQL Dashboard"
  caption="SigNoz PostgreSQL Dashboard"
/>
