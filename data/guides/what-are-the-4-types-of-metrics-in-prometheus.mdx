  ...
  <script
    ...
    dangerouslySetInnerHTML={{
      __html: JSON.stringify({
        ...
        keywords:
          'Prometheus metrics, monitoring, observability, counters, gauges, histograms, summaries',
        ...
        about: [
          {
            ...
            description:
              'Numerical measurements collected at regular intervals to monitor the health, performance, and behavior of systems and applications.',
          },
          {
            '@type': 'Thing',
            name: 'Counters',
            description:
              'Metrics that represent cumulative values that only increase over time, ideal for tracking events, requests, or occurrences.',
          },
          {
            '@type': 'Thing',
            name: 'Gauges',
            description:
              'Metrics representing single numerical values that can arbitrarily go up and down, useful for measuring current states or values that fluctuate.',
          },
          {
            '@type': 'Thing',
            name: 'Histograms',
            description:
              'Metrics that measure the distribution of values across predefined buckets, valuable for understanding the spread and concentration of data points.',
          },
          {
            '@type': 'Thing',
            name: 'Summaries',
            description:
              'Metrics that calculate streaming φ-quantiles (percentiles) over a sliding time window, useful for precise percentile calculations.',
          },
        ],
        mentions: [
          {
