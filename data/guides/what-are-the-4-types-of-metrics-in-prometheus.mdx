    ...
    "mainEntity": {
      ...
      "mainEntity": [
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Prometheus can handle millions of time series, but practical limits depend on your hardware resources. High cardinality (many unique label combinations) can impact performance more than the total number of metrics. [Monitor Prometheus](https://signoz.io/guides/how-do-i-monitor-api-in-prometheus/)' resource usage and optimize your metrics accordingly."
          }
        }
      ]
    },
