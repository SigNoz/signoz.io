...
- Monitoring Permissions and Access: Implement AWS CloudTrail to [monitor API calls](https://signoz.io/guides/how-do-i-monitor-api-in-prometheus/) and ensure that Lambda functions are not being invoked by unauthorized users or roles.
