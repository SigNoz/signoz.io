...
related_articles: ['/guides/aws-monitoring', '/guides/ec2-monitoring', '/guides/aws-observability', '/comparisons/aws-monitoring-tools', '/blog/cloudwatch-alternatives', '/blog/cloudwatch-metrics']
---
