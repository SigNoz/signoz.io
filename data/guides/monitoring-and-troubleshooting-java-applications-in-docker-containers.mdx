...
<Figure
  src="/img/guides/2024/08/monitoring-and-troubleshooting-java-applications-in-docker-containers-Untitled.webp"
  alt="Adding Port Number in Fluentd"
  caption="Adding Port Number in Fluentd"
/>
...
<Figure
  src="/img/guides/2024/08/monitoring-and-troubleshooting-java-applications-in-docker-containers-Untitled%201.webp"
  alt="Running Java application in Docker Container."
  caption="Running Java application in Docker Container."
/>
...
- Navigate to `http://localhost:<localhost portnumber>` in your web browser or view it in Docker stats. By default the port number is `9090:9090.`
  {' '}
  <Figure
    src="/img/guides/2024/08/monitoring-and-troubleshooting-java-applications-in-docker-containers-Untitled%202.webp"
    alt="link to prometheus local host"
    caption="link to prometheus local host"
  />
  <Figure
    src="/img/guides/2024/08/monitoring-and-troubleshooting-java-applications-in-docker-containers-Untitled%203.webp"
    alt="Prometheus Browser page"
    caption="Prometheus Browser page"
  />
...
- Use PromQL to query metrics and visualize them.
  {' '}
  <Figure
    src="/img/guides/2024/08/monitoring-and-troubleshooting-java-applications-in-docker-containers-0e38c5de-d0ef-4c3d-ab33-a385a505021c.webp"
    alt="Visualizing Prometheus Stats"
    caption="Visualizing Prometheus Stats"
  />
...
- JVM Heap Usage: Container memory limits can affect JVM memory allocation. Ensure your JVM settings align with container resources.
  ...
  {' '}
  <Figure
    src="/img/guides/2024/08/monitoring-and-troubleshooting-java-applications-in-docker-containers-Untitled%204.webp"
    alt="JVM heap usage in Docker"
    caption="JVM heap usage in Docker"
  />
  <Figure
    src="/img/guides/2024/08/monitoring-and-troubleshooting-java-applications-in-docker-containers-Untitled%205.webp"
    alt="CPU, memory usage and other stats"
    caption="CPU, memory usage and other stats"
  />
...
1. Java OutOfMemoryErrors:
   ...
   <Figure
     src="/img/guides/2024/08/monitoring-and-troubleshooting-java-applications-in-docker-containers-Untitled%206.webp"
     alt="Java out of memory error"
     caption="Java out of memory error"
   />
...
<Figure
  src="/img/guides/2024/08/monitoring-and-troubleshooting-java-applications-in-docker-containers-Untitled%207.webp"
