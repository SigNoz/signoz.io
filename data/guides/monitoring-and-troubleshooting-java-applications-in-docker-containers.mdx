...
related_articles:
  - '/guides/monitoring-java-applications'
  - '/guides/jmx-monitoring'
  - '/guides/java-application-profiling'
...
3. [Log Aggregation Tools](https://signoz.io/blog/best-log-management-tools/):
...
<Figure src="/img/guides/2024/08/monitoring-and-troubleshooting-java-applications-in-docker-containers-Untitled 1.webp" alt="Running Java application in Docker Container." caption="Running Java application in Docker Container." />
...
- Navigate to `http://localhost:<localhost portnumber>` in your web browser or view it in Docker stats. By default the port number is `9090:9090.`
    ...
    <Figure src="/img/guides/2024/08/monitoring-and-troubleshooting-java-applications-in-docker-containers-Untitled 2.webp" alt="link to prometheus local host" caption="link to prometheus local host" />
    
    <Figure src="/img/guides/2024/08/monitoring-and-troubleshooting-java-applications-in-docker-containers-Untitled 3.webp" alt="Prometheus Browser page" caption="Prometheus Browser page" />
...
We can also use SigNoz with the Docker to monitor and analyze our Java Applicaiton. To instrument your Java application to send metrics to SigNoz. You can use [OpenTelemetry](https://signoz.io/opentelemetry/) for this purpose. 
...
- JVM Heap Usage: Container memory limits can affect JVM memory allocation. Ensure your JVM settings align with container resources.
    ...
    <Figure src="/img/guides/2024/08/monitoring-and-troubleshooting-java-applications-in-docker-containers-Untitled 4.webp" alt="JVM heap usage in Docker" caption="JVM heap usage in Docker" />
    
    <Figure src="/img/guides/2024/08/monitoring-and-troubleshooting-java-applications-in-docker-containers-Untitled 5.webp" alt="CPU, memory usage and other stats" caption="CPU, memory usage and other stats" /> 
...
1. Java OutOfMemoryErrors:
    ...
    <Figure src="/img/guides/2024/08/monitoring-and-troubleshooting-java-applications-in-docker-containers-Untitled 6.webp" alt="Java out of memory error" caption="Java out of memory error" />
...
3. [Distributed Tracing](https://signoz.io/blog/distributed-tracing/):
    - Implement OpenTelemetry for end-to-end request tracing across microservices. To learn more about OpenTelemetry [visit](https://signoz.io/blog/what-is-distributed-tracing-in-opentelemetry/).
...
3. Configure the [OpenTelemetry agent](https://signoz.io/blog/opentelemetry-collector-complete-guide/) to send data to SigNoz.
4. View metrics, traces, and logs in the SigNoz dashboard.

<Figure src="/img/guides/2024/08/monitoring-and-troubleshooting-java-applications-in-docker-containers-Untitled 7.webp" alt="Signoz Dashboard" caption="Signoz Dashboard" />
