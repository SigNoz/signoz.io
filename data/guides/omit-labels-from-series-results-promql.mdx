...
<Figure src="/img/guides/2024/11/omit-labels-from-series-results-promql-image%205.webp" alt="PromQL query showing omitted instance and pod labels" caption="" />### Example: Omitting Instance and Pod Labels
