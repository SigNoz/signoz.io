...
related_articles: ['/guides/what-are-prometheus-labels', '/guides/what-are-the-limitations-of-prometheus-labels', '/guides/how-can-i-group-labels-in-a-prometheus-query', '/blog/prometheus-query']
---
...
<Figure src="/img/guides/2024/11/omit-labels-from-series-results-promql-image 1.webp" alt="Using without clause to remove labels" caption="Using without clause to remove labels" />
...
<Figure src="/img/guides/2024/11/omit-labels-from-series-results-promql-image 2.webp" alt="Using by clause to keep labels" caption="Using by clause to keep labels" />
...
<Figure src="/img/guides/2024/11/omit-labels-from-series-results-promql-image 3.webp" alt="Query result without label replacement" caption="Query result without label replacement" />

<Figure src="/img/guides/2024/11/omit-labels-from-series-results-promql-image 4.webp" alt="Query result with new result" caption="Query result with new result" />
...
<Figure src="/img/guides/2024/11/omit-labels-from-series-results-promql-image 5.webp" alt="PromQL query showing omitted instance and pod labels" caption="" />### Example: Omitting Instance and Pod Labels
...
<Figure src="/img/guides/2024/11/omit-labels-from-series-results-promql-image 6.webp" alt="Regex-based Label Selection" caption="Regex-based Label Selection" />
...
<Figure src="/img/guides/2024/11/omit-labels-from-series-results-promql-image 7.webp" alt="Label Joins for Complex Data Relationships" caption="Label Joins for Complex Data Relationships" />
...
1. Streamline Legend Entries: Use PromQL to omit unnecessary labels, resulting in cleaner legends:
    ...
    <Figure src="/img/guides/2024/11/omit-labels-from-series-results-promql-image 8.webp" alt="Streamline Legend Entries" caption="Streamline Legend Entries" />
...
2. Utilize Grafana's Label Filters: Complement PromQL label omission with Grafana's built-in label filters for dynamic visualizations.
    ...
    <Figure src="/img/guides/2024/11/omit-labels-from-series-results-promql-image 9.webp" alt="Utilize Grafana's Label Filters" caption="Utilize Grafana's Label Filters" />
...
3. Create Template Variables: Use Grafana template variables to allow users to select which label values to include or exclude dynamically. Check out the <a href="https://grafana.com/docs/grafana/latest/dashboards/variables/" rel="noopener noreferrer nofollow" target="_blank">steps for creating a template variable in Grafana.</a>  
    ...
    <Figure src="/img/guides/2024/11/omit-labels-from-series-results-promql-image 10.webp" alt="Create Template Variables" caption="Create Template Variables" />
...
1. Automatic [Context Propagation](https://signoz.io/blog/opentelemetry-context-propagation/): SigNoz automatically propagates relevant labels across services, reducing the need for manual label management.
    ...
    <Figure src="/img/guides/2024/11/omit-labels-from-series-results-promql-image 11.webp" alt="Automatic Context Propagation: SigNoz" caption="Automatic Context Propagation: SigNoz" />
...
3. Custom Attribute Mapping: SigNoz allows you to map custom attributes to labels, giving you fine-grained control over what information is included in your metrics.
    ...
    <Figure src="/img/guides/2024/11/omit-labels-from-series-results-promql-image 12.webp" alt="Custom Attribute Mapping: SigNoz" caption="Custom Attribute Mapping: SigNoz" /> 
