...
related_articles: ['/guides/what-are-prometheus-labels', '/guides/how-to-add-target-specific-label-in-prometheus', '/guides/what-is-prometheus-target', '/guides/what-is-Prometheus-used-for-in-DevOps', '/guides/how-to-write-a-prometheus-query-that-returns-the-value-of-the-label', '/guides/what-is-prometheus-for-monitoring']
---
