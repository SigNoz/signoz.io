...
keywords:
  [Kubernetes, CPU usage, Prometheus, container monitoring, PromQL, Grafana, resource optimization]
---
  ...
  <script
    ...
    dangerouslySetInnerHTML={{
      __html: JSON.stringify({
        ...
        alternativeHeadline:
          'Calculate Container CPU Usage in Kubernetes with Prometheus Monitoring',
        author: {
          '@type': 'Person',
          name: 'Ankit Anand',
        },
        ...
        about: [
          ...
          },
          {
            ...
            name: 'CPU Usage',
            description:
              'A measure of the amount of computational power used by processes in a computing environment.',
          },
          {
            '@type': 'Thing',
            name: 'PromQL',
