...
related_articles: ['/guides/prometheus-queries-to-get-cpu-and-memory-usage-in-kubernetes-pods', '/guides/how-to-monitor-custom-kubernetes-pod-metrics-using-prometheus', '/guides/kubernetes-monitoring-prometheus', '/guides/how-to-get-number-of-pods-running-in-prometheus', '/guides/does-kubernetes-use-prometheus', '/guides/how-to-install-prometheus-and-grafana-on-kubernetes']
---
