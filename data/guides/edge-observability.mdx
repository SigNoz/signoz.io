...
<Figure
  src="/img/guides/2024/11/edge-observability-image 1.webp"
...
<Figure
  src="/img/guides/2024/11/edge-observability-image 2.webp"
...
2. Instrument Your Edge Applications with [OpenTelemetry](https://signoz.io/opentelemetry/)
...
- [Java](/docs/introduction/instrumentation/java/opentelemetry-java/)
- [Javascript](/docs/introduction/instrumentation/javascript/opentelemetry-nodejs/)
- [Python](/docs/introduction/instrumentation/opentelemetry-python/)
- [Golang](/docs/introduction/instrumentation/opentelemetry-golang/)
- [AWS Monitoring](/docs/introduction/aws-monitoring/ec2/)
- [GCP Monitoring](/docs/introduction/gcp-monitoring/bootstrapping/)
- [Azure Monitoring](/docs/introduction/azure-monitoring/bootstrapping/)
- [View all documentation →](/docs/introduction/)
