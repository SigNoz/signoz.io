...
related_articles: ['/blog/kubernetes-metrics-server', '/blog/opentelemetry-kubernetes', '/guides/is-there-a-way-to-monitor-kube-cron-jobs-using-prometheus', '/guides/does-kubernetes-use-prometheus']
