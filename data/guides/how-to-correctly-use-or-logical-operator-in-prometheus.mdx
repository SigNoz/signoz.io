      ...
      __html: JSON.stringify({
        ...
        about: [
          ...
          },
          {
            ...
            name: 'OR Operator',
            description:
              'Logical operator used to combine multiple conditions in Prometheus queries.',
          },
          {
            '@type': 'Thing',
            name: 'Regex',
            description:
              'A sequence of characters that define a search pattern, often used for string matching within Prometheus queries.',
          },
        ],
        mentions: [
          {
