...
keywords:
  [Prometheus, null values, time series data, PromQL, Grafana, data visualization, SigNoz, metrics]
---
...
<Figure
  src="/img/guides/2024/10/time-series-from-prometheus-source-how-to-set-nulls-as-zero-image.webp"
  alt="Gaps in Prometheus Data"
  caption="Gaps in Prometheus Data"
/>
...
1. Using `or vector(0)`
   ...
   <Figure
     src="/img/guides/2024/10/time-series-from-prometheus-source-how-to-set-nulls-as-zero-image%201.webp"
     alt="Handling missing data using vector(0)"
     caption="Handling missing data using vector(0)"
   />
...
2. Utilizing the `absent()` Function
   ...
   <Figure
     src="/img/guides/2024/10/time-series-from-prometheus-source-how-to-set-nulls-as-zero-image%202.webp"
     alt="Handling missing data using absent()"
     caption="Handling missing data using absent()"
   />
...
1. Applying `group_left` and `group_right` for Label Matching
   ...
   <Figure
     src="/img/guides/2024/10/time-series-from-prometheus-source-how-to-set-nulls-as-zero-image%203.webp"
     alt="Handling missing data using group_left()"
     caption="Handling missing data using group_left()"
   />
...
2. Using `absent_over_time()` for Detecting Long-Term Absences
   ...
   <Figure
     src="/img/guides/2024/10/time-series-from-prometheus-source-how-to-set-nulls-as-zero-image%204.webp"
     alt="Handling missing data using absent_over_time()"
     caption="Handling missing data using absent_over_time()"
   />
