  ...
  <script
    ...
    dangerouslySetInnerHTML={{
      __html: JSON.stringify({
        ...
        alternativeHeadline:
          "Discover Jaeger's Metrics Capabilities and Integrations for Comprehensive Performance Monitoring",
        author: {
          '@type': 'Person',
          name: 'Ankit Anand',
        },
        ...
        keywords:
          'Jaeger metrics, performance monitoring, distributed tracing, Prometheus, OpenTelemetry, service performance monitoring',
        ...
        about: [
          ...
          },
          {
            ...
            name: 'OpenTelemetry',
            description:
              'A collection of tools, APIs, and SDKs for instrumenting, generating, collecting, and exporting telemetry data such as metrics, logs, and traces.',
          },
          {
            '@type': 'Thing',
            name: 'Service Performance Monitoring',
            description:
              'Monitoring the performance of various services to ensure they meet performance and availability standards.',
          },
        ],
        mentions: [
          {
