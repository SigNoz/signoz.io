...
authors:
  - ankit_anand
description: >-
  Discover Jaeger's metrics capabilities, learn how to enable and visualize
  performance data, and integrate with other monitoring tools for comprehensive
  system insights.
keywords:
  - Jaeger metrics
...
Here's a basic example of using [OpenTelemetry](https://signoz.io/opentelemetry/) to send both traces and metrics to Jaeger:
