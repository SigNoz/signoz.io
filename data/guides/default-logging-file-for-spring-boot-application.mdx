...
<Figure
  src="/img/guides/2024/08/default-logging-file-for-spring-boot-application-Screenshot_2024-08-25_132022.webp"
  alt="Understanding Spring Boot's Default Logging Behavior"
  caption="Understanding Spring Boot's Default Logging Behavior"
/>
...
2. Add the Following Properties to configure the file name, location, and log level:
   ...
   <Figure
     src="/img/guides/2024/08/default-logging-file-for-spring-boot-application-Screenshot_2024-08-28_220037.webp"
     alt="Console Output"
     caption="Console Output"
   />

   <Figure
     src="/img/guides/2024/08/default-logging-file-for-spring-boot-application-image.webp"
     alt="This is the output we will get after running the application, in this `demofile.log`."
     caption="This is the output we will get after running the application, in this `demofile.log`."
   />
...
<Figure
  src="/img/guides/2024/08/default-logging-file-for-spring-boot-application-5bb57452-de7f-4549-9f61-78bd101a9761.webp"
  alt="Implementing Rolling File Appenders with Logback"
  caption="Implementing Rolling File Appenders with Logback"
/>
...
<Figure
  src="/img/guides/2024/08/default-logging-file-for-spring-boot-application-image%201.webp"
  alt="Customizing Log Format and Patterns"
  caption="Customizing Log Format and Patterns"
/>
...
3. Modify logging as follows:
   ...
   <Figure
     src="/img/guides/2024/08/default-logging-file-for-spring-boot-application-d1fc62b5-2feb-4840-89e4-da7f9b02d3a1.webp"
     alt="Configuring Logging using `logback.xml`"
     caption="Configuring Logging using `logback.xml`"
   />
...
<Figure
  src="/img/guides/2024/08/default-logging-file-for-spring-boot-application-opentelemetry-spring-boot-logs-apply-filter.webp"
  alt="Logs tab in SigNoz, Spring Boot Application"
  caption="Logs tab in SigNoz, Spring Boot Application"
/>
