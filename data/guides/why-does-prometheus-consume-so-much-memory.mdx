...
related_articles: ['/guides/average-memory-usage-query-prometheus', '/guides/how-to-increase-prometheus-storage-retention', '/guides/what-is-prometheus-for-monitoring', '/guides/prometheus-queries-to-get-cpu-and-memory-usage-in-kubernetes-pods', '/guides/what-are-the-limitations-of-prometheus-labels', '/guides/how-to-get-all-the-metrics-of-an-instance-with-prometheus-api']
---
