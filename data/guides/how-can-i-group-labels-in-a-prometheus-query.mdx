...
related_articles: ['/guides/how-to-write-a-prometheus-query-that-returns-the-value-of-the-label', '/guides/prometheus-query-to-count-unique-label-values', '/blog/prometheus-query', '/guides/how-to-add-target-specific-label-in-prometheus', '/guides/what-are-prometheus-labels', '/guides/how-can-i-join-two-metrics-in-a-prometheus-query']
---
