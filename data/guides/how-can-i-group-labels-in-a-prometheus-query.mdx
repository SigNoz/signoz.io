  ...
  <script
    ...
    dangerouslySetInnerHTML={{
      __html: JSON.stringify({
        ...
        keywords:
          'Prometheus queries, label grouping, PromQL, metric analysis, data visualization, group() operator, by clause, label_replace()',
        ...
        about: [
          ...
          },
          {
            ...
            name: 'Label Grouping',
            description:
              'A method in Prometheus to organize and aggregate metrics by their labels for better analysis and visualization.',
          },
          {
            '@type': 'Thing',
            name: 'Metric Analysis',
            description:
              'The process of examining and interpreting collected metrics to understand system performance and behavior.',
          },
        ],
        mentions: [
          {
