...
related_articles: ['/guides/what-is-prometheus-for-monitoring', '/blog/opentelemetry-vs-prometheus', '/guides/how-does-prometheus-work', '/guides/prometheus-monitoring-101']
...
<Figure src="/img/guides/2024/12/configure-prometheus-to-use-non-default-port-image 1.webp" alt="Changing Prometheus port" caption="Changing Prometheus port" />
...
2. Enhanced Troubleshooting: With distributed tracing and log correlation, SigNoz helps to troubleshoot issues quickly by linking metrics with the corresponding logs and traces, making root cause analysis more efficient.
    ...
    <Figure src="/img/guides/2024/12/configure-prometheus-to-use-non-default-port-image 2.webp" alt="Enhanced Troubleshooting with distributed tracing and log correlation" caption="Enhanced Troubleshooting with distributed tracing and log correlation" />
...
3. Real-Time Alerting and Dashboards: SigNoz offers powerful real-time alerting and custom dashboards, allowing you to set up complex alerting rules that notify you about system anomalies, complementing the capabilities of Prometheus.
    ...
    <Figure src="/img/guides/2024/12/configure-prometheus-to-use-non-default-port-image 3.webp" alt="Custom Dashboards in SigNoz" caption="Custom Dashboards in SigNoz" />
...
5. Verify Configuration in SigNoz Cloud
    ...
    <Figure src="/img/guides/2024/12/configure-prometheus-to-use-non-default-port-image 4.webp" alt="Verify Configuration in SigNoz Cloud" caption="Verify Configuration in SigNoz Cloud" />
