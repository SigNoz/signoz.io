...
<Figure
  src="/img/guides/2024/12/configure-prometheus-to-use-non-default-port-image.webp"
  alt="Default Prometheus port in 9090"
  caption="Default Prometheus port in 9090"
/>
...
<Figure
  src="/img/guides/2024/12/configure-prometheus-to-use-non-default-port-image%201.webp"
  alt="Changing Prometheus port"
  caption="Changing Prometheus port"
/>
...
2. Enhanced Troubleshooting: With distributed tracing and log correlation, SigNoz helps to troubleshoot issues quickly by linking metrics with the corresponding logs and traces, making root cause analysis more efficient.
   ...
   <Figure
     src="/img/guides/2024/12/configure-prometheus-to-use-non-default-port-image%202.webp"
     alt="Enhanced Troubleshooting with distributed tracing and log correlation"
     caption="Enhanced Troubleshooting with distributed tracing and log correlation"
   />
...
3. Real-Time Alerting and Dashboards: SigNoz offers powerful real-time alerting and custom dashboards, allowing you to set up complex alerting rules that notify you about system anomalies, complementing the capabilities of Prometheus.
   ...
   <Figure
     src="/img/guides/2024/12/configure-prometheus-to-use-non-default-port-image%203.webp"
...
5. Verify Configuration in SigNoz Cloud
   ...
   <Figure
     src="/img/guides/2024/12/configure-prometheus-to-use-non-default-port-image%204.webp"
