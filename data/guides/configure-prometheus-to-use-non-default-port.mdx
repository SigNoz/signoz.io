...
2. Set Up the Prometheus Receiver
    ...
    Once the [OpenTelemetry](https://signoz.io/blog/what-is-opentelemetry/) Collector is installed, configure it to scrape Prometheus metrics. Edit your `otel-collector-config.yaml` file and add a Prometheus receiver configuration:
