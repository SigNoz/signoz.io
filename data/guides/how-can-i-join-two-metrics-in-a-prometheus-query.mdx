---
title: >-
  How can I 'join' two metrics in a Prometheus query? - Joining Metrics in
  PromQL
date: 2024-07-24
tags:
  - faq
...
authors:
  - daniel
description: >-
  Learn how to join two metrics in Prometheus queries using PromQL. Discover
  techniques, best practices, and real-world examples for effective metric
  correlation.
keywords:
  - Prometheus
  - PromQL
