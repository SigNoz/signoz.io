...
SigNoz Cloud supports OpenTelemetry for instrumentation. To illustrate, let’s explore how to instrument a Node.js application, as detailed [in this article](https://signoz.io/docs/instrumentation/javascript/opentelemetry-nodejs/#send-traces-to-signoz-cloud):
