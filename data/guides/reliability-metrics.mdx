...
- [Unified Observability](https://signoz.io/unified-observability/): With SigNoz, you get logs, metrics, and traces all in one platform. This centralization is crucial for understanding reliability metrics, as it lets you see the entire picture of your application’s performance.
  {' '}
  <Figure
    src="/img/guides/2024/12/reliability-metrics-signoz-header-2.webp"
    alt="A clear picture of a SigNoz Dashboard showing logs, metrics and traces on a single platform"
    caption="A clear picture of a SigNoz Dashboard showing logs, metrics and traces on a single platform"
  />
- [Distributed Tracing](https://signoz.io/distributed-tracing/): SigNoz allows you to trace requests across various microservices, making it easier to pinpoint exactly where an issue occurred. This feature is particularly valuable for teams working with complex architectures, as it helps track metrics like Mean Time to Repair (MTTR) by identifying the root cause of issues quickly.
  {' '}
  <Figure
    src="/img/guides/2024/12/reliability-metrics-signoz_flamegraphs.webp"
    alt="Spans of a trace visualized with the help of flamegraphs and gantt charts in SigNoz dashboard"
    caption="Spans of a trace visualized with the help of flamegraphs and gantt charts in SigNoz dashboard"
  />
...
- To connect to SigNoz Cloud, you need an [Ingestion Key](https://signoz.io/docs/ingestion/signoz-cloud/keys/). Navigate to the `Settings` page in the SigNoz UI and click on the `ingestion settings Tab` to generate your `ingestion key`
  {' '}
  <Figure
    src="/img/guides/2024/12/reliability-metrics-FireShot_Capture_001_-_SigNoz_-_Ingestion_Settings_-_guiding-grub.us.signoz.cloud.webp"
    alt="SigNoz UI showing the ingestion settings Tab"
    caption="SigNoz UI showing the ingestion settings Tab"
  />
...
- Click on the Traces tab to see a detailed log of application requests & performance data.
  {' '}
  <Figure
    src="/img/guides/2024/12/reliability-metrics-FireShot_Capture_002_-_SigNoz_-_Traces_Explorer_-_guiding-grub.us.signoz.cloud.webp"
    alt="SigNoz Cloud UI showing request data on the trace section"
    caption="SigNoz Cloud UI showing request data on the trace section"
  />
- Use filters to analyze specific endpoints or services.
  {' '}
  <Figure
    src="/img/guides/2024/12/reliability-metrics-FireShot_Capture_004_-_SigNoz_-_Traces_Explorer_-_guiding-grub.us.signoz.cloud.webp"
    alt="A Trace Explorer showing traces based on time and other filters"
    caption="A Trace Explorer showing traces based on time and other filters"
  />
...
- Drill down into specific errors to understand their root causes.
  {' '}
  <Figure
    src="/img/guides/2024/12/reliability-metrics-FireShot_Capture_005_-_SigNoz_-_Error_Detail_-_guiding-grub.us.signoz.cloud.webp"
    alt="SigNoz Cloud UI showing Exceptions section"
    caption="SigNoz Cloud UI showing Exceptions section"
  />
- Open the Metrics section to track request latency across endpoints.
- Identify bottlenecks and optimize slow-performing API.
  {' '}
  <Figure
    src="/img/guides/2024/12/reliability-metrics-FireShot_Capture_006_-_Open_source_Observability_Platform_-_SigNoz_-_guiding-grub.us.signoz.cloud.webp"
    alt="Overview of the Metrics section"
    caption="Overview of the Metrics section"
  />
...
- Save the alert and test it with sample data
  {' '}
  <Figure
    src="/img/guides/2024/12/reliability-metrics-alerts-create-notification-channel.gif"
    alt="A short demo on how to navigate the Alert section"
    caption="A short demo on how to navigate the Alert section"
  />
...
1. Emerging Metrics for Modern Architectures
   ...
   - Serverless-specific metrics, like _cold start time_ and _invocation success rate_.
