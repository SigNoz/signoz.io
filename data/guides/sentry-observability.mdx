...
<Figure
  src="/img/guides/2025/03/sentry-observability-image%203.webp"
  alt="Sentry Dashboard"
  caption="Sentry Dashboard"
/>
...
<Figure
  src="/img/guides/2025/03/sentry-observability-image%201.webp"
  alt="Key Components of Sentry's Observability Offering"
  caption="Key Components of Sentry's Observability Offering"
/>
...
<Figure
  src="/img/guides/2025/03/sentry-observability-image%202.webp"
  alt="Issues on Sentry"
  caption="Issues on Sentry"
/>
...
<Figure
  src="/img/guides/2025/03/sentry-observability-image%203.webp"
  alt="Detailed Issues tab"
  caption="Detailed Issues tab"
/>
...
<Figure
  src="/img/guides/2025/03/sentry-observability-image%204.webp"
  alt="Fingerprinting on sentry"
  caption="Fingerprinting on sentry"
/>
...
<Figure
  src="/img/guides/2025/03/sentry-observability-image%208.webp"
  alt="Trace View Sentry"
  caption="Trace View Sentry"
/>

Similarly, you can also view it on the Transactions Summary page

<Figure
  src="/img/guides/2025/03/sentry-observability-image%209.webp"
  alt="Transaction Summary Sentry"
  caption="Transaction Summary Sentry"
/>
...
<Figure
  src="/img/guides/2025/03/sentry-observability-image%2010.webp"
  alt="Feedback collected via the Crash-Report Modal"
  caption="Feedback collected via the Crash-Report Modal"
/>
...
<Figure
  src="/img/guides/2025/03/sentry-observability-image%2011.webp"
  alt="User Feedback: Crash Reporting Modal"
  caption="User Feedback: Crash Reporting Modal"
/>
...
<Figure
  src="/img/guides/2025/03/sentry-observability-image%2012.webp"
  alt="Performance Tab in Sentry"
  caption="Performance Tab in Sentry"
/>
...
<Figure
  src="/img/guides/2025/03/sentry-observability-image%2013.webp"
  alt="Sentry Performance Transactions Summary (Credit: Sentry)"
  caption="Sentry Performance Transactions Summary (Credit: Sentry)"
/>
...
<Figure
  src="/img/guides/2025/03/sentry-observability-image%2015.webp"
  alt="Trace View Page"
  caption="Trace View Page"
/>
...
<Figure
  src="/img/guides/2025/03/sentry-observability-image%2018.webp"
  alt="User Feedback in Sentry (Credit: Sentry)"
  caption="User Feedback in Sentry (Credit: Sentry)"
/>
...
<Figure
  src="/img/guides/2025/03/sentry-observability-image%2019.webp"
  alt="Strengths of Sentry in Modern DevOps Practices"
  caption="Strengths of Sentry in Modern DevOps Practices"
/>
...
<Figure
  src="/img/guides/2025/03/sentry-observability-image%2020.webp"
  alt="Sentry Alert"
  caption="Sentry Alert"
/>
...
<Figure
  src="/img/guides/2025/03/sentry-observability-image%2021.webp"
  alt="Sentry New Alert Rule"
  caption="Sentry New Alert Rule"
/>
...
<Figure
  src="/img/guides/2025/03/sentry-observability-image%2022.webp"
  alt="Sentry User Feedback"
  caption="Sentry User Feedback"
/>
...
<Figure
  src="/img/guides/2025/03/sentry-observability-image%2023.webp"
  alt="Sentry Breadcrumb section"
  caption="Sentry Breadcrumb section"
/>
...
<Figure
  src="/img/guides/2025/03/sentry-observability-image%2024.webp"
  alt="Trace View in Sentry"
  caption="Trace View in Sentry"
/>
...
<Figure
  src="/img/guides/2025/03/sentry-observability-image%2026.webp"
  alt="SKDs supported by sentry"
  caption="SKDs supported by sentry"
/>
