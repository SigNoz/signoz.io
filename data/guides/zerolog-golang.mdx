  ...
  <script
    ...
    dangerouslySetInnerHTML={{
      __html: JSON.stringify({
        ...
        alternativeHeadline:
          'Master Golang logging with Zerolog - Learn setup, configuration, and advanced features for efficient, structured logging',
        author: {
          '@type': 'Person',
          name: 'Eromosele',
        },
...
```json
{
  ...
  "time": "2024-07-05T16:41:49+01:00",
  "message": "Excessive disk usage"
}
```
...
<Figure
  src="/img/guides/2024/07/zerolog-golang-Screenshot_2024-07-05_at_17.10.30.webp"
...
<Figure
  src="/img/guides/2024/07/zerolog-golang-Screenshot_2024-07-01_at_14.15.51.webp"
...
<Figure
  src="/img/guides/2024/07/zerolog-golang-Screenshot_2024-07-06_at_02.29.06.webp"
