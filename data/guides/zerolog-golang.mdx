...
authors:
  - eromosele
description: >-
  The article guides on using Zerolog, a high-performance Go logging library. It
  covers installation, usage, log levels, context, prettifying logs, sampling,
  and integration with web apps.
keywords:
  - log
  - logging
  - golang
