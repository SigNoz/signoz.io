...
<Figure src="/img/guides/2024/08/snmp-monitoring-napkin-selection_(14" alt="SNMP Monitoring" caption="SNMP Monitoring" />.webp)
...
<Figure src="/img/guides/2024/08/snmp-monitoring-napkin-selection_(7" alt="SNMP metrics for network monitoring" caption="SNMP metrics for network monitoring" />.webp)
