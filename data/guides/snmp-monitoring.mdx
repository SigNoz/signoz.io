...
If you already run an OpenTelemetry pipeline, the [OpenTelemetry Collector](https://signoz.io/blog/opentelemetry-collector-complete-guide/) ships with an SNMP receiver that polls OIDs from routers, switches, and other network devices and converts them into [OTLP](https://signoz.io/blog/what-is-otlp/) metrics. That lets you fold network-device monitoring into the same pipeline as your hosts and applications instead of operating a separate SNMP tool.
