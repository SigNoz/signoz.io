  ...
  <script
    ...
    dangerouslySetInnerHTML={{
      __html: JSON.stringify({
        ...
        alternativeHeadline:
          'Prometheus Queries for Monitoring Kubernetes Pod CPU and Memory Usage',
        author: {
          '@type': 'Daniel',
          name: 'Yuvraj',
        },
        ...
        keywords:
          'Kubernetes monitoring, Prometheus queries, pod CPU usage, pod memory usage, PromQL, resource metrics, container monitoring',
