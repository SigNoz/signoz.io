...
<Figure
  src="/img/guides/2024/06/Ingestion_Key.webp"
  alt="Ingestion settings"
  caption="Ingestion settings"
/>
<br></br>To create the ConfigMap:
...
<Figure
  src="/img/guides/2024/06/log-monitoring.webp"
  alt="Log monitoring in SigNoz"
  caption="Log monitoring in SigNoz"
/>
<br></br>With SigNoz, you can create custom dashboards tailored to your specific monitoring and
observability needs.
...
<Figure
  ...
  alt="Running queries in the query builder"
  caption="Running queries in the query builder"
/>
<br></br>The above query `k8s_cronjob_active_jobs` set to `k8s_cronjob_name = my-cron-job` returns
the number of active jobs for the CronJob named "my-cronjob".

<Figure
  src="/img/guides/2024/06/cronjob-dashboard.webp"
  alt="CronJob monitoring dashboard"
  caption="CronJob monitoring dashboard"
/>
<br></br>You can execute additional queries and create more visualization in your dashboard as
needed.
