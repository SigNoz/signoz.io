...
For collection, the OpenTelemetry Collector's JMX receiver is the modern approach: it runs the JMX Metric Gatherer against your application's MBeans and emits the results over OTLP. This lets you monitor any JMX-enabled Java service in a vendor-neutral backend like SigNoz without wiring up a separate JMX exporter.
