...
The [UI where you query data](https://signoz.io/blog/opentelemetry-visualization/). A good platform doesn't just show distinct tabs for "Logs" and "Metrics", it links them. When you view a trace, it should automatically show you the logs from that timeframe.
...
- **Java:** [Auto-instrument Java applications using the OTel Java agent](https://signoz.io/docs/instrumentation/java/opentelemetry-java/)
