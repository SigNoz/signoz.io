...
related_articles: ['/guides/understanding-prometheus-rate-vs-increase-functions-correctly', '/guides/what-is-a-bucket-in-prometheus', '/blog/opentelemetry-vs-prometheus', '/guides/what-is-prometheus-for-monitoring']
