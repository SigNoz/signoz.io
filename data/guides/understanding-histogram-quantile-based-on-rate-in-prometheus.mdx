...
1. Request `Rate` Monitoring:
   ...
   <Figure
     src="/img/guides/2024/11/understanding-histogram-quantile-based-on-rate-in-prometheus-6934ff57-80ce-4eb6-836f-a1d003f3af82.webp"
     alt="Monitoring rate of request, normal traffic and spikes"
     caption="Monitoring rate of request, normal traffic and spikes"
   />
...
2. Throughput Analysis:
   ...
   <Figure
     src="/img/guides/2024/11/understanding-histogram-quantile-based-on-rate-in-prometheus-Screenshot_2024-10-28_at_12.18.27_AM.webp"
     alt="Monitoring HTTP requests by the server over 5 min"
     caption="Monitoring HTTP requests by the server over 5 min"
   />{' '}
...
3. CPU Usage Monitoring:
   ...
   <Figure
     src="/img/guides/2024/11/understanding-histogram-quantile-based-on-rate-in-prometheus-Screenshot_2024-10-28_at_12.32.43_AM.webp"
     alt="Monitoring CPU Usage over last 1 minute"
     caption="Monitoring CPU Usage over last 1 minute"
   />
...
3. Sum the Rates and Group by Bucket Boundaries: This query calculates the rate of promotion of objects in memory over a 12-hour window, grouped by the `area` label, which represents different segments of memory (such as heap and non-heap). By summing the rates and grouping by `area`, you can gain insights into how the promoted memory usage distributes across different parts of the Java Virtual Machine.
   ...
   <Figure
     src="/img/guides/2024/11/understanding-histogram-quantile-based-on-rate-in-prometheus-Screenshot_2024-10-30_at_10.45.08_AM.webp"
     alt="Sum Rates to monitor memory activities"
     caption="Sum Rates to monitor memory activities"
   />
