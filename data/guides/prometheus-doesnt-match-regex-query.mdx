...
related_articles:
  ...
  - '/guides/context-deadline-exceeded-prometheus'
  - '/guides/relabel-instance-to-hostname-in-prometheus'
...
- Simplified Querying: Writing complex regex queries in Prometheus can be challenging. SigNoz's built-in functions in the [Query Builder](https://signoz.io/docs/userguide/query-builder-v5/) allow you to construct efficient queries without needing to manually craft regex, saving time and effort.
    
    <Figure src="/img/guides/2024/09/prometheus-doesnt-match-regex-query-image 1.webp" alt="SigNoz Query Builder" caption="SigNoz Query Builder" />
