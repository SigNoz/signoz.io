...
keywords:
  [
    Grafana dashboard duplication,
    duplicate Grafana dashboard,
    Grafana Cloud,
...
<Figure
  src="/img/guides/2024/11/is-it-possible-to-duplicate-a-dashboard-in-grafana-Screenshot_2024-10-22_at_1.36.59_AM.webp"
...
<Figure
  src="/img/guides/2024/11/is-it-possible-to-duplicate-a-dashboard-in-grafana-Screenshot_2024-10-22_at_1.37.57_AM.webp"
  alt="Grafana dashboards page"
  caption="Grafana dashboards page"
/>
...
<Figure
  src="/img/guides/2024/11/is-it-possible-to-duplicate-a-dashboard-in-grafana-Screenshot_2024-10-22_at_1.52.52_AM.webp"
  alt="Grafana Dashboard Settings Page"
  caption="Grafana Dashboard Settings Page"
/>
...
<Figure
  src="/img/guides/2024/11/is-it-possible-to-duplicate-a-dashboard-in-grafana-Screenshot_2024-10-22_at_1.44.59_AM.webp"
  alt="Grafana “Save As” window"
  caption="Grafana “Save As” window"
/>

You will see the duplicated dashboard in your dashboard list.

<Figure
  src="/img/guides/2024/11/is-it-possible-to-duplicate-a-dashboard-in-grafana-Screenshot_2024-10-22_at_2.26.45_AM.webp"
  alt="SigNoz Dashboard Copy"
  caption="SigNoz Dashboard Copy"
/>
...
<Figure
  src="/img/guides/2024/11/is-it-possible-to-duplicate-a-dashboard-in-grafana-f0f8594b-d092-46fc-9dc7-0be5c4fb7a6a.webp"
  alt="Grafana Cloud login page"
  caption="Grafana Cloud login page"
/>
...
<Figure
  src="/img/guides/2024/11/is-it-possible-to-duplicate-a-dashboard-in-grafana-2e245007-1edc-4bd0-aaa3-3ae000d34fd5.webp"
  alt="Click on Settings"
  caption="Click on Settings"
/>
...
<Figure
  src="/img/guides/2024/11/is-it-possible-to-duplicate-a-dashboard-in-grafana-4bfd2d5c-a2ce-4131-b984-115f0cd96b06.webp"
  alt="Click on Save As to copy the dashboard"
  caption="Click on Save As to copy the dashboard"
/>
...
<Figure
  src="/img/guides/2024/11/is-it-possible-to-duplicate-a-dashboard-in-grafana-8c85d0b1-e862-4fa9-9bc7-479cec5c6314.webp"
  alt="Rename the dashboard and description"
  caption="Rename the dashboard and description"
/>
...
<Figure
  src="/img/guides/2024/11/is-it-possible-to-duplicate-a-dashboard-in-grafana-Screenshot_2024-10-30_at_2.34.13_PM.webp"
  alt="Edit the panel names or add new panels"
  caption="Edit the panel names or add new panels"
/>
...
<Figure
  src="/img/guides/2024/11/is-it-possible-to-duplicate-a-dashboard-in-grafana-2a5a66bf-df6d-49f9-9634-b2e6a24a7807.webp"
  alt="Editing Panels"
  caption="Editing Panels"
/>

<Figure
  src="/img/guides/2024/11/is-it-possible-to-duplicate-a-dashboard-in-grafana-Screenshot_2024-10-30_at_2.58.12_PM.webp"
  alt="Updating Panel Title"
  caption="Updating Panel Title"
/>
...
<Figure
  src="/img/guides/2024/11/is-it-possible-to-duplicate-a-dashboard-in-grafana-Screenshot_2024-10-30_at_3.00.12_PM.webp"
  alt="Selecting Grafana as DataSource"
  caption="Selecting Grafana as DataSource"
/>

<Figure
  src="/img/guides/2024/11/is-it-possible-to-duplicate-a-dashboard-in-grafana-24bf7cb5-2cc1-4a06-aaf7-46e85195681d.webp"
  alt="Running the Query and changing the panel title"
  caption="Running the Query and changing the panel title"
/>

<Figure
  src="/img/guides/2024/11/is-it-possible-to-duplicate-a-dashboard-in-grafana-9944bad3-9161-45d0-bc16-3f7ca2f1f5db.webp"
  alt="Final Dashboard"
...
<Figure
  src="/img/guides/2024/11/is-it-possible-to-duplicate-a-dashboard-in-grafana-c52b84ff-ce88-47bb-9a26-2bacc99a1bd9.webp"
  alt="Changing the time range"
  caption="Changing the time range"
/>
...
<Figure
  src="/img/guides/2024/11/is-it-possible-to-duplicate-a-dashboard-in-grafana-15c65278-85af-4201-be33-2a2463fbe88c.webp"
  alt="Removing Older Panels"
  caption="Removing Older Panels"
/>
...
1.  Use the Grafana API for Programmatic Dashboard Duplication
    The Grafana API allows you to automate the duplication of dashboards programmatically. Below is a Python example illustrating how to duplicate a dashboard using the API. 1. Create a Service Account and Generate a Token:
...
<Figure
  src="/img/guides/2024/11/is-it-possible-to-duplicate-a-dashboard-in-grafana-image.webp"
