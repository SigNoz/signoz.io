...
<Admonition title="Exporter for Windows OS." defaultCollapsed="true">
...
<Admonition title="Do you already have a prometheus.yml file?" defaultCollapsed="true">
...
<Admonition title="Breakdown of Prometheus.yml file" defaultCollapsed="true">
