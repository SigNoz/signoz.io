...
related_articles:
  ...
  - '/blog/quantile-aggregation-for-statsd-exporter'
...
For the complete copy-paste configuration file, refer to the [SigNoz Host Metrics Guide](https://signoz.io/docs/infrastructure-monitoring/user-guides/hostmetrics/).
