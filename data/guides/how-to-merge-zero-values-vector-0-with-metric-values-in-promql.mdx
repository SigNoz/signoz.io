...
authors:
  - simran_kumari
description: >-
  Learn how to effectively merge zero values with existing metrics in PromQL
  queries. Improve data visualization and analysis with this comprehensive
  guide.
keywords:
  - PromQL
  - zero values
...
<Figure src="/img/guides/2024/10/how-to-merge-zero-values-vector-0-with-metric-values-in-promql-image 1.webp" alt="Handling missing data with vector(0)" caption="Handling missing data with vector(0)" />
...
<Figure src="/img/guides/2024/10/how-to-merge-zero-values-vector-0-with-metric-values-in-promql-image 2.webp" alt="Using combination of grouping and vector(0)" caption="Using combination of grouping and vector(0)" />
