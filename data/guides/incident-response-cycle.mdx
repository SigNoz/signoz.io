...
<Figure
  src="/img/guides/2024/12/incident-response-cycle-CleanShot_2024-12-19_at_16.19.452x.webp"
  alt=""
  caption=""
/>
...
<Figure
  src="/img/guides/2024/12/incident-response-cycle-Untitled_design_(5).webp"
  alt="NIST lifecycle Phases"
  caption="NIST lifecycle Phases"
/>
...
<Figure
  src="/img/guides/2024/12/incident-response-cycle-NoteGPT_MindMap_1733589315416-transformed.webp"
  alt="Key components of an effective incident response plan"
  caption="Key components of an effective incident response plan"
/>
...
<Figure
  src="/img/guides/2024/12/incident-response-cycle-image.webp"
  alt="Anomaly Detection in SigNoz"
  caption="Anomaly Detection in SigNoz"
/>
...
<Figure
  src="/img/guides/2024/12/incident-response-cycle-distributed-tracing-cover.webp"
...
<Figure
  src="/img/guides/2024/12/incident-response-cycle-visualize-logs.webp"
  alt="logs and performance metrics"
  caption="logs and performance metrics"
/>
