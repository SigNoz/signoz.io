...
keywords:
  [Grafana, HTTP requests, Prometheus, PromQL, monitoring, visualization, performance analysis]
---
...
- <a href="https://grafana.com/grafana/download" rel="noopener noreferrer nofollow" target="_blank">
    Grafana Installed
  </a>
- <a href="https://prometheus.io/download/" rel="noopener noreferrer nofollow" target="_blank">
...
3.  Access the Prometheus Endpoint
    ...
    <Figure
      src="/img/guides/2024/10/grafana-graphing-http-requests-per-minute-with-http-server-requests-seconds-count-Screenshot_2024-10-05_at_11.17.10_AM.webp"
      alt="Exposed metrics from Java application in Prometheus format"
      caption="Exposed metrics from Java application in Prometheus format"
    />
...
3. Confirm Prometheus is Scraping Your Application’s Metrics
   ...
   <Figure
     src="/img/guides/2024/10/grafana-graphing-http-requests-per-minute-with-http-server-requests-seconds-count-Screenshot_2024-10-03_at_8.50.12_AM.webp"
     alt="Prometheus targets page"
     caption="Prometheus targets page"
   />
   ...
   <Figure
     src="/img/guides/2024/10/grafana-graphing-http-requests-per-minute-with-http-server-requests-seconds-count-Screenshot_2024-10-03_at_8.53.27_AM.webp"
     alt="Application metrics being served"
     caption="Application metrics being served"
   />
...
1. Log into Grafana
   ...
   <Figure
     src="/img/guides/2024/10/grafana-graphing-http-requests-per-minute-with-http-server-requests-seconds-count-Screenshot_2024-09-27_at_8.29.28_PM.webp"
     alt="Grafana landing page"
     caption="Grafana landing page"
   />
...
2. Add Prometheus as a Data Source
   ...
   <Figure
     src="/img/guides/2024/10/grafana-graphing-http-requests-per-minute-with-http-server-requests-seconds-count-Screenshot_2024-09-28_at_10.13.48_PM.webp"
     alt="Add data source"
   ...
   <Figure
     src="/img/guides/2024/10/grafana-graphing-http-requests-per-minute-with-http-server-requests-seconds-count-Screenshot_2024-09-28_at_10.15.11_PM.webp"
     alt="Add Prometheus as data source"
     caption="Add Prometheus as data source"
   />

   Enter the URL where Prometheus is running (e.g., `http://localhost:9090`).

   <Figure
     src="/img/guides/2024/10/grafana-graphing-http-requests-per-minute-with-http-server-requests-seconds-count-Screenshot_2024-09-28_at_10.16.29_PM.webp"
     alt="Prometheus data source page"
     caption="Prometheus data source page"
   />
...
3. Save the Configuration
   ...
   <Figure
     src="/img/guides/2024/10/grafana-graphing-http-requests-per-minute-with-http-server-requests-seconds-count-Screenshot_2024-09-28_at_10.18.37_PM.webp"
     alt="Prometheus successfully connected with Grafana"
     caption="Prometheus successfully connected with Grafana"
   />
...
1.  Create New Dashboard
    ...
    <Figure
      src="/img/guides/2024/10/grafana-graphing-http-requests-per-minute-with-http-server-requests-seconds-count-Screenshot_2024-10-04_at_11.42.37.webp"
    ...
    <Figure
      src="/img/guides/2024/10/grafana-graphing-http-requests-per-minute-with-http-server-requests-seconds-count-fec50360-ee07-4569-ab85-8794820adb6d.webp"
      alt="Adding visualization"
      caption="Adding visualization"
    />

    Select Prometheus as the data source

    <Figure
      src="/img/guides/2024/10/grafana-graphing-http-requests-per-minute-with-http-server-requests-seconds-count-093fbf6f-d2be-4924-8991-4961ca31fff0.webp"
...
2.  Use PromQL to Run Queries
    ...
    <Figure
      src="/img/guides/2024/10/grafana-graphing-http-requests-per-minute-with-http-server-requests-seconds-count-Screenshot_2024-09-29_at_12.12.25_PM.webp"
      alt="Querying HTTP request rate over the last minute"
      caption="Querying HTTP request rate over the last minute"
    />
...
4.  Multiply by 60:
    ...
    <Figure
      src="/img/guides/2024/10/grafana-graphing-http-requests-per-minute-with-http-server-requests-seconds-count-Screenshot_2024-09-29_at_1.18.04_PM.webp"
      alt="http_server_requests_seconds_count dashboard"
      caption="http_server_requests_seconds_count dashboard"
    />

5.  Customize the Panel
    To improve the readability and relevance of your dashboard, it's helpful to customize the panel: 1. Set the panel title: In the General tab, rename the panel to something more descriptive, such as "`HTTP Requests per Minute`." This makes it easier to understand the panel’s purpose at a glance.
