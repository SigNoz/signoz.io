...
authors:
  - nitin_gouda
description: >-
  Learn how to use Grafana to graph HTTP requests per minute using
  http_server_requests_seconds_count. Step-by-step guide for setup, querying,
  and analysis.
keywords:
  - Grafana
  - HTTP requests
...
To improve the readability and relevance of your dashboard, it's helpful to customize the panel:
    1. Set the panel title: In the General tab, rename the panel to something more descriptive, such as "`HTTP Requests per Minute`." This makes it easier to understand the panel’s purpose at a glance.
        ...
        <Figure src="/img/guides/2024/10/grafana-graphing-http-requests-per-minute-with-http-server-requests-seconds-count-Screenshot_2024-09-29_at_1.18.04_PM 1.webp" alt="changing the name of the panel tile" caption="changing the name of the panel tile" />
