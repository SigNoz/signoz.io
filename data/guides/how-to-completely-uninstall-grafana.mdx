...
keywords:
  [uninstall Grafana, remove Grafana, Grafana uninstallation, delete Grafana, clean Grafana removal]
---
...
1. Uninstall Grafana using Windows Control Panel:
   ...
   <Figure
     src="/img/guides/2024/10/how-to-completely-uninstall-grafana-image.webp"
     alt="Uninstall Grafana using Windows Control Panel"
     caption="Uninstall Grafana using Windows Control Panel"
   />
