...
<Figure
  src="/img/guides/2024/09/pq-could-not-resize-shared-memory-segment-no-space-left-on-device-image.webp"
  alt="How to fix 'PQ Could Not Resize Shared Memory' Error"
  caption="How to fix 'PQ: Could Not Resize Shared Memory' Error"
/>
...
1. Stop your PostgreSQL container:
   ...
   <Figure
     src="/img/guides/2024/09/pq-could-not-resize-shared-memory-segment-no-space-left-on-device-image%201.webp"
     alt="Stopping PostgreSQL container"
     caption="Stopping PostgreSQL container"
   />
...
2. Restart the container with increased shared memory:
   ...
   <Figure
     src="/img/guides/2024/09/pq-could-not-resize-shared-memory-segment-no-space-left-on-device-image%202.webp"
     alt="Restarting PostgreSQL container with increased shared memory"
     caption="Restarting PostgreSQL container with increased shared memory"
   />
...
- Shared Memory (Docker-specific) - Role: Controls the amount of memory allocated for inter-process communication (IPC) within Docker containers. Not directly a PostgreSQL setting, but affects how PostgreSQL and other processes within the container handle shared memory.
  </aside>
...
- Real-Time Metrics: Visualize memory usage, query performance, and other critical metrics in real-time dashboards.
  {' '}
  <Figure
    src="/img/guides/2024/09/pq-could-not-resize-shared-memory-segment-no-space-left-on-device-image%203.webp"
    alt="Real time Monitoring Dashboards in SigNoz"
    caption="Real time Monitoring Dashboards in SigNoz"
  />
- Detailed Logs: Access detailed logs to analyze and troubleshoot issues effectively.
  {' '}
  <Figure
    src="/img/guides/2024/09/pq-could-not-resize-shared-memory-segment-no-space-left-on-device-image%204.webp"
    alt="Analyzing logs in SigNoz"
    caption="Analyzing logs in SigNoz"
  />
- Custom Alerts: Set up alerts for specific conditions, such as high memory usage or slow queries, to stay informed about potential issues.
  {' '}
  <Figure
    src="/img/guides/2024/09/pq-could-not-resize-shared-memory-segment-no-space-left-on-device-image%205.webp"
    alt="Setting up Custom Alerts and Notifications in SigNoz"
    caption="Setting up Custom Alerts and Notifications in SigNoz"
  />
