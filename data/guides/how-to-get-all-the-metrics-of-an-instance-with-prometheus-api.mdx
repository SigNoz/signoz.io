...
authors:
  - nitin_gouda
description: >-
  Learn how to retrieve all metrics from a Prometheus instance using its API.
  This comprehensive guide covers PromQL, best practices, and advanced analysis
  techniques.
keywords:
  - Prometheus metrics
  - Prometheus API
...
By leveraging [OpenTelemetry](https://signoz.io/opentelemetry/) and combining traditional metrics with advanced tracing, SigNoz extends Prometheus' capabilities, providing a complete observability solution to ensure comprehensive system monitoring and faster issue resolution.
