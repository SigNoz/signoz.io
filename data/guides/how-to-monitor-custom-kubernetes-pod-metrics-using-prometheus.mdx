...
related_articles: ['/guides/kubernetes-monitoring-prometheus', '/guides/how-to-get-number-of-pods-running-in-prometheus', '/guides/does-kubernetes-use-prometheus', '/guides/how-to-calculate-containers-cpu-usage-in-kubernetes-with-prometheus-as-monitoring', '/guides/prometheus-queries-to-get-cpu-and-memory-usage-in-kubernetes-pods', '/guides/how-to-install-prometheus-and-grafana-on-kubernetes']
---
