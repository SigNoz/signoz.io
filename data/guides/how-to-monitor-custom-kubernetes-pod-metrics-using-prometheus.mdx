  ...
  <script
    ...
    dangerouslySetInnerHTML={{
      __html: JSON.stringify({
        ...
        keywords:
          'Kubernetes, Prometheus, custom metrics, pod monitoring, metrics collection, Kubernetes monitoring, Prometheus setup, PromQL',
        ...
        about: [
          ...
          },
          {
            ...
            name: 'Custom Metrics',
            description:
              "User-defined measurements that provide specific insights into an application's behavior and performance.",
          },
        ],
        mentions: [
          {
