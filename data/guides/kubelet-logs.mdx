...
meta_title: "Kubelet Logs: Locations and Troubleshooting"
...
If you use K8s on a regular basis, you must have realized that kubelet logs are just one slice of the wider picture. In case you want to further dissect the topic, check out our dedicated guide on broader [Kubernetes logging](https://signoz.io/blog/opentelemetry-kubernetes/) that encompasses node, pod, and control-plane logs.
