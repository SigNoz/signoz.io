...
related_articles: ['/guides/api-observability', '/guides/apm-metrics', '/blog/distributed-tracing-tools', '/blog/microservices-observability-with-distributed-tracing']
...
- Adding Instrumentation: Inject [OpenTelemetry](https://signoz.io/opentelemetry/) libraries into your application to capture trace data.
