...
<Figure
  src="/img/guides/2024/09/rabbit-mq-error-while-waiting-for-mnesia-tables-Screenshot_2024-09-18_at_11.37.10_AM.webp"
  alt="rabbitmq_cluster"
  caption="rabbitmq_cluster"
/>
...
<Figure
  src="/img/guides/2024/09/rabbit-mq-error-while-waiting-for-mnesia-tables-Screenshot_2024-09-18_at_11.37.24_AM.webp"
  alt="rabbitmq ping"
  caption="rabbitmq ping"
/>
...
<Figure
  src="/img/guides/2024/09/rabbit-mq-error-while-waiting-for-mnesia-tables-Screenshot_2024-09-25_at_1.04.54_PM.webp"
  alt="df command"
  caption="df command"
/>
...
<Figure
  src="/img/guides/2024/09/rabbit-mq-error-while-waiting-for-mnesia-tables-Screenshot_2024-09-18_at_11.44.46_AM.webp"
  alt="ls command"
  caption="ls command"
/>
...
<Figure
  src="/img/guides/2024/09/rabbit-mq-error-while-waiting-for-mnesia-tables-Screenshot_2024-09-25_at_1.40.30_PM.webp"
  alt="chown command"
  caption="chown command"
/>
...
2. Regularly back up your Mnesia database:
   ...
   <Figure
     src="/img/guides/2024/09/rabbit-mq-error-while-waiting-for-mnesia-tables-Screenshot_2024-09-25_at_1.24.05_PM.webp"
     alt="export defintions"
     caption="export defintions"
   />
...
3. If necessary, recover data from Mnesia files:
   ...
   <Figure
     src="/img/guides/2024/09/rabbit-mq-error-while-waiting-for-mnesia-tables-Screenshot_2024-09-25_at_1.42.28_PM.webp"
     alt="Backup"
     caption="Backup"
   />
...
3. Once it's up, rejoin other nodes to the cluster:
   ...
   <Figure
     src="/img/guides/2024/09/rabbit-mq-error-while-waiting-for-mnesia-tables-Screenshot_2024-09-25_at_1.43.26_PM.webp"
     alt="Server Detached"
     caption="Server Detached"
   />
