...
related_articles:
  - '/blog/distributed-tracing-tools'
...
> For a complete guide on instrumenting Node.js, check the [detailed setup instructions](https://signoz.io/docs/instrumentation/javascript/opentelemetry-nodejs/).
...
> For a complete guide on instrumenting FastAPI, see the [detailed setup instructions](https://signoz.io/docs/instrumentation/opentelemetry-python/).
...
To learn more about configuring this, see the [guide on Python logs auto-instrumentation](https://signoz.io/docs/logs-management/send-logs/python-logs/).
...
- **Java:** Using the [OpenTelemetry Java agent](https://signoz.io/docs/instrumentation/java/opentelemetry-java/) allows for powerful auto-instrumentation of popular frameworks like Spring Boot, Quarkus, and Micronaut with no code changes.
