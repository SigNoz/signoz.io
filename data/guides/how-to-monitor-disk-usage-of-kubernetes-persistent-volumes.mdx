  ...
  <script
    ...
    dangerouslySetInnerHTML={{
      __html: JSON.stringify({
        ...
        alternativeHeadline:
          'Effective Methods to Monitor Disk Usage of Kubernetes Persistent Volumes',
        author: {
          '@type': 'Person',
          name: 'Ankit Anand',
        },
        ...
        about: [
          ...
          },
          {
            ...
            description:
              'Storage resources in Kubernetes that exist independently of pods and provide data persistence.',
          },
          {
            '@type': 'Thing',
            name: 'Prometheus',
