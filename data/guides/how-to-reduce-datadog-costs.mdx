...
related_articles: ['/blog/datadog-pricing', '/blog/pricing-comparison-signoz-vs-datadog-vs-newrelic-vs-grafana', '/guides/datadog-apm', '/guides/new-relic-pricing']
...
- **Core Observability Features**
    ...
    - **Traces:** Native [OpenTelemetry](https://signoz.io/opentelemetry/) support with distributed-trace flame graphs and span-level querying.
