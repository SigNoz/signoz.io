...
keywords:
  [datadog pricing, observability costs, monitoring expenses, APM pricing, log management costs]
---
...
Custom metrics are useful for application-specific monitoring, but they can become a _silent budget killer_ if not managed.
...
If you only need high-level trends and not granular details, consider aggregating metrics _before_ sending to Datadog.
...
<Figure
  src="/img/guides/2025/05/how-to-reduce-datadog-costs-image%201.webp"
  alt="Metrics Summary page showing highest cardinality metrics. (Source: Datadog docs)"
  caption="Metrics Summary page showing highest cardinality metrics. (Source: Datadog docs)"
/>
...
**Why filter before sending?** Once data reaches Datadog, you’re incurring ingestion costs. Dropping data _after_ ingestion (via exclusion filters) saves on indexing but not on ingestion costs. So it’s often best to do initial filtering in your logging agent or pipeline on your infrastructure.
...
<Figure
  src="/img/guides/2025/05/how-to-reduce-datadog-costs-image%202.webp"
  alt="Log index configuration showing daily quotas. (source: Datadog docs)"
  caption="Log index configuration showing daily quotas. (source: Datadog docs)"
/>
...
<Figure
  src="/img/guides/2025/05/how-to-reduce-datadog-costs-image%203.webp"
  alt="Recently deleted dashboards can be recovered using the recycle bin. (source: Datadog docs)"
  caption="Recently deleted dashboards can be recovered using the recycle bin. (source: Datadog docs)"
/>
...
An unused pipeline might not incur a cost directly, but it adds processing overhead and complexity. More importantly, some pipelines extract custom attributes or generate metrics from logs which _do_ cost money.
...
<Figure
  src="/img/guides/2025/05/how-to-reduce-datadog-costs-image%204.webp"
  alt="Datadog cost monitor dashboard."
  caption="Datadog cost monitor dashboard."
/>
...
{/_ > _"I used to work at Coinbase actually. At Coinbase, there was a huge effort internally to minimize the Datadog bill. I think we were spending tens of millions of dollars on Datadog at Coinbase."_
— Shiv Ansal, Co-founder & CTO, Bands (Read [full case study](https://signoz.io/case-study/bands/)) _/}
