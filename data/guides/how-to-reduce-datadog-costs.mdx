...
Smaller [log events](https://signoz.io/comparisons/opentelemetry-events-vs-logs/) = fewer GB ingested = lower cost. Datadog suggests using an “edit” processor to remove unused attributes and reduce log size.
