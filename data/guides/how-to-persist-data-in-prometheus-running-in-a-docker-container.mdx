  ...
  <script
    ...
    dangerouslySetInnerHTML={{
      __html: JSON.stringify({
        ...
        keywords:
          'Prometheus, Docker, data persistence, monitoring, container, volume, Docker Compose',
        ...
        about: [
          ...
          },
          {
            ...
            description:
              'The process of storing data in a way that ensures it remains available across restarts and crashes.',
          },
          {
            '@type': 'Thing',
            name: 'Volume',
            description:
              'Docker volumes are storage areas that can be mounted to containers to persist data.',
          },
          {
            '@type': 'Thing',
            name: 'Docker Compose',
