...
meta_title: "Log Processes Inside a Docker Container"
published_date: 2024-09-24
updated_date: 2026-07-07
tags: [logging]
authors: [nitin_gouda]
description: "Learn methods to log and monitor processes running inside Docker containers, from docker top to centralized process logging."
...
Do note that for the container's own stdout/stderr stream rather than its processes, the [Docker view logs guide](https://signoz.io/guides/docker-view-logs/) covers the base commands.
...
To enter a container and execute commands, use `docker exec.`
    ...
    <Figure src="/img/guides/2024/09/how-to-log-all-the-processes-running-inside-a-docker-container-c19803cc-03d2-4707-afe7-f6e8c85e20af.webp" alt="Interactive bash shell inside a Docker container" caption="" />`/bin/bash` provides an interactive shell interface and script execution environment within Docker containers, enabling command execution and process control.
...
Once inside the container, execute the following:
    ...
    <Figure src="/img/guides/2024/09/how-to-log-all-the-processes-running-inside-a-docker-container-Screenshot_2024-09-11_at_11.26.01_AM.webp" alt="Process list inside a Docker container" caption="" />The `ps -eaf` command provides a comprehensive view of all processes running inside the Docker container, including detailed process information, which aids in monitoring and performance optimization.
...
To view the logs from a running container, use the `docker logs` command:
    ...
    <Figure src="/img/guides/2024/09/how-to-log-all-the-processes-running-inside-a-docker-container-Screenshot_2024-09-11_at_11.28.29_AM.webp" alt="Docker container stdout and stderr logs" caption="" />This command will display the logs from the container’s standard output and standard error streams.
...
Supervisor is a powerful tool for controlling and monitoring multiple processes within a container. It allows you to:
    ...
    4. Build and Run the Docker Container
        ...
        <Figure src="/img/guides/2024/09/how-to-log-all-the-processes-running-inside-a-docker-container-Screenshot_2024-09-19_at_11.45.40_AM.webp" alt="Docker container startup command" caption="" />- Run the Docker container:
        
        ```bash
        docker run -d python-supervisor-app
        ```
        
        <Figure src="/img/guides/2024/09/how-to-log-all-the-processes-running-inside-a-docker-container-Screenshot_2024-09-19_at_11.47.03_AM.webp" alt="Supervisor logs inside a Docker container" caption="" />
        5. Where to See Supervisor Logs:
    You can access Supervisor logs directly within the container:
        1. Application logs:
            ...
            <Figure src="/img/guides/2024/09/how-to-log-all-the-processes-running-inside-a-docker-container-Screenshot_2024-09-19_at_12.17.41_PM.webp" alt="Supervisor process status inside the container" caption="" />2. Process status:
            
            ```bash
            docker exec -it <container_id> supervisorctl status
            ```
            
            <Figure src="/img/guides/2024/09/how-to-log-all-the-processes-running-inside-a-docker-container-Screenshot_2024-09-19_at_12.19.32_PM.webp" alt="Supervisor managing container processes" caption="" />Using a process manager like Supervisor is particularly useful in environments requiring high reliability and more granular control over process execution within containers.
...
While Docker provides basic logging mechanisms, integrating custom logging libraries into your application code can give you more detailed and tailored process logging. By adding logging directly into your application, you gain several benefits:
    ...
    - Enhanced log formats: With custom libraries, you can log in formats like JSON, making integration with [open source logging tools](https://signoz.io/blog/best-open-source-log-management-tools/) or dashboards easier.
    ...
    Rebuild your Docker image and run the container:
        ...
        <Figure src="/img/guides/2024/09/how-to-log-all-the-processes-running-inside-a-docker-container-Screenshot_2024-09-19_at_1.14.41_PM.webp" alt="Loguru log output from a Docker container" caption="" />
        1. Accessing Logs:
    To view the logs generated by `loguru`, Access container logs: 
        ...
        <Figure src="/img/guides/2024/09/how-to-log-all-the-processes-running-inside-a-docker-container-Screenshot_2024-09-19_at_1.23.26_PM.webp" alt="Application logging output from within a Docker container" caption="" />Integrating logging libraries into your applications is a good approach for teams that need precise control over their logs and want to capture application-specific data.
