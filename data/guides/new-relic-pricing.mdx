...
- **Simpler pricing:** SigNoz Cloud charges for data ingestion and retention, with no user-based charges or query fees.
...
[SigNoz Cloud](https://signoz.io/) pricing is based purely on ingestion and retention. Running queries, building dashboards, and setting alerts doesn't cost anything extra. You can also self-host the [open-source edition](https://signoz.io/docs/install/self-host/) and pay only for your own infrastructure.
