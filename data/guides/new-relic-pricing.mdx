...
SigNoz was built on [OpenTelemetry](https://signoz.io/blog/what-is-opentelemetry/) from day one, not retrofitted. Your instrumentation uses industry-standard SDKs that work with any OTel-compatible backend, so switching platforms doesn't require re-instrumenting your stack. 
