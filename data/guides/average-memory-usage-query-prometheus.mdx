...
related_articles: ['/guides/why-does-prometheus-consume-so-much-memory', '/guides/how-to-write-a-prometheus-query-that-returns-the-value-of-the-label', '/blog/prometheus-query', '/guides/prometheus-queries-to-get-cpu-and-memory-usage-in-kubernetes-pods', '/guides/how-to-get-total-requests-in-a-period-of-time-with-prometheus', '/guides/how-to-increase-prometheus-storage-retention']
---
