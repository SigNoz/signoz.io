...
When working with containerized applications, memory usage can be monitored using cAdvisor or the [Kubelet metrics](https://signoz.io/docs/infrastructure-monitoring/k8s-metrics/). For example, if you are using Kubernetes, the following container metrics can be helpful:
