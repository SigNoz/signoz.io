...
<Figure
  src="/img/guides/2024/10/average-memory-usage-query-prometheus-1d586591-adb8-4062-9bcd-89bb2faa382d.webp"
  alt="Memory Usage on Different Operating Systems"
  caption="Memory Usage on Different Operating Systems"
/>
...
1. Add a new panel to your Grafana dashboard.
   - Visit the `Dashboards` section and click on the `New` button.
     {' '}
     <Figure
       src="/img/guides/2024/10/average-memory-usage-query-prometheus-image.webp"
   ...
   - Add `New Dashboard` and click the `Add visualization` button.
     {' '}
     <Figure
       src="/img/guides/2024/10/average-memory-usage-query-prometheus-image%201.webp"
   ...
   - Select the Prometheus as your data source
     {' '}
     <Figure
       src="/img/guides/2024/10/average-memory-usage-query-prometheus-image%202.webp"
...
2. In the query editor, enter your PromQL query for average memory usage.
   ...
   <Figure
     src="/img/guides/2024/10/average-memory-usage-query-prometheus-image%203.webp"
     alt="PromQL query for average memory usage"
     caption="PromQL query for average memory usage"
   />

3. Choose an appropriate visualization type (e.g., graph or gauge).

   <Figure
     src="/img/guides/2024/10/average-memory-usage-query-prometheus-image%204.webp"
     alt="Choose an appropriate visualization type"
     caption="Choose an appropriate visualization type"
   />

4. You should be able to visualize the average memory usage in your dashboard panel.

   <Figure
     src="/img/guides/2024/10/average-memory-usage-query-prometheus-image%205.webp"
     alt="Dashboard panel for Average memory usage in Grafana"
     caption="Dashboard panel for Average memory usage in Grafana"
   />
