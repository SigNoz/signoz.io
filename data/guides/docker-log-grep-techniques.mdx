...
title: Docker Log Techniques with Grep - A Quick Guide
slug: docker-log-grep-techniques
date: 2024-07-30
tags: [docker-grep, advanced grep]
...
<Figure src="/img/guides/2024/08/docker-log-grep-techniques-Screenshot_2024-07-29_at_1.04.34_AM.webp" alt="Grep error output" caption="Grep error output" />
...
<Figure src="/img/guides/2024/08/docker-log-grep-techniques-Screenshot_2024-07-29_at_1.08.05_AM.webp" alt="grep -i output" caption="grep -i output" />
...
<Figure src="/img/guides/2024/08/docker-log-grep-techniques-Screenshot_2024-07-29_at_1.10.22_AM.webp" alt="grep -v output" caption="grep -v output" />
...
<Figure src="/img/guides/2024/08/docker-log-grep-techniques-Screenshot_2024-07-29_at_1.13.40_AM.webp" alt="grep -n output" caption="grep -n output" />
...
<Figure src="/img/guides/2024/08/docker-log-grep-techniques-834e7acc-867b-4f52-b3e4-bf2a26f858b8.webp" alt="Flag -C output" caption="Flag -C output" />
...
<Figure src="/img/guides/2024/08/docker-log-grep-techniques-Screenshot_2024-07-26_at_4.43.35_PM.webp" alt="Time based filtering output" caption="Time based filtering output" />
...
<Figure src="/img/guides/2024/08/docker-log-grep-techniques-Screenshot_2024-07-29_at_1.21.18_AM.webp" alt="Combination of grep with another command" caption="Combination of grep with another command" />
...
<Figure src="/img/guides/2024/08/docker-log-grep-techniques-Screenshot_2024-07-29_at_1.23.33_AM.webp" alt="Multiple grep command" caption="Multiple grep command" />
...
<Figure src="/img/guides/2024/08/docker-log-grep-techniques-Screenshot_2024-07-29_at_7.56.59_AM.webp" alt="grep with awk" caption="grep with awk" />
...
<Figure src="/img/guides/2024/08/docker-log-grep-techniques-Screenshot_2024-07-29_at_1.26.41_AM.webp" alt="Grep Context Options" caption="Grep Context Options" />
...
<Figure src="/img/guides/2024/08/docker-log-grep-techniques-Screenshot_2024-07-29_at_1.25.07_AM.webp" alt="Docker logs output" caption="Docker logs output" />
