---
title: "How to Clear Docker Logs: Safe Commands & Rotation"
meta_title: "How to Clear Docker Logs: Safe Commands & Rotation"
date: 2026-07-06
tags: [Docker, Logging]
authors: [nitin_gouda]
description: "Clear Docker container logs safely with five command-based methods, then configure rotation and size limits to prevent the disk from filling again."
...
<Figure src="/img/guides/2024/07/docker-clear-logs-Screenshot_2024-07-16_at_5.01.07_AM.webp" alt="Docker logs" caption="Docker logs growing over time can consume significant disk space" width={1200} height={675} priority />
...
If unused images are taking up the space, you can [remove Docker images](https://signoz.io/guides/docker-remove-image/) individually or prune unused images before considering a broader system cleanup.
