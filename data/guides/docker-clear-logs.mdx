...
<Figure src="/img/guides/2024/07/docker-clear-logs-Screenshot_2024-07-16_at_5.01.07_AM.webp" alt="Docker logs" caption="Docker logs growing over time can consume significant disk space" priority />
