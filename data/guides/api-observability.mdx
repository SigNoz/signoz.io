...
<Figure src="/img/guides/2024/08/api-observability-Untitled 1.webp" alt="API Health and Performance Metrics" caption="API Health and Performance Metrics" />
...
1. Instrument your code with a tracing library (e.g., [OpenTelemetry](https://signoz.io/opentelemetry/))
...
<Figure src="/img/guides/2024/08/api-observability-image 1.webp" alt="Prometheus and Grafana working together" caption="Prometheus and Grafana working together" />
...
<Figure src="/img/guides/2024/08/api-observability-Untitled 2.webp" alt="API Observability tools: Summary" caption="API Observability tools: Summary" />
...
For a detailed guide: Read our documentation on [API Monitoring in SigNoz](https://signoz.io/docs/apm-and-distributed-tracing/application-details/). 
...
- Metrics:
    ...
    <Figure src="/img/guides/2024/08/api-observability-Untitled 3.webp" alt="Real-time monitoring of API performance using Metrics in SigNoz" caption="Real-time monitoring of API performance using Metrics in SigNoz" />
...
- User Analytics:
    ...
    <Figure src="/img/guides/2024/08/api-observability-Untitled 4.webp" alt="SigNoz Dashboards for Analysis" caption="SigNoz Dashboards for Analysis" />
...
- [API Monitoring in SigNoz](https://signoz.io/docs/apm-and-distributed-tracing/application-details/)
