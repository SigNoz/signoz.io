...
<Figure
  src="/img/guides/2024/08/sql-server-monitoring-image.webp"
  alt="Key factors for optimizing SQL Server"
  caption="Key factors for optimizing SQL Server"
/>
...
<Figure
  src="/img/guides/2024/08/sql-server-monitoring-image%201.webp"
  alt="Choosing a third party SQL Server Monitoring Tool"
  caption="Choosing a third party SQL Server Monitoring Tool"
/>
