  ...
  <script
    ...
    dangerouslySetInnerHTML={{
      __html: JSON.stringify({
        ...
        keywords:
          'Prometheus, storage retention, monitoring, data analysis, configuration, troubleshooting, best practices',
        ...
        about: [
          ...
          },
          {
            ...
            description:
              'The duration for which time-series data is kept before being automatically purged.',
          },
          {
            '@type': 'Thing',
            name: 'Data Analysis',
