...
<Figure
  src="/img/guides/2024/09/relabel-instance-to-hostname-in-prometheus-image.webp"
  alt="Default instance label in Prometheus"
  caption="Default instance label in Prometheus"
/>
...
<Figure
  src="/img/guides/2024/09/relabel-instance-to-hostname-in-prometheus-image%201.webp"
  alt="Relabeling instance with relabel_configs"
  caption="Relabeling instance with relabel_configs"
/>{' '}
...
<Figure
  src="/img/guides/2024/09/relabel-instance-to-hostname-in-prometheus-image%202.webp"
  alt="Labelling instance with hostname using File-based Service discovery"
  caption="Labelling instance with hostname using File-based Service discovery"
/>
