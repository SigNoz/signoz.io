...
related_articles:
  - '/guides/how-to-add-target-specific-label-in-prometheus'
  ...
  - '/guides/what-is-the-job-label-in-prometheus'
---
...
Once set up, [SigNoz can ingest your Prometheus metrics](https://signoz.io/docs/metrics-management/send-metrics/#enable-a-prometheus-receiver), including the relabeled instance names. This allows you to create more intuitive dashboards and alerts based on your hostname-labeled metrics.
