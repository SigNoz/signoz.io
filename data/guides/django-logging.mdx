  ...
  <script
    ...
    dangerouslySetInnerHTML={{
      __html: JSON.stringify({
        ...
        alternativeHeadline:
          'Master Django logging - Learn setup, configuration, and advanced features for efficient, structured logging',
        author: {
          '@type': 'Person',
          name: 'Sushant Gaurav',
        },
        ...
        keywords:
          'django logging, django logging example, django logging best practices, django logging to file, django logging formatter',
