...
1. Check your terminal to see the logs printed to the console.
   ...
   <Figure
     src="/img/guides/2024/08/how-should-i-log-while-using-multiprocessing-in-python-CleanShot_2024-08-30_at_14.28.512x.webp"
     alt=""
     caption=""
   />
   2. Log in to your SigNoz dashboard to view the logs sent to SigNoz.

   <Figure
     src="/img/guides/2024/08/how-should-i-log-while-using-multiprocessing-in-python-CleanShot_2024-08-30_at_14.29.482x.webp"
     alt=""
     caption=""
   />
   You should now see your application logs both in the terminal and in the SigNoz dashboard.
