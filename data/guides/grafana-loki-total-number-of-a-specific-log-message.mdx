...
title: "Grafana Loki Log Query: Count Specific Log Messages"
meta_title: Count Specific Log Messages in Grafana Loki
date: 2026-06-09
tags: [faq, grafana]
authors: [simran_kumari]
description: "Learn how to count specific log messages in Grafana Loki using LogQL. Master query syntax, time-based aggregations, and visualizations for log analysis."
keywords: [Grafana Loki, log counting, LogQL, log analysis, Grafana dashboards, log monitoring, SigNoz, observability]
related_articles:
  - '/guides/loki-json-logs-filter-by-detected-fields-from-grafana'
  - '/blog/loki-alternatives'
  - '/blog/best-open-source-log-management-tools'
  - '/guides/a-regex-in-query-in-grafana'
  - '/guides/grafana-graphing-http-requests-per-minute-with-http-server-requests-seconds-count'
...
3. Add Loki as a data source in Grafana:
    ...
    - Click "Add data source" and select Loki
        ...
        <Figure src="/img/guides/2024/09/grafana-loki-total-number-of-a-specific-log-message-image 1.webp" alt="Adding Loki as data source in Grafana" caption="Adding Loki as data source in Grafana" />
        
    - Enter the URL of your Loki instance and save the configuration
        
        <Figure src="/img/guides/2024/09/grafana-loki-total-number-of-a-specific-log-message-image 2.webp" alt="Specifying the Loki instance URL" caption="Specifying the Loki instance URL" />
        
    - Save and test the data source
        
        <Figure src="/img/guides/2024/09/grafana-loki-total-number-of-a-specific-log-message-image 3.webp" alt="Testing Grafana Loki data source" caption="Testing Grafana Loki data source" />
...
1. Log stream selectors:  Log stream selectors specify which log streams you want to query. They are similar to label selectors in Prometheus. Here’s how they work:
    ...
    <Figure src="/img/guides/2024/09/grafana-loki-total-number-of-a-specific-log-message-image 4.webp" alt="Log stream selectors" caption="Log stream selectors" />
...
2. Filters: Filters allow you to narrow down logs based on their content. 
    ...
    <Figure src="/img/guides/2024/09/grafana-loki-total-number-of-a-specific-log-message-image 5.webp" alt="Filters in LogQL" caption="Filters in LogQL" />
...
3. Aggregation functions: Use functions like `count_over_time` to aggregate log data:
    ...
    <Figure src="/img/guides/2024/09/grafana-loki-total-number-of-a-specific-log-message-image 6.webp" alt="Aggregate functions in LogQL" caption="Aggregate functions in LogQL" />
...
1. Regex patterns: Use regular expressions for flexible message matching:
    ...
    <Figure src="/img/guides/2024/09/grafana-loki-total-number-of-a-specific-log-message-image 7.webp" alt="Regex patterns in LogQL" caption="Regex patterns in LogQL" />
...
2. Time-based aggregations: Group counts by time intervals:
    ...
    <Figure src="/img/guides/2024/09/grafana-loki-total-number-of-a-specific-log-message-image 8.webp" alt="Time-based aggregations using Loki logQL" caption="Time-based aggregations using Loki logQL" />
...
3. Label matching: Leverage labels for precise counting:
    ...
    <Figure src="/img/guides/2024/09/grafana-loki-total-number-of-a-specific-log-message-image 9.webp" alt="Label matching in Loki LogQL" caption="Label matching in Loki LogQL" />
...
4. Combining queries: Use logical operators to create complex scenarios:
    ...
    <Figure src="/img/guides/2024/09/grafana-loki-total-number-of-a-specific-log-message-image 10.webp" alt="Combining queries in Loki LogQL" caption="Combining queries in Loki LogQL" />
...
2. Query Configuration: Use Loki queries to fetch log counts. Adjust the query according to your log labels and desired time range. Update the query section.
    ...
    <Figure src="/img/guides/2024/09/grafana-loki-total-number-of-a-specific-log-message-image 11.webp" alt="Query Configuration in Grafana Dashboard" caption="Query Configuration in Grafana Dashboard" />
...
3. Choose Visualization Type: Select the appropriate visualization type from the panel options. For log counts, the "Time series" and "Stat" panels are commonly used.
    ...
    <Figure src="/img/guides/2024/09/grafana-loki-total-number-of-a-specific-log-message-image 12.webp" alt="Choosing Visualization Type in Grafana Dashboard" caption="Choosing Visualization Type in Grafana Dashboard" />
...
1. Create an alert rule in Grafana:
    ...
    <Figure src="/img/guides/2024/09/grafana-loki-total-number-of-a-specific-log-message-image 13.webp" alt="Creating alerts in Grafana Dashboard" caption="Creating alerts in Grafana Dashboard" />
...
- Unified Platform: SigNoz combines logs, metrics, and traces in one place, offering better context and more holistic analysis. You can view logs, correlate them with traces, and analyze system performance without switching between tools.
    ...
    <Figure src="/img/guides/2024/09/grafana-loki-total-number-of-a-specific-log-message-image 14.webp" alt="SigNoz combines logs, metrics, and traces in one place." caption="SigNoz combines logs, metrics, and traces in one place." /> 
...
- Built-In Visualizations: Unlike Loki, SigNoz offers native visualization capabilities for logs, metrics, and traces. This eliminates the need to use external tools like Grafana and simplifies the process of creating dashboards and reports.
    ...
    <Figure src="/img/guides/2024/09/grafana-loki-total-number-of-a-specific-log-message-image 15.webp" alt="SigNoz offers native visualization capabilities for logs, metrics, and traces." caption="SigNoz offers native visualization capabilities for logs, metrics, and traces." />
