...
related_articles:
  ...
  - '/guides/sql-server-monitoring'
  - '/comparisons/infrastructure-monitoring-tools'
  - '/guides/linux-server-monitoring'
  - '/comparisons/network-security-monitoring-tools'
...
<InlineCTA message="Monitor your Windows servers with SigNoz — CPU, memory, disk, and network metrics with built-in dashboards and alerting." ctaText="Go to Docs" ctaLink="/docs/infrastructure-monitoring/user-guides/hostmetrics/" />
