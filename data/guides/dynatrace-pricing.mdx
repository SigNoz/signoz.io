...
keywords:
  [dynatrace pricing, dynatrace cost, DPS, DDU, application monitoring pricing, observability costs]
---
...
<Figure
  src="/img/guides/2025/09/dynatrace-pricing-signoz-logging-dashboard.webp"
  alt="SigNoz logging dashboard"
  caption="SigNoz logging dashboard"
/>
