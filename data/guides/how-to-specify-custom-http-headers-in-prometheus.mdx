  ...
  <script
    ...
    dangerouslySetInnerHTML={{
      __html: JSON.stringify({
        ...
        alternativeHeadline:
          'Implementing Custom HTTP Headers in Prometheus for Enhanced Security and Access',
        author: {
          '@type': 'Person',
          name: 'Daniel',
        },
        ...
        keywords:
          'Prometheus, custom HTTP headers, metrics collection, authentication, reverse proxy, custom exporter, Grafana integration',
        ...
        about: [
          ...
          },
          {
            ...
            description:
              'A custom-built application to export metrics with additional functionality.',
          },
        ],
        mentions: [
          {
