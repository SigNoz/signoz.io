...
related_articles: ['/guides/how-do-i-monitor-api-in-prometheus', '/guides/how-does-prometheus-work', '/guides/how-to-get-all-the-metrics-of-an-instance-with-prometheus-api', '/guides/how-to-get-total-requests-in-a-period-of-time-with-prometheus', '/blog/prometheus-query', '/guides/how-to-add-target-specific-label-in-prometheus']
---
