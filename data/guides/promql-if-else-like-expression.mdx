...
<Figure
  src="/img/guides/2024/10/promql-if-else-like-expression-image.webp"
  alt="Using the and Operator"
  caption="Using the and Operator"
/>
...
<Figure
  src="/img/guides/2024/10/promql-if-else-like-expression-image%201.webp"
  alt="Using the or Operator"
  caption="Using the or Operator"
/>
...
<Figure
  src="/img/guides/2024/10/promql-if-else-like-expression-image%202.webp"
  alt="Using the or Operator in PromQL query"
  caption="Using the or Operator in PromQL query"
/>
...
<Figure
  src="/img/guides/2024/10/promql-if-else-like-expression-image%203.webp"
  alt="Combining and and or for Complex Logic"
  caption="Combining and and or for Complex Logic"
/>
...
- Provide details like:
  ...
  - Add in the query based on the result of which alert needs to be triggered. Set the threshold for the same.
    {' '}
    <Figure
      src="/img/guides/2024/10/promql-if-else-like-expression-image%204.webp"
      alt="Setting alert rule in Grafana"
      caption="Setting alert rule in Grafana"
    />
...
<Figure
  src="/img/guides/2024/10/promql-if-else-like-expression-image%205.webp"
  alt="Firing alerts using Grafana"
  caption="Firing alerts using Grafana"
/>
...
<Figure
  src="/img/guides/2024/10/promql-if-else-like-expression-image%206.webp"
  alt="Using the unless Operator"
  caption="Using the unless Operator"
/>
...
<Figure
  src="/img/guides/2024/10/promql-if-else-like-expression-image%207.webp"
  alt="Ternary-like behavior using vector matching- Satisfying if condition"
  caption="Ternary-like behavior using vector matching- Satisfying if condition"
/>

<Figure
  src="/img/guides/2024/10/promql-if-else-like-expression-image%208.webp"
  alt="Ternary-like behavior using vector matching - Satisfying else condition"
  caption="Ternary-like behavior using vector matching - Satisfying else condition"
/>
...
3. Integrating traces and logs with metrics for comprehensive observability
   ...
   <Figure
     src="/img/guides/2024/10/promql-if-else-like-expression-image%209.webp"
