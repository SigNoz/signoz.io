        ...
        about: [
          {
            ...
            name: 'Zap Logger',
            description:
              'Complete guide to using Zap Logger in Golang, including installation, setup, and advanced configurations.',
          },
          {
            '@type': 'Thing',
            name: 'Logging',
            description:
              'Techniques and best practices for logging in software development using Zap Logger in Golang.',
          },
          {
            '@type': 'Thing',
            name: 'Golang',
...
{
  "level": "info",
  "ts": 1721163003.793889,
  "caller": "Signoz-Article/main.go:13",
...
{
  "L": "INFO",
  "T": "2024-07-16T22:56:42.529+0100",
  "C": "Signoz-Article/main.go:23",
  "M": "Custom logger initialized"
}
```
...
{
  "level": "info",
  "ts": 1721168784.654409,
  "caller": "Signoz-Article/main.go:20",
  "msg": "This message will be logged to multiple outputs"
}
```
...
{
  "level": "info",
  "ts": 1721173746.537836,
  "caller": "Signoz-Article/main.go:15",
...
<Figure
  src="/img/guides/2024/07/zap-logger-Screenshot_2024-07-01_at_14.15.51.webp"
...
<Figure
  src="/img/guides/2024/07/zap-logger-Screenshot_2024-07-06_at_02.29.06.webp"
  alt="Signoz Log Output"
  caption="Signoz Log Output"
/>{' '}
