...
Regex can be a powerful tool in Prometheus queries, especially when you want to filter metrics based on their names or labels. Here’s how you can do it:
    ...
    Let’s say you want to filter [all metrics](https://signoz.io/guides/how-to-get-all-the-metrics-of-an-instance-with-prometheus-api/) related to HTTP requests in your Flask application:
