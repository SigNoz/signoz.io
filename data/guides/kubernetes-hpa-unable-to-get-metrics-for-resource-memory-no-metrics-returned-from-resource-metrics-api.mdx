...
<Figure
  src="/img/guides/2024/09/kubernetes-hpa-unable-to-get-metrics-for-resource-memory-no-metrics-returned-from-resource-metrics-api-Screenshot_2024-09-17_at_7.16.04_PM.webp"
  alt="hpa-nginx"
  caption="hpa-nginx"
/>
...
<Figure
  src="/img/guides/2024/09/kubernetes-hpa-unable-to-get-metrics-for-resource-memory-no-metrics-returned-from-resource-metrics-api-Screenshot_2024-09-19_at_8.22.46_AM.webp"
  alt="example-hpa"
  caption="example-hpa"
/>
...
- Error Messages: Pay attention to any error messages or warnings in the output. These can tell you whether the issue is related to missing metrics, a misconfigured HPA, or connectivity issues with the metrics API.
  {' '}
  <Figure
    src="/img/guides/2024/09/kubernetes-hpa-unable-to-get-metrics-for-resource-memory-no-metrics-returned-from-resource-metrics-api-6aa66ac1-c78b-4e42-a523-6fe8a23c838d.webp"
    alt="hpa-error"
    caption="hpa-error"
  />
...
<Figure
  src="/img/guides/2024/09/kubernetes-hpa-unable-to-get-metrics-for-resource-memory-no-metrics-returned-from-resource-metrics-api-Screenshot_2024-09-17_at_7.16.30_PM.webp"
  alt="metrics-server"
  caption="metrics-server"
/>
...
<Figure
  src="/img/guides/2024/09/kubernetes-hpa-unable-to-get-metrics-for-resource-memory-no-metrics-returned-from-resource-metrics-api-Screenshot_2024-09-17_at_7.16.46_PM.webp"
  alt="Raw metrics"
  caption="Raw metrics"
/>
...
- Correctly Defined Resource Requests: Ensure that the pod has appropriate resource requests and limits for CPU and memory. This will allow the metrics server to collect usage data, which the HPA can then use to make scaling decisions.
  {' '}
  <Figure
    src="/img/guides/2024/09/kubernetes-hpa-unable-to-get-metrics-for-resource-memory-no-metrics-returned-from-resource-metrics-api-Screenshot_2024-09-19_at_9.01.57_AM.webp"
    alt="pod describe"
    caption="pod describe"
  />
...
1.  Ensure metrics server is properly deployed and running:
    The metrics server is essential for HPA as it aggregates resource usage data that HPA uses to make scaling decisions. - Check Metrics-Server Deployment:
...
2.  Verify metrics-server version compatibility:
    ...
    - Update Metrics-Server:
      If an update is necessary, apply the latest compatible Metrics-Server manifest. This can be done by downloading the updated YAML file from the Kubernetes GitHub repository and applying it with `kubectl apply`. - Confirm your metrics-server version is compatible with your Kubernetes cluster version. - Update if necessary using the appropriate manifest for your cluster version.
...
3.  Check RBAC permissions: HPA and Metrics-Server require specific RBAC permissions to function properly.
    ...
    <Figure
      src="/img/guides/2024/09/kubernetes-hpa-unable-to-get-metrics-for-resource-memory-no-metrics-returned-from-resource-metrics-api-Screenshot_2024-09-17_at_7.18.36_PM.webp"
      alt="Clusterrole"
      caption="Clusterrole"
    />

    <Figure
      src="/img/guides/2024/09/kubernetes-hpa-unable-to-get-metrics-for-resource-memory-no-metrics-returned-from-resource-metrics-api-Screenshot_2024-09-17_at_7.19.29_PM.webp"
      alt="Clusterbinding"
      caption="Clusterbinding"
    />

4.  Validate resource requests and limits:
    Proper configuration of resource requests and limits is crucial for accurate metrics collection by the metrics server. - Review and Adjust Resource Specifications:
...
1.  Configure proper resource requests for monitored pods:
    ...
    <Figure
      src="/img/guides/2024/09/kubernetes-hpa-unable-to-get-metrics-for-resource-memory-no-metrics-returned-from-resource-metrics-api-Screenshot_2024-09-19_at_8.19.32_AM.webp"
      alt="hpa apply"
      caption="hpa apply"
    />
...
<Figure
  src="/img/guides/2024/09/kubernetes-hpa-unable-to-get-metrics-for-resource-memory-no-metrics-returned-from-resource-metrics-api-Screenshot_2024-09-19_at_8.19.58_AM.webp"
  alt="hpa-describe"
  caption="hpa-describe"
/>
...
<Figure
  src="/img/guides/2024/09/kubernetes-hpa-unable-to-get-metrics-for-resource-memory-no-metrics-returned-from-resource-metrics-api-Screenshot_2024-09-18_at_12.39.04_AM.webp"
  alt=""
  caption=""
/>
## Monitoring and Debugging HPA Performance
