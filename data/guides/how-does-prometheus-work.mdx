...
authors:
  - daniel
description: >-
  Prometheus periodically scrapes metrics from configured targets (such as
  applications, services, or infrastructure components) using HTTP endpoints.
  These targets expose metrics in a specific format that Prometheus understands.
keywords:
  - prometheus
  - monitor
  - monitoring
...
related_articles:
  ...
  - /guides/what-is-prometheus-target/
...
<Figure src="/img/guides/2024/07/how-does-prometheus-work-Untitled 1.webp" alt="Metrics displayed from an HTTP endpoint (localhost:8080/metrics)" caption="Metrics displayed from an HTTP endpoint (localhost:8080/metrics)" />
...
<Figure src="/img/guides/2024/07/how-does-prometheus-work-Untitled 2.webp" alt="Prometheus web UI" caption="Prometheus web UI" />
...
<Figure src="/img/guides/2024/07/how-does-prometheus-work-Untitled 3.webp" alt="PromQL query" caption="PromQL query" />
...
<Figure src="/img/guides/2024/07/how-does-prometheus-work-Untitled 4.webp" alt="Alerting rules in Prometheus" caption="Alerting rules in Prometheus" />
...
<Figure src="/img/guides/2024/07/how-does-prometheus-work-Untitled 5.webp" alt="Prometheus service discovery" caption="Prometheus service discovery" />
