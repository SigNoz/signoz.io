...
<script type="application/ld+json">
  ...
  "image": "https://signoz.io/img/blog/2024/07/grafana-without-prometheus-cover.webp",
  "author": {
    "@type": "Person",
    "name": "Yuvraj"
  },
...
<Figure src="/img/guides/2024/07/1-mysql-setup.webp" alt="MySQL setup for Grafana" caption="Setting up MySQL for Grafana data source." />
...
<Figure src="/img/guides/2024/07/2-grafana-start.webp" alt="Grafana login page" caption="Logging into Grafana with default credentials" />


- Navigate to Configuration > Data Sources and click Add data source.


<Figure src="/img/guides/2024/07/3-grafana-add-source.webp" alt="Grafana add data source page" caption="Navigating to add a new data source in Grafana" />
...
<Figure src="/img/guides/2024/07/4-grafana-mysql-setup.webp" alt="Configuring MySQL in Grafana" caption="Entering MySQL connection details in Grafana" />
...
<Figure src="/img/guides/2024/07/5-grafana-add-dashboard.webp" alt="Creating a new Grafana dashboard" caption="Adding a new panel to create a Grafana dashboard." />
...
<Figure src="/img/guides/2024/07/6-grafana-mysql-dashboard.webp" alt="Grafana dashboard with MySQL data" caption="Visualizing MySQL data on a Grafana dashboard" />
