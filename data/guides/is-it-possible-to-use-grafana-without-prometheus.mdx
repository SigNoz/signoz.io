...
authors:
  - yuvraj
description: >-
  Discover how to use Grafana without Prometheus by exploring its versatility
  with various data sources like MySQL. Learn the benefits, setup process, and
  practical applications in this comprehensive guide.
keywords:
