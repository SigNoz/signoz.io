...
To start capturing this telemetry data from your Native Sidecars, refer to the official SigNoz guides. You can follow the steps to [**collect Kubernetes metrics**](https://signoz.io/docs/infrastructure-monitoring/k8s-metrics/) for resource monitoring and set up [**Pod log collection**](https://signoz.io/docs/userguide/collect_kubernetes_pod_logs/) to unify your application and sidecar logs in one place.
