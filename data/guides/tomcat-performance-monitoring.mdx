...
related_articles:
  ...
  - '/guides/apm-metrics'
  - '/blog/opentelemetry-metrics-with-examples'
---
...
If you want to create custom dashboards for JVM metrics or Tomcat-specific panels, follow the [SigNoz dashboard creation guide](/docs/userguide/manage-dashboards/).
