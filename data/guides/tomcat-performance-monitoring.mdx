...
<Figure src="/img/guides/2026/03/tomcat-performance-monitoring-logs.webp" alt="SigNoz logs explorer displaying repeated Servlet.service exceptions for error.jsp from tomcat-monitoring-demo service." caption="Tomcat servlet exception logs correlated in SigNoz." width={1200} height={675} />
