...
- **Traces**: Click any trace to see the span waterfall. You should see spans for `GET /`, `GET /slow.jsp`, and `GET /error.jsp`.
  ...
  <NextFigure src="/img/guides/2026/03/tomcat-performance-monitoring-traces.webp" alt="SigNoz trace detail view showing GET /index.jsp span for tomcat-monitoring-demo with duration, service metadata, and span attributes." caption="Detailed span view for a Tomcat request with execution time and attributes." />
...
<NextFigure src="/img/guides/2026/03/tomcat-performance-monitoring-logs.webp" alt="SigNoz logs explorer displaying repeated Servlet.service exceptions for error.jsp from tomcat-monitoring-demo service." caption="Tomcat servlet exception logs correlated in SigNoz." />
