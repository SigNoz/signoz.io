...
meta_title: "AWS EC2 Monitoring Guide"
...
- Detailed Monitoring: For an additional cost, you gain more detailed insights using data at 1-minute intervals. For a full breakdown of these costs, see our [CloudWatch pricing guide](https://signoz.io/guides/cloudwatch-pricing/) and [cost optimization playbook](https://signoz.io/guides/cloudwatch-cost-optimization/).
...
To learn more, visit the [SigNoz Documentation](https://signoz.io/docs/introduction/).
...
Related reading: [AWS ECS monitoring](https://signoz.io/blog/aws-ecs-monitoring/), [AWS Lambda monitoring](https://signoz.io/guides/aws-lambda-monitoring/), [Linux server monitoring](https://signoz.io/guides/linux-server-monitoring/), and [APM tools](https://signoz.io/blog/open-source-apm-tools/).

For the vendor-neutral angle and wider AWS coverage, compare [OpenTelemetry vs CloudWatch](https://signoz.io/comparisons/opentelemetry-vs-cloudwatch/), browse the broader [AWS monitoring tools](https://signoz.io/comparisons/aws-monitoring-tools/), and see how this extends to [virtual machine monitoring](https://signoz.io/guides/virtual-machine-monitoring/).
