...
title: Metric Name Migration Guid
slug: migrations
date: 2025-05-06
...
We have introduced a new exporter: `SignozClickhouseMetrics`, which supports dot-based metric names (`system.memory.usage`).
...
Once the data for both naming formats has existed in your system for at least one full retention cycle, we will proceed with the final migration.
