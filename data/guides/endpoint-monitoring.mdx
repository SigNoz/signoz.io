...
meta_title: "Endpoint Monitoring Guide"
...
**Related reading:** Pair endpoint visibility with [health check monitoring](https://signoz.io/blog/health-check-monitoring-with-opentelemetry/), [server health monitoring](https://signoz.io/guides/server-health-monitoring/), broader [infrastructure monitoring](https://signoz.io/guides/infrastructure-monitoring/), and a look at modern [APM tools](https://signoz.io/blog/apm-tools/).

For distributed estates, see how [remote server monitoring](https://signoz.io/guides/remote-server-monitoring/) and [proactive monitoring](https://signoz.io/guides/proactive-monitoring/) extend the same approach.