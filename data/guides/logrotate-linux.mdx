...
<Figure src="/img/guides/2024/07/logrotate-linux-Untitled.webp" alt="Updating package lists" caption="Updating package lists" /><br></br><Figure src="/img/guides/2024/07/logrotate-linux-Untitled%201.webp" alt="Installinf logrotate on Ubuntu" caption="Installinf logrotate on Ubuntu" /><br></br>
...
<Figure src="/img/guides/2024/07/logrotate-linux-Untitled%202.webp" alt="Installing logrotate on CentOS" caption="Installing logrotate on CentOS" /><br></br>
...
<Figure src="/img/guides/2024/07/logrotate-linux-Untitled%203.webp" alt="Checking the logrotate version" caption="Checking the logrotate version" /><br></br>
...
<Figure src="/img/guides/2024/07/logrotate-linux-Untitled%204.webp" alt="`logrotate` Global Configuration file" caption="`logrotate` Global Configuration file" />
...
<Figure src="/img/guides/2024/07/logrotate-linux-9a1791a9-da17-4ba9-83aa-1275585e8a4f.webp" alt="`logrotate` addtional configuration files directory" caption="`logrotate` addtional configuration files directory" />
...
<Figure src="/img/guides/2024/07/logrotate-linux-Untitled%205.webp" alt="Running the generate-logs script in the background" caption="Running the generate-logs script in the background" /><br></br>Step 5: Monitor Log Rotation
...
<Figure src="/img/guides/2024/07/logrotate-linux-Untitled%206.webp" alt="Watch the log directory to get the list of  file generated by logrotate" caption="Watch the log directory to get the list of  file generated by logrotate" /><br></br>This command updates the file listing every second, allowing you to see new log files being created and old ones being compressed and archived.
...
<Figure src="/img/guides/2024/07/logrotate-linux-Untitled%207.webp" alt="Installing OpenTelemetry collector" caption="Installing OpenTelemetry collector" /><br></br>Note: Ensure you have the latest version of the OpenTelemetry Collector. The commands above use version 0.88.0, which is the latest at the time of writing. To verify and download the most current version, visit the <a href="https://github.com/open-telemetry/opentelemetry-collector-releases" rel="noopener noreferrer nofollow" target="_blank">OpenTelemetry Collector Releases</a> page.
...
<Figure src="/img/guides/2024/07/logrotate-linux-Untitled%208.webp" alt="Exploring logs in the SigNoz Dashboard" caption="Exploring logs in the SigNoz Dashboard" /><br></br>- You can filter logs on various parameters , for example if body contains “Error”

<Figure src="/img/guides/2024/07/logrotate-linux-Untitled%209.webp" alt="Filtering logs in SigNoz Logs Explorer" caption="Filtering logs in SigNoz Logs Explorer" /><br></br>What if you want to set up alerts if some error logs are received?  You can make use of SigNoz alerts in that case.
...
<Figure src="/img/guides/2024/07/logrotate-linux-Untitled%2010.webp" alt="Setting up conditions for SigNoz alerts" caption="Setting up conditions for SigNoz alerts" /><br></br>- Threshold: 1 occurrence within the last 60 minutes.

<Figure src="/img/guides/2024/07/logrotate-linux-Untitled%2011.webp" alt="Configuring threshold for SigNoz alerts" caption="Configuring threshold for SigNoz alerts" /><br></br>- Action: Send an email or trigger a webhook.

<Figure src="/img/guides/2024/07/logrotate-linux-Untitled%2012.webp" alt="Configuring notification channel for SigNoz alerts" caption="Configuring notification channel for SigNoz alerts" /><br></br>
