  ...
  <script
    ...
    dangerouslySetInnerHTML={{
      __html: JSON.stringify({
        ...
        alternativeHeadline:
          'A comprehensive guide to configuring and managing log rotation in Linux systems',
        ...
        about: [
          ...
          },
          {
            ...
            name: 'Log Management',
            description:
              'The process of handling log files to maintain system performance and security',
          },
          {
            '@type': 'Thing',
            name: 'Linux',
