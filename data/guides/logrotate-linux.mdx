...
The Linux logrotate utility solves this problem by automatically rotating, compressing, and removing old logs based on a defined schedule or when they reach a specific size threshold. 
...
When managing log rotation in Linux, <a href="https://github.com/logrotate/logrotate" target="_blank" rel="noopener noreferrer">logrotate</a> is the go-to system utility designed to simplify the administration of log files on systems that generate a lot of log data. It allows for the automatic rotation, compression, removal, and mailing of log files.
