...
To learn more about how these changes were made, you can follow the [JVM Metrics Setup Guide](https://signoz.io/docs/metrics-management/send-metrics/applications/opentelemetry-java/#jvm-runtime-metrics) on the SigNoz documentation.
...
To configure the [OpenTelemetry Collector](https://signoz.io/blog/opentelemetry-collector-complete-guide/)on your local or virtual machine, follow the steps outlined in the [Documentation](https://signoz.io/docs/opentelemetry-collection-agents/vm/install/).
...
After setting up the Otel [collector agent](https://signoz.io/blog/opentelemetry-collector-complete-guide/), follow the steps below to instrument your Java Application. 
