    ...
    dangerouslySetInnerHTML={{
      __html: JSON.stringify({
        ...
        description:
          'Master Python Logging with this Comprehensive Guide on Loggers, Handlers, Formatters, Filters, Configurations, and Best Practices for Debugging, Monitoring, and Performance.',
        keywords:
          'logging in python, python logging example, python logging to file, python logging to the console, python logging best practices',
        ...
        about: [
          ...
          },
          {
            ...
            name: 'Logging',
            description:
              'The process of recording events, messages, and data during software execution',
          },
          {
            '@type': 'Thing',
            name: 'SigNoz',
...
<Figure
  src="/img/guides/2024/08/logging-in-python-image.webp"
  alt="Python Logging Components"
  caption="Python Logging Components"
/>
