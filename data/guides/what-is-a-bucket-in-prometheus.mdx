...
authors:
  - ankit_anand
description: >-
  Discover what buckets are in Prometheus, how they work with histogram metrics,
  and their crucial role in data aggregation and analysis for effective
  monitoring.
keywords:
  - Prometheus
  - buckets
...
related_articles:
  ...
  - /guides/what-are-the-4-types-of-metrics-in-prometheus/
