  ...
  <script
    ...
    dangerouslySetInnerHTML={{
      __html: JSON.stringify({
        ...
        description:
          'Prometheus provides basic visualization via its expression browser, which allows for ad hoc queries and basic graphing. For more comprehensive dashboards, dedicated visualization tools like Grafana or SigNoz are recommended.',
        keywords: 'prometheus, metrics, monitoring, visualization',
        ...
        about: [
          ...
          },
          {
            ...
            name: 'Visualization',
            description:
              'The representation of data or metrics in a visual format, such as graphs or charts, to make analysis easier.',
          },
        ],
        mentions: [
          {
