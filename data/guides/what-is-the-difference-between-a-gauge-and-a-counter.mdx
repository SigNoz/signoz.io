  ...
  <script
    ...
    dangerouslySetInnerHTML={{
      __html: JSON.stringify({
        ...
        alternativeHeadline:
          'Understanding the Key Differences Between Gauge and Counter Metrics in Monitoring Systems',
        author: {
          '@type': 'Person',
          name: 'Daniel',
        },
        ...
        keywords:
          'gauge metrics, counter metrics, monitoring systems, Prometheus, metric types, data visualization, performance tracking, time series data',
        ...
        about: [
          {
            ...
            name: 'Gauge Metrics',
            description:
              'A metric that represents a single numerical value that can arbitrarily go up and down, used for fluctuating measurements.',
          },
          {
            '@type': 'Thing',
            name: 'Counter Metrics',
            description:
              'A cumulative metric that only increases in value or resets to zero, used for tracking continuously growing values.',
          },
          {
            '@type': 'Thing',
            name: 'Prometheus',
          ...
          },
          {
            ...
            description:
              'Tools and processes used to track the performance and health of systems over time.',
          },
        ],
        mentions: [
          {
