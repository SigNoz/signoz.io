...
<Figure
  src="/img/guides/2024/10/loki-json-logs-filter-by-detected-fields-from-grafana-image.webp"
  alt="Grafana-Loki log analysis"
  caption="Grafana-Loki log analysis"
/>
...
<Figure
  src="/img/guides/2024/10/loki-json-logs-filter-by-detected-fields-from-grafana-image%201.webp"
  alt="How Grafana Detects Fields in JSON Logs"
  caption="How Grafana Detects Fields in JSON Logs"
/>
...
2. Select Loki as your data source from the dropdown menu.
   ...
   <Figure
     src="/img/guides/2024/10/loki-json-logs-filter-by-detected-fields-from-grafana-image%202.webp"
     alt="Select Loki as your data source"
     caption="Select Loki as your data source"
   />

3. Enter your basic query to retrieve logs (for example, `{job="your-job-name"}`).

   <Figure
     src="/img/guides/2024/10/loki-json-logs-filter-by-detected-fields-from-grafana-image%203.webp"
     alt="Retrieve logs"
     caption="Retrieve logs"
   />
...
1. Extract JSON fields
   ...
   <Figure
     src="/img/guides/2024/10/loki-json-logs-filter-by-detected-fields-from-grafana-image%204.webp"
     alt="Extract JSON fields using LogQL"
     caption="Extract JSON fields using LogQL"
   />
...
2. Extracting Specific Fields
   ...
   <Figure
     src="/img/guides/2024/10/loki-json-logs-filter-by-detected-fields-from-grafana-image%205.webp"
     alt="Extract Specific Fields using LogQL"
     caption="Extract Specific Fields using LogQL"
   />
...
3. Combining Multiple Filters
   ...
   <Figure
     src="/img/guides/2024/10/loki-json-logs-filter-by-detected-fields-from-grafana-image%206.webp"
     alt="Combining Multiple Filters on JSON fields"
     caption="Combining Multiple Filters on JSON fields"
   />
...
1. Using Regular Expressions for Flexible Field Matching
   ...
   <Figure
     src="/img/guides/2024/10/loki-json-logs-filter-by-detected-fields-from-grafana-image%207.webp"
     alt="Using Regular Expressions for Flexible Field Matching"
     caption="Using Regular Expressions for Flexible Field Matching"
   />{' '}
...
2. Implementing Dynamic Field Filtering with Variables
   ...
   <Figure
     src="/img/guides/2024/10/loki-json-logs-filter-by-detected-fields-from-grafana-image%208.webp"
     alt="Implementing Dynamic Field Filtering with Variables"
     caption="Implementing Dynamic Field Filtering with Variables"
   />
...
3. Leveraging Derived Fields for Enhanced Filtering
   ...
   <Figure
     src="/img/guides/2024/10/loki-json-logs-filter-by-detected-fields-from-grafana-image%209.webp"
     alt="Leveraging Derived Fields for Enhanced Filtering"
     caption="Leveraging Derived Fields for Enhanced Filtering"
   />
