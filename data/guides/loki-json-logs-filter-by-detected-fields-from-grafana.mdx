...
meta_title: "Filter Loki JSON Logs in Grafana"
...
Once you've mastered filtering your JSON logs, the next natural step is aggregating those results. Check out our guide on [counting log messages in Loki](https://signoz.io/guides/grafana-loki-total-number-of-a-specific-log-message/) to learn how to apply LogQL aggregation functions to your filtered log streams.
