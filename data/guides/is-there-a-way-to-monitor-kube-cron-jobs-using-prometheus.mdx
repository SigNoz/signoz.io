...
- Prometheus and PushGateway: Install Prometheus and PushGateway. They can be installed using Helm or other tools, as long as they are configured to communicate within the cluster.
    ...
    <Figure src="/img/guides/2024/11/is-there-a-way-to-monitor-kube-cron-jobs-using-prometheus-image 1.webp" alt="Prometheus and PushGateway Installation Verification" caption="Prometheus and PushGateway Installation Verification" />
...
<Figure src="/img/guides/2024/11/is-there-a-way-to-monitor-kube-cron-jobs-using-prometheus-image 2.webp" alt="CronJob Running" caption="CronJob Running" />
...
1. Find the Prometheus Custom Resource in your cluster:
    ...
    <Figure src="/img/guides/2024/11/is-there-a-way-to-monitor-kube-cron-jobs-using-prometheus-image 3.webp" alt="Find the Prometheus Custom Resource" caption="Find the Prometheus Custom Resource" /> 
...
2. Once you’ve identified the name of your Prometheus CR, edit it:
    ...
    <Figure src="/img/guides/2024/11/is-there-a-way-to-monitor-kube-cron-jobs-using-prometheus-image 4.webp" alt="Editing the Custom Resource" caption="Editing the Custom Resource" />
...
<Figure src="/img/guides/2024/11/is-there-a-way-to-monitor-kube-cron-jobs-using-prometheus-image 5.webp" alt="Prometheus is scraping metrics from PushGateway" caption="Prometheus is scraping metrics from PushGateway" />
...
2. Alert for Long-Running CronJobs:
    ...
    <Figure src="/img/guides/2024/11/is-there-a-way-to-monitor-kube-cron-jobs-using-prometheus-image 6.webp" alt="Configuring Alerting Rules for K8s CronJob" caption="Configuring Alerting Rules for K8s CronJob" /> 
...
- SigNoz's ability to collect and visualize these [metrics in intuitive dashboards](https://signoz.io/metrics-and-dashboards/) allows you to quickly identify issues, optimize job performance, and ensure that your CronJobs run smoothly.
    ...
    <Figure src="/img/guides/2024/11/is-there-a-way-to-monitor-kube-cron-jobs-using-prometheus-image 7.webp" alt="SigNoz: metrics and dashboards" caption="SigNoz: metrics and dashboards" />
...
- With advanced [alerting capabilities](https://signoz.io/alerts-management/), SigNoz can notify you of critical failures or performance bottlenecks, making it an essential tool for [proactive monitoring](https://signoz.io/guides/proactive-monitoring/) and faster troubleshooting.
    ...
    <Figure src="/img/guides/2024/11/is-there-a-way-to-monitor-kube-cron-jobs-using-prometheus-image 8.webp" alt="SigNoz: Alerting Capabilities" caption="SigNoz: Alerting Capabilities" />
...
- [Send cronjob metrics to SigNoz Cloud](https://signoz.io/docs/metrics-management/send-metrics/)
- [Send cronjob metrics to Self-hosted SigNoz](https://signoz.io/docs/metrics-management/send-metrics/)
...
- Alert Correlation Setup:
    - Link alerts to specific [dashboard panels](https://signoz.io/docs/userguide/manage-dashboards/) to make it easier to investigate issues immediately when an alert is triggered.
