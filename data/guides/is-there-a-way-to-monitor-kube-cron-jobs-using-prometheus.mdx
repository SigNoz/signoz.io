...
related_articles: ['/guides/kubernetes-monitoring-prometheus', '/guides/does-kubernetes-use-prometheus', '/guides/how-to-monitor-custom-kubernetes-pod-metrics-using-prometheus', '/blog/kubernetes-monitoring']
