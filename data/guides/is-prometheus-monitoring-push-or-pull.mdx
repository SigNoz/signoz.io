...
authors:
  - daniel
description: >-
  Prometheus utilizes a pull-based monitoring model, where it retrieves metrics
  from predefined targets by scraping data from their exposed endpoints.
keywords:
  - prometheus
  - monitoring
  - metrics
...
<Figure src="/img/guides/2024/07/is-prometheus-monitoring-push-or-pull-Untitled 1.webp" alt="Exposed metrics endpoint" caption="Exposed metrics endpoint" />
...
<Figure src="/img/guides/2024/07/is-prometheus-monitoring-push-or-pull-Untitled 2.webp" alt="Prometheus targets" caption="Prometheus targets" />
...
<Figure src="/img/guides/2024/07/is-prometheus-monitoring-push-or-pull-Untitled 3.webp" alt="Push-based monitoring" caption="Push-based monitoring" />
