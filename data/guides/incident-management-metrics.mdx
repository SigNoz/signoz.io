...
keywords:
  [incident management metrics, MTTR, MTTA, SLA compliance, incident response, IT operations]
---
...
<Figure
  src="/img/guides/2024/12/incident-management-metrics-image.webp"
  alt="Proactive and Reactive Metric"
  caption="Proactive and Reactive Metric"
/>
...
<Figure
  src="/img/guides/2024/12/incident-management-metrics-image%201.webp"
  alt="Incident Metrics Visual"
  caption="Incident Metrics Visual"
/>
...
<Figure
  src="/img/guides/2024/12/incident-management-metrics-image%202.webp"
  alt="Mean Time To: X"
  caption="Mean Time To: X"
/>
...
<Figure
  src="/img/guides/2024/12/incident-management-metrics-image%203.webp"
  alt="Alert Notification Channel in SigNoz"
  caption="Alert Notification Channel in SigNoz"
/>
...
<Figure
  src="/img/guides/2024/12/incident-management-metrics-image%204.webp"
  alt="Alert Configuration in SigNoz"
  caption="Alert Configuration in SigNoz"
/>
...
<Figure
  src="/img/guides/2024/12/incident-management-metrics-image%205.webp"
  alt="Alert conditions setup"
  caption="Alert conditions setup"
/>
...
<Figure
  src="/img/guides/2024/12/incident-management-metrics-image%206.webp"
  alt="Threshold crossed for this incident metric"
  caption="Threshold crossed for this incident metric"
/>
...
<Figure
  src="/img/guides/2024/12/incident-management-metrics-image%207.webp"
  alt="Triggered Alert for crossed threshold"
  caption="Triggered Alert for crossed threshold"
/>

When an incident metric that we defined earlier crosses the set threshold, an email is sent in the following manner:

<Figure
  src="/img/guides/2024/12/incident-management-metrics-image%208.webp"
  alt="Email received from SigNoz"
  caption="Email received from SigNoz"
/>
...
<Figure
  src="/img/guides/2024/12/incident-management-metrics-image%209.webp"
  alt="Incident Management Tools"
  caption="Incident Management Tools"
/>
