...
meta_title: "Incident Management Metrics: 10 KPIs to Track"
...
related_articles:
  - '/guides/incident-tracking'
  - '/guides/incident-response-cycle'
  - '/guides/sre-best-practices'
  - '/guides/alerts-as-code'
...
<Figure src="/img/guides/2024/12/incident-management-metrics-image 1.webp" alt="Incident Metrics Visual" caption="Incident Metrics Visual" />
...
<Figure src="/img/guides/2024/12/incident-management-metrics-image 2.webp" alt="Mean Time To: X" caption="Mean Time To: X" />
...
<Figure src="/img/guides/2024/12/incident-management-metrics-image 3.webp" alt="Alert Notification Channel in SigNoz" caption="Alert Notification Channel in SigNoz" />
...
<Figure src="/img/guides/2024/12/incident-management-metrics-image 4.webp" alt="Alert Configuration in SigNoz" caption="Alert Configuration in SigNoz" />
...
<Figure src="/img/guides/2024/12/incident-management-metrics-image 5.webp" alt="Alert conditions setup" caption="Alert conditions setup" />
...
<Figure src="/img/guides/2024/12/incident-management-metrics-image 6.webp" alt="Threshold crossed for this incident metric" caption="Threshold crossed for this incident metric" />
...
<Figure src="/img/guides/2024/12/incident-management-metrics-image 7.webp" alt="Triggered Alert for crossed threshold" caption="Triggered Alert for crossed threshold" />

When an incident metric that we defined earlier crosses the set threshold, an email is sent in the following manner: 

<Figure src="/img/guides/2024/12/incident-management-metrics-image 8.webp" alt="Email received from SigNoz" caption="Email received from SigNoz" />
...
<Figure src="/img/guides/2024/12/incident-management-metrics-image 9.webp" alt="Incident Management Tools" caption="Incident Management Tools" />
...
**Related reading:** [SRE metrics](https://signoz.io/guides/sre-metrics/), [proactive monitoring](https://signoz.io/guides/proactive-monitoring/), and [SLO monitoring](https://signoz.io/guides/slo-monitoring/).