...
Go to Alerts → Select Trace-[based alert](https://signoz.io/docs/alerts-management/metrics-based-alerts/) (ideal for monitoring external APIs) → Configure the metrics to monitor, such as status codes (e.g., 503) → Click Stage to run the query.
