...
<Figure
  src="/img/guides/2024/10/how-to-get-number-of-pods-running-in-prometheus-Screenshot_2024-10-06_at_10.46.56_PM.webp"
  alt="Count all pods"
  caption="Count all pods"
/>
...
<Figure
  src="/img/guides/2024/10/how-to-get-number-of-pods-running-in-prometheus-Screenshot_2024-10-06_at_10.47.52_PM.webp"
  alt="Count pods which are in running state"
  caption="Count pods which are in running state"
/>
...
<Figure
  src="/img/guides/2024/10/how-to-get-number-of-pods-running-in-prometheus-Screenshot_2024-10-06_at_11.09.26_PM.webp"
  alt="Count kube from a specific namespace"
  caption="Count kube from a specific namespace"
/>
...
<Figure
  src="/img/guides/2024/10/how-to-get-number-of-pods-running-in-prometheus-Screenshot_2024-10-06_at_11.08.24_PM.webp"
  alt="Number of pods changing over 1 hour"
  caption="Number of pods changing over 1 hour"
/>
...
<Figure
  src="/img/guides/2024/10/how-to-get-number-of-pods-running-in-prometheus-Screenshot_2024-10-22_at_1.07.21_AM.webp"
  alt="Checking any abnormalities during a time range"
  caption="Checking any abnormalities during a time range"
/>
...
<Figure
  src="/img/guides/2024/10/how-to-get-number-of-pods-running-in-prometheus-Screenshot_2024-10-06_at_11.49.23_PM.webp"
  alt="Count pods in grafana"
  caption="Count pods in grafana"
/>
...
<Figure
  src="/img/guides/2024/10/how-to-get-number-of-pods-running-in-prometheus-Screenshot_2024-10-06_at_11.50.28_PM.webp"
  alt="Count pods by namespace in grafana"
  caption="Count pods by namespace in grafana"
/>
...
<Figure
  src="/img/guides/2024/10/how-to-get-number-of-pods-running-in-prometheus-Screenshot_2024-10-22_at_12.42.07_AM.webp"
  alt="Pie chart for pods running, pending and failed"
  caption="Pie chart for pods running, pending and failed"
/>
...
<Figure
  src="/img/guides/2024/10/how-to-get-number-of-pods-running-in-prometheus-Screenshot_2024-10-22_at_1.06.03_AM.webp"
  alt="Pod count graph for 24 hours range"
  caption="Pod count graph for 24 hours range"
/>
...
<Figure
  src="/img/guides/2024/10/how-to-get-number-of-pods-running-in-prometheus-120f8dd1-1ae7-4a7f-86f6-df6d37934572.webp"
  alt="Setting up variable"
  caption="Setting up variable"
/>

<Figure
  src="/img/guides/2024/10/how-to-get-number-of-pods-running-in-prometheus-Screenshot_2024-10-22_at_12.34.57_AM.webp"
  alt="Using variable name instead of using the query"
  caption="Using variable name instead of using the query"
/>
...
- Look for messages in the Events section of the output, which may indicate why the pod couldn’t be scheduled (e.g., insufficient CPU, memory, or unavailable nodes).
  {' '}
  <Figure
    src="/img/guides/2024/10/how-to-get-number-of-pods-running-in-prometheus-Screenshot_2024-10-07_at_5.39.13_PM.webp"
    alt="Kubernetes pod description"
    caption="Kubernetes pod description"
  />
...
- Make sure your nodes have sufficient available resources by using `kubectl describe nodes` or `kubectl top nodes` to check the current resource usage on each node.
  {' '}
  <Figure
    src="/img/guides/2024/10/how-to-get-number-of-pods-running-in-prometheus-Screenshot_2024-10-07_at_6.49.41_PM.webp"
    alt="Kubernetes pod description in yaml format"
    caption="Kubernetes pod description in yaml format"
  />
...
- If the pod contains multiple containers, specify the container name like this: `kubectl logs <pod-name> -c <container-name>`.
  {' '}
  <Figure
    src="/img/guides/2024/10/how-to-get-number-of-pods-running-in-prometheus-Screenshot_2024-10-07_at_6.50.38_PM.webp"
    alt="Pod logs"
    caption="Pod logs"
  />
...
- Check for any recent deployment updates or changes to scaling rules by using `kubectl describe deployment <deployment-name>`.
  {' '}
  <Figure
    src="/img/guides/2024/10/how-to-get-number-of-pods-running-in-prometheus-Screenshot_2024-10-07_at_6.51.41_PM.webp"
    alt="More info about pod deployment"
    caption="More info about pod deployment"
  />
