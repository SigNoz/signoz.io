...
<Figure
  src="/img/guides/2024/09/when-does-dynamodb-throttle-request-image.webp"
  alt="DynamoDB landing page"
  caption="DynamoDB landing page"
/>
...
<Figure
  src="/img/guides/2024/09/when-does-dynamodb-throttle-request-image%201.webp"
  alt="Capacity Modes of DynamoDB"
  caption="Capacity Modes of DynamoDB"
/>
