...
authors:
  - sushant_gaurav
description: >-
  Learn when and why DynamoDB throttles requests, how to identify throttling
  issues, and strategies to prevent them for optimal database performance.
keywords:
  - DynamoDB throttling
  - request throttling
  - AWS database
...
<Figure src="/img/guides/2024/09/when-does-dynamodb-throttle-request-image 1.webp" alt="Capacity Modes of DynamoDB" caption="Capacity Modes of DynamoDB" />
