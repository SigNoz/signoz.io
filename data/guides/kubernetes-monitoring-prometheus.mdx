...
<Figure src="/img/guides/2024/06/kubernetes-monitoring-prometheus-cover.webp" alt="Kubernetes Prometheus monitoring cover illustration" caption="" />
...
Visit our guide on [OpenTelemetry Collector]((https://signoz.io/blog/opentelemetry-collector-complete-guide/)) to learn more about it. You can also explore the broader [Kubernetes monitoring](https://signoz.io/kubernetes-monitoring/) capabilities available in SigNoz.
