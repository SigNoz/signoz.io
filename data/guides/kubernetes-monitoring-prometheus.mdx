# Kubernetes Monitoring | How to Monitor Kubernetes Clusters using Prometheus

title: Kubernetes Monitoring - How to Monitor Kubernetes Clusters using Prometheus
...
If you want to jump straight into implementation, start with the <a href="https://www.notion.so/Kubernetes-Monitoring-How-to-Monitor-Kubernetes-Clusters-using-Prometheus-59729faf32e0430a912bcae05340f764?pvs=21" rel="noopener noreferrer nofollow" target="_blank">prerequisites</a> section.
...
<Figure src="/public/img/guides/2024/06/030593fc-3b03-468d-a838-8714e1d8e949.png" alt="*Saved SigNoz dashboard*" caption="*Saved SigNoz dashboard*" /><br></br>You can proceed to run more queries against metrics of your choice.
...
If you're excited about SigNoz and want to go deeper, <a href="https://signoz-community.slack.com/join/shared_invite/zt-1v5ms4lg2-uupFbX9_qFIWNeVXbMszkw#/shared-invite/email" rel="noopener noreferrer nofollow" target="_blank">join the SigNoz Slack</a> to be part of this awesome open-source community!