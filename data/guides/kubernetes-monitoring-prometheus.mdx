...
related_articles: ['/guides/how-to-monitor-custom-kubernetes-pod-metrics-using-prometheus', '/guides/does-kubernetes-use-prometheus', '/guides/prometheus-queries-to-get-cpu-and-memory-usage-in-kubernetes-pods', '/guides/how-to-calculate-containers-cpu-usage-in-kubernetes-with-prometheus-as-monitoring', '/guides/how-to-get-number-of-pods-running-in-prometheus', '/blog/out-of-box-application-monitoring-prometheus']
---
