...
<Figure src="/public/img/guides/2024/06/signoz-dashboard.webp" alt="Saved SigNoz dashboard" caption="Saved SigNoz dashboard" /><br></br>You can proceed to run more queries against metrics of your choice.
