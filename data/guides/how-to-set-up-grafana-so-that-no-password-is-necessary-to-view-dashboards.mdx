...
2. Find the `[auth.anonymous]` section in your configuration file(or add it if it doesn't exist).
   ...
   <Figure
     src="/img/guides/2024/09/how-to-set-up-grafana-so-that-no-password-is-necessary-to-view-dashboards-image.webp"
     alt="Configure authorization in Grafana Configuration file"
     caption="Configure authorization in Grafana Configuration file"
   />
...
3. Set the following options:
   ...
   <Figure
     src="/img/guides/2024/09/how-to-set-up-grafana-so-that-no-password-is-necessary-to-view-dashboards-image%201.webp"
     alt="Enabling Anonymous access for Grafana Dashboard"
     caption="Enabling Anonymous access for Grafana Dashboard"
   />
...
1. Log in to Grafana as an admin. Visit Administration → General → Organizations → `New org`
   ...
   <Figure
     src="/img/guides/2024/09/how-to-set-up-grafana-so-that-no-password-is-necessary-to-view-dashboards-image%202.webp"
     alt="Creating new organization in Grafana"
     caption="Creating new organization in Grafana"
   />

2. Create a new organization (e.g., "Public Dashboards").

   <Figure
     src="/img/guides/2024/09/how-to-set-up-grafana-so-that-no-password-is-necessary-to-view-dashboards-image%203.webp"
     alt="Naming Organization in Grafana"
     caption="Naming Organization in Grafana"
   />{' '}
...
- To switch to the new organization, click on your admin user account icon, then select Profile. Scroll down to Organizations and choose the desired organization. Usually, a newly created organization is automatically set as the current one.
  {' '}
  <Figure
    src="/img/guides/2024/09/how-to-set-up-grafana-so-that-no-password-is-necessary-to-view-dashboards-image%204.webp"
    alt="Switching Profile in Grafana"
    caption="Switching Profile in Grafana"
  />
