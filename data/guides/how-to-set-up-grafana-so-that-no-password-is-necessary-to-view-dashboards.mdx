...
authors:
  - simran_kumari
description: >-
  Learn how to configure Grafana for password-free dashboard viewing. Enhance
  accessibility while maintaining security for your monitoring dashboards.
keywords:
  - Grafana
  - password-free dashboards
  - anonymous access
  - dashboard security
  - monitoring
  - observability
