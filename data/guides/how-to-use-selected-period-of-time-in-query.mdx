...
1. Absolute Time Periods: Absolute periods specify exact start and end times, such as `"2023-01-01T00:00:00"` to `"2023-12-31T23:59:59"`. Absolute periods allow you to analyze a fixed timeframe, ideal for detailed reports or historical data snapshots.
   ...
   <Figure
     src="/img/guides/2024/11/how-to-use-selected-period-of-time-in-query-image.webp"
     alt="Absolute Time Periods"
     caption="Absolute Time Periods"
   />
...
2. Relative Time Periods: Relative periods use expressions like “last week,” `now-24h` (last 24 hours) or `now-7d` (last seven days), based on the current time. Relative periods are great for dashboards, as they automatically update to reflect the latest data without manual adjustment.
   ...
   <Figure
     src="/img/guides/2024/11/how-to-use-selected-period-of-time-in-query-image%201.webp"
     alt="Relative Time Periods"
     caption="Relative Time Periods"
   />
...
<Figure
  src="/img/guides/2024/11/how-to-use-selected-period-of-time-in-query-image%202.webp"
  alt="Basic Time Range Filters"
  caption="Basic Time Range Filters"
/>
...
- rate(): The `rate()` function calculates the average per-second rate of increase over a specified time interval. Ideal for metrics like network requests or CPU usage.
  ...
  {' '}
  <Figure
    src="/img/guides/2024/11/how-to-use-selected-period-of-time-in-query-image%203.webp"
    alt="rate() function"
    caption="rate() function"
  />
- increase(): Calculates the cumulative increase over a given period, useful for counters.
  ...
  {' '}
  <Figure
    src="/img/guides/2024/11/how-to-use-selected-period-of-time-in-query-image%204.webp"
    alt="increase() function"
    caption="increase() function"
  />
...
- sum_over_time(): Returns the total value over a specified interval, which is useful for aggregating metrics like total bytes transferred.
  ...
  {' '}
  <Figure
    src="/img/guides/2024/11/how-to-use-selected-period-of-time-in-query-image%205.webp"
    alt="sum_over_time() - Time aggregation"
    caption="sum_over_time() - Time aggregation"
  />
- avg_over_time(): Calculates the average value over a given interval. For instance:
  ...
  {' '}
  <Figure
    src="/img/guides/2024/11/how-to-use-selected-period-of-time-in-query-image%206.webp"
    alt="avg_over_time() - Time aggregation"
    caption="avg_over_time() - Time aggregation"
  />
...
<Figure
  src="/img/guides/2024/11/how-to-use-selected-period-of-time-in-query-image%207.webp"
  alt="Time-Based Joins and Correlations"
  caption="Time-Based Joins and Correlations"
/>
...
- Real-Time Querying Capabilities: SigNoz allows for fast, real-time querying of time series data, enabling you to track and troubleshoot issues as they arise. SigNoz streamlines the process with its intuitive interface and seamless integration with [observability pipelines](https://signoz.io/guides/observability-pipeline/).
  {' '}
  <Figure
    src="/img/guides/2024/11/how-to-use-selected-period-of-time-in-query-image%208.webp"
...
- Built-In Time Range Selectors: With SigNoz, users can easily adjust time ranges within dashboards to pinpoint the exact moment events occurred. This built-in functionality eliminates the need for manual configurations, offering a more streamlined experience.
  {' '}
  <Figure
    src="/img/guides/2024/11/how-to-use-selected-period-of-time-in-query-b7c63af8-2a57-4089-a31b-2f04539bc53e.webp"
    alt="Built-in time range selectors in SigNoz"
    caption="Built-in time range selectors in SigNoz"
  />
- Custom Dashboard Creation: SigNoz simplifies the creation of customized dashboards tailored to your unique monitoring needs. While Grafana provides extensive customization options, SigNoz focuses on reducing complexity and offering a user-friendly design that integrates out-of-the-box observability features. This makes it a great option for teams looking to quickly set up and scale their monitoring systems.
  {' '}
  <Figure
    src="/img/guides/2024/11/how-to-use-selected-period-of-time-in-query-image%209.webp"
    alt="Custom dashboard creation"
    caption="Custom dashboard creation"
  />
...
- Daily Aggregation Queries: Aggregate the `http_requests_total` metric by day to track daily traffic.
  ...
  {' '}
  <Figure
    src="/img/guides/2024/11/how-to-use-selected-period-of-time-in-query-image%2010.webp"
    alt="Daily aggregation queries"
    caption="Daily aggregation queries"
  />
- Business Hours Filtering: Filter `http_requests_total` for data during business hours (9 AM - 5 PM).
  {' '}
  <Figure
    src="/img/guides/2024/11/how-to-use-selected-period-of-time-in-query-image%2011.webp"
    alt="Business hours filtering"
    caption="Business hours filtering"
  />
- Time-Based Comparisons: Compare `http_requests_total` from different time periods, such as this week vs. last week.
  ...
  {' '}
  <Figure
    src="/img/guides/2024/11/how-to-use-selected-period-of-time-in-query-image%2012.webp"
    alt="Time-based comparisons"
    caption="Time-based comparisons"
  />
- Seasonal Analysis Queries: Analyze seasonal trends in `http_requests_total`, like yearly or monthly totals.
  ...
  {' '}
  <Figure
    src="/img/guides/2024/11/how-to-use-selected-period-of-time-in-query-image%2013.webp"
    alt="Seasonal analysis queries"
    caption="Seasonal analysis queries"
  />
