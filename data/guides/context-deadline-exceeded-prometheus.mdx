...
3. Use Prometheus debug endpoints:
    ...
    - Look for goroutines stuck in scrape operations
        ...
        <Figure src="/img/guides/2024/09/context-deadline-exceeded-prometheus-image%204.webp" alt="Prometheus error output showing context deadline exceeded" caption="" />Let’s decode it one by one :
