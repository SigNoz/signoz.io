...
<Figure
  src="/img/guides/2024/08/what-is-apm-CleanShot_2024-08-08_at_15.25.292x.webp"
...
<Figure
  src="/img/guides/2024/08/what-is-apm-Untitled.webp"
  alt="SigNoz Ingestion Settings Page"
  caption="SigNoz Ingestion Settings Page"
/>
...
<Figure
  src="/img/guides/2024/08/what-is-apm-Screenshot_2024-08-07_at_2.39.26_PM.webp"
  alt="Screenshot 2024-08-07 at 2.39.26 PM.webp"
  caption="Screenshot 2024-08-07 at 2.39.26 PM.webp"
/>
...
<Figure
  src="/img/guides/2024/08/what-is-apm-Screenshot_2024-08-05_at_11.35.06_AM.webp"
  alt="SigNoz Getting Started"
  caption="SigNoz Getting Started"
/>
...
<Figure
  src="/img/guides/2024/08/what-is-apm-Screenshot_2024-08-05_at_11.37.49_AM.webp"
  alt="SigNoz Application Monitoring (Select Data Source)"
  caption="SigNoz Application Monitoring (Select Data Source)"
/>
...
<Figure
  src="/img/guides/2024/08/what-is-apm-9ce80b11-fab2-4e1a-90fd-0a2d77247ad1.webp"
  alt="SigNoz Env Details"
  caption="SigNoz Env Details"
/>
...
<Figure
  src="/img/guides/2024/08/what-is-apm-Screenshot_2024-08-05_at_11.43.33_AM.webp"
  alt="Select the method using to send data to SigNoz OTEL SDK or OTEL Collector to send data."
  caption="Select the method using to send data to SigNoz OTEL SDK or OTEL Collector to send data."
/>
...
<Figure
  src="/img/guides/2024/08/what-is-apm-Screenshot_2024-08-05_at_1.01.24_PM.webp"
  alt="SigNoz Services Page"
  caption="SigNoz Services Page"
/>

Clicking on the Service `flask-app` you will see something like this, where you can check the latency, key Operations etc.

<Figure
  src="/img/guides/2024/08/what-is-apm-Screenshot_2024-08-05_at_12.56.44_PM.webp"
  alt="SigNoz Dashboard Services Overview"
  caption="SigNoz Dashboard Services Overview"
/>

1. Checking the traces:

<Figure
  src="/img/guides/2024/08/what-is-apm-Screenshot_2024-08-05_at_12.55.19_PM.webp"
...
<Figure
  src="/img/guides/2024/08/what-is-apm-Screenshot_2024-08-05_at_12.55.40_PM.webp"
  alt="Trace Details of Requests"
  caption="Trace Details of Requests"
/>

Check only the `Error` tag in the Status menu to filter traces by errors.

<Figure
  src="/img/guides/2024/08/what-is-apm-Screenshot_2024-08-05_at_12.57.43_PM.webp"
  alt="SigNoz Traces Dashboard"
  caption="SigNoz Traces Dashboard"
/>
