...
6.  **Infrastructure Monitoring Support**:
    ...
    <Figure
      src="/img/guides/2025/03/remote-server-monitoring-269bf300-b072-4858-af63-6281178cc638.webp"
      alt="Click on Infra Monitoring"
      caption="Click on Infra Monitoring"
    />

    Click on the desired **`Host Name`** to open its corresponding dashboard

    <Figure
      src="/img/guides/2025/03/remote-server-monitoring-3b6e2b2c-9fa8-47fb-a094-5f35c8de5924.webp"
      alt="Select your hostname"
      caption="Select your hostname"
    />
    ...
    <Figure
      src="/img/guides/2025/03/remote-server-monitoring-ac600f6d-9587-4b21-a5a5-533ca0787857.webp"
      alt="Infrastructure dashboard"
      caption="Infrastructure dashboard"
    />
