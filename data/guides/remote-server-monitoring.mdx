...
For more information, refer to [OpenTelemetry Binary Usage in Virtual Machine(VM)](https://signoz.io/docs/opentelemetry-collection-agents/vm/install/) to get your Otel [Collector agent](https://signoz.io/comparisons/opentelemetry-collector-vs-agent/) up and running.
