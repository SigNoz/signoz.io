...
meta_title: "Enable and Query VPC Flow Logs in AWS"
...
<ArticleSeriesTop
  ...
  currentPart="2"
  totalParts="2"
  previousTitle="VPC Flow Logs Deep Dive - How They Work and Why You Need Them?"
  previousHref="/guides/vpc-flow-logs"
/>
