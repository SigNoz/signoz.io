...
<Figure
  src="/img/guides/2024/09/how-can-i-sort-the-legend-by-series-name-in-prometheus-grafana-image.webp"
  alt="Legends in Grafana dashboard based on data collected from Prometheus"
  caption="Legends in Grafana dashboard based on data collected from Prometheus"
/>
...
1. In the Grafana Dashboard go to `Dashboards` section and select the dashboard for which you want to edit the panel.
   ...
   <Figure
     src="/img/guides/2024/09/how-can-i-sort-the-legend-by-series-name-in-prometheus-grafana-image%201.webp"
     alt="Selecting dashboards in Grafana"
     caption="Selecting dashboards in Grafana"
   />

2. Select the panel you want to work with within the dashboard and click the `Edit` option.

   <Figure
     src="/img/guides/2024/09/how-can-i-sort-the-legend-by-series-name-in-prometheus-grafana-image%202.webp"
     alt="Selecting Panel in Grafana Dashboard"
     caption="Selecting Panel in Grafana Dashboard"
   />

3. Navigate to the "Legend" tab in the panel settings.

   <Figure
     src="/img/guides/2024/09/how-can-i-sort-the-legend-by-series-name-in-prometheus-grafana-image%203.webp"
     alt="Navigating to Legends tab in Panel settings"
     caption="Navigating to Legends tab in Panel settings"
   />

4. Under Mode, select Table.

   <Figure
     src="/img/guides/2024/09/how-can-i-sort-the-legend-by-series-name-in-prometheus-grafana-image%204.webp"
     alt="Selecting Legend Mode"
     caption="Selecting Legend Mode"
   />

5. Under Values, select the value or calculation that you want to show. The legend table now displays values.

   <Figure
     src="/img/guides/2024/09/how-can-i-sort-the-legend-by-series-name-in-prometheus-grafana-image%205.webp"
     alt="Selecting Legend Values"
     caption="Selecting Legend Values"
   />

   <Figure
     src="/img/guides/2024/09/how-can-i-sort-the-legend-by-series-name-in-prometheus-grafana-Screenshot_2024-09-19_212729.webp"
     alt="Values get added to the Legend table"
     caption="Values get added to the Legend table"
   />

6. Click the calculation name header in the legend table to sort the values in the table in ascending or descending order.

   <Figure
     src="/img/guides/2024/09/how-can-i-sort-the-legend-by-series-name-in-prometheus-grafana-image%206.webp"
     alt="Sorting Legend table based on Values"
     caption="Sorting Legend table based on Values"
   />
...
<Figure
  src="/img/guides/2024/09/how-can-i-sort-the-legend-by-series-name-in-prometheus-grafana-image%207.webp"
  alt="Enabling experimental feature on Prometheus"
  caption="Enabling experimental feature on Prometheus"
/>
...
- Ascending order by label value (`generation` in this case):
  ...
  {' '}
  <Figure
    src="/img/guides/2024/09/how-can-i-sort-the-legend-by-series-name-in-prometheus-grafana-c21d717b-09a3-4a6b-8136-bf5b03ad29b0.webp"
    alt="Running PromQL to sort legends in ascending order"
    caption="Running PromQL to sort legends in ascending order"
  />
- Descending order by label value (`generation`):
  ...
  {' '}
  <Figure
    src="/img/guides/2024/09/how-can-i-sort-the-legend-by-series-name-in-prometheus-grafana-1f17fa86-4142-43cc-9d27-19c8adf727fb.webp"
    alt="Running PromQL to sort legends in descending order"
    caption="Running PromQL to sort legends in descending order"
  />
...
<Figure
  src="/img/guides/2024/09/how-can-i-sort-the-legend-by-series-name-in-prometheus-grafana-image%208.webp"
  alt="Consistent naming and Color selection in Grafana Time-series visualization"
  caption="Consistent naming and Color selection in Grafana Time-series visualization"
/>
