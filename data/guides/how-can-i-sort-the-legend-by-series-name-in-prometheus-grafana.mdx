...
authors:
  - simran_kumari
description: >-
  Learn how to sort legends by series name in Prometheus and Grafana for
  improved data visualization and analysis. Discover step-by-step methods and
  best practices.
keywords:
  - legend sorting
  - Prometheus
...
1. In the Grafana Dashboard go to `Dashboards` section and select the dashboard for which you want to edit the panel. 
    ...
    <Figure src="/img/guides/2024/09/how-can-i-sort-the-legend-by-series-name-in-prometheus-grafana-image 1.webp" alt="Selecting dashboards in Grafana" caption="Selecting dashboards in Grafana" />
    
2. Select the panel you want to work with within the dashboard and click the `Edit` option.
    
    <Figure src="/img/guides/2024/09/how-can-i-sort-the-legend-by-series-name-in-prometheus-grafana-image 2.webp" alt="Selecting Panel in Grafana Dashboard" caption="Selecting Panel in Grafana Dashboard" />
    
3. Navigate to the "Legend" tab in the panel settings.
    
    <Figure src="/img/guides/2024/09/how-can-i-sort-the-legend-by-series-name-in-prometheus-grafana-image 3.webp" alt="Navigating to Legends tab in Panel settings" caption="Navigating to Legends tab in Panel settings" />
    
4. Under Mode, select Table.
    
    <Figure src="/img/guides/2024/09/how-can-i-sort-the-legend-by-series-name-in-prometheus-grafana-image 4.webp" alt="Selecting Legend Mode" caption="Selecting Legend Mode" />
    
5. Under Values, select the value or calculation that you want to show. The legend table now displays values.
    
    <Figure src="/img/guides/2024/09/how-can-i-sort-the-legend-by-series-name-in-prometheus-grafana-image 5.webp" alt="Selecting Legend Values" caption="Selecting Legend Values" />
...
6. Click the calculation name header in the legend table to sort the values in the table in ascending or descending order.
    ...
    <Figure src="/img/guides/2024/09/how-can-i-sort-the-legend-by-series-name-in-prometheus-grafana-image 6.webp" alt="Sorting Legend table based on Values" caption="Sorting Legend table based on Values" />
...
<Figure src="/img/guides/2024/09/how-can-i-sort-the-legend-by-series-name-in-prometheus-grafana-image 7.webp" alt="Enabling experimental feature on Prometheus" caption="Enabling experimental feature on Prometheus" />
...
<Figure src="/img/guides/2024/09/how-can-i-sort-the-legend-by-series-name-in-prometheus-grafana-image 8.webp" alt="Consistent naming and Color selection in Grafana Time-series visualization" caption="Consistent naming and Color selection in Grafana Time-series visualization" />
