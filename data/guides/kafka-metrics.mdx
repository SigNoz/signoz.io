...
related_articles: ['/blog/opentelemetry-kafka', '/blog/kafka-monitoring-opentelemetry', '/guides/apm-metrics', '/guides/sre-metrics']
...
2. Collect Metrics with SigNoz
    ...
    SigNoz provides built-in support for collecting Kafka metrics seamlessly. Set up SigNoz to ingest these metrics through its [OpenTelemetry](https://signoz.io/opentelemetry/)-based architecture.
...
2. Start ZooKeeper (if not using KRaft):
    ...
    <Figure src="/img/guides/2024/12/kafka-metrics-Screenshot_2024-11-26_at_8.12.25_AM.webp" alt="Kafka broker setup in the terminal" caption="" />3. Configure and Start Two Kafka Brokers:
...
1.  Create Kafka Topics:
    ...
    <Figure src="/img/guides/2024/12/kafka-metrics-Screenshot_2024-11-26_at_3.41.20_PM.webp" alt="Kafka topics created in the cluster" caption="" />Verify the setup:
...
2. Test Kafka Setup:
    ...
    <Figure src="/img/guides/2024/12/kafka-metrics-f563e248-c0a2-4397-bee5-e9998393c3bb.webp" alt="Kafka producer and consumer instrumentation setup" caption="" />### Step 2: Install OpenTelemetry Java Agent
...
3. Start the Collector:
    ...
    <Figure src="/img/guides/2024/12/kafka-metrics-Screenshot_2024-11-28_at_8.33.07_AM.webp" alt="OpenTelemetry Collector configuration for Kafka metrics" caption="" />---
...
<Figure src="/img/guides/2024/12/kafka-metrics-Screenshot_2024-11-26_at_3.38.23_PM.webp" alt="Kafka metrics dashboard in SigNoz" caption="" /><Figure src="/img/guides/2024/12/kafka-metrics-Screenshot_2024-11-26_at_3.39.23_PM.webp" alt="Kafka consumer lag and throughput dashboard in SigNoz" caption="" /><Figure src="/img/guides/2024/12/kafka-metrics-Screenshot_2024-11-28_at_8.37.53_AM.webp" alt="Kafka alerts dashboard in SigNoz" caption="" />You can also create alerts based on critical Kafka metrics for proactive issue resolution.
