...
related_articles: ['/blog/distributed-tracing-jaeger-cassandra', '/blog/ha-prometheus-cortex-cassandra', '/guides/what-database-does-jaeger-use', '/guides/database-monitoring']
