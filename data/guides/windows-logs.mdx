...
<script type="application/ld+json">
  ...
  "alternativeHeadline": "Understanding and Utilizing Windows Event Logs for System Monitoring and Troubleshooting",
  "image": "https://signoz.io/img/blog/2024/07/windows-logs-cover.webp",
  "author": {
    "@type": "Person",
    "name": "Nitin Gouda"
  },
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://signoz.io/blog/windows-logs/"
  },
  "description": "Discover the importance of Windows logs for system monitoring, troubleshooting, and security. Learn to access, interpret, and utilize logs effectively for efficient problem-solving.",
  "keywords": "windows logs, event viewer, logging",
  ...
  "about": [
    {
      ...
      "description": "A feature in Windows that records system, security, and application events"
    },
    {
      "@type": "Thing",
      "name": "Event Viewer",
    ...
    },
    {
      ...
      "description": "The process of observing and analyzing a computer system's performance and activities"
    }
  ],
  "mentions": [
    {
...
1. Using the Start Menu:
    ...
    <Figure src="/img/guides/2024/07/windows-logs-77731785-467c-46db-8102-6d00474dfe03.webp" alt="Using start menu to open Event viewer" caption="Using start menu to open Event viewer" /><br></br>- Select Event Viewer from the search results which will popup something like this.
    
    <Figure src="/img/guides/2024/07/windows-logs-Untitled.webp" alt="Event Viewer main page" caption="Event Viewer main page" /><br></br>2. Using the Run Dialog:
    - Press `Windows + R` to open the Run dialog.
    - Type `eventvwr` and press Enter.
        
        <Figure src="/img/guides/2024/07/windows-logs-run_Event_Viewer.webp" alt="Windows Run App to open Event Viewer" caption="Windows Run App to open Event Viewer" /><br></br><Figure src="/img/guides/2024/07/windows-logs-Untitled%201.webp" alt="Windows Event viewer landing page" caption="Windows Event viewer landing page" /><br></br>3. Using Control Panel:
    - Open the Command Prompt and run as administrator
    
    <Figure src="/img/guides/2024/07/windows-logs-29b6dd44-f920-429f-af6c-0ba817fbb16c.webp" alt="Open CMD as Administrator from start menu" caption="Open CMD as Administrator from start menu" /><br></br>- Once open, type ``eventvwr`` and press enter, and you will be redirected to Event Viewer page.
    
    <Figure src="/img/guides/2024/07/windows-logs-Untitled%202.webp" alt="CMD terminal" caption="CMD terminal" /><br></br>
...
<Figure src="/img/guides/2024/07/windows-logs-Untitled%203.webp" alt="Windows Event Viewer logs" caption="Windows Event Viewer logs" /><br></br>You can find many other log files which could be related to system operations & other processes that are happening inside the Windows System.  Windows 11uses the `.evtx` format rather than using the classic `EVT` format.
...
<Figure src="/img/guides/2024/07/windows-logs-Untitled%204.webp" alt="Severity levels for events" caption="Severity levels for events" /><br></br><Figure src="/img/guides/2024/07/windows-logs-Untitled%205.webp" alt="System Event logs page" caption="System Event logs page" /><br></br>
...
<Figure src="/img/guides/2024/07/windows-logs-Untitled%206.webp" alt="Opening Administrative events" caption="Opening Administrative events" /><br></br><Figure src="/img/guides/2024/07/windows-logs-Untitled%207.webp" alt="Custom View page from Admin Events" caption="Custom View page from Admin Events" /><br></br>1. In the Custom View page, you can see `logged` drop down, choose a preferred time or it gives you an option to create a custom time to set. 
2. On the Event Level choose an appropriate level for your custom view, You can choose among the 5 levels. 

<Figure src="/img/guides/2024/07/windows-logs-Untitled%208.webp" alt="Selecting Event Levels" caption="Selecting Event Levels" /><br></br>1. Once done, choose how you want the events to be filtered, `By log` or `By source`.

<Figure src="/img/guides/2024/07/windows-logs-Untitled%209.webp" alt="Filtering using: By log" caption="Filtering using: By log" /><br></br><Figure src="/img/guides/2024/07/windows-logs-Untitled%2010.webp" alt="Filtering using: By Source" caption="Filtering using: By Source" /><br></br>Once everything is set up according to your needs, save all events in Custom View as  
