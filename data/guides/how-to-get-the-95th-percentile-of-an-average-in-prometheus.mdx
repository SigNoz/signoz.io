...
- Summaries: If you’re using summaries, retrieving the 95th percentile is straightforward:
  ...
  {' '}
  <Figure
    src="/img/guides/2024/10/how-to-get-the-95th-percentile-of-an-average-in-prometheus-image.webp"
    alt="Using quantile()"
    caption="Using quantile()"
  />
- Histograms: For histograms, you can use the `histogram_quantile()` function. This function estimates the desired quantiles based on the bucket counts:
  ...
  {' '}
  <Figure
    src="/img/guides/2024/10/how-to-get-the-95th-percentile-of-an-average-in-prometheus-image%201.webp"
    alt="Using histogram_quantile() in table view"
    caption="Using histogram_quantile() in table view"
  />
  <Figure
    src="/img/guides/2024/10/how-to-get-the-95th-percentile-of-an-average-in-prometheus-image%202.webp"
    alt="Using histogram_quantile() in graph view"
    caption="Using histogram_quantile() in graph view"
  />
...
<Figure
  src="/img/guides/2024/10/how-to-get-the-95th-percentile-of-an-average-in-prometheus-image%203.webp"
  alt="Combining `avg()` and `quantile()` in prometheus"
  caption="Combining `avg()` and `quantile()` in prometheus"
/>
...
- 1-Hour Window:
  ...
  {' '}
  <Figure
    src="/img/guides/2024/10/how-to-get-the-95th-percentile-of-an-average-in-prometheus-image%204.webp"
    alt="Handling Time Ranges and Aggregation"
    caption="Handling Time Ranges and Aggregation"
  />
...
1. Connect Grafana to your [Prometheus data](https://signoz.io/guides/how-does-grafana-get-data-from-prometheus/) source.
   ...
   <Figure
     src="/img/guides/2024/10/how-to-get-the-95th-percentile-of-an-average-in-prometheus-image%205.webp"
     alt="Create new data souce in Grafana"
     caption="Create new data souce in Grafana"
   />

   - Select `Prometheus` as the data source

   <Figure
     src="/img/guides/2024/10/how-to-get-the-95th-percentile-of-an-average-in-prometheus-image%206.webp"
     alt="Selecting Prometheus as the data source"
     caption="Selecting Prometheus as the data source"
   />

   - Update the name and URL and save the data source.

   <Figure
     src="/img/guides/2024/10/how-to-get-the-95th-percentile-of-an-average-in-prometheus-image%207.webp"
     alt="Specifying data source details"
     caption="Specifying data source details"
   />
...
2. Create a new dashboard and add a panel.
   - Visit the `Dashboards` section and click on the `New` button.
     {' '}
     <Figure
       src="/img/guides/2024/10/how-to-get-the-95th-percentile-of-an-average-in-prometheus-image%208.webp"
       alt="Creating new dashboards"
       caption="Creating new dashboards"
     />
   - Add `New Dashboard` and click the `Add visualization` button.
     {' '}
     <Figure
       src="/img/guides/2024/10/how-to-get-the-95th-percentile-of-an-average-in-prometheus-image%209.webp"
   ...
   - Select the data source created
     {' '}
     <Figure
       src="/img/guides/2024/10/how-to-get-the-95th-percentile-of-an-average-in-prometheus-image%2010.webp"
       alt="Selecting the datasource"
       caption="Selecting the datasource"
     />
3. Use PromQL to query your average of 95th percentile data.

   <Figure
     src="/img/guides/2024/10/how-to-get-the-95th-percentile-of-an-average-in-prometheus-image%2011.webp"
     alt="Using PromQL to query average of 95th percentile data."
     caption="Using PromQL to query average of 95th percentile data."
   />

4. Choose appropriate visualization types—line charts or gauge work well for tracking average of percentiles over time.

   <Figure
     src="/img/guides/2024/10/how-to-get-the-95th-percentile-of-an-average-in-prometheus-image%2012.webp"
     alt="Choosing appropriate visualization type"
     caption="Choosing appropriate visualization type"
   />
...
- Built-in Advanced Percentile Calculations: SigNoz effortlessly calculates and displays various percentile metrics, such as p50, p90, and p99.
  {' '}
  <Figure
    src="/img/guides/2024/10/how-to-get-the-95th-percentile-of-an-average-in-prometheus-image%2013.webp"
    alt="SigNoz Built-in percentile calculations"
    caption="SigNoz Built-in percentile calculations"
  />
