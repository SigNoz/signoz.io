...
authors:
  - simran_kumari
description: >-
  Learn how to securely embed Grafana charts with authentication using iframes.
  Step-by-step guide covering multiple auth methods and security best practices.
keywords:
  - grafana embed charts
...
related_articles:
  ...
  - /guides/what-is-the-default-username-and-password-for-grafana-login-page/
  - /blog/community-update-19/
...
- Real-time Performance Monitoring: Unlike Grafana, which focuses on historical data, SigNoz enables real-time analysis of application performance, helping identify bottlenecks and issues as they occur.
    ...
    <Figure src="/img/guides/2024/11/how-to-authenticate-and-embedded-grafana-charts-into-iframe-image 1.webp" alt="Real-Time Performance Monitoring" caption="Real-Time Performance Monitoring" />
