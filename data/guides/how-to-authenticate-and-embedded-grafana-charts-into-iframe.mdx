...
3. Set Up Service Account Tokens: 
    ...
    - Go to Administration → Users and access → Service accounts, and click on the `Add service account` button.
        ...
        <Figure src="/img/guides/2024/11/how-to-authenticate-and-embedded-grafana-charts-into-iframe-embedding-a-website-in-a-grafana-dashboard-image%208.webp" alt="Adding service account in Grafana" caption="Adding service account in Grafana" />
        
    - Add the display name for the service account, choose the corresponding role, and click on the `Create` button.
        
        <Figure src="/img/guides/2024/11/how-to-authenticate-and-embedded-grafana-charts-into-iframe-embedding-a-website-in-a-grafana-dashboard-image%209.webp" alt="Creating service account in Grafana" caption="Creating service account in Grafana" />
        
    - Next, click on the `Add Service account token`
        
        <Figure src="/img/guides/2024/11/how-to-authenticate-and-embedded-grafana-charts-into-iframe-embedding-a-website-in-a-grafana-dashboard-image%2010.webp" alt="Add service account token" caption="Add service account token" />
        
    - Generate a token, you can also set an expiration date if you want. The token will be used for access.
        
        <Figure src="/img/guides/2024/11/how-to-authenticate-and-embedded-grafana-charts-into-iframe-embedding-a-website-in-a-grafana-dashboard-image%2011.webp" alt="Generate token for service account" caption="Generate token for service account" />
