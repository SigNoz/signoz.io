...
related_articles: ['/guides/caused-by-java-lang-noclassdeffounderror-org-apache-log4j-logger', '/guides/loggerFactory-getLogger-cannot-be-resolved-to-a-type', '/guides/classcastexception-org-slf4j-impl-log4jloggeradapter-cannot-be-cast-to-ch-qos-logback-classic-logger', '/guides/slf4j-logger', '/guides/slf4j-vs-log4j', '/guides/java-log']
---
