  ...
  <script
    ...
    dangerouslySetInnerHTML={{
      __html: JSON.stringify({
        ...
        keywords:
          'Jaeger database, Elasticsearch, Cassandra, distributed tracing, storage backend, Kafka, data persistence',
        ...
        about: [
          ...
          },
          {
            ...
            name: 'Cassandra',
            description:
              'A highly scalable NoSQL database designed to handle large amounts of data across many commodity servers.',
          },
          {
            '@type': 'Thing',
            name: 'Kafka',
            description:
              'A distributed streaming platform capable of handling high-throughput data feeds.',
          },
        ],
        mentions: [
          {
