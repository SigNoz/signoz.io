...
authors:
  - yuvraj
description: >-
  Discover the primary databases Jaeger uses for distributed tracing. Compare
  Elasticsearch and Cassandra to choose the best option for your deployment.
keywords:
  - Jaeger database
  - Elasticsearch
  - Cassandra
