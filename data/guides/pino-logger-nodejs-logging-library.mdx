...
Output:
<Figure src="/img/guides/2026/03/pino-logger-output-2.webp" alt="" caption="" />Using `process.env.LOG_LEVEL` lets you change verbosity at deploy time without touching code. Set it to `debug` in staging, `warn` in production.
