...
Java application profiling is the process of measuring and analyzing a program's behavior and performance as it runs. In simpler terms, profiling tells you what your application _actually_ does at runtime (and where it spends time or uses memory), rather than what the code _appears_ to do.
...
- **[Distributed tracing](https://signoz.io/blog/distributed-tracing/)** might show that a certain request took 5 seconds as it traveled through various microservices. **Profiling** can reveal _why_ it took 5 seconds by pinpointing the exact lines of code or database calls that consumed most of the time.
...
<Figure
  src="/img/guides/2024/09/java-application-profiling-Analyze_JVM_Memory_using_JVisual_VM___Memory_Leak___Heap__Thread_Dump___Profiling___Java_Techie_6-15_screenshot.webp"
  alt="Profiling in VisualVM"
  caption="Profiling in VisualVM"
/>

- **Async Profiler** – Low-overhead Java profiler specializing in CPU and memory profiling using sampling. Often used to generate _flame graphs_ for CPU usage.
...
<Figure
  src="/img/guides/2024/09/java-application-profiling-image.webp"
  alt="Flame Graph to view CPU consumption for different methods"
  caption="Flame Graph to view CPU consumption for different methods"
/>
...
<Figure
  src="/img/guides/2024/09/java-application-profiling-8c2f5751-1092-49a3-929e-ca8a64d68cfa.webp"
  caption="Graph demonstrating memory leak"
  alt="Graph demonstrating memory leak"
/>
