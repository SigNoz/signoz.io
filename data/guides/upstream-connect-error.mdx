...
For Spring Boot applications, add [OpenTelemetry](https://signoz.io/opentelemetry/) integration:
...
When facing an [upstream error](https://signoz.io/guides/upstream-connect-error/), check these items in order:
