...
related_articles: ['/guides/how-to-monitor-custom-kubernetes-pod-metrics-using-prometheus', '/blog/kubernetes-observability', '/guides/kubernetes-sidecar', '/guides/prometheus-queries-to-get-cpu-and-memory-usage-in-kubernetes-pods']
