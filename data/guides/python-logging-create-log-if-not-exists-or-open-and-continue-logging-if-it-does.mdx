...
<Figure
  src="/img/guides/2024/09/python-logging-create-log-if-not-exists-or-open-and-continue-logging-if-it-does-image.webp"
  alt="Output Example"
...
<Figure
  src="/img/guides/2024/09/python-logging-create-log-if-not-exists-or-open-and-continue-logging-if-it-does-image%201.webp"
  alt="Compressed log files"
  caption="Compressed log files"
/>
