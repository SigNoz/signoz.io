...
related_articles:
  ...
  - '/guides/dropwizard-metrics-meters-vs-timers'
...
<Figure src="/img/guides/2024/10/codahale-metrics-using-timed-metrics-annotation-in-plain-java-image 1.webp" alt="Configuring MagicRegistry and integrating reporter" caption="Configuring MagicRegistry and integrating reporter" />
...
Download the latest [OpenTelemetry Java agent](https://signoz.io/docs/instrumentation/java/opentelemetry-java/) binary using the following command:
...
For a complete implementation guide refer to [documentation](https://signoz.io/docs/instrumentation/java/opentelemetry-java/#send-traces-directly-to-signoz-cloud).
