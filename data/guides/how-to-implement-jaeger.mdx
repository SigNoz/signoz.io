  ...
  <script
    ...
    dangerouslySetInnerHTML={{
      __html: JSON.stringify({
        ...
        alternativeHeadline:
          'Master Jaeger Implementation: Setup, Instrumentation, and Best Practices for Developers',
        author: {
          '@type': 'Person',
          name: 'Daniel',
        },
        ...
        keywords:
          'Jaeger, distributed tracing, microservices, OpenTelemetry, instrumentation, monitoring, troubleshooting, observability',
        ...
        about: [
          ...
          },
          {
            ...
            description:
              'A method used to monitor applications built on a microservices architecture.',
          },
          {
            '@type': 'Thing',
            name: 'Microservices',
