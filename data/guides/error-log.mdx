...
<Figure src="/img/guides/2024/07/error-log-SigNoz_(1" alt="SigNoz (1).webp" caption="SigNoz (1).webp" />.webp)
...
<Figure src="/img/guides/2024/07/error-log-signoz_logs.webp" alt="Logs management in SigNoz" caption="Logs management in SigNoz" />
...
<Figure src="/img/guides/2024/07/error-log-signoz_live_logs.webp" alt="Live tail logging in SigNoz" caption="Live tail logging in SigNoz" />
...
<Figure src="/img/guides/2024/07/error-log-signoz_log_query_builder.webp" alt="Advanced query builder to search and filter logs quickly in SigNoz dashboard" caption="Advanced query builder to search and filter logs quickly in SigNoz dashboard" />
