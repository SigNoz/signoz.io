...
related_articles:
  ...
  - '/guides/metrics-migration-cloud-users'
  - '/blog/datadog-migration-tool'
  - '/blog/query-builder-v5'
---
...
The `signoz_alert` resource was **removed** in SigNoz Terraform provider v0.1.0 and replaced by the typed `signoz_rule` resource, which expresses queries, conditions, and thresholds as first-class HCL attributes instead of opaque `jsonencode(...)` strings. If you manage alerts as code, migrate to `signoz_rule` — see the <a href="https://registry.terraform.io/providers/SigNoz/signoz/latest/docs/guides/migrate-signoz-alert-to-signoz-rule" target="_blank" rel="noopener noreferrer nofollow">signoz_alert to signoz_rule migration guide</a> and the <a href="https://registry.terraform.io/providers/SigNoz/signoz/latest/docs/guides/v0.0.x-to-v0.1.0" target="_blank" rel="noopener noreferrer nofollow">v0.0.x to v0.1.0 upgrade guide</a>. For an overview, see the [SigNoz Terraform provider guide](https://signoz.io/docs/alerts-management/terraform-provider-signoz/).
