...
<InlineCTA message="Go beyond local Rails logs — collect, search, and correlate your application logs with traces using OpenTelemetry and SigNoz." ctaText="Learn How to Instrument Ruby on Rails" ctaLink="/docs/instrumentation/opentelemetry-ruby-on-rails/" />
