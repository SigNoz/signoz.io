...
related_articles: ['/guides/java-lang-classnotfoundexception-org-apache-logging-log4j-logger-after-updating-log4j-1-2-17-to-2-13-0', '/guides/loggerFactory-getLogger-cannot-be-resolved-to-a-type', '/guides/classcastexception-org-slf4j-impl-log4jloggeradapter-cannot-be-cast-to-ch-qos-logback-classic-logger', '/guides/slf4j-logger', '/guides/java-log', '/guides/default-logging-file-for-spring-boot-application']
---
