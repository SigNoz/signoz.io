...
keywords:
  [slog, logging, logging slog, golang, opentelemetry, opentelemetry golang, opentelemetry slog]
---
  ...
  <script
    ...
    dangerouslySetInnerHTML={{
      __html: JSON.stringify({
        ...
        alternativeHeadline:
          'A comprehensive guide to implementing structured logging in Golang using slog',
        author: {
          '@type': 'Person',
          name: 'Aayush Sharma',
        },
        ...
        description:
          'In this tutorial, we will discover Golang slog and some of the best practices provided by slog for implementing structured logging in Golang applications. We will set up the Golang application and practice different logging formats slog provides.',
        keywords:
          'slog, logging, logging slog, golang, opentelemetry, opentelemetry golang, opentelemetry slog',
