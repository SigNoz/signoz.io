...
<script type="application/ld+json">
  ...
  "image": "https://signoz.io/img/blog/2024/07/golang-slog-cover.webp",
  "author": {
    "@type": "Person",
    "name": "Aayush Sharma"
  },
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://signoz.io/blog/golang-slog/"
  },
  "description": "In this tutorial, we will discover Golang slog and some of the best practices provided by slog for implementing structured logging in Golang applications. We will set up the Golang application and practice different logging formats slog provides.",
  "keywords": "slog, logging, logging slog, golang, opentelemetry, opentelemetry golang, opentelemetry slog",
...
<Figure src="/img/guides/2024/07/golangslog-1.webp" alt="SigNoz localhost showcasing the log output of the above application." caption="SigNoz localhost showcasing the log output of the above application." />
