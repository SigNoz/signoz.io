...
related_articles: ['/guides/observability-as-code', '/guides/how-do-i-add-alerts-to-prometheus', '/guides/how-do-i-delete-a-time-series-from-prometheus-v2-specifically-a-series-of-alerts', '/blog/introducing-alerts-history-and-scheduled-maintenance']
...
<Figure src="/img/guides/2024/12/alerts-as-code-image 1.webp" alt="Architecture for Implementing Alerts as Code with SigNoz" caption="Architecture for Implementing Alerts as Code with SigNoz" />
...
1. Declarative Configuration:
    - Alerting rules (`alerts.yml`), Prometheus settings (`prometheus.yml`), and [OpenTelemetry](https://signoz.io/opentelemetry/) configurations are written in declarative YAML files.
...
2. Start Prometheus with the configuration:
    ...
    <Figure src="/img/guides/2024/12/alerts-as-code-image 2.webp" alt="Prometheus Scraping" caption="Prometheus Scraping" />
...
3. Restart the Prometheus server, and check the alerts section to see it the alert is listed. 
    ...
    <Figure src="/img/guides/2024/12/alerts-as-code-image 3.webp" alt="Prometheus Alerts" caption="Prometheus Alerts" /> 
...
<Figure src="/img/guides/2024/12/alerts-as-code-image 4.webp" alt="Alerts Triggered in Prometheus" caption="Alerts Triggered in Prometheus" />

You can visualize the metric in the dashboard and see if there was a sudden spike, or there has been a constant increase. 

<Figure src="/img/guides/2024/12/alerts-as-code-image 5.webp" alt="Visualizing Metrics in SigNoz" caption="Visualizing Metrics in SigNoz" />
