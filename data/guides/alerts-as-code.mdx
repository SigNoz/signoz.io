...
<Figure
  src="/img/guides/2024/12/alerts-as-code-08701358-8f4a-4c21-a407-fba0319c6a13.webp"
  alt="Alert Configuration Management Process"
  caption="Alert Configuration Management Process"
/>
...
<Figure
  src="/img/guides/2024/12/alerts-as-code-image.webp"
  alt="Essential Tools for Implementing Alerts as Code"
  caption="Essential Tools for Implementing Alerts as Code"
/>
...
<Figure
  src="/img/guides/2024/12/alerts-as-code-image%201.webp"
  alt="Architecture for Implementing Alerts as Code with SigNoz"
  caption="Architecture for Implementing Alerts as Code with SigNoz"
/>
...
2. Start Prometheus with the configuration:
   ...
   <Figure
     src="/img/guides/2024/12/alerts-as-code-image%202.webp"
     alt="Prometheus Scraping"
     caption="Prometheus Scraping"
   />
...
3. Restart the Prometheus server, and check the alerts section to see it the alert is listed.
   ...
   <Figure
     src="/img/guides/2024/12/alerts-as-code-image%203.webp"
...
<Figure
  src="/img/guides/2024/12/alerts-as-code-image%204.webp"
  alt="Alerts Triggered in Prometheus"
  caption="Alerts Triggered in Prometheus"
/>

You can visualize the metric in the dashboard and see if there was a sudden spike, or there has been a constant increase.

<Figure
  src="/img/guides/2024/12/alerts-as-code-image%205.webp"
  alt="Visualizing Metrics in SigNoz"
  caption="Visualizing Metrics in SigNoz"
/>
