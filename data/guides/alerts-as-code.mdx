...
related_articles:
  ...
  - '/guides/how-do-i-add-alerts-to-prometheus'
  - '/guides/how-do-i-delete-a-time-series-from-prometheus-v2-specifically-a-series-of-alerts'
  - '/blog/introducing-alerts-history-and-scheduled-maintenance'
