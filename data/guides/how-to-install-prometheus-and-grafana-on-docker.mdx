...
authors:
  ...
  - ankit_anand
description: >-
  Learn how to install Prometheus and Grafana on Docker with this comprehensive
  guide. Step-by-step instructions for setup, configuration, and monitoring.
keywords:
  - Prometheus
  - Grafana
  - Docker
  ...
  - visualization
related_articles:
  - /guides/how-to-monitor-docker-containers-with-prometheus-and-grafana/
  - /guides/how-to-install-prometheus-and-grafana-on-kubernetes/
  - /guides/how-does-grafana-get-data-from-prometheus/
  - /guides/how-to-see-prometheus-metrics-in-grafana/
  - /guides/is-it-possible-to-use-grafana-without-prometheus/
  - /guides/how-to-persist-data-in-prometheus-running-in-a-docker-container/
---
...
<InlineCTA message="Need metrics, logs, and traces in one place without managing Prometheus + Grafana + Loki separately? SigNoz gives you unified observability out of the box." ctaText="Learn More" ctaLink="/blog/grafana-alternatives/" />
...
5. **Verify Prometheus is Running**
    ...
    <Figure src="/img/guides/2025/06/how-to-install-prometheus-and-grafana-on-docker-image 1.webp" alt="command: docker ps" caption="command: docker ps" />
...
3. **Verify Metric Collection in the Prometheus UI**
    ...
    - Use the **Graph** tab to query example metrics, such as:
        ...
        <Figure src="/img/guides/2025/06/how-to-install-prometheus-and-grafana-on-docker-image 2.webp" alt="Prometheus graph using PromQL Query" caption="Prometheus graph using PromQL Query" />
...
2. **Launch Grafana**
    ...
    <Figure src="/img/guides/2025/06/how-to-install-prometheus-and-grafana-on-docker-image 3.webp" alt="Command: docker-compose up -d" caption="Command: docker-compose up -d" />
...
1. **Set up Prometheus as a Data Source in Grafana**
    - Navigate to Connections → Data Sources → Add data source in the left side panel.
        ...
        <Figure src="/img/guides/2025/06/how-to-install-prometheus-and-grafana-on-docker-image 4.webp" alt="Adding a data source in Grafana" caption="Adding a data source in Grafana" />
        
    - Enter the **Prometheus server URL** in the configuration field.
        
        <Figure src="/img/guides/2025/06/how-to-install-prometheus-and-grafana-on-docker-image 5.webp" alt="Enter Prometheus server URL in the config field" caption="Enter Prometheus server URL in the config field" />
...
2. **Create a New Dashboard and Panel**
    - Navigate to **Dashboards** → **New Dashboard** → Click on the **Add Visualization** button
        ...
        <Figure src="/img/guides/2025/06/how-to-install-prometheus-and-grafana-on-docker-image 6.webp" alt="Create a new dashboard and add a visualization" caption="Create a new dashboard and add a visualization" />
        
    - Select **Prometheus** from the data source dropdown
        
        <Figure src="/img/guides/2025/06/how-to-install-prometheus-and-grafana-on-docker-image 7.webp" alt="Select Prometheus as the data source" caption="Select Prometheus as the data source" />
...
- Built-in support for **[OpenTelemetry](https://signoz.io/opentelemetry/)**
