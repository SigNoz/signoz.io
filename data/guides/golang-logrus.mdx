...
authors:
  - aayush_sharma
description: >-
  In this tutorial, we will discover Golang logrus and some of the best
  practices provided by logrus for implementing structured logging in Golang
  applications. We will set up the Golang application and practice different
  logging formats logrus provides.
keywords:
  - logrus
  - logging
  - logging logrus
...
<Figure
  src="/img/guides/2024/07/golang-logrus-Untitled 1.webp"
...
<Figure
  src="/img/guides/2024/07/golang-logrus-Untitled 2.webp"
