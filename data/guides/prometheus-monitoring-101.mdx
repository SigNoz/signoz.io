...
related_articles:
  ...
  - '/guides/is-prometheus-a-visualization-tool'
...
- **Tracing Requests:** Lacks distributed tracing; Jaeger or SigNoz with [OpenTelemetry](https://signoz.io/opentelemetry/) are better options.
...
<Figure src="/img/guides/2025/02/prometheus-monitoring-101-image 1.webp" alt="Prometheus architecture" caption="Prometheus architecture" />
...
2. **Service Discovery**
    ...
    **Tools Supported:**
    ...
    <Figure src="/img/guides/2025/02/prometheus-monitoring-101-image 2.webp" alt="Prometheus service discovery" caption="Prometheus service discovery" />
...
<Figure src="/img/guides/2025/02/prometheus-monitoring-101-image 3.webp" alt="Accessing Prometheus UI" caption="Accessing Prometheus UI" />
...
<Figure src="/img/guides/2025/02/prometheus-monitoring-101-image 4.webp" alt="Prometheus’s Built-in Expression Browser" caption="Prometheus’s Built-in Expression Browser" />
...
2. Add a Query:
    ...
    - Preview the results in the graph below.
        ...
        <Figure src="/img/guides/2025/02/prometheus-monitoring-101-image 5.webp" alt="Visualizing Metrics in Grafana" caption="Visualizing Metrics in Grafana" />
...
<Figure src="/img/guides/2025/02/prometheus-monitoring-101-image 6.webp" alt="Setting Alerts in Prometheus" caption="Setting Alerts in Prometheus" />
...
1. Alert States:
    ...
    <Figure src="/img/guides/2025/02/prometheus-monitoring-101-image 7.webp" alt="Alert States" caption="Alert States" />
...
2. Labels:
    ...
    <Figure src="/img/guides/2025/02/prometheus-monitoring-101-image 8.webp" alt="Alert Labels" caption="Alert Labels" />
...
1. Set Up the Prometheus Receiver
    ...
    Once the OpenTelemetry Collector is installed, configure it to scrape Prometheus metrics. Edit your `otel-collector-config.yaml` file and add a [Prometheus receiver](https://signoz.io/docs/userguide/prometheus-metrics/) configuration:
