...
<Figure
  src="/img/guides/2025/02/prometheus-monitoring-101-image.webp"
  alt="Key Features of Prometheus"
  caption="Key Features of Prometheus"
/>
...
<Figure
  src="/img/guides/2025/02/prometheus-monitoring-101-image%201.webp"
...
2. **Service Discovery**
   ...
   **Tools Supported:**
   ...
   <Figure
     src="/img/guides/2025/02/prometheus-monitoring-101-image%202.webp"
...
8. **Query Language (PromQL)**
   ...
   **PromQL allows for flexible querying with features like filtering, aggregation, and mathematical operations to extract actionable insights.**
   ...
   <Figure
     src="/img/guides/2025/02/prometheus-monitoring-101-how-does-prometheus-work-Untitled203.webp"
     alt="PromQL query"
...
<InterlinkCard
  title="Read more on How Does Prometheus Work?"
  href="/guides/how-does-prometheus-work/"
/>
...
<Figure
  src="/img/guides/2025/02/prometheus-monitoring-101-image%203.webp"
  alt="Accessing Prometheus UI"
  caption="Accessing Prometheus UI"
/>
...
<Figure
  src="/img/guides/2025/02/prometheus-monitoring-101-image%204.webp"
  alt="Prometheus’s Built-in Expression Browser"
  caption="Prometheus’s Built-in Expression Browser"
/>
...
<a href="https://grafana.com/" rel="noopener noreferrer nofollow" target="_blank">
  Grafana
</a> is a widely used open-source visualization tool that pairs perfectly with Prometheus for
...
2. Add a Query:
   ...
   - Preview the results in the graph below.
     {' '}
     <Figure
       src="/img/guides/2025/02/prometheus-monitoring-101-image%205.webp"
       alt="Visualizing Metrics in Grafana"
       caption="Visualizing Metrics in Grafana"
     />
...
<Figure
  src="/img/guides/2025/02/prometheus-monitoring-101-image%206.webp"
  alt="Setting Alerts in Prometheus"
  caption="Setting Alerts in Prometheus"
/>
...
1. Alert States:
   ...
   <Figure
     src="/img/guides/2025/02/prometheus-monitoring-101-image%207.webp"
     alt="Alert States"
     caption="Alert States"
   />
...
2. Labels:
   ...
   <Figure
     src="/img/guides/2025/02/prometheus-monitoring-101-image%208.webp"
     alt="Alert Labels"
     caption="Alert Labels"
   />
...
4. Verify Configuration in SigNoz Cloud
   ...
   <Figure
     src="/img/guides/2025/02/prometheus-monitoring-101-configure-prometheus-to-use-non-default-port-image204.webp"
     alt="Verify Configuration in SigNoz Cloud"
     caption="Verify Configuration in SigNoz Cloud"
   />
