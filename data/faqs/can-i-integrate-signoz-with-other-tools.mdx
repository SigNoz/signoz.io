...
4. **Cloud Services (AWS, GCP, Azure)**:
   - **AWS**: [SigNoz monitors AWS services](https://signoz.io/docs/aws-monitoring/lambda/lambda-logs/) like RDS, API Gateway, and Lambda through OpenTelemetry. It can be deployed on AWS EKS using Helm.
   - **GCP**: [You can monitor GCP services](https://signoz.io/google-cloud-monitoring/) like those on GKE with specific configurations in Helm for GCP environments.
