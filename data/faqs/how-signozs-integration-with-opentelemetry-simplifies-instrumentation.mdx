...
Using OpenTelemetry libraries, you can instrument your application easily. [For example, in a Node.js app, you can install the necessary packages, configure exporters, and send data to SigNoz](https://signoz.io/opentelemetry/nodejs-tutorial-overview/):
