...
related_articles:
  ...
  - '/faqs/who-uses-signoz-in-production'
...
The [**Query Builder**](https://signoz.io/docs/userguide/query-builder-v5/) in SigNoz lets you apply advanced filters to logs and traces. You can filter by service name, response time, error rates, and more, allowing you to focus on relevant data points when diagnosing issues.
...
[Aggregation in SigNoz](https://signoz.io/docs/userguide/query-builder-v5/#histogram-and-time-series-visualizations-) helps you summarize large data sets efficiently. You can apply functions like average, sum, count, and percentiles over specific time intervals or groups to derive meaningful insights.
...
SigNoz [correlates metrics, logs, and traces](https://signoz.io/docs/traces-management/guides/correlate-traces-and-logs/) to give you a holistic view of system interactions.
