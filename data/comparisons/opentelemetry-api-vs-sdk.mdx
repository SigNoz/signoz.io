...
meta_title: "OpenTelemetry API vs SDK Explained"
...
- The [OpenTelemetry](https://signoz.io/opentelemetry/) API provides instrumentation interfaces, whereas the SDK includes concrete implementations for collecting, processing, and exporting telemetry data.
...
To dig deeper into related comparisons, see [gRPC vs HTTP](https://signoz.io/comparisons/opentelemetry-grpc-vs-http/) and [traces vs spans](https://signoz.io/comparisons/opentelemetry-trace-vs-span/). You may also find [Collector vs Agent](https://signoz.io/comparisons/opentelemetry-collector-vs-agent/), [Collector vs Exporter](https://signoz.io/guides/opentelemetry-collector-vs-exporter/) and the [OpenTelemetry alternatives](https://signoz.io/blog/opentelemetry-alternatives/) guide useful.
