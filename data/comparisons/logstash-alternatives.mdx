...
SigNoz is an open-source observability platform for monitoring applications that allows you to aggregate, store, analyze, and visualize your application data. SigNoz uses [OpenTelemetry](https://signoz.io/comparisons/opentelemetry-vs-splunk/) for collecting telemetry data and supports all frameworks and programming languages supported by OpenTelemetry. Data can be sent from applications directly to the SigNoz [Otel collector](https://signoz.io/blog/opentelemetry-collector-complete-guide/) or external [Otel](https://signoz.io/blog/opentelemetry-vs-datadog/) collectors can be used for collecting telemetry data & sending it to the SigNoz Otel collector.
...
- **Filebeat:** for [log events](https://signoz.io/comparisons/opentelemetry-events-vs-logs/),
