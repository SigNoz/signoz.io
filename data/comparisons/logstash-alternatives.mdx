...
- With its self-hosted option, SigNoz enables easy configuration and also allows configuration with different options such as [Kubernetes logging](https://signoz.io/blog/opentelemetry-kubernetes/), Docker Standalone, and Docker Swarm.
