...
<Figure src="/img/comparisons/2026/01/papertrail-alternatives-image%201.webp" alt="SolarWinds Observability Dashboard (credits: solarwinds)" caption="SolarWinds Observability Dashboard (credits: solarwinds)" />
...
<Figure src="/img/comparisons/2026/01/papertrail-alternatives-image%202.webp" alt="Grafana Loki Dashboard(credits: grafana)" caption="Grafana Loki Dashboard(credits: grafana)" />
...
<Figure src="/img/comparisons/2026/01/papertrail-alternatives-image%203.webp" alt="SolarWinds Loggly Dashboard(credits: solarwinds)" caption="SolarWinds Loggly Dashboard(credits: solarwinds)" />
...
<Figure src="/img/comparisons/2026/01/papertrail-alternatives-image%204.webp" alt="Graylog Dashboard(credits: graylog)" caption="Graylog Dashboard(credits: graylog)" />
