...
meta_title: "OpenTelemetry Trace vs Span Explained"
...
3. Trace Propagation: The mechanism by which trace context is passed between different services or components. This ensures that all parts of a distributed operation are connected under the same trace.
    ...
    <Figure src="/img/comparisons/2024/11/opentelemetry-trace-vs-span-image 1.webp" alt="Trace Propagation Flow" caption="Trace Propagation Flow" />
...
<Figure src="/img/comparisons/2024/11/opentelemetry-trace-vs-span-image 2.webp" alt="Trace in a Microservice environment" caption="Trace in a Microservice environment" />
...
<Figure src="/img/comparisons/2024/11/opentelemetry-trace-vs-span-image 3.webp" alt="SigNoz Traces Dashboard" caption="SigNoz Traces Dashboard" />
...
<Figure src="/img/comparisons/2024/11/opentelemetry-trace-vs-span-image 4.webp" alt="SigNoz Trace Dashboard" caption="SigNoz Trace Dashboard" />
...
To explore related OpenTelemetry concepts, see [Traces vs Metrics](https://signoz.io/comparisons/opentelemetry-traces-vs-metrics/), [API vs SDK](https://signoz.io/comparisons/opentelemetry-api-vs-sdk/), and [OpenTelemetry vs Prometheus](https://signoz.io/blog/opentelemetry-vs-prometheus/). If you are focused on tracing specifically, it is worth comparing [OpenTelemetry vs Jaeger](https://signoz.io/blog/opentelemetry-vs-jaeger/) and reviewing this guide to [distributed tracing tools](https://signoz.io/blog/distributed-tracing-tools/).
