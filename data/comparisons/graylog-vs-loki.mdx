...
- GELF (Graylog Extended Log Format): Graylog's own format designed for [structured logging](https://signoz.io/guides/structlog/) with advanced features like support for compression and batch processing.
