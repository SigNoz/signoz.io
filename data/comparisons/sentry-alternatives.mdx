...
- **Retention Periods**
  ...
  **SigNoz** clearly defines retention policies such as, logs and traces: 15 days and metrics: 1 month whereas for s**entry r**etention terms are less explicitly outlined, adding potential uncertainty.
