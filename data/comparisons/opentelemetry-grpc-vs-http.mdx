...
related_articles: ['/blog/opentelemetry-grpc-golang', '/blog/health-check-monitoring-with-opentelemetry', '/guides/grafana-graphing-http-requests-per-minute-with-http-server-requests-seconds-count', '/comparisons/opentelemetry-vs-xray']
