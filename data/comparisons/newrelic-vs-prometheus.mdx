...
related_comparisons: ['/prometheus-alternatives', '/opentelemetry-vs-newrelic', '/opentelemetry-vs-newrelic', '/new-relic-vs-appdynamics', '/new-relic-vs-grafana', '/splunk-vs-prometheus']
---
