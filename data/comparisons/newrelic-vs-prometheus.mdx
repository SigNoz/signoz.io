...
authors:
  - daniel
description: >-
  New Relic and Prometheus are both monitoring tools. But while New Relic is a
  comprehensive application monitoring platform that offers a wide range of
  features, including Application Performance Monitoring (APM), log monitoring,
  infrastructure monitoring, and real-user monitoring, Prometheus is focused
  only on metrics monitoring...
