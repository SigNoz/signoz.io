...
### Metrics: Real-Time Resource Performance Data
...
### Logs: Centralized Output from Your Workloads
...
### Alarms: Threshold-Based Alerts and Automated Actions
...
### Event History: Your 90-Day Audit Timeline
...
### Event Detail: The "Who, What, When, From Where" Breakdown
...
### Trails and Event Data Stores for Longer Retention
...
[SigNoz](https://signoz.io/) is your cross-stack observability layer. CloudTrail remains your AWS-native audit trail.
