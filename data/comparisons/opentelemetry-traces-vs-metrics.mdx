...
related_articles: ['/comparisons/opentelemetry-trace-vs-span', '/blog/opentelemetry-metrics-with-examples', '/blog/opentelemetry-postgresql-metrics-monitoring', '/guides/apm-metrics']
