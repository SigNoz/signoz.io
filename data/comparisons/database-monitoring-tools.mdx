...
related_articles: ['/guides/database-monitoring', '/blog/clickhouse-storage-monitoring', '/blog/mysql-monitoring-tools', '/comparisons/infrastructure-monitoring-tools']
