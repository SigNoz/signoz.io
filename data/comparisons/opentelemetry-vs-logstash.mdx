...
authors:
  - sushant_gaurav
description: >-
  Compare OpenTelemetry and Logstash to make the right choice for your
  observability needs. Learn key differences, features, and migration
  strategies.
keywords:
  - opentelemetry vs logstash
...
Let's now take a look at the architecture of [OpenTelemetry](https://signoz.io/opentelemetry/) and Logstash for better clarity.
...
<Figure src="/img/comparisons/2024/11/opentelemetry-vs-logstash-image 1.webp" alt="Basic Flow of the Migration" caption="Basic Flow of the Migration" />
