...
<NextFigure src="/img/comparisons/2026/02/LlmObservabilityMeta.webp" alt="SigNoz Dashboard showing MCP Server Tool Calls" caption="SigNoz Dashboard showing MCP Server Tool Calls" width={1200} height={675} priority />
...
<NextFigure src="/img/comparisons/2026/02/llm-observability-tools-llm-analytics.webp" alt="Langfuse Dashboard, credits: langfuse" caption="Langfuse Dashboard, credits: langfuse" width={1200} height={675} />
...
<NextFigure src="/img/comparisons/2026/02/llm-observability-tools-subsets_monitor.webp" alt="Langsmith Dashboard, credits: langchain" caption="Langsmith Dashboard, credits: langchain" width={1200} height={675} />
...
<NextFigure src="/img/comparisons/2026/02/llm-observability-tools-helicone-dashboard.webp" alt="Helicone Dashboard, credits: helicone" caption="Helicone Dashboard, credits: helicone" width={1200} height={675} />
...
<NextFigure src="/img/comparisons/2026/02/llm-observability-tools-arize-ai-dashboard.webp" alt="Arize Phoenix Dashboard, credits: arize" caption="Arize Phoenix Dashboard, credits: arize" width={1200} height={675} />
...
<NextFigure src="/img/comparisons/2026/02/llm-observability-tools-trace-dark.webp" alt="OpenLLMetry Dashboard, credits: traceloop" caption="OpenLLMetry Dashboard, credits: traceloop" width={1200} height={675} />
...
<NextFigure src="/img/comparisons/2026/02/llm-observability-tools-quickstart_single_experiment_page.webp" alt="Comet Opik Dashboard, credits: comet" caption="Comet Opik Dashboard, credits: comet" width={1200} height={675} />
