...
related_articles: ['/comparisons/opensearch-vs-splunk', '/blog/python-elasticsearch-tutorial', '/blog/prometheus-vs-elasticsearch', '/guides/what-database-does-jaeger-use']
