...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/apm-and-distributed-tracing/traces-view.webp" alt="Traces represented as Flamegraphs and Gantt charts in SigNoz dashbaord"/>
