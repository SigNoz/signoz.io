...
[SigNoz Cloud](https://signoz.io/docs/introduction/) is a managed observability platform that provides metrics, traces, and logs within a single pane of glass. Self-Hosted SigNoz provides the self-managed, open-source deployment option. This unified approach simplifies the [observability stack](https://signoz.io/guides/observability-stack/) for developers and operators.

In terms of managed pricing, SigNoz Cloud uses a straightforward, usage-based structure. This differs from Datadog's SKU-based model and Elastic Cloud's subscription fees. Self-Hosted SigNoz has a separate cost model based on the infrastructure and engineering work that your team manages.
