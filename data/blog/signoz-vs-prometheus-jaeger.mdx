...
- 10x cheaper than DataDog [[blog on cost benchmark](/blog/pricing-comparison-signoz-vs-datadog-vs-newrelic-vs-grafana/)]
...
2. Instrument your application using OpenTelemetry to start sending data to SigNoz. We have opentelemetry instrumentation docs for [NodeJs](https://signoz.io/docs/instrumentation/java/opentelemetry-java/script/opentelemetry-nodejs/), [Java](https://signoz.io/docs/instrumentation/java/opentelemetry-java/), [Python](https://signoz.io/docs/instrumentation/opentelemetry-python/), [Golang](https://signoz.io/docs/instrumentation/opentelemetry-golang/) and more to come.
