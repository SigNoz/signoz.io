...
2. Instrument your application using OpenTelemetry to start sending data to SigNoz. We have opentelemetry instrumentation docs for [NodeJs](https://signoz.io/docs/instrumentation/javascript/opentelemetry-nodejs/), [Java](https://signoz.io/docs/instrumentation/java/opentelemetry-java/), [Python](https://signoz.io/docs/instrumentation/opentelemetry-python/), [Golang](https://signoz.io/docs/instrumentation/opentelemetry-golang/) and more to come.
