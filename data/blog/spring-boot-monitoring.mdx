...
meta_title: "Spring Boot Monitoring Guide"
published_date: 2024-05-15
updated_date: 2026-06-30
tags: [OpenTelemetry]
authors: [leigh-finch]
description: "Spring Boot monitoring in 2026: the JVM and Spring metrics that matter, dashboards, and alerts in SigNoz. Pairs with OpenTelemetry instrumentation."
...
5. Changes are required to your Logback.xml to add span and trace attributes to logs for trace-to-[log correlation](https://signoz.io/docs/traces-management/guides/correlate-traces-and-logs/).
