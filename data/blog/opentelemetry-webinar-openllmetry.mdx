...
related_articles: ['/blog/signoz-tracetest-opentelemetry-native-observability-meets-testing', '/blog/diving-in-to-opentelemetry-data-with-our-new-trace-and-logs-explorer', '/blog/opentelemetry-webinar-on-trace-api', '/opentelemetry', '/blog/opentelemetry-demo', '/blog/opentelemetry-dotnet']
---
...
When you are first implementing [open telemetry](https://signoz.io/opentelemetry/) instrumentation or when using instrumentation, it is important to disable batching so that you can see each request traced in your dashboard. This is because you want to be able to see the results of your changes as soon as possible. 
