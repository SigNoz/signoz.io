...
<div class="flex flex-wrap -mx-4">
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">Pranshu Chittora</div>
 ...
 <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">Axay sagathiya</div>
         <small class="text-sm text-muted-foreground">
            India
         </small>
      </div>
...
<div class="flex flex-wrap -mx-4">
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">Siddhant Parekh</div>
         <small class="text-sm text-muted-foreground">
         India
         </small>
      </div>
    ...
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">Sonia Manoubi</div>
         <small class="text-sm text-muted-foreground">
            Nice, France
         </small>
      </div>
...
<div class="flex flex-wrap -mx-4">
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">Patrik</div>
         <small class="text-sm text-muted-foreground">
         Sweden
         </small>
      </div>
    ...
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">Siddhant Khare</div>
         <small class="text-sm text-muted-foreground">
            India
         </small>
      </div>
...
<div class="flex flex-wrap -mx-4">
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">Mustaque Ahmed</div>
         <small class="text-sm text-muted-foreground">
         India
         </small>
      </div>
    ...
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">Devesh Kumar</div>
         <small class="text-sm text-muted-foreground">
            India
         </small>
      </div>
...
<div class="flex flex-wrap -mx-4">
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">Anik Das</div>
         <small class="text-sm text-muted-foreground">
         India
         </small>
      </div>
