...
{
"@type": "Question",
"name": "[What is OpenTelemetry](https://signoz.io/opentelemetry/) and why should I use it with FastAPI?",
"acceptedAnswer": {
"@type": "Answer",
...
<InlineCTA message="Send your FastAPI traces to SigNoz Cloud in 15 minutes — auto-instrumentation, pre-built dashboards, and guided onboarding included." />
