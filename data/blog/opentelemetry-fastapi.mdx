---
title: Implementing OpenTelemetry in FastAPI - A 2026 Guide
...
With the app running in the background, re-activate your virtual environment and start Locust with the shipped configuration:
...
Logging in an OTel-instrumented FastAPI application is not much different from [logging in a typical Python application](https://signoz.io/guides/logging-in-python/). You define and initialize the logging configuration during application startup, and individual logger instances honour that configuration throughout the application lifecycle.

However, as specialized libraries have more extensive features, or are better suited for FastAPI's async nature, most production FastAPI applications often rely on one of [Loguru](https://signoz.io/guides/loguru/), or [Structlog](https://signoz.io/guides/structlog/#structlog-with-fastapi) to manage their logging needs.
