...
If you're interested in trying out SigNoz for your FastAPI applications, [sign up](https://signoz.io/teams/) for a 30-day free trial (no credit card required). Once your application is sending traces, you can take debugging a step further with the [SigNoz MCP Server](https://signoz.io/docs/ai/signoz-mcp-server/), which connects your observability data directly to coding agents like Cursor or GitHub Copilot for [Agent Native Observability](https://signoz.io/agent-native-observability/).
