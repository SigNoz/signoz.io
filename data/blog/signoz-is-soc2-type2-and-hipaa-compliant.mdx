...
related_articles: ['/blog/signoz-soc-2-compliance', '/blog/community-update-03', '/blog/community-update-22', '/blog/community-update-04', '/blog/hacktoberfest', '/blog/community-update-23']
---
...
<Figure src="/img/blog/2024/09/signoz-is-soc2-type2-and-hipaa-compliant-soc2-hipaa-cover.webp" alt="SigNoz SOC 2 Type II and HIPAA compliance announcement graphic" caption=""/>
...
SigNoz is a one-stop observability tool that can be used to monitor logs, metrics, and traces. We’re [OpenTelemetry](https://signoz.io/opentelemetry/)-native and have built the best visualization layer on OpenTelemetry data. You can sign up for a 30-day free cloud trial and experience all features.
