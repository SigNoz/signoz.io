...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/blog/2024/03/signal-34-access-token-1.webp" alt="Access token management screen in SigNoz"/>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/blog/2024/03/signal-34-access-token-2.webp" alt="Create new access token form in SigNoz"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" width="70%" src="/img/blog/2024/03/signal-34-access-token-3.webp" alt="Access token role and expiration settings in SigNoz"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/blog/2024/03/signal-34-postman.webp" alt="Postman request using a SigNoz access token"/>
    <figcaption><i></i></figcaption>
</figure>
...
You can find all the features that were in the spotlight during the launch week [here](https://signoz.io/blog/launch-week-1/). 
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/blog/2024/03/signal-34-paris.webp" alt="KubeCon Paris talk announcement graphic"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/blog/2024/03/signal-34-reddit.webp" alt="Reddit user shoutout comparing SigNoz with other observability tools"/>
    <figcaption><i></i></figcaption>
</figure>
...
<div class="flex flex-wrap -mx-4">
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">Hayden</div>
    ...
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">Liran Tal</div>
         <small class="text-sm text-muted-foreground">
         </small>
      </div>
      </div>
...
<div class="flex flex-wrap -mx-4">
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">Alexander</div>
         <small class="text-sm text-muted-foreground">
         </small>
      </div>
      </div>
    ...
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">Jiho Lee</div>
         <small class="text-sm text-muted-foreground">
         </small>
      </div>
      </div>
