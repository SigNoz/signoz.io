...
If you wish to move beyond tailing, filtering and multi-container pods are handled in the comprehensive [kubectl logs guide](https://signoz.io/blog/kubectl-logs-tail/).
