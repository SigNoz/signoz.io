...
<Figure src="/img/blog/2026/01/opentelemetry-collector-contrib-image.webp" alt="Data moves through an OTel Collector Contrib pipeline; extensions enhance the Collector’s behavior" caption="Data moves through an OTel Collector Contrib pipeline; extensions enhance the Collector’s behavior" />
...
The `otel-config.yaml` file in the repo contains the pipeline configuration we defined in the <a href="https://www.notion.so/draft-v1-2d3fcc6bcd19807e9cc5ea7401a117c9?pvs=21" rel="noopener noreferrer nofollow" target="_blank">previous section</a>. To deploy Contrib using Docker, execute:
