...
meta_title: "Monitoring Elixir Applications using OpenTelemetry"
published_date: 2022-12-10
tags: [OpenTelemetry Instrumentation, Elixir / Erlang]
authors: [ricardo]
description: "Instrument Elixir and Phoenix applications with OpenTelemetry and export traces to any OTLP backend."
...
In this tutorial, we'll show you how to monitor your Elixir application using [OpenTelemetry](https://signoz.io/opentelemetry/) and Signoz. We'll focus on the most common and basic Elixir combo: **Phoenix + Ecto**.
...
You can access SigNoz UI at `http://localhost:3301/application` (after signing up) to see your Elixir Phoenix API being monitored. The other applications that you see are sample applications that come bundled with the installation.
...
You can go to `http://localhost:3301/errors` to check out the errors in your application.
