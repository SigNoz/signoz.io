...
<Figure 
  src="attachment:510ea0ec-c4a7-4bb5-8849-a60615e82f19:image.png"
...
## #1  Understanding codebases faster
...
Don't paste **sensitive or proprietary code** into external AI tools unless you're allowed to. For open source or personal projects, go for it. For company code, we we sanitize the snippet to avoid secret leakage. Debugging with AI is awesome, just do it responsibly.
...
AI can be amazing at providing a first round of reviews. Lately, we’ve been experimenting with AI to **assist** (not replace) our pull request (PR) review process. We use [ellipses](https://www.ellipsis.dev/) for doing a preliminary round of reviews. 
...
<Figure 
  src="attachment:64a59044-605b-4442-a319-12e21fab9c77:image.png"
  alt="Rubber-ducking comic"
  caption="Rubber-ducking comic. PC: https://sketchplanations.com/rubberducking"
  link="https://sketchplanations.com/rubberducking"
  sourceText="Sketchplanations"
/>

Rubber-ducking comic. PC: https://sketchplanations.com/rubberducking
