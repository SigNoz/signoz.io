---
title: A Developer’s Guide to Configuring OpenTelemetry Environment Variables
...
keywords: [opentelemetry, opentelemetry env vars, opentelemetry environment variables]
---

If you routinely manage the deployment and configuration of your application services, you must likely adjust telemetry settings across deployments often, as requirements change and your applications evolve. The process of packaging and deploying new application versions for these adjustments can be time-consuming and error-prone.

[OpenTelemetry](https://signoz.io/opentelemetry/) (OTel) environment variables relieve this pressure by enabling developers to manage telemetry configuration without making code changes and frequent end-to-end deployments.

This guide covers what OpenTelemetry environment variables are, the core OTel environment variables that you should know about, and how they work practically.
