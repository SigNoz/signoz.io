...
If you are using multiple observability tools, you can configure different endpoints for each signal. Here, we will send metrics to a local [Prometheus](https://signoz.io/guides/what-is-prometheus-for-monitoring/) instance <a href="https://prometheus.io/docs/prometheus/latest/querying/api/#otlp-receiver" rel="noopener noreferrer nofollow" target="_blank">configured to receive OTLP data</a>.
