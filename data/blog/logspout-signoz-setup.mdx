...
related_articles: ['/guides/docker-compose-logs', '/blog/docker-syslog', '/guides/docker-logs-tail', '/blog/centralized-logging', '/guides/how-to-log-all-the-processes-running-inside-a-docker-container', '/blog/community-update-16']
---
...
<Figure src="/img/blog/2024/11/logspout-signoz-setup-Screenshot_2024-11-05_at_7.52.42_PM.webp" alt="Logspout SigNoz setup screenshot" caption="" />
