...
For more detailed guidance on collecting Docker container logs with SigNoz, refer to the <a href="https://www.notion.so/Rich-Logs-Collector-for-Docker-Compose-Services-131fcc6bcd198127a898f7f05cc1b973?pvs=21" rel="noopener noreferrer nofollow" target="_blank">official documentation on how to send Docker container logs</a>
