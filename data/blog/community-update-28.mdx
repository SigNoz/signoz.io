...
related_articles:
  - '/blog/community-update-31'
  - '/blog/community-update-36'
  - '/blog/community-update-37'
  - '/blog/community-update-29'
  - '/blog/community-update-23'
...
<figure data-zoomable align='center'>
    <img src="/img/blog/2023/09/apdex_score.webp" alt="SigNoz Apdex score dashboard"/>
...
<figure data-zoomable align='center'>
    <img src="/img/blog/2023/09/live_logs_view.webp" alt="SigNoz live logs view"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img src="/img/blog/2023/09/4_million.webp" alt="SigNoz milestone graphic celebrating 4 million Docker downloads"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img src="/img/blog/2023/09/team_signoz.webp" alt="SigNoz team workation in Goa"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img src="/img/blog/2023/09/jamstack_radio.webp" alt="SigNoz on Jamstack Radio"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img src="/img/blog/2023/09/udemy-signoz.webp" alt="Udemy course featuring SigNoz"/>
    <figcaption><i></i></figcaption>
</figure>
...
We are pleased to see the long-lasting value that SigNoz provides to its users. If you’re looking for an open-source alternative to SaaS vendors like Datadog or Newrelic, SigNoz might be the right choice. You can get started [here](https://signoz.io/docs/introduction/).

<figure data-zoomable align='center'>
    <img src="/img/blog/2023/09/twitter_user.webp" alt="Twitter user praising SigNoz"/>
    <figcaption><i></i></figcaption>
</figure>
...
<div class="flex flex-wrap -mx-4">
   <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">Martin Gaida</div>
    ...
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">Yunus M</div>
         <small class="text-sm text-muted-foreground">
         </small>
      </div>
      </div>
...
<div class="flex flex-wrap -mx-4">
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">Nico</div>
         <small class="text-sm text-muted-foreground">
         </small>
      </div>
      </div>
    ...
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">Daman Arora</div>
         <small class="text-sm text-muted-foreground">
         </small>
      </div>
      </div>
...
<div class="flex flex-wrap -mx-4">
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">Shivanshu Raj Shrivastava</div>
         <small class="text-sm text-muted-foreground">
         </small>
      </div>
      </div>
    ...
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">Neelesh Sharma</div>
         <small class="text-sm text-muted-foreground">
         </small>
      </div>
      </div>
...
<div class="flex flex-wrap -mx-4">
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">Romain Challier</div>
         <small class="text-sm text-muted-foreground">
         </small>
      </div>
      </div>
    ...
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">Nočnica Mellifera</div>
         <small class="text-sm text-muted-foreground">
         </small>
      </div>
      </div>
...
<div class="flex flex-wrap -mx-4">
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">Dhawal Sanghvi</div>
         <small class="text-sm text-muted-foreground">
         </small>
      </div>
      </div>
    ...
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">Lucas Recoaro</div>
         <small class="text-sm text-muted-foreground">
         </small>
      </div>
      </div>
...
<div class="flex flex-wrap -mx-4">
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">TheEpic-dev</div>
         <small class="text-sm text-muted-foreground">
         </small>
      </div>
      </div>
