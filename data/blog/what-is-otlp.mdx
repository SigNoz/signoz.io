...
High-throughput OTLP clients can easily overwhelm the servers consuming their data. To handle this, OTLP integrates **backpressure** signalling directly into the protocol; this mechanism that lets overloaded servers tell clients to slow down, rather than silently dropping data or crashing.
