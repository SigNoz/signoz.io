...
Further, engineers also found themselves **vendor-locked**. Because the application code used vendor-specific instrumentation agents, switching providers required weeks of effort. **The prevailing mindset was just make it work** with the current toolset, rather than trying to improve it.
...
<Figure src="/img/blog/2026/01/what-is-otlp-image%201.webp" alt="OTLP maintains performance and reliability under load with smart data transmission principles." caption="OTLP maintains performance and reliability under load with smart data transmission principles." />
...
<Figure src="/img/blog/2026/01/what-is-otlp-image%203.webp" alt="Clients process the next batch of data after acknowledgement, or retry on transient failures" caption="Clients process the next batch of data after acknowledgement, or retry on transient failures" />
...
<Figure src="/img/blog/2026/01/what-is-otlp-image%204.webp" alt="OTLP nodes use backpressure signalling to avoid system failures" caption="OTLP nodes use backpressure signalling to avoid system failures" />
