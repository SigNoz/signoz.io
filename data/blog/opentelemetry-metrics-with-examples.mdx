...
If you come from Prometheus, the mental model still fits because OpenTelemetry can work with both push and pull models, including pull-based collection through Prometheus receivers and exporters.
...
We have covered the differences in more detail [in a separate blog](https://signoz.io/blog/opentelemetry-vs-prometheus/).
