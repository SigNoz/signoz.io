...
Instruments can be broadly classified into two based on <u>***when***</u> the metric is collected.
...
Asynchronous instruments usually register **callback functions** which are called when necessary for metric collection.
</Admonition>
...
<figure data-zoomable align='center'>
    ...
    <figcaption><i>OTel metric intruments</i></figcaption>
</figure>
