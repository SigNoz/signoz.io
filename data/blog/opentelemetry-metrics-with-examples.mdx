...
The OTel metrics programming model consisting of a metric pipeline, meter and instruments is shown below. You can read about it in detail [here](https://opentelemetry.io/docs/specs/otel/metrics/#concepts).
...
We can further monitor the total_stock metric in SigNoz to see how the stock levels change over time as shown below.
