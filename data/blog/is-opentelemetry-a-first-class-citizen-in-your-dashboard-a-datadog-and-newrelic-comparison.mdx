...
By contrast, with just the automatic instrumentation for Python in OpenTelemetry, an OpenTelemetry-native backend such as [SigNoz](https://signoz.io/docs/introduction/) can connect traces to related logs without an additional processor.
