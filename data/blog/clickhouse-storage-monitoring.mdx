...
related_articles: ['/blog/community-update-02', '/blog/community-update-20', '/blog/community-update-29', '/blog/community-update-23', '/blog/community-update-27', '/blog/community-update-03']
---
...
We will soon be enabling custom metrics in SigNoz with the ClickHouse  storage backend. Metrics represent the health of your system over time and are a crucial component of observability. SigNoz uses [OpenTelemetry](https://signoz.io/opentelemetry/) for instrumentation and you can measure metrics like p99, p50 latency, etc.
