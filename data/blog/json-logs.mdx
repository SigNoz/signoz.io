...
related_articles: ['/blog/log-shipper', '/blog/structured-logs', '/comparisons/logstash-alternatives', '/blog/fluentd-vs-logstash', '/comparisons/opentelemetry-vs-logstash', '/guides/slf4j-vs-log4j']
---
