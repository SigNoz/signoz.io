...
<Admonition title="Production Recommendation" defaultCollapsed={true}>
...
<Admonition title="A quick note on the span names" defaultCollapsed={false}>
...
<Admonition title="Why a .env file?" defaultCollapsed={true}>
...
<Admonition title="My service disappeared!" defaultCollapsed={false}>
...
<Admonition title="Security Recommendation" defaultCollapsed={true}>
...
<Admonition title="Why is the value &quot;3&quot; and not &quot;5&quot;?" defaultCollapsed={false}>
