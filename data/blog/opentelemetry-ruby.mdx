---
title: OpenTelemetry Ruby Instrumentation Guide
meta_title: OpenTelemetry Ruby Instrumentation Guide
date: 2026-06-09
tags: [OpenTelemetry Instrumentation, Ruby]
authors: [vishal, ankit_anand]
description: "Learn how to instrument Ruby with OpenTelemetry, collect traces, metrics, and logs, and send telemetry data to SigNoz for debugging and monitoring."
...
Now navigate to `http://localhost:3301/application` (needs signup) to analyse the telemetry data of Rails app.
