...
Reading so far, it seems like the agreement is universal: you should never ever send [Otel](https://signoz.io/blog/opentelemetry-vs-datadog/) data straight to your database unless it’s purpose-built. Martin Thwaites of Honeycomb talks about one reason to send your data to more than one place:
