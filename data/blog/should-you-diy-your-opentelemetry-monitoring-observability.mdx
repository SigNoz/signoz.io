...
The thread, however, is pretty universally opposed to this approach; and I have to say that I agree. While several replies recommend SaaS tools as endpoints to receive [OpenTelemetry](https://signoz.io/opentelemetry/) data, and the tools mentioned are great, there are also fully open-source and self-hosted tools that will make your life much much easier than trying to import directly to Postgres.
...
Reading so far, it seems like the agreement is universal: you should never ever send [OTel](https://signoz.io/opentelemetry/) data straight to your database unless it’s purpose-built. Martin Thwaites of Honeycomb talks about one reason to send your data to more than one place:
