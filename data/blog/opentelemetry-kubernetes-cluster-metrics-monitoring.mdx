...
For a more comprehensive, modern, and automated guide using the official OpenTelemetry Helm charts, check out our new definitive tutorial: [Kubernetes Observability with OpenTelemetry](https://signoz.io/blog/opentelemetry-kubernetes/).
</Admonition>
...
You can find more information on the <a href = "https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/main/receiver/k8sclusterreceiver" rel="noopener noreferrer nofollow" target="_blank" >OpenTelemetry Kubernetes receiver</a>.
...
In this tutorial, you configured an OpenTelemetry collector to export metrics data from a Kubernetes cluster. You then sent the data to SigNoz for monitoring and visualization. See [Kubernetes monitoring with SigNoz](https://signoz.io/kubernetes-monitoring/) for the complete product overview.
