...
related_articles:
  ...
  - '/guides/how-to-view-docker-compose-healthcheck-logs'
  - '/blog/docker-syslog'
---
...
Removing a container leaves its image available locally. If you no longer need it, follow the steps to [remove the Docker image](https://signoz.io/guides/docker-remove-image/).
