---
title: "Winston Logger for Node.js: Transports, Levels & Examples"
meta_title: "Winston Logger for Node.js: Transports, Levels & Examples"
date: 2026-06-11
tags: [nodejs, logging]
authors: [saurabh_patil]
description: "Learn how to install and configure Winston logger for Node.js with npm, transports, formats, log levels, exceptions, and working examples."
...
The Winston log levels follow the severity ordering specified by <a href="https://tools.ietf.org/html/rfc5424" rel="noopener noreferrer nofollow" target="_blank">RFC5424</a>, which assumes the levels to be numerically ordered from most important to least important. By default, Winston uses NPM style [logging levels](https://signoz.io/blog/logging-levels/) (`0-highest`  to `6-lowest`):
...
A [log management tool](https://signoz.io/blog/best-log-management-tools/) centralizes those logs so you can search them, filter by metadata, build dashboards, and create alerts. In this section, we will send Winston logs from a Node.js application to [SigNoz](https://signoz.io/), an all-in-one observability platform for logs, metrics, and traces. SigNoz supports [OpenTelemetry](https://signoz.io/opentelemetry/), so the same logging approach can also be adapted for other OTLP-compatible backends, usually by changing exporter configuration rather than rewriting your logging calls.
