...
- **Datadog** has a complex, usage-based subscription model. You pay per host, per GB of ingested logs, per million indexed [log events](https://signoz.io/comparisons/opentelemetry-events-vs-logs/), for custom metrics, and more. While powerful, this can lead to unpredictable and high costs at scale, forcing teams to make architectural choices to manage their bills. For a detailed breakdown, check out our guide on [Datadog Pricing](/blog/datadog-pricing).
