...
<Figure title="Some Kubernetes metrics as visualised by SigNoz" alt="Some Kubernetes metrics as visualised by SigNoz" src="/img/blog/2025/07/k8s-metrics.webp" />


<Figure title="Infra metrics collected from the minikube cluster visualised in SigNoz" alt="Infra metrics collected from the minikube cluster visualised in SigNoz" src="/img/blog/2025/07/k8s-infra-metrics.gif" />
...
- Though demoed on Minikube, this **a**rchitecture mirrors real-world production setups and can be extended to any Kubernetes environment with minimal changes.