...
<Figure src="/img/blog/2026/01/opentelemetry-serilog-distributed-trace.webp" alt="View of a distributed trace in SigNoz(a OTel-native backend), capturing data execution flow across multiple services." caption="View of a distributed trace in SigNoz(a OTel-native backend), capturing data execution flow across multiple services." />
...
To provide a separation of concerns between Serilog and the application logic, we have scoped all static configuration to the [appsettings.json](https://github.com/SigNoz/examples/blob/ea56f27620a766dd5e7e306f8ad6333564078800/dot-net/serilog-demo/appsettings.json). Let’s go through the relevant configuration:
...
<Figure src="/img/blog/2026/01/opentelemetry-serilog-correlation.webp" alt="Serilog and OpenTelemetry configuration enables correlation of logs and traces." caption="Serilog and OpenTelemetry configuration enables correlation of logs and traces." />
