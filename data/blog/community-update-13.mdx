...
<div class="flex flex-wrap -mx-4">
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">Medicharla Chiranjeevi</div>
    ...
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">Christopher Demicoli</div>
         <small class="text-sm text-muted-foreground">
            India
         </small>
      </div>
...
<div class="flex flex-wrap -mx-4">
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">Chenna Raidu D</div>
         <small class="text-sm text-muted-foreground">
         India
         </small>
      </div>
