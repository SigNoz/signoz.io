...
## Instrumenting the Browser with Web Vitals
...
- Look for metrics like `web_vitals_lcp`, `web_vitals_inp`, and `web_vitals_cls`
    ...
    <Figure src="/img/blog/2025/06/opentelemetry-nextjs-web-vitals-image.webp" alt="" caption="" />- Create a dashboard to track these over time
    
    <Figure src="/img/blog/2025/06/opentelemetry-nextjs-web-vitals-image%201.webp" alt="" caption="" />---
