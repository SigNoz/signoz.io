---
title: OpenTelemetry Java Instrumentation Guide
meta_title: OpenTelemetry Java Instrumentation Guide
date: 2026-06-09
tags: [OpenTelemetry]
authors: [daniel]
description: "Learn how to instrument Java with OpenTelemetry, collect traces, metrics, and logs, and send telemetry data to SigNoz for debugging and monitoring."
...
related_articles:
  ...
  - '/guides/tomcat-performance-monitoring'
...
You can access the running app at `http://localhost:8090`
...
<figure data-zoomable align='center'>
    <img src="/img/blog/2023/11/ingestion-key-details.webp" alt="SigNoz ingestion key details in Settings"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img src="/img/blog/2023/11/java_app_running.webp" alt="Java application running in the terminal"/>
    <figcaption><i></i></figcaption>
</figure>
...
From the above image, no GET request was returned. This is because the Java application hasn’t been accessed at `http://localhost:8090` yet. To generate an HTTP GET request, visit the application at `http://localhost:8090` and try to refresh it one or two times. After that, on your SigNoz dashboard, still on the Traces Explorer page, change the duration to the ‘Last 5 min’, give it some time, and then run the same query again. You should see the GET requests you generated.
