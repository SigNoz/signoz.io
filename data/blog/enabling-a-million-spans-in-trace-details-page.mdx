---
title: How We Enabled Loading a Million Spans in SigNoz Trace Details Page
...
The motivation behind building this feature was clear—our users needed this capability. It unlocks new debugging workflows, making it easier to analyze massive traces efficiently.

Below is our revamped trace details page. Each line represents a span. In this blog, we’ll break down the techniques that enabled seamless loading and analysis of any number of spans.
