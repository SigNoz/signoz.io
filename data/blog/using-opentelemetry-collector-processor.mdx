...
**Pranay:** Sure. I think the collector is the main orchestrator in OpenTelemetry. To make OpenTelemetry work, you need to send data to something, and then the [OTel collector](https://signoz.io/blog/opentelemetry-collector-complete-guide/) processes it and sends it to the backend, where the data is stored or visualization happens.
...
**Nica:** Yes, I agree that is a key part. I think the two things that helped me understand [OpenTelemetry](https://signoz.io/opentelemetry/) early on were:
...
<img src="/img/blog/2023/08/otel-collector.webp" alt="OpenTelemetry Collector overview diagram"/>
...
<figure data-zoomable align='center'>
<img src="/img/blog/2023/08/contrib-receiver.webp" alt="OpenTelemetry Collector receiver diagram"/>
<figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
<img src="/img/blog/2023/08/contrib-processor.webp" alt="OpenTelemetry Collector processor diagram"/>
<figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
<img src="/img/blog/2023/08/service-discovery.webp" alt="OpenTelemetry Collector service discovery diagram"/>
<figcaption><i></i></figcaption>
</figure>
