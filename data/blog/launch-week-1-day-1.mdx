...
related_articles:
  ...
  - '/blog/launch-week-1-day-2'
  - '/blog/launch-week-1-day-5'
---


<div className='announcementContainer'>

<span class="inline-flex rounded-full bg-secondary px-2 py-0.5 text-xs font-medium text-secondary-foreground mb-4">Launch Week 1.0</span>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/events/launch-week-1/json-filter.gif" alt="JSON log filtering demo in SigNoz Logs Explorer"/>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/events/launch-week-1/add-to-dashboard.gif" alt="Add to Dashboard demo from the logs explorer"/>
    <figcaption><i></i></figcaption>
</figure>
...
<div classundefined="row spotlight-flex flex-wrap -mx-4">
  <div class="px-4 w-1/2">
    <div class="rounded-md border border-border bg-card">
      <a class="rounded-md border border-border bg-card" href="https://signoz.io/blog/launch-week-1-day-1/"
  ...
  <div class="px-4 w-1/2">
    <div class="rounded-md border border-border bg-card">
      <a class="rounded-md border border-border bg-card" href="https://signoz.io/blog/launch-week-1-day-2/"
						rel="noopener noreferrer"
						target="_blank">
        <div class="overflow-hidden rounded-t-md">
        <img
...
<div classundefined="row spotlight-flex flex-wrap -mx-4">
  <div class="px-4 w-1/2">
    <div class="rounded-md border border-border bg-card">
      <a class="rounded-md border border-border bg-card" href="https://signoz.io/blog/launch-week-1-day-3/"
						rel="noopener noreferrer"
						target="_blank">
        <div class="overflow-hidden rounded-t-md">
        <img
  ...
  <div class="px-4 w-1/2">
    <div class="rounded-md border border-border bg-card">
      <a class="rounded-md border border-border bg-card" href="https://signoz.io/blog/launch-week-1-day-4/"
						rel="noopener noreferrer"
						target="_blank">
        <div class="overflow-hidden rounded-t-md">
        <img
...
<div class="px-4 w-1/2">
    <div class="rounded-md border border-border bg-card">
      <a class="rounded-md border border-border bg-card" href="https://signoz.io/blog/launch-week-1-day-5/"
						rel="noopener noreferrer"
						target="_blank">
        <div class="overflow-hidden rounded-t-md">
        <img
