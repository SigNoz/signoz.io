...
related_articles:
  ...
  - '/blog/signoz-tracetest-opentelemetry-native-observability-meets-testing'
  - '/blog/opentelemetry-vs-opentracing'
---
...
OpenTelemetry provides tracing SDKs for most programming languages like [Java](https://signoz.io/docs/instrumentation/java/opentelemetry-java/), [Python](https://signoz.io/docs/instrumentation/opentelemetry-python/), [Javascript](https://signoz.io/docs/instrumentation/javascript/opentelemetry-nodejs/), [Golang](https://signoz.io/docs/instrumentation/opentelemetry-golang/), etc.
...
OpenTelemetry provides a standalone service which is called OpenTelemetry Collector([OTel collector](https://signoz.io/blog/opentelemetry-collector-complete-guide/)). You can use the OTel collector to collect different types of metrics like hostmetrics, metrics about your database instances, k8s infra metrics, etc.
...
OpenTelemetry allows you to capture and manage logs and events generated by your applications. It provides logging SDKs in languages such as [Java](https://signoz.io/docs/logs-management/send-logs/java-logs/) and [Python](https://signoz.io/docs/logs-management/send-logs/python-logs/). Using [OpenTelemetry logging](https://signoz.io/blog/opentelemetry-logs/) SDKs, you can generate structured logs which is also correlated with other signals like traces.
...
Using [OpenTelemetry trace](https://signoz.io/blog/what-is-distributed-tracing-in-opentelemetry/) data you can monitor exceptions happening in your application. Not many backend tools will let you do this. An OpenTelemetry-native backend like SigNoz allows you to monitor exceptions from your OpenTelemetry data.
...
It is easy to get started with OpenTelemetry. You can check out [instrumentation instructions](https://signoz.io/docs/instrumentation/). As OpenTelemetry does not provide a backend, you need to choose one that supports OpenTelemetry. An [OpenTelemetry-native APM](https://signoz.io/blog/opentelemetry-apm/) can be a good choice for your observability backend.
