...
meta_title: "SigNoz Logs Search and Filter Improvements"
published_date: 2024-09-20
updated_date: 2026-07-08
tags: [product, launch-week]
authors: [ankit_anand]
description: "See how SigNoz improved logs search and filtering to speed up log-based debugging workflows."
...
<Figure src="/img/launch-week/launch-week-2/logs-ui-day-5-cover.webp" alt="Logs search and filter improvements announcement graphic" caption="" />Let’s dive into these new improvements, how they help, and what more we have in store for the future.
