...
<Figure src="/img/blog/common/signoz_trace_explorer.webp" alt="Trace explorer provided in an OpenTelemetry UI like SigNoz helps you dig deeper in trace data" caption="Trace explorer provided in an OpenTelemetry UI like SigNoz helps you dig deeper in trace data" />
...
<Figure src="/img/blog/common/signoz-infra-metrics.webp" alt="Hostmetrics dashboard in SigNoz - Data is collected using OpenTelemetry Collector" caption="Hostmetrics dashboard in SigNoz - Data is collected using OpenTelemetry Collector" />
...
<Figure src="/img/blog/common/signoz_logs.webp" alt="Logs Collected using OpenTelemetry and visualized in SigNoz" caption="Logs Collected using OpenTelemetry and visualized in SigNoz" />
