...
- **Analytics and reporting:** Beyond monitoring and observability, an OpenTelemetry UI also help identify trends and patterns that might not be immediately obvious. For example, engineers can choose to find and optimize the "hot paths" used by applications based on past 30 days' data.
...
<Figure src="/img/blog/common/signoz_charts_application_metrics.webp" alt="SigNoz APM view showing p90, p99 latency, request rate, apdex, etc." caption="SigNoz APM view showing p90, p99 latency, request rate, apdex, etc." />
...
<Figure src="/img/blog/common/application_metrics_to_traces.webp" alt="You can click on “View Traces” to access traces around that timestamp" caption="You can click on “View Traces” to access traces around that timestamp" />
...
<Figure src="/img/blog/common/signoz_list_of_span.webp" alt="List view of spans has all the spans around a particular timestamp" caption="List view of spans has all the spans around a particular timestamp" />
...
<Figure src="/img/blog/common/traces_custom_aggregates.webp" alt="" caption="" />
