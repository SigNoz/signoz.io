...
meta_title: "EKS Monitoring with OpenTelemetry"
published_date: 2023-12-04
updated_date: 2026-07-14
tags: [OpenTelemetry]
authors: [jaikanth]
description: "Monitor your Amazon EKS cluster with OpenTelemetry: deploy the Collector, capture cluster metrics, and visualize them in SigNoz."
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/blog/2023/12/helm_deployed.webp" alt="Helm deployment output for the OpenTelemetry agent"/>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/blog/2023/12/daemonset_congfigs.webp" alt="DaemonSet configuration for the OpenTelemetry agent"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/blog/2023/12/view_access_token.webp" alt="SigNoz ingestion settings access token"/>
    <figcaption><i></i></figcaption>
</figure>
...
Once the above setup is done, you will be able to access the collected metrics in the SigNoz dashboard. You can go to the `Dashboards` tab and try adding a new panel. You can learn how to create dashboards in SigNoz [here](https://signoz.io/docs/userguide/manage-dashboards/).
...
In this tutorial, you installed an [OpenTelemetry Collector](https://signoz.io/guides/opentelemetry-collector-vs-exporter/) to collect [kubelet metrics](https://signoz.io/docs/infrastructure-monitoring/user-guides/k8s-metrics/) from your EKS cluster and send the collected data to SigNoz for monitoring and alerts.
