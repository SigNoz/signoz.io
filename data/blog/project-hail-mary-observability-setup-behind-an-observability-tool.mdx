...
canonicalUrl: https://signoz.io/blog/project-hail-mary-observability-setup-behind-an-observability-tool/
...
_Hey there, it's Elizabeth from SigNoz!_

_I wasn't planning on making this a blog of its own and initially wanted to combine it with [this](https://signoz.io/blog/how-we-monitor-signoz-cloud/). Later, when I got on a call with Pandey (the brains behind Nightswatch), I realised this deserved a blog of its own._

_This is an attempt to do justice to the insane work our platform-pod does daily to keep all our customers' cloud instances alive and stable. I hope you enjoy reading this as much as I enjoyed learning about this and crafting it for you._
