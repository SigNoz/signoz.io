...
meta_title: "Inkeep AI Agent Monitoring with SigNoz & OpenTelemetry"
published_date: 2025-12-15
updated_date: 2026-07-02
tags: [AI & LLM Observability]
authors: [anushka_karmakar]
description: "Inkeep uses Self-Hosted SigNoz for local development and SigNoz Cloud in production to trace agent runs, tool calls, and token usage."
...
That's why Inkeep integrated both deployment paths directly into their framework: Self-Hosted SigNoz for local development and SigNoz Cloud in production. Agents built with Inkeep come with observability out of the box.
...
In practice, Inkeep uses Self-Hosted SigNoz for local development and SigNoz Cloud in production. Switching between them is an environment variable change. Same traces, same dashboards, same debugging experience.
...
Running Self-Hosted SigNoz locally with Docker isn't just convenient; it's fundamental. Developers building with Inkeep's framework can test agent configurations with full observability before deploying, debug performance issues with realistic trace volumes, and develop custom observability tooling without touching production.
...
For Inkeep, using Self-Hosted SigNoz locally and SigNoz Cloud in production solved this by providing:
...
*Related reading: [LLM observability tools](https://signoz.io/comparisons/llm-observability-tools/), [model monitoring](https://signoz.io/guides/model-monitoring/), [OpenTelemetry tracing](https://signoz.io/blog/opentelemetry-tracing/), and [OpenTelemetry spans](https://signoz.io/blog/opentelemetry-spans/).*
