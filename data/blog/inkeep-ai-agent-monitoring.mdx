...
description: "How Inkeep monitors its AI agent framework with SigNoz and OpenTelemetry: tracing agent runs, tool calls, and token usage via GenAI conventions."
