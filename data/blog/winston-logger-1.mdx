...
<NextImage src="/img/blog/2023/02/winston_logger_cover.webp" alt="Cover Image" width={1200} height={675} priority />
...
SigNoz uses [OpenTelemetry](https://signoz.io/opentelemetry/) to collect logs. With OpenTelemetry, you can also correlate your logs with other telemetry signals like metrics and traces. Having contextual information in your logs can help you debug applications faster. You can get an overview of logs management in SigNoz from the [logs documentation](https://signoz.io/docs/logs-management/overview/).
