...
meta_title: Observing Vercel AI SDK with OpenTelemetry
published_date: 2025-07-31
updated_date: 2026-06-16
tags: [OpenTelemetry, Vercel AI SDK, SigNoz]
authors: [goutham_karthi]
description: Monitor Vercel AI SDK apps with OpenTelemetry and SigNoz. A practical guide to instrumenting an LLM app and tracking traces, latency, and token usage.
...
<figure data-zoomable align='center'>
    <img
        src="/img/blog/2025/08/vercel-ai-sdk-cover.webp"
        alt="Illustration of Vercel AI SDK observability with OpenTelemetry and SigNoz"
    />
</figure>
