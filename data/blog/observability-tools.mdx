...
If your code is not instrumented, Honeycomb has an automatic instrumentation agent called "Honeycomb Beelines" to take care of that for you. It also supports [OpenTelemetry](https://signoz.io/opentelemetry/) for generating instrumentation data.
