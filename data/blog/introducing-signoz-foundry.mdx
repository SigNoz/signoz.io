...
### Reproductibility and Version Guardrails

Because Foundry separates your declarative config (the *cast*) from the output manifests (the *pour*), it integrates directly into GitOps workflows.<br/>
Teams can manage version-controlled configurations with per-environment <a link="https://github.com/SigNoz/foundry/blob/main/docs/concepts/patches.md" rel="noopener noreferrer nofollow" target="_blank">patches</a>.
...
<Figure src="/img/blog/2026/04/introducing-signoz-foundry-version-pinning.webp" alt="Foundry pins the ClickHouse image to a tested, stable default version for guaranteed compatibility." caption="Foundry pins the ClickHouse image to a tested, stable default version for guaranteed compatibility." />
