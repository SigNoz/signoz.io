---
title: Introducing SigNoz Foundry for your One Config, One Command Deployment
date: 2026-04-16
tags: [Product]
authors: [dhruv_ahuja]
...
related_articles: ['/blog/cloud-vs-self-hosted-deployment-guide', '/blog/launching-signoz-single-binary', '/blog/cloud-teams-plan-now-at-49usd', '/blog/open-source-observability']
---
...
Consider the <a href="https://github.com/SigNoz/foundry/tree/main/docs/examples/ecs/ec2/terraform" target="_blank" rel="noopener noreferrer nofollow">AWS ECS target</a>: instead of forcing you to figure out how to translate our architecture into AWS concepts, Foundry generates the complete Terraform configuration.<br />
...
As you can see above, you install Foundry once on your system, create a casting manifest, and point the `foundryctl cast` command to this manifest.<br />
...
Earlier, you would have to follow each step in our [comprehensive installation guide](https://signoz.io/docs/install/linux/) (which amounts to <a href="https://github.com/SigNoz/signoz.io/blob/main/data/docs/install/linux.mdx" rel="noopener noreferrer nofollow" target="_blank">13KB of Markdown</a> if you’re feeding it to an LLM), while you dealt with any roadblocks that came along the way.
...
Compared to the massive requirement of 9 config files, Foundry's equivalent at just <a href="https://github.com/SigNoz/foundry/tree/main/docs/examples/systemd/binary#configuration" rel="noopener noreferrer nofollow" target="_blank">7 lines of YAML</a> is as minimal as it gets.
...
To start using Foundry right away, install `foundryctl` with the installer script and run your first deployment.
...
For manual install (Windows PowerShell, air-gapped environments, etc.) or configuring installation specifics, see the <a href="https://github.com/SigNoz/foundry/blob/main/docs/getting-started.md" target="_blank" rel="noopener noreferrer nofollow">Foundry getting-started guide</a>.
...
If something does not work for your specific use case, start a discussion or open an issue on the [Foundry GitHub repo](https://github.com/SigNoz/foundry). We will actively work with you to gather feedback, and help resolve your issues.
