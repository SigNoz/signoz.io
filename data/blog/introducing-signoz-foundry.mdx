...
As you can see above, you install Foundry once on your system, create a casting manifest, and point the `foundryctl cast` command to this manifest. The `casting.yaml` manifest referenced in the image contains <a href="https://github.com/SigNoz/foundry/tree/main/docs/examples/docker/compose#configuration" rel="noopener noreferrer nofollow" target="_blank">less than 10 lines of code</a>.
...
Foundry is a big step towards simplifying open-source observability for our users. It has laid the groundwork that will enable us not only to ship features and bug fixes faster but also distribute SigNoz across more platforms confidently.
...
If something does not work for your specific use case, feel free to start a discussion or open an issue on the [Foundry GitHub repo](https://github.com/SigNoz/foundry). We will actively work with you to gather feedback, and help resolve your issues.
