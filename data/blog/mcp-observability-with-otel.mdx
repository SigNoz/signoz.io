...
If you are already building with MCP observability in mind, SigNoz takes it further with [Agent Native Observability](https://signoz.io/agent-native-observability/), a production-ready [MCP Server](https://signoz.io/docs/ai/signoz-mcp-server/) that connects your telemetry data directly to coding agents like Claude Code and Cursor. Query your traces, logs, and service dependencies in natural language, right from your terminal, no browser tab needed.