...
keywords: [mcp, observability, OpenTelemetry, Backstage, developer portal, instrumentation, metrics, traces, logs]
---
...
- **System resource metrics** [collected via OTel/ system receivers]
    ...
    <Figure src="/img/blog/2025/07/signoz-metrics.webp" alt="Set of metrics collected by OTel in an MCP system visualised in SigNoz" />
...
<Figure src="/img/blog/2025/07/signoz-traces.webp" alt="Distributed tracing for an MCP server-tool-client system as visualised by SigNoz" />

Distributed tracing for an MCP server-tool-client system as visualised by SigNoz
...
For a detailed step-by-step guide on instrumenting your systems with OpenTelemetry, refer to [this comprehensive guide](https://www.notion.so/MCP-Observability-with-OpenTelemetry-21afcc6bcd1980d49c9ef47b2f376e54?pvs=21).
...
Check out [this video tutorial](https://youtu.be/Y0sTVeIra2E) where we walk through how to manually instrument an MCP system for deep observability using OTel.
