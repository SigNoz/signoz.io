...
description: CloudWatch is a great observability tool for AWS users, but it has its limitations.
  In this blog, we will explore some of the challenges faced by CloudWatch and how modern observability platforms can help.
...
<figure>
  <img src="/img/blog/2025/04/cloudwatch-cover.webp" alt="cloudWatch-cover" />
  <figcaption>Modern observability platforms vs CloudWatch</figcaption>
</figure>
...
<figure>
  <img src="/img/blog/2025/04/cloudwatch-blog.webp" alt="cloudwatch-blog" />
  <figcaption>Notes from a CloudWatch user getting “Too many datapoints requested error”</figcaption>
</figure>
...
<figure>
  <img src="/img/blog/2025/04/cloudwatch-pricing-1.webp" alt="cloudwatch-reddit-1" />
  <figcaption>A reddit thread on AWS cost spike based with inflated api requests</figcaption>
</figure>
...
<figure>
  <img src="/img/blog/2025/04/cloudwatch-signoz-correlation.gif" alt="docker-containers" />
  <figcaption>Correlation from APM to Traces to Logs in a couple of clicks as visualised in SigNoz</figcaption>
</figure>
...
<figure>
  <img src="/img/blog/2025/04/cloudwatch-6hr.webp" alt="X-Ray-erroring-out" />
  <figcaption>AWS X-Ray erroring out, when chosen a day’s interval</figcaption>
</figure>
...
<figure>
  <img src="/img/blog/2025/04/cloudwatch-stackoverflow.webp" alt="stack-overflow-thread" />
  <figcaption>Stack overflow thread on the trace visualisation constraint</figcaption>
</figure>
...
<figure>
  <img src="/img/blog/2025/04/cloudwatch.webp" alt="cloudwatch-logs" />
  <figcaption>Logs Explorer in AWS CloudWatch</figcaption>
</figure>

<figure>
  <img src="/img/blog/2025/04/cloudwatch-signoz.webp" alt="signoz-logs" />
  <figcaption>The modern observability experience [Screenshot is from SigNoz Logs Explorer]</figcaption>
</figure>
...
<figure>
  <img src="/img/blog/2025/04/cloudwatch-ux-reddit.webp" alt="cloudwatch-ux-reddit" />
  <figcaption>Some Reddit threads of users mentioning their AWS UI experience</figcaption>
</figure>
