...
related_articles: ['/blog/opentelemetry-express', '/blog/opentelemetry-angular', '/opentelemetry/nodejs', '/opentelemetry', '/opentelemetry/nodejs-tutorial-overview', '/blog/opentelemetry-visualization']
---
...
<Figure src="/img/blog/common/deploy_docker_documentation.webp" alt="SigNoz Docker installation documentation" caption="" />When you are done installing SigNoz, you can access the UI at <a href="http://localhost:3301/" rel="noopener noreferrer nofollow" target="_blank">http://localhost:3301</a>
...
<Figure src="/img/blog/common/join_slack_cta.webp" alt="Join the SigNoz Slack community" caption="" />
