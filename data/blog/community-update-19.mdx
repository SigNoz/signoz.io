...
With the above query, you can GroupBy a tag/attribute in distributed tracing data. Read our docs for more [sample ClickHouse queries](https://signoz.io/docs/userguide/writing-clickhouse-traces-query/).
...
<div class="flex flex-wrap -mx-4">
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">Lucas Mellos Carlos</div>
    ...
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">KatePang</div>
         <small class="text-sm text-muted-foreground">
         </small>
      </div>
      </div>
