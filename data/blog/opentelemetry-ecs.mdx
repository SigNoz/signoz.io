...
meta_title: "OpenTelemetry ECS: Monitor AWS ECS Metrics"
published_date: 2023-12-28
updated_date: 2026-06-17
tags: [OpenTelemetry]
authors: [abhishek-kothari]
description: Monitor AWS ECS metrics with OpenTelemetry. Set up the Collector to gather ECS Container Insights metrics and send them to SigNoz.
