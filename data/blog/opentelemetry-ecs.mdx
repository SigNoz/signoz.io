...
- <a href = "https://github.com/SigNoz/dashboards/blob/main/hostmetrics/hostmetrics.json" rel="noopener noreferrer nofollow" target="_blank" >hostmetrics-with-variable.json</a>
