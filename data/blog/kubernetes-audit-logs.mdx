...
meta_title: "Kubernetes Audit Logs: Configuration Guide"
published_date: 2022-01-03
updated_date: 2026-07-08
tags: [Tech Tutorial]
authors: [vinayak]
description: "Learn how to configure Kubernetes audit logs with audit policies and levels for a complete security record of API server activity."
...
related_articles:
  ...
  - '/guides/kubernetes-monitoring-best-practices'
  - '/blog/kubectl-logs'
  - '/blog/kubectl-logs-tail'
...
While audit logs are critical for reviewing activity across your k8s cluster, they should complement the logs you collect from your applications and other components.

Check out our detailed guide on [Kubernetes logging](https://signoz.io/blog/kubernetes-logging/) that covers pod and node log collection to learn more.
...
You can also check out the documentation for logs [here](https://signoz.io/docs/logs-management/overview/).
