...
The summary view gives you a one-glance breakdown of [all metrics](https://signoz.io/guides/how-to-get-all-the-metrics-of-an-instance-with-prometheus-api/) currently being ingested. You’ll see:
