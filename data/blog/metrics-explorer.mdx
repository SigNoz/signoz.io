...
slug: metrics-explorer-search-query-analyze
date: 2025-05-13
tags: [product]
...
<Figure src="/img/blog/2025/05/metrics-explorer-dashboard.webp" alt="Metrics Explorer summary view showing all ingested metrics and their types." caption="Metrics Explorer summary view showing all ingested metrics and their types." />
...
<Figure src="/img/blog/2025/05/alert to metrics.webp" alt="Metrics Explorer interface with search and filter options for finding specific metrics." caption="Metrics Explorer interface with search and filter options for finding specific metrics." />
...
<Figure src="/img/blog/2025/05/metrics_explorer.gif" alt="Metrics Explorer query playground for running ad hoc metric queries and visualizing results." caption="Metrics Explorer query playground for running ad hoc metric queries and visualizing results." />
