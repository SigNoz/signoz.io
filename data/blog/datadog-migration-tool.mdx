...
description: Learn how the SigNoz Cloud LLM-powered migration tool automates Datadog dashboard migration in minutes. Migrate metrics, logs, and traces dashboards without manual rebuilding or rewriting queries.
image: /img/blog/2025/11/dd-migration-tool-signoz.webp
...
related_articles:
  - '/guides/metrics-migration'
  - '/blog/opentelemetry-vs-datadog'
  - '/guides/new-qb-json-migration'
...
We kept hearing about this from teams evaluating SigNoz Cloud, so we built a solution.

Today, we're introducing the [SigNoz Datadog Migration Tool](https://signoz.io/datadog-migration-tool/), an LLM-powered tool that automates dashboard migration from Datadog to SigNoz Cloud.

What used to take weeks now takes minutes!

<Figure
src="/img/blog/2025/11/dd-migration-tool-signoz.webp"
...
The SigNoz Datadog Migration Tool automates dashboard translation from Datadog to SigNoz Cloud. The process is straightforward. You export your Datadog dashboard configurations in JSON format, run them through our migration tool, and import the translated dashboards into SigNoz Cloud.
...
We're launching this as a private beta to work closely with early users and refine the tool based on feedback. If you're currently on Datadog and evaluating SigNoz Cloud, you can [request early access](https://signoz.io/datadog-migration-tool/) to the migration tool. Our team will reach out to help you get set up.

The goal is to make switching from Datadog to SigNoz Cloud as frictionless as possible so teams can focus on the observability benefits rather than the migration logistics.
