...
Datadog's log management pricing is decoupled into stages. Rather than a single rate for all log management openrations, costs are distributed across four main components. Datadog refers to this model as "Logging without Limits," which separates initial log processing from storage and indexing.
