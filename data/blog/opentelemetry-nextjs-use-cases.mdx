...
## Common Use Cases: Query Builder & Dashboards in SigNoz

Let’s talk about one of the most powerful features of SigNoz enabled via OpenTelemetry: **Query Builder**.

Whether you’re tracking 404s, debugging API latency, or monitoring business metrics, the Query Builder lets you slice your telemetry data—traces, metrics, logs—without learning a new query language.
...
<Figure src="/img/blog/2025/06/opentelemetry-nextjs-use-cases-image.webp" alt="Querying for 404 requests with SigNoz + OpenTelemetry" caption="Querying for 404 requests with SigNoz + OpenTelemetry" />
...
<Figure src="/img/blog/2025/06/opentelemetry-nextjs-use-cases-CleanShot_2025-06-20_at_12.16.062x.webp" alt="Time series view of 404 requests to detect spikes." caption="Time series view of 404 requests to detect spikes." />
...
2.  **Add to Dashboard**
    ...
    <Figure src="/img/blog/2025/06/opentelemetry-nextjs-use-cases-image%201.webp" alt="Creating a dashboard panel via query builder in SigNoz" caption="Creating a dashboard panel via query builder in SigNoz" />
...
<Figure src="/img/blog/2025/06/opentelemetry-nextjs-use-cases-image%203.webp" alt="" caption="" />You’ll see:
...
<Figure src="/img/blog/2025/06/opentelemetry-nextjs-use-cases-image%204.webp" alt="" caption="" />- Full stack trace
