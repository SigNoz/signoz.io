...
related_articles: ['/blog/json-logs', '/guides/loki-json-logs-filter-by-detected-fields-from-grafana', '/comparisons/clickhouse-alternatives', '/blog/json-flattening-query-failures-storage-costs']
---
...
<Figure src="/img/blog/2025/12/cols-during-ingestion.webp" alt="Here’s the entire process of splitting promoted columns and primary colums during ingestion"/>
