...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/blog/2024/01/signal-32-user-shoutout-reddit.webp" alt="Reddit user shoutout about SigNoz"/>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/blog/2024/01/signal-32-devfest.webp" alt="SigNoz talk at Devfest Raipur"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/blog/2024/01/signal-32-twitter-shoutout-1.webp" alt="Twitter shoutout about SigNoz pricing and user experience"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/blog/2024/01/signal-32-twitter-shoutout-2.webp" alt="Twitter shoutout about SigNoz and single-pane observability"/>
    <figcaption><i></i></figcaption>
</figure>
...
<div class="flex flex-wrap -mx-4">
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">Avijeet Pandey</div>
    ...
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">Gaurav Sharma</div>
         <small class="text-sm text-muted-foreground">
         </small>
      </div>
      </div>
...
<div class="flex flex-wrap -mx-4">
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">guangwu</div>
         <small class="text-sm text-muted-foreground">
         </small>
      </div>
      </div>
    ...
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">Alex Bowers</div>
         <small class="text-sm text-muted-foreground">
         </small>
      </div>
      </div>
