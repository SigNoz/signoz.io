...
We've rebuilt the trace detail view from the ground up to spot the failing span in million-span traces at a glance. Designed for [AI-scale telemetry](https://app.notion.com/p/Building-observability-for-the-AI-era-agent-native-and-AI-scale-telemetry-3a0fcc6bcd198066b385e397f8c036d4?pvs=21). The flame graph, waterfall, search, and span details panel are all new.
...
<Figure
  ...
  alt="SigNoz Cloud flamegraph 100,000 spans"
