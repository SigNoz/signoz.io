...
<Figure src="/img/blog/2025/06/distributed-tracing-tools-CleanShot_2025-05-14_at_10.36.122x.jpg" alt="Spans of a trace visualized with the help of flamegraphs and gantt charts in SigNoz dashboard" caption="Spans of a trace visualized with the help of flamegraphs and gantt charts in SigNoz dashboard" />
...
<Figure src="/img/blog/2025/06/distributed-tracing-tools-trace-detail-ss.jpg" alt="Detailed trace view in Jaeger UI" caption="Detailed trace view in Jaeger UI" />
...
<Figure src="/img/blog/2025/06/distributed-tracing-tools-web-screenshot.jpg" alt="Zipkin UI" caption="Zipkin UI" />
...
<Figure src="/img/blog/2025/06/distributed-tracing-tools-grafana-products-traces-hero.jpg" alt="Grafana Tempo dashboard" caption="Grafana Tempo dashboard" />
...
<Figure src="/img/blog/2025/06/distributed-tracing-tools-BAM.jpg" alt="Turbo360 BAM dashboard" caption="Turbo360 BAM dashboard" />
...
<Figure src="/img/blog/2025/06/distributed-tracing-tools-purepath-sequence.jpg" alt="Distributed tracing by Dynatace’s PurePath technology" caption="Distributed tracing by Dynatace’s PurePath technology" />
...
<Figure src="/img/blog/2025/06/distributed-tracing-tools-distributed-tracing_screenshot-full_distributed-tracing-map.jpg" alt="Distributed tracing data in the New Relic UI" caption="Distributed tracing data in the New Relic UI" />
...
<Figure src="/img/blog/2025/06/distributed-tracing-tools-honeycomb-distributed-tracing.jpg" alt="Honeycomb distributed tracing dashboard" caption="Honeycomb distributed tracing dashboard" />
...
<Figure src="/img/blog/2025/06/distributed-tracing-tools-trace_main.jpg" alt="ServiceNow Cloud Observability dashboard" caption="ServiceNow Cloud Observability dashboard" />
...
<Figure src="/img/blog/2025/06/distributed-tracing-tools-instana_analyze_trace_dashboard.jpg" alt="IBM Instana Observability dashboard" caption="IBM Instana Observability dashboard" />
...
<Figure src="/img/blog/2025/06/distributed-tracing-tools-datadog-distributed-tracing.jpg" alt="Datadog distributed tracing dashboard" caption="Datadog distributed tracing dashboard" />
...
<Figure src="/img/blog/2025/06/distributed-tracing-tools-apm-distributed-tracing.jpg" alt="Elastic APM distributed tracing dashboard" caption="Elastic APM distributed tracing dashboard" />
...
<Figure src="/img/blog/2025/06/distributed-tracing-tools-splunk_distributed_tracing_dashboard-min.jpg" alt="Splunk distributed tracing dashboard" caption="Splunk distributed tracing dashboard" />
...
This <a href="https://www.notion.so/Distributed-Tracing-Tools-1ecfcc6bcd1980e4b1b1caf87cfd360b?pvs=21" rel="noopener noreferrer nofollow" target="_blank">thread</a> is also worth checking out.

## AWS X-Ray

<Figure src="/img/blog/2025/06/distributed-tracing-tools-xray-service-map.jpg" alt="AWS X-Ray service map" caption="AWS X-Ray service map" />
...
<Figure src="/img/blog/2025/06/distributed-tracing-tools-microservices-architecture-distributed-tracing-trace-waterfall.jpg" alt="The Trace Waterfall View in Google Cloud Console" caption="The Trace Waterfall View in Google Cloud Console" />
