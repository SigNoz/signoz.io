...
### 🛠️ Option 2: Self-Hosting (Docker / K8s)
...
### 🧪 Real-World Benchmark (20 requests/endpoint)

| Operation | No OTel | With OTel | Impact |
| --- | --- | --- | --- |
| SSR Homepage | 45.68ms | 44.43ms |  *-2.7%* |
| Protected Route | 64.43ms | 63.50ms |  *-1.4%* |
| External API Route | 218.63ms | 333.63ms | ❌ *+52.6%* |
| Overall Avg | 109.58ms | 147.19ms | ❌ *+34.3%* |
| Memory | 711MB | 558MB |  *-21.5%* |

> ✔️ SSR pages? Minimal impact.
> 
> 
> ❌ API routes with external calls? That’s where the cost shows up.
> 
...
### 🧪 Cold Start Comparison (Avg of 5 runs)

| Metric | No OTel | With OTel | Delta |
| --- | --- | --- | --- |
| Server startup | 1457ms | 1766ms | ❌ +21% |
| First request | 3848ms | 4274ms | ❌ +11% |

> 🔍 Real impact depends on baseline.
> 
> 
> In prod, absolute overhead is usually lower than in dev.
> 
