...
Today, this makes SigNoz one of the most powerful [OpenTelemetry](https://signoz.io/opentelemetry/) native observability platforms with features which leverage data models prescribed by OpenTelemetry.
