...
The benchmark tasks are public, so contamination is real and absolute pass rates are probably generous. This affects all three models similarly, so the comparison holds.
