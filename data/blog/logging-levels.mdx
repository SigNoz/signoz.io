...
For sending logs from your application to SigNoz using OpenTelemetry, the setup depends on your language. The SigNoz documentation covers instrumentation for [Python](/docs/instrumentation/opentelemetry-python/), [Java](/docs/instrumentation/java/opentelemetry-java/), [Go](/docs/instrumentation/opentelemetry-golang/), and [Node.js](/docs/instrumentation/javascript/opentelemetry-nodejs/), among others.
