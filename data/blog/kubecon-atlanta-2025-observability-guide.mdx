...
1. [**Beyond Production: End-to-end CI/CD Observability with OpenTelemetry**](https://www.notion.so/signoz/ADD_LINK_HERE)
   - Time: 2:05 PM EST
...
2. [**Building Secure MLOps Pipelines with KitOps + Argo Workflows**](https://www.notion.so/signoz/ADD_LINK_HERE)
   - Time: 3:20 PM EST
   - Speakers: Ekansh Gupta & Shivay Lamba
   - Topic: Making ML pipelines traceable and secure using KitOps and Argo
3. [**Skip the Deployment Queue: Automated Rollouts and Rollbacks using OpenFeature**](https://www.notion.so/signoz/ADD_LINK_HERE)
   - Time: 4:35 PM EST
   - Speakers: Ekansh Gupta & Shivay Lamba
...
1. [**Designing Platforms with Judgement: Agentic Flows with K8GP**](https://www.notion.so/signoz/ADD_LINK_HERE)
   - Time: 4:00 PM EST
   - Speakers: Ekansh Gupta & Shivay Lamba
   - Topic: Platform design for AI agents in Kubernetes with observability
2. [**Tracing the Untraceable: OpenTelemetry for 'Vibe-Coded' LLM Apps**](https://www.notion.so/signoz/ADD_LINK_HERE) (Lightning Talk)
   - Time: 5:41 PM - 5:46 PM
