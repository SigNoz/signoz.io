...
meta_title: Implementing OpenTelemetry in Angular
...
Now let’s get down to how to implement [OpenTelemetry Angular](https://signoz.io/docs/frontend-monitoring/sending-traces-with-opentelemetry/) libraries and then visualize the collected data in SigNoz.
...
Finally, you should also monitor and work on cutting down on your frontend bundle size to provide a better user experience. We have a dedicated write-up on tips and tricks that help you [reduce OpenTelemetry bundle for browser frontends](https://signoz.io/blog/reduce-opentelemetry-bundle-size-for-browser-frontend/).
...
- **Intuitive Dashboards**: SigNoz provides visually appealing dashboards that make it easy to analyze key metrics, pinpoint issues, and optimize application performance.
    ...
    ![SigNoz: metrics and dashboards](/img/guides/2024/11/is-there-a-way-to-monitor-kube-cron-jobs-using-prometheus-image 7.webp)
...
- **[Proactive Monitoring](https://signoz.io/guides/proactive-monitoring/)**: With advanced [**alerting capabilities**](https://signoz.io/alerts-management/), SigNoz notifies you of critical failures or performance bottlenecks, empowering faster troubleshooting and maintaining smooth operations.
    ...
    ![SigNoz alerting capabilities](/img/guides/2024/11/is-there-a-way-to-monitor-kube-cron-jobs-using-prometheus-image 8.webp)
