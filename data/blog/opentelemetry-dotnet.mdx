...
meta_title: "OpenTelemetry .NET - Practical Instrumentation Guide"
published_date: 2022-06-03
updated_date: 2026-07-14
tags: [OpenTelemetry Instrumentation, .NET]
authors: [chenna]
description: "Instrument .NET applications with OpenTelemetry: set up the SDK, capture traces and metrics, and export them to a backend."
