---
title: OpenTelemetry .NET Instrumentation Guide
meta_title: OpenTelemetry .NET Instrumentation Guide
date: 2026-06-09
tags: [OpenTelemetry Instrumentation, .NET]
authors: [chenna]
description: "Learn how to instrument .NET with OpenTelemetry, collect traces, metrics, and logs, and send telemetry data to SigNoz for debugging and monitoring."
