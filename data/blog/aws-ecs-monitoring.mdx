...
meta_title: AWS ECS Monitoring with OpenTelemetry
published_date: 2023-05-30
updated_date: 2026-06-29
tags: [SigNoz, Product]
authors: [kshitij]
description: "AWS ECS monitoring in 2026: instrument ECS tasks with OpenTelemetry (ADOT) and monitor metrics, traces, and logs in SigNoz. Setup and best practices."
...
related_articles:
  ...
  - '/blog/why-are-we-building-signoz'
  - '/guides/aws-observability'
  - '/guides/ec2-monitoring'
  - '/blog/opentelemetry-ecs'
...
## Self-Hosting SigNoz on AWS ECS (Backend Setup)
...
<figure data-zoomable align='center'>
    <img
        src="/img/blog/2023/05/Screenshot_2023-03-27_at_12.05.29_PM.webp"
        alt="AWS ECS console showing the SigNoz services deployed on Fargate"
    />
</figure>
...
<figure data-zoomable align='center'>
    <img
        src="/img/blog/2023/05/Screenshot_2023-03-22_at_3.23.46_PM.webp"
        alt="AWS architecture diagram for an EC2-hosted ClickHouse cluster with private and public subnets"
    />
</figure>
...
<figure data-zoomable align='center'>
    <img
        src="/img/blog/2023/05/Screenshot_2023-03-28_at_4.01.51_PM.webp"
        alt="SigNoz services list showing the monitored ECS services"
    />
...
<figure data-zoomable align='center'>
    <img
        src="/img/blog/2023/05/Screenshot_2023-03-28_at_3.57.51_PM.webp"
        alt="SigNoz latency chart for API calls handled by the Gin service"
    />
...
<figure data-zoomable align='center'>
    <img
        src="/img/blog/2023/05/Screenshot_2023-03-28_at_3.54.00_PM.webp"
        alt="SigNoz trace charts showing latency and request metrics for API calls"
    />
...
<figure data-zoomable align='center'>
    <img
        src="/img/blog/2023/05/Screenshot_2023-03-28_at_3.54.15_PM.webp"
        alt="SigNoz logs view showing application logs from the ECS workload"
    />
...
<figure data-zoomable align='center'>
    <img
        src="/img/blog/2023/05/Screenshot_2023-03-28_at_3.55.32_PM.webp"
        alt="SigNoz custom chart showing application CPU load over time"
    />
...
Feel free to check out related reads on AWS and cloud observability:

- [AWS Lambda monitoring](https://signoz.io/guides/aws-lambda-monitoring/)
- [OpenTelemetry vs CloudWatch](https://signoz.io/comparisons/opentelemetry-vs-cloudwatch/)
- [AWS monitoring tools](https://signoz.io/comparisons/aws-monitoring-tools/)
- [APM tools](https://signoz.io/blog/open-source-apm-tools/)
- [OpenTelemetry vs X-Ray](https://signoz.io/comparisons/opentelemetry-vs-xray/)
- [Kubernetes monitoring best practices](https://signoz.io/blog/kubernetes-monitoring/)
- [Cloud monitoring tools](https://signoz.io/comparisons/cloud-monitoring-tools/)
