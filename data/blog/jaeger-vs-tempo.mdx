...
<NextImage src="/img/blog/2021/09/jaeger_vs_tempo_cover-min.webp" alt="Cover Image" width={1200} height={630} priority />
...
<NextFigure src="/img/blog/2021/09/jaeger_vs_zipkin_microservices_architecture.webp" alt="Microservices architecture" caption="Microservice architecture of a fictional e-commerce application" width={1200} height={675} />
...
<NextFigure src="/img/blog/2021/09/opentelemetry_distributed_tracing-min.webp" alt="Trace context is passed to track user requests across services" caption="A trace context is passed when user requests pass from one service to another" width={1200} height={675} />
...
<NextFigure src="/img/blog/2021/09/Jaeger_architecture-min.webp" alt="Architecture of Jaeger" caption="Architecture of Jaeger" width={1200} height={675} />
...
<NextFigure src="/img/blog/2021/09/grafana_tempo_architecture-min.webp" alt="Architecture of Grafana Tempo" caption="Grafana tempo architecture" width={1200} height={675} />
...
<NextFigure src="/img/blog/2021/09/grafana_tempo_trace_query-min.webp" alt="Querying a trace on Grafana Tempo using a Trace ID" caption="Querying a trace on Grafana Tempo using a Trace ID" width={1200} height={675} />


Jaeger's UI is basic but comprehensive when it comes to distributed tracing. 

<NextFigure src="/img/blog/2021/09/jaeger_ui-min.webp" alt="Jaeger UI" caption="Jaeger UI showing services and corresponding traces" width={1200} height={675} />
...
<NextFigure src="/img/blog/2021/09/SigNoz_architecture_clickhouse.webp" alt="Architecture of SigNoz with OpenTelemetry and ClickHouse" caption="Architecture of SigNoz with ClickHouse as storage backend and OpenTelemetry for code instrumentation" width={1200} height={675} />


SigNoz comes with out of box visualization of things like RED metrics.

<NextFigure src="/img/blog/common/signoz_charts_application_metrics.webp" alt="SigNoz UI showing the popular RED metrics" caption="SigNoz UI showing application overview metrics like RPS, 50th/90th/99th Percentile latencies, and Error Rate" width={1200} height={675} />


You can also use flamegraphs to visualize spans from your trace data. All of this comes out of the box with SigNoz.

<NextFigure src="/img/blog/common/signoz_flamegraphs.webp" alt="Flamegraphs used to visualize spans of distributed tracing in SigNoz UI" caption="Flamegraphs showing exact duration taken by each spans - a concept of distributed tracing" width={1200} height={675} />
