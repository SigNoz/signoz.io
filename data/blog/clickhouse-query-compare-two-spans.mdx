...
related_articles: ['/comparisons/opentelemetry-vs-tempo', '/comparisons/opentelemetry-trace-vs-span', '/blog/diving-in-to-opentelemetry-data-with-our-new-trace-and-logs-explorer', '/blog/opentelemetry-spans', '/blog/opentelemetry-webinar-on-trace-api', '/blog/distributed-tracing-span']
---
...
See more examples of custom queries in the <a href = "https://signoz.io/docs/userguide/writing-clickhouse-traces-query/" rel="noopener noreferrer nofollow" target="_blank" >SigNoz query documenation.</a>
