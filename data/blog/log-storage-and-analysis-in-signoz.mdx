...
<Figure
  src="/img/blog/2026/07/log-pipeline.webp"
  alt="A visual representation of how logs pass through the OpenTelemetry Collector and SigNoz."
  caption="A visual representation of how logs pass through the OpenTelemetry Collector and SigNoz."
/>
...
<Figure
  src="/img/blog/2026/07/resource-fingerprint.webp"
  alt="Resource fingerprinting groups logs from the same source."
  caption="Resource fingerprinting groups logs from the same source."
/>
...
<Figure
  src="/img/blog/2026/07/query-builder.webp"
  alt="A snapshot of the SigNoz Query Builder."
  caption="A snapshot of the SigNoz Query Builder."
/>
