...
<Figure src="/img/blog/2024/09/opentelemetry-nginx-image.webp" alt="OpenTelemetry monitoring for NGINX requests and traces" caption="" />1. **Enhanced visibility**: Track requests as they flow through your Nginx servers and into your application services.
...
<Figure src="/img/blog/common/deploy_docker_documentation.webp" alt="SigNoz Docker installation documentation" caption="" />Pre-requisites:
...
- At the end of the method, the span will be closed, and traces will be exported to the SigNoz [otel collector](https://signoz.io/blog/opentelemetry-collector-complete-guide/).
...
1. **Secure your implementation**:
    - Use TLS for all communications between Nginx, the [OpenTelemetry](https://signoz.io/opentelemetry/) Collector, and your backend
