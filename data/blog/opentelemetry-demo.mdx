...
If you are not interested in the architecture, you can skip to the [Send OpenTelemetry Demo App Telemetry to SigNoz](#send-opentelemetry-demo-app-telemetry-to-signoz) section.
</KeyPointCallout>
