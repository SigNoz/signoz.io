...
slug: exploring-opentelemetry-demo-application-with-signoz
date: 2025-03-26
tags: [OpenTelemetry]
...
<figure>
  <img src="/img/blog/2025/03/otel-demo-map.gif" alt="SigNoz service map" />
  <figcaption>Service architecture as visualised by SigNoz Service map</figcaption>
</figure>
...
We enable appropriate flags to simulate errors, in each of the following scenarios.

<figure>
  <img src="/img/blog/2025/03/otel-demo-flags.webp" alt="Feature page of OTel Demo App" />
  <figcaption>List of feature flags provided by OTel Demo App that helps simulate scenarios</figcaption>
</figure>
...
<figure>
  <img src="/img/blog/2025/03/otel-demo-kafka-metrics.webp" alt="Kafka Monitoring Dashboard" />
  <figcaption>Dashboard with various panels monitoring different Kafka properties</figcaption>
</figure>
...
<figure>
  <img src="/img/blog/2025/03/otel-demo-kafka-traces.webp" alt="Logstab with fraud detection service logs" />
  <figcaption>Logs being used to debug Kafka lag by leveraging Filters</figcaption>
</figure>
...
<figure>
  <img src="/img/blog/2025/03/otel-demo-msg-queues.webp" alt="Messaging Queues with fraud-detection service in focus" />
  <figcaption>Messaging Queues with fraud-detection service in focus</figcaption>
</figure>
...
<figure>
  <img src="/img/blog/2025/03/otel-demo-exceptions.webp" alt="Exceptions Tab used for debugging service failure" />
  <figcaption>Exceptions Tab used for debugging service failure</figcaption>
</figure>

Diving deeper, we notice that the *cartService* is unable to connect to the Redis cache.

<figure>
  <img src="/img/blog/2025/03/otel-demo-exception-detail.webp" alt="Exception details showing cart service cannot connect to Redis" />
  <figcaption>Exception details showing cart service cannot connect to Redis</figcaption>
</figure> 
...
<figure>
  <img src="/img/blog/2025/03/otel-demo-traces.webp" alt="Trace view with flame graph and span details" />
  <figcaption>Trace view with flame graph and span details</figcaption>
</figure>
...
<figure>
    <img src="/img/blog/2025/03/otel-demo-metrics-panel.webp" alt="The Spanmetrics Dashboard showing error rates during a productcatalog service failure" />
    <figcaption>The Spanmetrics Dashboard showing error rates during a productcatalog service failure</figcaption>
</figure>
...
<figure>
    <img src="/img/blog/2025/03/otel-demo-traces-explorer.webp" alt="Traces explorer with Error filter applied and subsequent query output" />
    <figcaption>Traces explorer with Error filter applied and subsequent query output</figcaption>
</figure>
...
<figure>
    <img src="/img/blog/2025/03/otel-demo-pid.webp" alt="Detailed trace view with flame graph and span details emphasising a specific product id which likely causes failure" />
    <figcaption>Detailed trace view with flame graph and span details emphasising a specific product id which likely causes failure</figcaption>
</figure>
...
<figure>
    <img src="/img/blog/2025/03/otel-demo-events.webp" alt="Events Tab for a particular trace, showing cause of failure" />
    <figcaption>Events Tab for a particular trace, showing cause of failure</figcaption>
</figure>
