...
1. **Free Plan**: \$0 per month, includes 20 million events per month, 2 triggers, distributed tracing, [OpenTelemetry](https://signoz.io/comparisons/opentelemetry-vs-splunk/) support, and more.
