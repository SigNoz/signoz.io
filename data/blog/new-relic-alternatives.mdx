...
On ownership: AppDynamics is now a Cisco product, folded into Cisco's observability portfolio alongside Splunk. Similar to IBM's acqusition of Instana, both the acquired observability tools now sit inside larger enterprise suites today.
</KeyPointCallout>
