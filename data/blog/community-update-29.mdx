...
related_articles:
  ...
  - '/blog/community-update-04'
  - '/blog/community-update-34'
  - '/blog/community-update-22'
  - '/blog/community-update-05'
---
...
Read more about our funding [here](https://signoz.io/blog/signoz-funding/).
...
<figure data-zoomable align='center'>
    <img src="/img/blog/2023/10/json_filter_1.webp" alt="JSON filter examples in the logs explorer"/>
...
<figure data-zoomable align='center'>
    <img src="/img/blog/2023/10/json_filter_2.webp" alt="JSON filter examples in the logs explorer"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img src="/img/blog/2023/10/save_view_logs.webp" alt="Save view feature in the query builder"/>
...
<figure data-zoomable align='center'>
    <img src="/img/blog/2023/10/query_builder_ft.webp" alt="Metrics query builder supporting limit, order by, and having"/>
...
<figure data-zoomable align='center'>
    <img src="/img/blog/2023/10/qb_plotting_1.webp" alt="Metrics query builder plotting example"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img src="/img/blog/2023/10/qb_plotting_2.webp" alt="Metrics query builder plotting example"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img src="/img/blog/2023/10/github-trending.webp" alt="SigNoz trending on GitHub"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img src="/img/blog/2023/10/twitter_shoutout.webp" alt="Twitter shoutout about SigNoz"/>
    <figcaption><i></i></figcaption>
</figure>
...
<div class="flex flex-wrap -mx-4">
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">Himanshu Gupta</div>
...
<div class="flex flex-wrap -mx-4">
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">Eng Zer Jun</div>
         <small class="text-sm text-muted-foreground">
         </small>
      </div>
      </div>
    ...
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">Kanishka Chowdhury</div>
         <small class="text-sm text-muted-foreground">
         </small>
      </div>
      </div>
...
<div class="flex flex-wrap -mx-4">
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">CheetoDa</div>
         <small class="text-sm text-muted-foreground">
         </small>
      </div>
      </div>
    ...
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">Ben Walding</div>
         <small class="text-sm text-muted-foreground">
         </small>
      </div>
      </div>
...
<div class="flex flex-wrap -mx-4">
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">Michal Knapcok</div>
         <small class="text-sm text-muted-foreground">
         </small>
      </div>
      </div>
