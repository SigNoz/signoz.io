...
related_articles: ['/blog/opentelemetry-django', '/blog/opentelemetry-flask', '/opentelemetry/nodejs', '/blog/opentelemetry-browser-instrumentation', '/opentelemetry/nodejs-tutorial-overview', '/blog/health-check-monitoring-with-opentelemetry']
---
...
You can also checkout [Redis installation guide](https://redis.io/docs/latest/operate/oss_and_stack/install/install-redis/) for installing Redis on different Operating Systems.
...
```
And, congratulations! You have instrumented your sample Falcon app. You can check if your app is running or not by hitting the endpoint at `http://localhost:8001/api/v1/test`.
