...
related_articles: ['/guides/is-opentelemetry-ready-for-production', '/blog/opentelemetry-vs-opentracing', '/comparisons/opentelemetry-vs-opencensus', '/opentelemetry', '/blog/openmetrics-vs-opentelemetry', '/blog/is-opentelemetry-a-first-class-citizen-in-your-dashboard-a-datadog-and-newrelic-comparison']
---
...
- **14 new receivers and 8 exporters were added in [OTel](https://signoz.io/opentelemetry/) Collector in 2023**
...
Processors available in Otel Collector support dozens of different transformations on metric, span and log data. The [OTTL](https://github.com/open-telemetry/opentelemetry-collector-contrib/blob/main/pkg/ottl/README.md) is a language for transforming [open telemetry](https://signoz.io/opentelemetry/) data. This will help users in writing processing operations in a SQL-like declarative language in `transform` processor rather than specific syntaxes.
