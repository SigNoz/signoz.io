...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/blog/2023/11/mysql_dashboard.webp" alt="SigNoz MySQL dashboard showing query throughput, latency, and connection metrics"/>
