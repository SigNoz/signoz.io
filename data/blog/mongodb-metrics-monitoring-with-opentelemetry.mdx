...
This tutorial assumes that you have the [Opentelemetry](https://signoz.io/comparisons/opentelemetry-vs-splunk/) collector installed on the same host as your database if you plan to monitor a local database.
