...
This tutorial assumes that you have the [OpenTelemetry](https://signoz.io/blog/what-is-opentelemetry/) collector installed on the same host as your database if you plan to monitor a local database.
