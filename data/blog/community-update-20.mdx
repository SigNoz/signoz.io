...
<a href = "https://outplayhq.com/" rel="noopener noreferrer nofollow" target="_blank" >Outplay</a>, a sales engagement and sales automation platform uses SigNoz to monitor their APM metrics. The Outplay team has used SigNoz to optimize their APIs after migrating their entire workload from EC2 to Kubernetes. Check out the full story <a href = "https://signoz.io/customers/outplay/" target="_blank" >here</a>.
...
<a href = "https://www.wombo.ai/" rel="noopener noreferrer nofollow" target="_blank" >Wombo</a>, an AI-powered content generator, uses SigNoz to make the user experience smooth for more than 5 million monthly active users. They have used SigNoz to optimize their key user experience metrics and to identify the root cause of application performance issues. Check out the full story <a href = "https://signoz.io/customers/wombo/" target="_blank" >here</a>.
...
<figure data-zoomable align='center'>
    <img src="/img/blog/2023/01/signal_20_nishant.webp" alt="Community shoutout from Nishant about SigNoz"/>
...
<figure data-zoomable align='center'>
    <img src="/img/blog/2023/01/signal_20_vignesh.webp" alt="Community shoutout from Vignesh about SigNoz"/>
    <figcaption><i></i></figcaption>
</figure>
