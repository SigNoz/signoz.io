...
<div class="flex flex-wrap -mx-4">
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">Zsombor</div>
   ...
   <div class="px-4 w-1/2">
      ...
      >
         ...
         <div class="flex flex-col">
            <div class="font-semibold text-foreground">Marius Kimmina</div>
   ...
   <div class="px-4 w-1/2">
      ...
      >
         ...
         <div class="flex flex-col">
            <div class="font-semibold text-foreground">Yash Joshi</div>
            <small class="text-sm text-muted-foreground"></small>
         </div>
      </div>
   </div>
   ...
   <div class="px-4 w-1/2">
      ...
      >
         ...
         <div class="flex flex-col">
            <div class="font-semibold text-foreground">Michael</div>
            <small class="text-sm text-muted-foreground"></small>
         </div>
      </div>
   </div>
