...
<div class="flex flex-wrap -mx-4">
    <div class="px-4 w-1/2">
      ...
      >
         ...
         <div class="flex flex-col">
            <div class="font-semibold text-foreground">Ram S Gupta</div>
            <small class="text-sm text-muted-foreground"></small>
         </div>
      </div>
   </div>
   ...
   <div class="px-4 w-1/2">
      ...
      >
         ...
         <div class="flex flex-col">
            <div class="font-semibold text-foreground">Fellipe Montes</div>
            <small class="text-sm text-muted-foreground"></small>
         </div>
      </div>
   </div>
   ...
   <div class="px-4 w-1/2">
      ...
      >
         ...
         <div class="flex flex-col">
            <div class="font-semibold text-foreground">volodfast</div>
            <small class="text-sm text-muted-foreground"></small>
         </div>
      </div>
   </div>
...
**[Complete Guide to Distributed Tracing with OpenTelemetry - Part I](https://signoz.io/blog/what-is-distributed-tracing-in-opentelemetry/)**

**[Complete Guide to Distributed Tracing with OpenTelemetry - Part II](https://signoz.io/blog/opentelemetry-tracing/)**
