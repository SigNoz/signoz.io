...
slug: reduce-bundle-size-for-browser-frontend
date: 2025-12-22
tags: [OpenTelemetry]
...
Both of the above are proven techniques for bringing down bundle size. Apart from these, there are some more optimisations for how we send telemetry data from the browser and framework-specific techniques, which I’ll cover in another edition. Till then, adieu!