...
We'll update your existing `otel-collector` setup to export traces and metrics to SigNoz Cloud—while keeping Jaeger for local use.
...
Now that data is flowing, let’s explore how to actually use SigNoz to:
