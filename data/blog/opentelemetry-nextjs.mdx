...
At this point, you’ll research, understand [observability in detail](https://signoz.io/guides/what-is-observability/), likely explore Jaeger or Datadog. But:
...
- **API Routers**: Has two options: the [App Router](https://nextjs.org/docs/app) and the [Pages Router](https://nextjs.org/docs/pages),that follow distinct implementation patterns.
...
Now that your Next.js app is streaming traces to SigNoz, the first thing you'll notice is that the APM view is already populated — latency percentiles, error rates, endpoint breakdown — without any additional configuration.
