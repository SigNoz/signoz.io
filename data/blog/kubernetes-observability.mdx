...
If you’re using OpenTelemetry, you can avoid vendor lock-in. For applications deployed on Kubernetes, OpenTelemetry provides an [operator](https://signoz.io/docs/opentelemetry-collection-agents/k8s/otel-operator/overview/) which makes it very easy to instrument workloads deployed on Kubernetes.
