...
SigNoz is a full-stack [open source observability platform](https://signoz.io/blog/observability-tools/) that provides metrics, traces, and logs under a single pane of glass. It uses [OpenTelemetry](https://signoz.io/comparisons/opentelemetry-vs-splunk/) for application instrumentation which is quietly becoming the world standard for observability instrumentation.
