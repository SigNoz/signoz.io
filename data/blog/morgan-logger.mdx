...
Let us use Morgan Logger in a sample Nodejs application and send the captured logs to an [open-source log management tool](/blog/best-log-management-tools/).
