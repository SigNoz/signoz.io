...
SigNoz indexes all OpenTelemetry ([OTel](https://signoz.io/blog/opentelemetry-vs-datadog/)) attributes—whether string, number, or boolean—without the limitations imposed by tools like Loki. This means you can effortlessly query and aggregate high-cardinality data (such as detailed duration metrics) without performance penalties.
