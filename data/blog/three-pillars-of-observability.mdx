...
related_articles:
  ...
  - '/guides/observability-pipeline'
  - '/guides/full-stack-observability-essentials'
---
...
- **Correlate traces with logs and metrics**: [Link trace IDs to log entries](https://signoz.io/docs/traces-management/guides/correlate-traces-and-logs/) and metric data points for a holistic view of system behavior.
