...
**Take it into your IDE:** With your Spring Boot application now sending traces to SigNoz, connect the [SigNoz MCP Server](https://signoz.io/docs/ai/signoz-mcp-server/) to GitHub Copilot or VS Code. You can then query latency spikes, error traces, and service dependencies in natural language — without leaving your development environment. [Learn more about Agent Native Observability](https://signoz.io/agent-native-observability/).
