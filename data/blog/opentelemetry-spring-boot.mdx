...
<InlineCTA message="Send your Spring Boot traces to SigNoz Cloud in 15 minutes — auto-instrumentation with the Java agent, JVM metrics, and pre-built dashboards included." />
...
<figure data-zoomable align="center">
  ...
  <figcaption>
    <i>
      Architecture - How OpenTelemetry fits in an application architecture. [OTel](https://signoz.io/opentelemetry/) collector refers to
...
In this tutorial, we will use [SigNoz](https://signoz.io/docs/introduction/), an OpenTelemetry-native APM as the backend and visualization layer.
