...
related_articles: ['/comparisons/jaeger-alternatives', '/blog/jaeger-vs-opentracing', '/blog/distributed-tracing-jaeger', '/guides/how-to-implement-jaeger', '/blog/jaeger-vs-prometheus', '/blog/opentelemetry-vs-jaeger']
---
...
{/* <!-- <figure data-zoomable align='center'>
    <img className="box-shadowed-image"
    alt="SigNoz architecture diagram with ClickHouse setup"
