...
Metrics collected by [OTel](https://signoz.io/blog/opentelemetry-vs-datadog/) on instrumenting your producer/ consumer is the same as the generic metrics collected by OTel from any application and gives values for error rates, latency etc.
