...
related_articles: ['/blog/opentelemetry-kafka', '/guides/kafka-metrics', '/blog/kafka-monitoring-opentelemetry', '/blog/opentelemetry-powered-kafka-celery-monitoring']
---
...
Metrics collected by [OTel](https://signoz.io/opentelemetry/) on instrumenting your producer/ consumer is the same as the generic metrics collected by OTel from any application and gives values for error rates, latency etc.
