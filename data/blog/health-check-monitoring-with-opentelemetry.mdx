...
meta_title: "Health Check Monitoring with OpenTelemetry"
published_date: 2024-09-26
updated_date: 2026-06-30
tags: [OpenTelemetry]
authors: [daniel]
description: "Health check monitoring with OpenTelemetry: use the Collector's httpcheck receiver to probe HTTP endpoints and track uptime in SigNoz. Step-by-step guide."
...
related_articles:
  ...
  - '/blog/opentelemetry-apache-server-metrics-monitoring'
...
On collection, the modern, OpenTelemetry-native way to do this is the Collector's httpcheck receiver: it periodically issues requests to your HTTP endpoints and emits availability and latency metrics over [OTLP](https://signoz.io/blog/what-is-otlp/), so health checks live in the same pipeline as your traces and metrics in a backend like SigNoz, with no separate uptime service.
...
<figure data-zoomable align='center'>
<img className="box-shadowed-image" src="/img/blog/2023/12/https_check_status.webp" alt="HTTP endpoint health check status screenshot"/>
...
Visit the SigNoz [documentation](https://signoz.io/docs/userguide/manage-dashboards/) to learn more about creating dashboards and running queries.
...
- [Essential Guide to Endpoint Monitoring - Secure Your Network](https://signoz.io/guides/endpoint-monitoring/)
- [Essential Guide to Server Health Monitoring - Tools and Best Practices](https://signoz.io/guides/server-health-monitoring/)
- [What is Distributed Tracing and How to implement it with Open Source?](https://signoz.io/blog/distributed-tracing/)
- [Top APM Tools](https://signoz.io/blog/open-source-apm-tools/)
- [APM Metrics: All You Need to Know](https://signoz.io/guides/apm-metrics/)
---
