...
meta_title: "OpenTelemetry Operator: A Complete Guide"
...
description: Learn how to deploy and manage OpenTelemetry in Kubernetes with the OpenTelemetry Operator, including auto-instrumenting a Java app.
keywords: [OpenTelemetry Operator, Kubernetes, observability, telemetry, auto-instrumentation, collectors, SigNoz]
related_articles:
  - '/blog/opentelemetry-kubernetes-cluster-metrics-monitoring'
  - '/blog/opentelemetry-collector-complete-guide'
  - '/blog/opentelemetry-kubernetes'
  - '/blog/kubernetes-events-monitoring'
  - '/blog/eks-monitoring-with-opentelemetry'
  - '/blog/using-signoz-to-monitor-your-kubernetes-cluster'
---
...
The Operator is the most automated way to run collectors in a cluster, but if you prefer to wire the Collector up by hand as a DaemonSet and Deployment, our full walkthrough on [Kubernetes observability with OpenTelemetry](https://signoz.io/blog/opentelemetry-kubernetes/) covers that path step by step.
...
You can then access the running application at `http://localhost:8090`
...
There are two ways to install the OpenTelemetry Operator in your Kubernetes cluster,

1/ Applying the release YAML directly
2/ Using the official Helm chart

For this tutorial, we'll use the direct kubectl apply method because it's fast and straightforward. This command
installs the operator, its Custom Resource Definitions (CRDs), and all the necessary RBAC rules.
...
While the direct apply method is good for a quick start, the recommended method for production and the best practice is to use the official Helm chart. 
Helm allows you to easily manage configuration options, set resource limits, and handle version upgrades more robustly.


Assuming you have Helm installed, you can add the OpenTelemetry repository and install the operator with these commands:
...
helm install opentelemetry-operator open-telemetry/opentelemetry-operator --namespace
     opentelemetry-operator-system --create-namespace
```
...
<figure data-zoomable align='center'>
    <img src="/img/blog/2025/09/signoz-settings.webp" alt="SigNoz settings page for ingestion keys"/>
    <figcaption><i></i></figcaption>
</figure>
...
There are different ways to set up auto-instrumentation for your applications using the OpenTelemetry Operator, which you can look at [here](https://signoz.io/docs/opentelemetry-collection-agents/k8s/otel-operator/overview/#opentelemetry-auto-instrumentation-injection).
...
In your browser, visit `http://localhost:8080` to see the running application.
...
<figure data-zoomable align='center'>
    <img src="/img/blog/2025/09/signoz-petclinic.webp" alt="SigNoz UI showing spring-petclinic application"/>
...
<figure data-zoomable align='center'>
    <img src="/img/blog/2025/09/signoz-time-filters.webp" alt="Duration options"/>
...
<figure data-zoomable align='center'>
    <img src="/img/blog/2025/09/signoz-services.webp" alt="List of services in Services tab"/>
...
<figure data-zoomable align='center'>
    <img src="/img/blog/2025/09/signoz-latency.webp" alt="Latency chart showing p99, p90 and p50 percentiles"/>
...
<figure data-zoomable align='center'>
    <img src="/img/blog/2025/09/signoz-operations.webp" alt="SigNoz operations view for the Spring PetClinic application"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img src="/img/blog/2025/09/signoz-trace-explorer.webp" alt="Trace Explorer tab"/>
