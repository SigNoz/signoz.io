---
title: OpenTelemetry with Prometheus
meta_title: Monitor PostgreSQL Metrics with OpenTelemetry
date: 2026-06-09
tags: [OpenTelemetry]
authors: [deepam]
description: Learn how to monitor PostgreSQL metrics using OpenTelemetry Collector. Configure the PostgreSQL receiver and visualize key metrics in SigNoz dashboards.
...
## Monitoring OpenTelemetry data with SigNoz dashboards
