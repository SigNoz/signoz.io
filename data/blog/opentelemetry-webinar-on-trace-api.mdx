...
related_articles: ['/blog/diving-in-to-opentelemetry-data-with-our-new-trace-and-logs-explorer', '/blog/opentelemetry-logs', '/blog/opentelemetry-webinar-openllmetry', '/blog/opentelemetry-tracing', '/blog/otel-webinar-kafka-otlp', '/opentelemetry/correlating-traces-logs-metrics-nodejs']
---
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/webinars/trace-api/1.webp" alt="Slide introducing manual instrumentation and the Trace API"/>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/webinars/trace-api/2.webp" alt="Slide showing tracer provider, context, tracer, and span"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/webinars/trace-api/3.webp" alt="Slide explaining the tracer provider"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/webinars/trace-api/4.webp" alt="Slide about scoped tracers and semantic conventions"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/webinars/trace-api/5.webp" alt="Slide about in-process context propagation"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/webinars/trace-api/6.webp" alt="Slide showing SpanFromContext and ContextWithSpan usage"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/webinars/trace-api/7.webp" alt="Slide about passing context to preserve parent-child spans"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/webinars/trace-api/8.webp" alt="Slide introducing the tracer object and StartAsCurrentSpan"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/webinars/trace-api/9.webp" alt="Slide comparing StartAsCurrentSpan and StartSpan"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/webinars/trace-api/10.webp" alt="Slide about starting spans with a custom timestamp"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/webinars/trace-api/11.webp" alt="Slide summarizing span operations"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/webinars/trace-api/12.webp" alt="Slide showing SpanContext fields like TraceID and SpanID"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/webinars/trace-api/13.webp" alt="Slide about using TraceID and SpanID in logs"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/webinars/trace-api/14.webp" alt="Slide about IsRecording and sampling"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/webinars/trace-api/15.webp" alt="Slide about SetAttributes on spans"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/webinars/trace-api/16.webp" alt="Slide about AddEvents for span events"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/webinars/trace-api/17.webp" alt="Slide about AddLinks for linking traces"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/webinars/trace-api/18.webp" alt="Slide about SetStatus to mark span success or error"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/webinars/trace-api/19.webp" alt="Slide about UpdateName for renaming a span"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/webinars/trace-api/20.webp" alt="Slide about End and RecordException span methods"/>
    <figcaption><i></i></figcaption>
</figure>
