...
<figure data-zoomable align='center'>
    <img src="/img/docs/apm-and-distributed-tracing/traces-view.webp" alt="Flamegraphs showing exact duration taken by each spans - a concept of distributed tracing"/>
