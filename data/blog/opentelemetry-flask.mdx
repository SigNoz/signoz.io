...
related_articles:
  ...
  - '/opentelemetry/python-custom-metrics'
---
...
If you face any problem in instrumenting with OpenTelemetry, refer to [these docs](https://signoz.io/docs/instrumentation/opentelemetry-python/).
