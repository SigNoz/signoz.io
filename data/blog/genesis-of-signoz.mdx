...
related_articles: ['/blog/open-source-observability', '/blog/signoz-vs-prometheus-jaeger', '/blog/community-update-15', '/blog/community-update-03', '/blog/community-update-20', '/blog/community-update-23']
---
...
***Pranay:***<br></br>
Yes, we are taking the route of default [OpenTelemetry](https://signoz.io/opentelemetry/) support, and we are seeing that's like serving like 80 percent of the use cases or customers and that's fine for us as of now because being a small team we don't want to integrate different libraries and builds exporters for all of those.
