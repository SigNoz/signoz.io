...
So for the 80% of the users, I think [query builder](https://signoz.io/blog/query-builder-v5/) will suffice, which they can use to write metrics, etc, and then we support [PromQL and](https://signoz.io/guides/promql-if-else-like-expression/) ClickHouse native queries. 
