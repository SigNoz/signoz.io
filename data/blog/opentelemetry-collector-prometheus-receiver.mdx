...
meta_title: "Monitoring OpenTelemetry Collector Prometheus Receiver"
published_date: 2023-11-24
updated_date: 2026-07-14
tags: [OpenTelemetry]
authors: [daniel]
description: "Configure the Prometheus receiver in the OpenTelemetry Collector to scrape Prometheus metrics and export them anywhere."
...
related_articles:
  ...
  - '/blog/mongodb-metrics-monitoring-with-opentelemetry'
...
The OTLP receiver accepts data through gRPC or HTTP in the [OTLP format](https://signoz.io/blog/what-is-otlp/). There are advanced configurations that you can enable via the YAML file.
...
You can find more details on <a href = "https://github.com/open-telemetry/opentelemetry-collector/blob/main/receiver/otlpreceiver/README.md" rel="noopener noreferrer nofollow" target="_blank">advanced configurations for the OTLP receiver</a>.
...
You can find more information on the <a href = "https://github.com/rycus86/prometheus_flask_exporter/tree/master/examples/sample-signals#requests-per-second" rel="noopener noreferrer nofollow" target="_blank">type of Flask metrics</a> in Prometheus format that can be collected.
...
A simple Flask application has been provided, you can <a href = "https://github.com/SigNoz/opentelemetry-collector-prometheus-receiver-example" rel="noopener noreferrer nofollow" target="_blank">access it on GitHub</a>. The provided Flask application has been configured to export metrics in Prometheus format using the “prometheus_flask_exporter” library.
...
The OpenTelemetry Collector offers various deployment options to suit different environments and preferences. It can be deployed using Docker, Kubernetes, Nomad, or directly on Linux systems. You can find all the <a href = "https://opentelemetry.io/docs/collector/installation" rel="noopener noreferrer nofollow" target="_blank">installation options</a>. For the purpose of this article, the OpenTelemetry Collector will be installed manually.
...
You can find more information on the <a href = "https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/main/receiver/prometheusreceiver" rel="noopener noreferrer nofollow" target="_blank">Prometheus receiver</a>.
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/blog/2023/11/new_dashboard.webp" alt="New dashboard button in SigNoz"/>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/blog/2023/11/dashboard_configure.webp" alt="Dashboard configuration dialog in SigNoz"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/blog/2023/11/dashboard_name_flask.webp" alt="Dashboard name input for Flask monitoring"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/blog/2023/11/dashboard_types_flask.webp" alt="Dashboard visualization type selector"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/blog/2023/11/flask_metrics.webp" alt="Flask metrics appearing in Query Builder"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/blog/2023/11/flask_http_request_duration_seconds_count.webp" alt="Query Builder chart for flask_http_request_duration_seconds_count"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/blog/2023/11/histogram_quantile.webp" alt="PromQL histogram_quantile query for Flask request latency"/>
    <figcaption><i></i></figcaption>
</figure>
