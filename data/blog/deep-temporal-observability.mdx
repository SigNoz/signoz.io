...
related_articles: ['/blog/what-is-distributed-tracing-in-opentelemetry', '/blog/distributed-tracing', '/blog/opentelemetry-tracing', '/guides/microservices-monitoring']
---
...
[Instrument](https://signoz.io/docs/integrations/temporal-cloud-metrics/) your Temporal app with [OpenTelemetry](https://signoz.io/opentelemetry/). We support Go and TypeScript out of the box. The instrumentation attaches all the right attributes like workflow ID, activity type, namespace, task queue, etc. to your telemetry data.
