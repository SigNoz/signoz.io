...
image: img/blog/2025/05/deep-temporal-observability-cover.png
...
This feature exists because users needed it. If you're using Temporal, try [deep observability](https://signoz.io/docs/integrations/temporal-cloud-metrics/) in SigNoz and let us know:
