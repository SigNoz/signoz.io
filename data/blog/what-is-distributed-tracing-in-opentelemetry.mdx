...
For example, **Zipkin** and **[Jaeger](https://signoz.io/blog/jaeger-tracing/)** also have similar architecture.
...
We will be going more deeply into [OpenTelemetry](https://signoz.io/opentelemetry/) in our next article, where we will be learning more about OpenTelemetry and also show you a demo with a sample application.
