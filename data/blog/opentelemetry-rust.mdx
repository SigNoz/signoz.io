...
<Figure src="/img/blog/2026/03/opentelemetry-rust-uv.webp" alt="uv, which is now the go-to Python package manager, is essentially entirely written in Rust." caption="uv, which is now the go-to Python package manager, is essentially entirely written in Rust." link="https://github.com/astral-sh/uv" sourceText="GitHub" />
