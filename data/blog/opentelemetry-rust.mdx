...
![*OpenTelemetry libraries instrument application code to generate telemetry data that is then sent to an observability tool for storage & visualization*](https://signoz.io/img/blog/2022/09/opentelemetry_architecture.webp)
