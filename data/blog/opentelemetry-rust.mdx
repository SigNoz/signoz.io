...
meta_title: Implementing OpenTelemetry in Rust Applications
...
related_articles:
  ...
  - '/blog/opentelemetry-ruby'
  - '/blog/opentelemetry-java'
...
[Metrics](https://signoz.io/blog/opentelemetry-metrics-with-examples/) are a foundational pillar of observability, and for good reason. Tracking key metrics helps you understand overall system health at a glance.<br />In this demo, we are capturing two "standard" metrics — *active requests* via an up-down counter and *request duration* via a histogram.
