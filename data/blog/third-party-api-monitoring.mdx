...
SigNoz leverages OpenTelemetry’s latest semantic conventions to automatically extract and organize third-party API calls from your trace data. Whether your app is using HTTP, gRPC, or RPC, SigNoz identifies domains, endpoints, and status codes masking sensitive data and normalizing paths for clarity and performance.
...
1. **Instrument your application with OpenTelemetry**
    ...
    SigNoz [supports](https://signoz.io/docs/introduction/) all major languages and frameworks.
    
2. **Enable [API Monitoring](https://signoz.io/docs/application-monitoring/api-monitoring/) in SigNoz**
    
    Out of the box, you’ll see all external domains and endpoints your services call.
    
3. **Correlate, analyze, and act**
    
    Use filters, drill downs, and trace navigation to troubleshoot issues, generate audit reports, and keep your systems resilient.
    
4. **Set up alerts** *(Coming soon)*
    
    Create alerts directly from API monitoring to notify your team when a vendor’s latency or error rates exceed thresholds.
