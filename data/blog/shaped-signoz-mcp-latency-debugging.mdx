...
authors: [mahak_kaur]
description: Kathleen Xue at Shaped used SigNoz Cloud and the SigNoz MCP server to fix a Redis latency bug that had persisted in production for almost a year.
