...
meta_title: "Collect .NET Application Logs with OpenTelemetry"
published_date: 2024-05-15
updated_date: 2026-07-08
tags: [.NET, observability, OpenTelemetry]
authors: [hridyesh_bisht, abhishek-policepatil]
description: "Learn how to collect logs from .NET 8 applications using OpenTelemetry, from the OTLP exporter setup to shipping logs to a backend."
