...
For any user of an observability platform, a dashboard is the first place to visit to understand system health patterns and track key metrics. Dashboards must be intuitive to use, easy to maintain and flexible to match the needs of the power users.

Let us see what kind of visualizations are possible with OpenTelemetry data.

**Application Metrics**

[SigNoz](https://signoz.io/blog/open-source-datadog-alternative/) comes with out-of-box charts for the popular RED(requests, error, and duration) metrics.
...
<Figure src="/img/blog/2026/02/opentelemetry-visualization-traces.webp" alt="Visualize trace data as charts via time series queries in SigNoz." caption="Visualize trace data as charts via time series queries in SigNoz." />
...
<Figure src="/img/docs/dashboards/dashboard-templates/claude-code-dashboard.webp" alt="SigNoz supports building custom dashboards to track LLM usage for services such as Claude Code." caption="SigNoz supports building custom dashboards to track LLM usage for services such as Claude Code." />
