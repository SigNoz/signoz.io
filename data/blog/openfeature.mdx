...
related_articles: ['/opentelemetry', '/blog/open-source-observability', '/blog/api-monitoring-tools', '/blog/current-state-of-opentelemetry', '/blog/open-source-datadog-alternative', '/opentelemetry/java-auto-instrumentation']
---
...
<Figure src="/img/blog/2024/09/openfeature-image 1.webp" alt="Flag value returned `on` based on Evaluation Context passed" caption="Flag value returned `on` based on Evaluation Context passed" />

<Figure src="/img/blog/2024/09/openfeature-image 2.webp" alt="Flag value returned `off` based on Evaluation Context passed" caption="Flag value returned `off` based on Evaluation Context passed" />
...
<Figure src="/img/blog/2024/09/openfeature-image 3.webp" alt="Flag Evaluation Life Cycle" caption="Flag Evaluation Life Cycle" />
...
<Figure src="/img/blog/2024/09/openfeature-image 4.webp" alt="Feature Flagging architecture using OpenFeature" caption="Feature Flagging architecture using OpenFeature" />
...
<Figure src="/img/blog/2024/09/openfeature-image 5.webp" alt="Request Flow in Feature Flagging architecture using OpenFeature" caption="Request Flow in Feature Flagging architecture using OpenFeature" />
...
<Figure src="/img/blog/2024/09/openfeature-image 6.webp" alt="OpenFeature and OpenTelemetry Integration" caption="OpenFeature and OpenTelemetry Integration" />
...
2. Instrument your application with [OpenTelemetry](https://signoz.io/opentelemetry/), which SigNoz uses for data collection.
