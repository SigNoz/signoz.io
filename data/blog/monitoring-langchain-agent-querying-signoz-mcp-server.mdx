...
related_articles: ['/blog/mcp-observability-with-otel', '/blog/langchain-observability-with-opentelemetry', '/blog/unhyped-take-on-mcp-servers', '/comparisons/opentelemetry-collector-vs-agent']
---
...
We’ll walk through how to set up a SigNoz MCP agent with LangChain, instrument it with [OpenTelemetry](https://signoz.io/opentelemetry/), and explore the kinds of insights it can surface when observability data becomes part of the agent’s context.

<figure data-zoomable align='center'>
    <img
        src="/img/blog/2025/10/langchain-cover-2.webp"
        alt="Illustration of a LangChain agent querying the SigNoz MCP server"
    />
</figure>
