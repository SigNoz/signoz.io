...
1. **OpenTelemetry support:** Collect telemetry using vendor-neutral APIs, SDKs, and protocols so that instrumentation remains portable.
...
6. **Dashboards and alerting:** Track important telemetry through custom dashboards and notify teams when defined conditions are met.
...
|---|---|---|
| **[SigNoz](https://signoz.io/blog/open-source-apm-tools/#1-signoz-best-for-unified-opentelemetry-native-apm)** | Unified, OpenTelemetry-native APM | Application and infrastructure metrics, distributed traces, log correlation, service maps, dashboards, and alerts |
| **[Prometheus and Grafana](https://signoz.io/blog/open-source-apm-tools/#2-prometheus-with-grafana-best-for-metrics-first-application-monitoring)** | Metrics-first monitoring | Time-series metrics, PromQL, dashboards, and alerting |
| **[Elastic APM](https://signoz.io/blog/open-source-apm-tools/#3-elastic-apm-best-for-teams-already-using-elasticsearch-and-kibana)** | Teams already using Elasticsearch and Kibana | Transactions, traces, errors, APM metrics, service maps, and log correlation |
| **[Uptrace](https://signoz.io/blog/open-source-apm-tools/#4-uptrace-best-for-opentelemetry-based-multi-signal-monitoring)** | OpenTelemetry-based, multi-signal monitoring | Traces, metrics, logs, dashboards, errors, and alerts |
| **[Zipkin](https://signoz.io/blog/open-source-apm-tools/#5-zipkin-best-for-focused-trace-collection-and-lookup)** | Focused distributed tracing | Trace collection, search, visualization, and service dependency diagrams |
| **[Jaeger](https://signoz.io/blog/open-source-apm-tools/#6-jaeger-best-for-opentelemetry-oriented-distributed-tracing)** | OpenTelemetry-oriented distributed tracing | Trace collection and search, service dependencies, sampling, and trace-derived service performance monitoring |

## 1. SigNoz: Best for unified, OpenTelemetry-native APM

[SigNoz](https://signoz.io/) is an OpenTelemetry-native APM and observability platform for teams that want one place to investigate application and infrastructure performance. It is available as a self-hosted deployment or a managed service called SigNoz Cloud.
