...
[Jaeger](https://signoz.io/blog/jaeger-tracing/) is a CNCF-graduated distributed tracing platform for monitoring requests across services. Jaeger v2 is based on the OpenTelemetry Collector framework and is designed to operate as a configurable tracing backend.
