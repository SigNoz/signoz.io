...
<NextImage src="/img/blog/2023/10/opentelemetry-tools-cover.webp" alt="Cover Image" width={1200} height={630} priority />
...
<NextFigure src="/img/blog/common/signoz_charts_application_metrics.webp" alt="An OpenTelemetry backend built natively for OpenTelemetry, SigNoz provides out-of-box charts for application metrics" caption="An OpenTelemetry backend built natively for OpenTelemetry, SigNoz provides out-of-box charts for application metrics" width={1200} height={675} priority />
...
<NextFigure src="/img/blog/common/signoz_flamegraphs.webp" alt="Spans of a trace visualized with the help of flamegraphs and gantt charts in SigNoz dashboard" caption="Spans of a trace visualized with the help of flamegraphs and gantt charts in SigNoz dashboard" width={1200} height={675} />
...
<NextFigure src="/img/blog/2023/10/jaeger_ui.webp" alt="Jaeger UI showing traces for selected services" caption="Jaeger UI showing traces for selected services" width={1200} height={675} />
...
<NextFigure src="/img/blog/2023/10/prmetheus_dashboard.webp" alt="Grafana used for visualization with Prometheus" caption="Grafana used for visualization with Prometheus (Source: Prometheus website)" width={1200} height={675} />
...
<NextFigure src="/img/blog/2023/10/honeycomb_tracing_dashboard-min.webp" alt="Honeycomb distributed tracing dashboard" caption="Honeycomb distributed tracing dashboard (Source: Honeycomb website)" width={1200} height={675} />
...
<NextFigure src="/img/blog/2023/10/datadog_distributed_tracing_dashboard.webp" alt="DataDog distributed tracing dashboard" caption="DataDog distributed tracing dashboard (Source: DataDog website)" width={1200} height={675} />
...
<NextFigure src="/img/blog/2023/10/new_relic_distributed_tracing.webp" alt="New Relic distributed tracing dashboard" caption="New Relic distributed tracing dashboard (Source: New Relic website)" width={1200} height={675} />
