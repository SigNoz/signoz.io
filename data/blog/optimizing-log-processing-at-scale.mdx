...
meta_title: "Optimizing Log Processing at Scale"
published_date: 2025-07-21
updated_date: 2026-07-08
tags: [Product]
authors: [anushka_karmakar]
description: "How SigNoz optimized its log processing pipeline by moving from sequential to concurrent processing to boost throughput at scale."
...
related_articles:
  ...
  - '/blog/json-flattening-query-failures-storage-costs'
...
The core issue was architectural. Being [OpenTelemetry](https://signoz.io/opentelemetry/)-native, we followed the standard sequential processing approach from the [OTel collector](https://signoz.io/blog/opentelemetry-collector-complete-guide/). However, this creates a processing tunnel where logs are handled one by one.
