...
The processing rate increased from 35.7k to 47k logs/second, representing a **30% improvement** in throughput with the same infrastructure.
...
- **30% throughput improvement** (35.7k to 47k logs/second)
