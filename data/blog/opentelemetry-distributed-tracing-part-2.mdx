...
Once your application is instrumented with [OTel](https://signoz.io/blog/opentelemetry-vs-datadog/) libraries, you can configure the exporter to send telemetry data directly to SigNoz.
