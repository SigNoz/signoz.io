...
related_articles:
  ...
  - '/blog/community-update-32'
  - '/blog/community-update-34'
  - '/blog/community-update-26'
---
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/blog/2024/05/signal-36-integration-flow.gif" alt="SigNoz integration flow demo"/>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/blog/2024/05/signal-36-drag-n-drop.gif" alt="SigNoz drag-and-drop time range selection demo"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/blog/2024/05/signal-36-share-views.gif" alt="SigNoz share views demo"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/blog/2024/05/signal-36-10m-docker-downloads.webp" alt="SigNoz milestone graphic celebrating 10 million Docker downloads"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/blog/2024/05/signal-36-oss.webp" alt="SigNoz at the OSS summit"/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/blog/2024/05/signal-36-langchain.webp" alt="SigNoz tutorial for tracing GenAI applications"/>
    <figcaption><i></i></figcaption>
</figure>
...
<div class="flex flex-wrap -mx-4">
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">hulk</div>
    ...
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">Richard Lavey</div>
         <small class="text-sm text-muted-foreground">
         </small>
      </div>
      </div>
...
<div class="flex flex-wrap -mx-4">
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">Thijs De Meester</div>
         <small class="text-sm text-muted-foreground">
         </small>
      </div>
      </div>
    ...
    <div class="px-4 w-1/2">
      ...
      <div class="flex flex-col">
         <div class="font-semibold text-foreground">Sinhyeok Seo</div>
         <small class="text-sm text-muted-foreground">
         </small>
      </div>
      </div>
