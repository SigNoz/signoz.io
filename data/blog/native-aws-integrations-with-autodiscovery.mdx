...
We’ve currently rolled out AWS Monitoring to our beta users and it will soon be live for all users. You can get started with AWS monitoring in SigNoz by following the docs [here](https://signoz.io/docs/aws-monitoring/ec2/).
