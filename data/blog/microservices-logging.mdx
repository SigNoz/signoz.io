...
Clone the [SigNoz github](https://signoz.io/docs/cicd/github/github-metrics/) repository:
...
3. **Handling Containerized and Serverless Environments**:
    ...
    - Implement [structured logging](https://signoz.io/guides/structlog/) for easier parsing
