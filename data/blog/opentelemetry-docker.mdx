---
title: "OpenTelemetry with Docker: Instrumentation and Monitoring Guide"
meta_title: "OpenTelemetry with Docker: Instrumentation and Monitoring Guide"
date: 2026-06-09
tags: [OpenTelemetry, Docker]
authors: [abhishek-kothari]
description: "Learn how to use OpenTelemetry with Docker to collect container metrics, traces, and logs, then send telemetry to SigNoz for monitoring."
...
## Why monitor Docker containers with OpenTelemetry?
...
## OpenTelemetry overview for Docker monitoring
...
## How the OpenTelemetry Collector collects Docker metrics
...
## Set up the OpenTelemetry Collector for Docker
...
## Monitoring Docker telemetry with SigNoz dashboards
...
You can build a complete dashboard around various metrics emitted. Here’s a look at a sample dashboard we built out using the metrics collected. You can get started quickly with this dashboard by using the JSON <a href = "https://github.com/SigNoz/dashboards/blob/main/container-metrics/docker/container-metrics-by-host.json" rel="noopener noreferrer nofollow" target="_blank" >here</a>.
...
## Reference: Docker metrics and labels collected by the OpenTelemetry Collector
