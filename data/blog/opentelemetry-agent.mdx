...
Now that you understand what OpenTelemetry agents are, how they operate under the hood, and the best practices for using them effectively, you can get started by following our documentation for [Java instrumentation](https://signoz.io/docs/instrumentation/java/opentelemetry-java/opentelemetry-java/) or [Python instrumentation](https://signoz.io/docs/instrumentation/opentelemetry-python/).
