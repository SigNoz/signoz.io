...
So as long as these components support the OTLP format ( OpenTelemetry’s format), they can process and visualize [OTel](https://signoz.io/blog/opentelemetry-vs-datadog/) data
