...
- **[OpenTelemetry](https://signoz.io/opentelemetry/) makes your instrumentation future-proof**<br></br>
...
So as long as these components support the OTLP format ( OpenTelemetry’s format), they can process and visualize [OTel](https://signoz.io/opentelemetry/) data
...
For companies using Kubernetes, we would suggest using [OpenTelemetry operators](https://signoz.io/docs/opentelemetry-collection-agents/k8s/otel-operator/overview/) which makes it very easy to set up Collector and instrument workloads deployed on Kubernetes.
