...
related_articles: ['/blog/mongodb-monitoring', '/blog/mongodb-monitoring-tools', '/blog/mongodb-metrics-monitoring-with-opentelemetry', '/blog/opentelemetry-browser-instrumentation', '/blog/opentelemetry-tools', '/opentelemetry/metrics-nodejs']
---
...
Add job metrics scraping job to the `otel-collector-config.yaml` file. You can find the file <a href = "https://github.com/SigNoz/signoz/blob/main/deploy/docker/otel-collector-config.yaml" rel="noopener noreferrer nofollow" target="_blank">here</a>.
