...
description: "OpenTelemetry (OTel) is the open-source standard for generating and collecting telemetry data. Learn how OTel APIs, SDKs, and the Collector work."
