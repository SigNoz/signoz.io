...
You can learn how to set up monitoring for the above application in our guide on [instrumenting Node.js with OpenTelemetry](https://signoz.io/opentelemetry/nodejs/). 
