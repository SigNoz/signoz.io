...
related_articles:
  ...
  - '/opentelemetry/setting-up-flask-application'
...
- <a href = "https://nodejs.org/en/download/" rel="noopener noreferrer nofollow" target="_blank">Nodejs v22 (LTS)</a>
...
**Step 7:** Scroll down and whitelist the `http://localhost` IP in order to be able to connect with MongoDB atlas. Then click on `Add Entry` → `Finish and Close`.
...
You can learn how to set up monitoring for the above application from the blog [here](https://signoz.io/opentelemetry/nodejs/). 

SigNoz uses [OpenTelemetry](https://signoz.io/opentelemetry/) - an open-source project aimed at creating an open standard for instrumentation - to instrument applications for generating telemetry data. SigNoz is open-source, so you can try it out directly from its GitHub repo:

[![SigNoz GitHub repo](/img/blog/common/signoz_github.webp)](https://github.com/SigNoz/signoz)

**Further Reading**:

[Monitoring your MEVN application with SigNoz](https://signoz.io/opentelemetry/nodejs/)
