...
To understand the concepts behind the traces you're collecting, see our primer on [distributed tracing](https://signoz.io/blog/distributed-tracing/) and how it fits into the wider landscape of [APM tools](https://signoz.io/blog/open-source-apm-tools/).
