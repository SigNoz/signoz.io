...
related_articles: ['/blog/appdynamics-alternative', '/blog/open-source-newrelic-alternative', '/blog/community-update-27', '/blog/centralized-logging', '/blog/dynatrace-alternatives', '/comparisons/prometheus-alternatives']
---
...
<NextImage src="/img/blog/2023/03/open_source_dynatrace_alternative_cover.webp" alt="cover image" width={1200} height={675} priority />
...
<figure data-zoomable>
    <NextImage src="/img/blog/common/signoz_charts_application_metrics.webp" alt="SigNoz dashboard showing popular RED metrics" width={1200} height={675} />
...
<figure data-zoomable align='center'>
    <NextImage src="/img/blog/common/application_metrics_to_traces.webp" alt="Seamless flow between metrics and traces" width={1200} height={675} />
...
<figure data-zoomable align='center'>
    <NextImage className="box-shadowed-image"
...
<figure data-zoomable align='center'>
    <NextImage src="/img/blog/common/filters_trace_data.webp" alt="Filters on trace data" width={1200} height={675} />
...
<figure data-zoomable align='center'>
    <NextImage src="/img/blog/common/traces_custom_aggregates.webp" alt="Custom aggregates on filtered traces" width={1200} height={675} />
...
<figure data-zoomable align='center'>
    <NextImage src="/img/blog/common/signoz_flamegraphs.webp" alt="Detailed Flamegraphs & Gantt charts" width={1200} height={675} />
...
<figure data-zoomable align='center'>
    <NextImage src="/img/blog/common/signoz_logs.webp" alt="Logs tab in SigNoz" width={1200} height={675} />
...
<figure data-zoomable align='center'>
    <NextImage src="/img/blog/common/signoz_usage_explorer.webp" alt="Transparent usage data" width={1200} height={675} />
