...
<NextImage src="/img/blog/2023/03/open_source_dynatrace_alternative_cover.webp" alt="cover image" width={1200} height={630} priority />
...
<NextFigure src="/img/blog/common/signoz_charts_application_metrics.webp" alt="SigNoz dashboard showing popular RED metrics" caption="SigNoz UI showing application overview metrics like RPS, 50th/90th/99th Percentile latencies, and Error Rate" width={1200} height={675} priority />
...
<NextFigure src="/img/blog/common/application_metrics_to_traces.webp" alt="Seamless flow between metrics and traces" caption="Move from metrics to traces at any point of time which needs more analysis" width={1200} height={675} />
...
<NextFigure src="/img/blog/common/filters_trace_data.webp" alt="Filters on trace data" caption="Use advanced filters to analyze your trace data" width={1200} height={675} />
...
<NextFigure src="/img/blog/common/traces_custom_aggregates.webp" alt="Custom aggregates on filtered traces" caption="Find custom aggregates on filtered traces" width={1200} height={675} />
...
<NextFigure src="/img/blog/common/signoz_flamegraphs.webp" alt="Detailed Flamegraphs &amp; Gantt charts" caption="Spans of a trace visualized with the help of flamegraphs and gantt charts in SigNoz dashboard" width={1200} height={675} />
...
<NextFigure src="/img/blog/common/signoz_logs.webp" alt="Logs tab in SigNoz" caption="Logs tab in SigNoz comes equipped with advanced logs query builder and live tailing" width={1200} height={675} />
...
<NextFigure src="/img/blog/common/signoz_usage_explorer.webp" alt="Transparent usage data" caption="SigNoz provides usage explorer so that you are always informed about your usage" width={1200} height={675} />
