...
SigNoz is built on top of [OpenTelemetry](https://signoz.io/blog/what-is-opentelemetry/)(OTel) from day 1, and leverages OTel data to its full potential. We have helped many users migrate from Datadog to SigNoz, and there are numerous reasons that teams want to migrate away from Datadog, or look for a better alternative.
...
SigNoz is OpenTelemetry-native, designed to leverage the full power of [OTel](https://signoz.io/blog/opentelemetry-vs-datadog/) data for a unified view of logs, metrics, and traces. We've also recently launched features that double down on our OTel-native approach, including:
