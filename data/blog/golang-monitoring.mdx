...
**Traditional Golang Monitoring Approaches**

There is a mix of approaches for monitoring a Go application,, including logs, CPU and memory metrics, garbage collection data, exported application metrics, distributed tracing, and profiling with tools like `pprof`. Each method offers a different perspective on application health and performance, and it’s common for teams to combine them depending on their needs.
...
- `Enrichment`: Works without modifying log statements—even plain logrus.Info() gets enriched.
...
The script we ran in the previous section repeatedly calls the `/products`, `/orders`, `/checkInventory`, `/cpuTest`, and `/concurrencyTest` endpoints, generating traces, metrics, and logs. This simulates real user activity, enabling SigNoz to visualise request latency, business metrics, and Go runtime behaviour in real time.
...
<Figure
  ...
  caption="Your Go application being monitored on the SigNoz dashboard"
/>
...
You can monitor application metrics such as application latency, requests per second, error percentage, and more in the **`Metrics`** tab of SigNoz. 

Click on the **`goApp`** service, and you should be redirected to the metrics page.

<Figure
  src="/img/blog/2025/11/go-monitoring-service-metrics-page.webp"
  alt="Metrics from Go app"
  caption="Monitor your Go application metrics like application latency, requests per second, error percentage, etc."
/>
...
<Figure
  src="/img/blog/2025/11/go-monitoring-goroutines.webp"
  alt="Goroutines metric on SigNoz"
  caption="Monitoring Goroutine from the sample golang application"
/>
...
<Figure
  src="/img/blog/2025/11/go-monitoring-gomemory.webp"
  alt="Go Memory metric on SigNoz"
  caption="Monitoring Heap memory from the sample golang application"
/>
...
<Figure
  src="/img/blog/2025/11/go-monitoring-latency.webp"
  alt="Request Latency & Throughput on SigNoz"
  caption="Monitoring latency and throughput from the sample golang application"
/>

### Application & Business Metrics

### Business Counters
Custom counters that represent real user actions (e.g., orders_total, product_order_total) provide visibility into business events alongside system metrics.

<Figure
  src="/img/blog/2025/11/go-monitoring-orders-total.webp"
  alt="Custom metrics from Go app"
  caption="Monitoring Orders Total metrics from the sample golang application."
/>

<Figure
  src="/img/blog/2025/11/go-monitoring-products-total.webp"
  alt="Custom metrics from Go app"
  caption="Monitoring Product Order Total metrics from the sample golang application."
/>
...
<Figure
  src="/img/blog/2025/11/go-monitoring-trace.webp"
  alt="Traces from Go app"
  caption="Traces tab for golang application on SigNoz"
/>

<Figure
  src="/img/blog/2025/11/go-monitoring-logs.webp"
  alt="Logs from Go app"
  caption="Logs tab for golang application on SigNoz"
/>
