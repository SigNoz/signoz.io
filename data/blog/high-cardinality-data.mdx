...
The Reddit threads are full of these stories: "I added a request_id label for debugging and my Prometheus crashed overnight." "Why does my memory usage spike every deploy?" (Answer: new <Tooltip text="pod" content="The smallest deployable unit in Kubernetes, representing one or more containers running together." link="https://signoz.io/guides/how-to-check-what-port-a-pod-is-listening-on-with-kubectl-and-not-looking-at-the-dockerfile/" />  IDs creating new series with every restart.)
