...
OpenTelemetry does not provide a storage and visualization layer, while DataDog does. If you’re using OpenTelemetry, you need an observability backend such as SigNoz Cloud or DataDog to visualize and store the collected telemetry data.
...
3. Choose a backend:
   - Select a compatible monitoring platform such as SigNoz to store and analyze your telemetry data
     {' '}
     <GetStartedSigNoz />
