...
keywords: [otel baggage, opentelemetry, context propagation, otel, demo, context, opentelemetry context propagation]
image: /img/blog/2026/01/otel-baggage-trace.webp
related_articles: ['/blog/opentelemetry-context-propagation', '/blog/context-propagation-in-distributed-tracing', '/opentelemetry', '/guides/context-deadline-exceeded-prometheus']
---
...
A baggage is an *immutable* object that holds metadata as key-value pairs, similar to how [resource attributes](https://signoz.io/blog/otel-resource-attributes/) are defined. When applications *auto-instrumented* by OpenTelemetry make or receive API calls, most libraries (such as HTTP clients) automatically inject and extract the baggage via HTTP header or gRPC metadata.
