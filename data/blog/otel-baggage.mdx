...
<Figure src="/img/blog/2026/01/otel-baggage-image%201.webp" alt="OTel baggage automatically propagates global metadata context across service boundaries." caption="OTel baggage automatically propagates global metadata context across service boundaries." />
...
<Figure src="/img/blog/2026/01/otel-baggage-image%202.webp" alt="Baggage is used for passing business logic at runtime, and is not stored by observability backends." caption="Baggage is used for passing business logic at runtime, and is not stored by observability backends." />
...
<Figure src="/img/blog/2026/01/otel-baggage-image%203.webp" alt="Fill your SigNoz ingestion details to enable the application to export telemetry." caption="Fill your SigNoz ingestion details to enable the application to export telemetry." />
...
<Figure src="/img/blog/2026/01/otel-baggage-image%204.webp" alt="Running our microservices in one pane using honcho. Honcho injects env vars into each service automatically." caption="Running our microservices in one pane using honcho. Honcho injects env vars into each service automatically." />
...
<Figure src="/img/blog/2026/01/otel-baggage-CleanShot_2026-01-30_at_20.24.192x.webp" alt="Application frontend showcasing items with discounted prices, and baggage flow in the footer." caption="Application frontend showcasing items with discounted prices, and baggage flow in the footer." />
...
<Figure src="/img/blog/2026/01/otel-baggage-image%205.webp" alt="SigNoz Trace Detail View showcasing a breakdown of a distributed trace." caption="SigNoz Trace Detail View showcasing a breakdown of a distributed trace." />
...
<Figure src="/img/blog/2026/01/otel-baggage-image%206.webp" alt="OpenTelemetry signal correlation enables users to check span-level logs within Traces view." caption="OpenTelemetry signal correlation enables users to check span-level logs within Traces view." />

Clicking on the `Open in Logs Explorer` button will open the dedicated logs view for the complete trace.

<Figure src="/img/blog/2026/01/otel-baggage-image%207.webp" alt="SigNoz logs view when accessing all logs for a given trace in one click." caption="SigNoz logs view when accessing all logs for a given trace in one click." />
...
<Figure src="/img/blog/2026/01/otel-baggage-image%208.webp" alt="SigNoz provides pre-built APM dashboards for all services ingesting trace data." caption="SigNoz provides pre-built APM dashboards for all services ingesting trace data." />
