...
You can follow along in [this GitHub repo](https://github.com/SigNoz/kafka-opentelemetry-instrumentation/tree/master/client-spans) to implement the above example.
