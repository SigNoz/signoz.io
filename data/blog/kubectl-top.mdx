---
title: "kubectl top: Monitor Pod and Node Resource Usage"
meta_title: "kubectl top: Monitor Pod and Node Resource Usage"
date: 2024-08-13
tags: [Tech Tutorial]
authors: [daniel, ankit_anand]
description: "Use kubectl top pod and kubectl top node to inspect Kubernetes CPU and memory usage, sort results, verify Metrics Server, and troubleshoot missing metrics."
...
- [Using Kubectl Logs | How to view Kubernetes Pod Logs?](https://signoz.io/blog/kubectl-logs-tail/)
