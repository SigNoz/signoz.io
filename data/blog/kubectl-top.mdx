...
<a href="https://signoz.io/" rel="noopener noreferrer nofollow" target="_blank">
  SigNoz
</a> is a full-stack open-source APM tool that can help you monitor your Kubernetes cluster. It uses <a
  href="https://opentelemetry.io/"
  rel="noopener noreferrer nofollow"
  target="_blank"
>
  OpenTelemetry
</a> to collect metrics from your K8s cluster for monitoring. OpenTelemetry is becoming the world
standard for instrumentation of cloud-native applications, and it is backed by <a
  href="https://www.cncf.io/"
  rel="noopener noreferrer nofollow"
  target="_blank"
>
  CNCF
</a> foundation, the same foundation under which Kubernetes graduated.
