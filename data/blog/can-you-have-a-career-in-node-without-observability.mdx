...
related_articles:
  ...
  - '/opentelemetry/nodejs-clone-application'
  - '/opentelemetry/nodejs-docker-setup'
---
...
- Report data to an OpenTelemetry collector on your system, and <a href = "https://signoz.io/docs/opentelemetry-collection-agents/vm/configure/#send-data-from-applications-to-collector-on-vm" rel="noopener noreferrer nofollow" target="_blank" >connect that collector to SigNoz</a>
