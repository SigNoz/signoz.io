...
related_articles: ['/blog/microservices-observability-with-distributed-tracing', '/blog/distributed-tracing-span', '/blog/what-is-distributed-tracing-in-opentelemetry', '/comparisons/opentelemetry-trace-vs-span']
---
...
- **Define Multi-Stage Flows:** Select significant spans as funnel steps, representing key operations in your distributed system.
...
If your application is already instrumented with [OpenTelemetry](https://signoz.io/opentelemetry/) and sending traces to SigNoz, you can start using Tracing Funnels right away:
