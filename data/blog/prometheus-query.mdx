...
related_articles: ['/guides/how-to-write-a-prometheus-query-that-returns-the-value-of-the-label', '/guides/how-to-get-all-the-metrics-of-an-instance-with-prometheus-api', '/guides/how-can-i-group-labels-in-a-prometheus-query', '/guides/how-can-i-join-two-metrics-in-a-prometheus-query', '/guides/filter-prometheus-results-by-metric-value-not-by-label-value', '/guides/how-to-get-total-requests-in-a-period-of-time-with-prometheus']
---
...
You can also query Prometheus from the command line. If you prefer working exclusively with a CLI, here's a list of <a href = "https://prometheus.io/docs/prometheus/latest/command-line/prometheus/" rel="noopener noreferrer nofollow" target="_blank">Prometheus command line options/flags</a> to help you practice using its REST API to tinker around with an instance and relative configuration variables. 
