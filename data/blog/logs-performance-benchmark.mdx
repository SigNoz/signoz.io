...
meta_title: "SigNoz Logs Performance Benchmark vs ELK and Loki"
published_date: 2023-01-17
updated_date: 2026-07-08
tags: [SigNoz, Open Source]
authors: [nitya, ankit_anand]
description: "SigNoz benchmarked 2.5x faster than ELK for querying. See the methodology, setup, and results comparing SigNoz, Elasticsearch, and Loki."
...
<NextImage src="/img/blog/2022/12/benchmark-cover.webp" alt="Cover Image" width={1200} height={675} priority />
...
- **Ingestion**<br></br>
  Distributed cloud-native applications can generate logs at a humungous scale. [Open source log management tools](https://signoz.io/blog/best-open-source-log-management-tools/) should be efficient at ingesting log data at scale.
...
The storage design behind these numbers is detailed in how we built a [high-performance JSON log store](https://signoz.io/blog/building-a-high-performance-log-store/).
...
Companies like Uber have found that in production environment, more than <a href = "https://www.uber.com/blog/logging/" rel="noopener noreferrer nofollow" target="_blank" >80% of queries</a> are aggregation queries, such as terms, histograms and percentile aggregations.
