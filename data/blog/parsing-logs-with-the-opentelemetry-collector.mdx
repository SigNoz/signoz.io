...
meta_title: "Parsing Logs with the OpenTelemetry Collector"
...
If you’re not reporting data already, check out our guide on [instrumenting a Node.js application with OpenTelemetry](https://signoz.io/opentelemetry/nodejs/), then come back here!
...
If you're looking for a dedicated guide on filtering application logs, check out this guide on [sending and filtering Python logs](https://signoz.io/blog/sending-and-filtering-python-logs-with-opentelemetry/).
...
See further documentation on logs [receivers and operators](https://signoz.io/docs/logs-management/overview/#operators-for-parsing-and-manipulating-logs) in our docs for parsing CSV and JSON formats, syslog native parsing, and math and other functions.

## Conclusions

Logs processing is extremely flexible and powerful with the [OpenTelemetry](https://signoz.io/opentelemetry/) Collector, and a combination of receivers and processors makes it possible to transform raw logs into highly structured data.
