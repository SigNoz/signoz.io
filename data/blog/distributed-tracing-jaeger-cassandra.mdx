...
related_articles: ['/guides/what-database-does-jaeger-use', '/guides/how-to-implement-jaeger', '/blog/jaeger-microservices', '/blog/distributed-tracing-jaeger', '/blog/distributed-tracing-nodejs', '/blog/jaeger-vs-signoz']
---
...
<figure data-zoomable align='center'>
    ...
    alt="Jaeger and Cassandra architecture diagram for distributed tracing"
