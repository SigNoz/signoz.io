...
related_articles: ['/guides/logging-in-python', '/guides/structlog', '/guides/python-logging-best-practices', '/guides/how-to-write-to-a-file-using-the-logging-python-module', '/guides/python-logging-create-log-if-not-exists-or-open-and-continue-logging-if-it-does', '/guides/loguru']
---
...
We will use two modules: `syslog`, a built-in Python library for system logging, and `logging`, a built-in Python library for logging in general. Logs are only helpful if analyzed properly to give actionable insights. In the last part of this tutorial, we will demonstrate how to send logs to SigNoz - ranked highly among [open source log management tools](https://signoz.io/blog/best-open-source-log-management-tools/).
