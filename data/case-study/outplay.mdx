...
description: Outplay uses Self-Hosted SigNoz traces to find slow APIs, tune database queries after its Kubernetes migration, and improve backend response time by 35%.
...
_I sat down with Vijay, Technical Lead at <a href = "https://outplayhq.com" rel="noopener noreferrer nofollow" target="_blank" >Outplay</a> to understand how they use Self-Hosted SigNoz. Here’s a few snippets from our conversation (edited for legibility)_
