...
<div class="flex items-center gap-3">
  <a class="h-12 w-12 rounded-full object-cover-link h-12 w-12 rounded-full object-cover h-16 w-16 rounded-full object-cover" href="https://twitter.com/pranay01">
    <img alt="Pranay Profile" src="/img/authors/pranay_profile_pic.webp" />
  </a>
  <div class="flex flex-col">
    <div class="font-semibold text-foreground">Pranay Prateek</div>
