...
description: Kiwi uses SigNoz Cloud in India to monitor fintech flows, alert on OTP and log anomalies, and cut a critical API's latency from 20 seconds to milliseconds.
...
## Implementing SigNoz Cloud for End-to-End Monitoring & Observability

Kiwi chose SigNoz Cloud as its managed observability platform for its ease of integration, data residency, cost-effectiveness, and open-source foundation.

One thing that we consistently hear from developers and founders is how quick and easy it is to start working with SigNoz Cloud.
...
The team at Kiwi are big fans of open-source tools. They have plans to contribute back to the open-source SigNoz project. Its transparency also helped the team choose SigNoz Cloud over solutions like Datadog and New Relic.
...
SigNoz Cloud's ability to host data within India made it compliant with Kiwi's regulatory needs.

## Using SigNoz Cloud for End-to-End Observability

### Real-Time Monitoring and Alerting

Kiwi relies heavily on SigNoz Cloud for real-time monitoring and alerting to maintain system uptime and reliability.
...
Kiwi uses SigNoz Cloud in development, staging, and production environments to ensure consistency and reliability.
...
- **Efficient Debugging:** Unified logs, metrics, and traces in SigNoz Cloud streamline the debugging process.
...
That’s why the team at Kiwi is planning to move everything to SigNoz Cloud soon. We believe you shouldn’t be worried about your queries while debugging your application and even if there is a cost associated with making heavy queries it should not come as a surprise.

## Looking Ahead: Expanding SigNoz Cloud Usage

Kiwi plans to move more of their infrastructure monitoring from CloudWatch to SigNoz Cloud, including AWS logs and additional metrics.
...
SigNoz Cloud has become an indispensable part of Kiwi's observability stack, enabling them to ensure real-time reliability, maintain regulatory compliance, and optimize system performance—all while being cost-effective.
