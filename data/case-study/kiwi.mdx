...
<div class="flex items-center gap-3">
  <a
    class="h-12 w-12 rounded-full object-cover-link h-12 w-12 rounded-full object-cover h-16 w-16 rounded-full object-cover"
    href="https://www.linkedin.com/in/ankit-anand-686a53a1/"
  >
    <img alt="Ankit Profile" src="/img/users/ankit-anand.webp" />
  </a>
  <div class="flex flex-col">
    <div class="font-semibold text-foreground">Ankit Anand</div>
    <small class="text-sm text-muted-foreground">Maintainer, SigNoz</small>
  </div>
</div>
