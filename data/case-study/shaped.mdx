...
description: Shaped AI consolidated CloudWatch and Honeycomb into SigNoz Cloud, unifying logs, metrics, and traces so engineers troubleshoot faster and keep costs predictable.
...
We sat down with [Karl Lyons](https://www.linkedin.com/in/karllyons/), a senior site reliability engineer at Shaped, to understand how the engineering team uses SigNoz Cloud for observability.
...
## The Solution - Finding a Unified, OpenTelemetry-Native Platform with SigNoz Cloud

Karl’s search led him to SigNoz Cloud. Several factors immediately stood out, making it the ideal choice for Shaped.
...
4. **Cost-Effectiveness:** "Looking after costs is a big part of what I do," Karl states. SigNoz Cloud presented a powerful feature set at a price point that was more economical than their previous combination of CloudWatch and Honeycomb.
...
Today, SigNoz Cloud is the nerve center for Shaped’s engineering team. It's the default destination for monitoring, debugging, and performance optimization.
...
From a fragmented, costly, and frustrating setup, Shaped has moved to a state of observability clarity. With SigNoz Cloud, the entire engineering team is now equipped with a unified, one-stop, and cost-effective observability tool that has become an indispensable part of their daily workflows.
