...
description: Resolve Docker and Swarm-specific SigNoz issues: missing Compose tooling, inactive Swarm, unhealthy containers, stuck bootstrap jobs, and restart loops.
doc_type: howto
---
