...
<Admonition title="Why Kustomize?" defaultCollapsed={true}>
...
<Admonition title="Casting reference" defaultCollapsed={true}>
...
<Admonition title="Skip cast and apply with kubectl directly" defaultCollapsed={true}>
...
<Admonition title="Patches reference" defaultCollapsed={true}>
