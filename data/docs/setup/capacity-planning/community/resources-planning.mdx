...
- **Smallest sizes that meet the table:** `e2-standard-4` (4 vCPUs, 16 GB) for General Purpose workloads, and `c3-highcpu-22` (22 vCPUs, 44 GB) for ClickHouse. C3 has no 16-vCPU shape, jumping from 8 to 22 vCPUs, and `c3-standard-8` carries only 8 vCPUs.
