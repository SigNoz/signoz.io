...
description: Observability and monitoring for LiteLLM usage and performance with OpenTelemetry instrumentation to send traces, logs, and metrics to SigNoz
---
