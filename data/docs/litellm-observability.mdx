...
title: LiteLLM Observability with SigNoz
description: Observability and monitoring for LiteLLM performance and usage with OpenTelemetry instrumentation to send traces, logs, and metrics to SigNoz
---
...
<Figure
  src="/img/docs/llm/litellm/litellmsdk-traces.webp"
  alt="LiteLLM Trace View"
  caption="LiteLLM SDK Trace View"
/>

When you click on a trace in SigNoz, you'll see a detailed view of the trace, including all associated spans, along with their events and attributes.

<Figure
  src="/img/docs/llm/litellm/litellmsdk-detailed-traces.webp"
  alt="LiteLLM Detailed Trace View"
  caption="LiteLLM SDK Detailed Trace View"
/>
...
<figure data-zoomable align="center">
  <img src="/img/docs/llm/litellm/related-logs.webp" alt="Related logs" width="300" />
  <figcaption>
...
<Figure
  src="/img/docs/llm/litellm/litellmsdk-logs.webp"
  alt="LiteLLM Logs View"
  caption="LiteLLM SDK Logs View"
/>

When you click on any of these logs in SigNoz, you'll see a detailed view of the log, including attributes:

<Figure
  src="/img/docs/llm/litellm/litellmsdk-detailed-logs.webp"
  alt="LiteLLM Detailed Log View"
  caption="LiteLLM SDK Detailed Logs View"
/>

You should be able to see LiteLLM related metrics in Signoz Cloud under the metrics tab:

<Figure
  src="/img/docs/llm/litellm/litellmsdk-metrics.webp"
  alt="LiteLLM Metrics View"
  caption="LiteLLM SDK Metrics View"
/>

When you click on any of these metrics in SigNoz, you'll see a detailed view of the metric, including attributes:

<Figure
  src="/img/docs/llm/litellm/litellmsdk-detailed-metrics.webp"
  alt="LiteLLM Detailed Metrics View"
  caption="LiteLLM SDK Detailed Metrics View"
/>

## Dashboard

You can also check out our custom LiteLLM SDK dashboard [here](https://signoz.io/docs/dashboards/dashboard-templates/litellm-dashboard/) which provides specialized visualizations for monitoring your LiteLLM usage in applications. The dashboard includes pre-built charts specifically tailored for LLM usage, along with import instructions to get started quickly.

<Figure
  src="/img/docs/llm/litellm/litellm-sdk-dashboard.webp"
  alt="LiteLLM SDK Dashboard"
...
<Figure
  src="/img/docs/llm/litellm/litellmproxy-traces.webp"
  alt="LiteLLM Trace View"
  caption="LiteLLM Proxy Trace View"
/>

When you click on a trace in SigNoz, you'll see a detailed view of the trace, including all associated spans, along with their events and attributes.

<Figure
  src="/img/docs/llm/litellm/litellmproxy-detailed-traces.webp"
  alt="LiteLLM Detailed Trace View"
  caption="LiteLLM Proxy Detailed Trace View"
/>

## Dashboard

You can also check out our custom LiteLLM Proxy dashboard [here](https://signoz.io/docs/dashboards/dashboard-templates/litellm-dashboard/) which provides specialized visualizations for monitoring your LiteLLM Proxy usage in applications. The dashboard includes pre-built charts specifically tailored for LLM usage, along with import instructions to get started quickly.

<Figure
  src="/img/docs/llm/litellm/litellm-proxy-dashboard.webp"
