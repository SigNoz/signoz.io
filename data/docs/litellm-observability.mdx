...
description: Learn how to instrument LiteLLM SDK and Proxy with OpenTelemetry and export traces, logs, and metrics to SigNoz for real-time LLM monitoring.
---
