...
title: Semantic Kernel Observability & Monitoring with OpenTelemetry
description: Observability and monitoring for Semantic Kernel usage and performance with OpenTelemetry instrumentation to send traces, logs, and metrics to SigNoz
doc_type: howto
---
