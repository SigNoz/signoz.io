...
description: Setup OpenClaw monitoring using OpenTelemetry and SigNoz. Track traces, logs, and metrics for your OpenClaw LLM applications and AI workflows.
doc_type: howto
---
