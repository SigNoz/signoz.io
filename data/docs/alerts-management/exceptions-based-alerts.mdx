...
Define the ClickHouse query that retrieves exception data and drives the alert condition. For help writing ClickHouse queries, see [Writing ClickHouse Traces Queries](https://signoz.io/docs/userguide/writing-clickhouse-traces-query/#dashboard-panel-examples) and [Writing ClickHouse Queries in Dashboards](https://signoz.io/docs/userguide/writing-clickhouse-traces-query/). Use these fields:
