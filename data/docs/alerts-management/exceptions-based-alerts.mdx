...
Here's a breakdown of the various sections and options available when configuring an Exceptions-based alert:
...
<figure data-zoomable align='center'>
    <img src="/img/docs/alerts/alerts-exceptions-based-2.webp" alt="Set alert conditions"/>
...
<figure data-zoomable align='center'>
    <img src="/img/docs/alerts/alerts-exceptions-based-3.webp" alt="Notification settings for the alert"/>
