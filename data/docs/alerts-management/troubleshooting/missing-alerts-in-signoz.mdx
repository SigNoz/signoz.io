...
1. **Configure No Data alerts:**
   ...
   <Figure
     src="/img/docs/product-features/alerts/no-data-alert-advanced-options.webp"
     alt="Advanced Options showing Alert when data stops coming enabled"
     caption='Enable "Alert when data stops coming" in Advanced Options'
   />
