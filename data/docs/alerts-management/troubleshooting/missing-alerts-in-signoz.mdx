...
description: Diagnose why alerts are not firing in SigNoz, covering evaluation pattern misconfiguration, threshold issues, and missing data points.
doc_type: howto
---
...
1. **Configure No Data alerts:**
   ...
   In **Step 2: Set Alert Conditions**, expand the **Advanced Options** section and enable **Alert when data stops coming**. Set the time period to match your needs (e.g., 5 minutes).

   <figure data-zoomable align='center'>
       <img src="/img/docs/product-features/alerts/no-data-alert-advanced-options.webp" alt="Advanced Options showing Alert when data stops coming enabled"/>
       <figcaption><i>Enable "Alert when data stops coming" in Advanced Options</i></figcaption>
   </figure>
