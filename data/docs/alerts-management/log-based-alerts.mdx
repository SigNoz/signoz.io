...
Here's a breakdown of the various sections and options available when configuring a Log-based alert:
...
<figure data-zoomable align='center'>
    <img src="/img/docs/alerts/alerts-log-based-3.webp" alt="Notification settings for the log alert"/>
...
<figure data-zoomable align='center'>
    <img src="/img/docs/product-features/alerts/logs/too-many-redis-timeouts-metric.webp" alt="logs builder query for redis timeout logs percentage"/>
...
<figure data-zoomable align='center'>
    <img src="/img/docs/product-features/alerts/logs/too-many-redis-timeouts-conditions.webp" alt="redis timeout alert condition"/>
...
<figure data-zoomable align='center'>
    <img src="/img/docs/product-features/alerts/logs/too-many-redis-timeouts-configuration.webp" alt="redis timeout alert configuration"/>
