...
In this step, you use the [Logs Query Builder](/docs/userguide/query-builder/#logs-and-traces-query-builder)
...
- **[Legend Format](/docs/userguide/query-builder/#legend-format)**: Define the format for the legend in the visual representation of the alert.
