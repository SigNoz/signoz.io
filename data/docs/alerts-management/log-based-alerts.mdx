...
date: 2026-04-07
id: log-based-alerts
title: How to Create Log-based Alerts
...
A log-based alert fires when an aggregated log query result crosses a threshold. Use this alert type to monitor error log rates, detect specific log patterns, or track keyword occurrences in your logs.

## Overview

Create a log-based alert in three steps: define the log query, set the alert conditions, and configure severity and notifications.

<Admonition type="info">

**Prerequisites**
- At least one [notification channel](https://signoz.io/docs/setup-alerts-notification/) configured in SigNoz
- Logs being ingested into SigNoz
...
- [Alert Evaluation Patterns](https://signoz.io/docs/alerts-management/user-guides/understanding-alert-evaluation-patterns/) — choose the right match type for your use case
- [Set Up Notification Channels](https://signoz.io/docs/setup-alerts-notification/) — configure Slack, PagerDuty, and more
- [How to Configure Alerts for Missing Data](https://signoz.io/docs/alerts-management/user-guides/how-to-configure-alerts-for-missing-data/) — detect when log ingestion stops
