...
description: View and analyze the complete history of triggered alerts in SigNoz, including alert states, timelines, and resolution details.
doc_type: reference
---
...
You can access the Alerts History by clicking the **History** button next to the **Overview** tab on any alert rule's detail page.

<Figure
  src="/img/docs/product-features/alerts/alerts-history-detail.webp"
  alt="Alerts History page showing total triggered count, resolution time, top contributors, and timeline"
  caption="Alerts History page"
/>
...
The timeline and the events table show timestamps in the [timezone](https://signoz.io/docs/manage/timezone/) that you select in the time range selector.
