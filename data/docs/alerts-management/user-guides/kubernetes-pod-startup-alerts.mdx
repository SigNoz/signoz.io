...
1. Enabled Kubernetes monitoring in SigNoz using the [k8s-infra Helm chart](https://signoz.io/docs/opentelemetry-collection-agents/k8s/k8s-infra/install-k8s-infra/) or configured the [k8scluster receiver](https://signoz.io/docs/infrastructure-monitoring/user-guides/k8s-metrics/) manually
...
- [Kubernetes Metrics Configuration Guide](https://signoz.io/docs/infrastructure-monitoring/user-guides/k8s-metrics/)
- [Metrics-Based Alerts Documentation](https://signoz.io/docs/alerts-management/metrics-based-alerts/)
- <a href="https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/main/receiver/k8sclusterreceiver" target="_blank" rel="noopener noreferrer nofollow">OpenTelemetry k8scluster Receiver</a>
- <a href="https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle/" target="_blank" rel="noopener noreferrer nofollow">Kubernetes Pod Lifecycle Documentation</a>
