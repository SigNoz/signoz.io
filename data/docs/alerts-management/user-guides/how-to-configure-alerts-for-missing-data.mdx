...
<figure data-zoomable align='center'>
    <img src="/img/docs/product-features/alerts/alert-conditions-advanced-options.webp" alt="Advanced Options in Set Alert Conditions showing Alert when data stops coming toggle"/>
    <figcaption><i>Advanced Options in Set Alert Conditions — enable "Alert when data stops coming"</i></figcaption>
</figure>
