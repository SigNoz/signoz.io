...
- Kubernetes cluster with [kubeletstats receiver configured](/docs/infrastructure-monitoring/k8s-metrics/)
...
- **[Time aggregation](/docs/metrics-management/types-and-aggregation/#aggregation):** `avg`
- **[Space aggregation](/docs/metrics-management/types-and-aggregation/#aggregation):** `max` by (`k8s.cluster.name`, `k8s.namespace.name`, `k8s.pod.name`, `k8s.container.name`)
...
- Learn more about [Kubernetes metrics](/docs/infrastructure-monitoring/k8s-metrics/)
- Explore [time aggregation best practices](/docs/alerts-management/user-guides/time-aggregation-best-practices/) for alerts
- Set up [notification channels](/docs/alerts-management/notification-channel/) to receive alerts via Slack, PagerDuty, or other channels
- Create similar alerts for [memory usage](/docs/infrastructure-monitoring/k8s-metrics/) using `k8s.container.memory_limit_utilization`
