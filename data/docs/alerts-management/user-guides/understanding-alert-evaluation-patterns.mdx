...
description: Understand SigNoz alert evaluation patterns — At Least Once, All the Time, and On Average — and when to use each for effective alerting.
...
<figure data-zoomable align='center'>
    <img src="/img/docs/product-features/alerts/alert-evaluation-patterns.webp" alt="Alert evaluation pattern options — At Least Once, All the Time, On Average, In Total, and Last"/>
    <figcaption><i>Alert evaluation pattern options in Set Alert Conditions</i></figcaption>
</figure>
