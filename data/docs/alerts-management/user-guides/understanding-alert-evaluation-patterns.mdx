...
<Figure
  src="/img/docs/product-features/alerts/alert-evaluation-patterns.webp"
  alt="Alert evaluation pattern options — At Least Once, All the Time, On Average, In Total, and Last"
  caption="Alert evaluation pattern options in Set Alert Conditions"
/>
