...
title: How to Create Metrics-based Alerts
...
A metrics-based alert in SigNoz fires when a metric query result crosses a threshold. Use this alert type to monitor CPU usage, memory utilization, error rates, latency, and any other numeric metric.

## Overview

Create a metrics-based alert in three steps: define the metric query, set the alert conditions, and configure severity and notifications.
...
- [Time Aggregation Best Practices](https://signoz.io/docs/alerts-management/user-guides/time-aggregation-best-practices/) — pick the right aggregation for your metric
