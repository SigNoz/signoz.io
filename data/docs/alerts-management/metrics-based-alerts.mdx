...
The chart preview uses the same legend controls as dashboard panels. Click a legend row to isolate a series, click a marker to toggle one series, and hover a row for **Only**/**All** and copy actions. See [Work with the chart legend](https://signoz.io/docs/dashboards/interactivity/#work-with-the-chart-legend).
</Admonition>
