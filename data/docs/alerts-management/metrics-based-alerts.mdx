...
### Notification Channels
   ...
   Choose the [notification channels](https://signoz.io/docs/alerts-management/notification-channel/slack/) to send alerts to from those configured in Settings > Alert Channels. You can select multiple channels per threshold.
