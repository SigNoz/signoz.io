...
In this step, you use the [Metrics Query Builder](/docs/userguide/query-builder/)
...
- **Aggregate within time series**: Select the time aggregation function (Avg, Sum, Min, Max, Count, Rate, etc.) and the step interval. Learn more about [time aggregation](/docs/metrics-management/types-and-aggregation/#aggregation).

- **Aggregate across time series**: Select the space aggregation function and optional group-by dimensions. Learn more about [space aggregation](/docs/metrics-management/types-and-aggregation/#aggregation).

- **[Legend Format](/docs/userguide/query-builder/#legend-format)**: Customize the legend's format in the visual representation of the alert.
...
### Notification Channels
   ...
   Choose the [notification channels](/docs/alerts-management/notification-channel/slack/) to send alerts to from those configured in Settings > Alert Channels. You can select multiple channels per threshold.
