...
Here's a breakdown of the various sections and options available when configuring a Metric-based alert:
...
Send periodic notifications while the alert condition remains active. Enable the toggle and set the interval and condition (Firing or No Data).
