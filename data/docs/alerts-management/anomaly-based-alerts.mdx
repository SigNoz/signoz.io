...
doc_type: howto
title: How to Create Anomaly Detection Alerts
---

An anomaly-based alert fires when a metric deviates from its expected historical pattern, rather than crossing a fixed threshold. Use this alert type when your metric has predictable hourly, daily, or weekly patterns and you want to catch unusual deviations without manually setting thresholds.

## Overview

Create an anomaly-based alert in three steps: define the metric, configure anomaly conditions (seasonality and z-score threshold), and configure severity and notifications.

<Admonition type="info">

**Prerequisites**
- At least one [notification channel](https://signoz.io/docs/setup-alerts-notification/) configured in SigNoz
- At least 4 seasons of historical data (e.g., 4 hours for hourly seasonality, 4 days for daily)
...
- [Metrics-based Alerts](https://signoz.io/docs/alerts-management/metrics-based-alerts/) — use fixed thresholds for metrics without seasonal patterns
- [Alert Evaluation Patterns](https://signoz.io/docs/alerts-management/user-guides/understanding-alert-evaluation-patterns/) — understand occurrence and evaluation settings
- [Set Up Notification Channels](https://signoz.io/docs/setup-alerts-notification/) — configure Slack, PagerDuty, and more
