...
Anomaly-based alerts are currently only available through the **old alerts experience**. Use the classic alert creation flow to access the Anomaly Detection Alert option.
