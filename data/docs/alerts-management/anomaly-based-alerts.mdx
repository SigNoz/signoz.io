...
Anomaly-based alerts only support the **Query Builder** query type. ClickHouse queries and PromQL are not available for anomaly alerts.
</Admonition>
...
- **[Legend Format](https://signoz.io/docs/userguide/query-builder-v5/#legend-format)**: An optional field to customize the legend's format in the visual representation of the alert.
...
<Figure
  src="/img/docs/alerts/anomaly-based-alert-condition.webp"
  alt="Define the alert conditions"
  caption="Define the alert conditions"
/>
...
<Figure
  ...
  alt="Configure the alert"
  caption="Setting the alert metadata"
/>
