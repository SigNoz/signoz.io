...
resource "signoz_alert" "example" {
  ...
  labels = {
   ...
   ```
Refer to the [provider's documentation](https://registry.terraform.io/providers/SigNoz/signoz/latest/docs/resources/alert) for the latest information about the API schema.
