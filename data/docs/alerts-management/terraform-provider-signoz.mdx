...
![Validate error](../../../public/img/docs/alerts/terraform-provider-validate.webp)
...
![Plan](../../../public/img/docs/alerts/terraform-provider-plan.webp)
...
![Apply](../../../public/img/docs/alerts/terraform-provider-apply.webp)
...
![Apply](../../../public/img/docs/alerts/terraform-provider-apply-complete.webp)

After getting the success message on the console, you'll find the alert provisioned on the remote:
![Created alert](../../../public/img/docs/alerts/terraform-provider-created-resource.webp)
