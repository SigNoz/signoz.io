...
title: How to Manage Alerts with Terraform
description: How to create and manage SigNoz alerts as code using the Terraform signoz provider.
doc_type: howto
---
...
- [Managing Alerts](https://signoz.io/docs/userguide/alerts-management/) — manage alerts via the SigNoz UI
- [Metrics-based Alerts](https://signoz.io/docs/alerts-management/metrics-based-alerts/) — understand alert configuration options
- [Routing Policies](https://signoz.io/docs/alerts-management/routing-policy/) — route alerts to the right channels
