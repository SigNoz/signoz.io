...
<Figure src="/img/docs/incident-io-source-setup.webp" alt="incident.io HTTP alert source setup page with the alert events URL and secret token." caption="The source's setup page — copy the URL and the token." />
...
<Figure src="/img/docs/incident-io-requests-tab.webp" alt="incident.io Requests tab showing each received event with its payload and outcome." caption="The source's Requests tab — every event SigNoz sent, with payload and outcome." />
...
<Figure src="/img/docs/incident-io-firing-alert.webp" alt="A firing SigNoz alert delivered in incident.io with markdown description and SigNoz deep links." caption="A firing alert delivered in incident.io." />
...
<Figure src="/img/docs/incident-io-resolved-alert.webp" alt="A resolved alert in incident.io showing the SigNoz labels mapped as attributes." caption="A resolved alert — SigNoz labels appear under Attributes once mapped." />
