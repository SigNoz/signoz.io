...
Since this integration uses the Webhook channel, you can configure it programmatically using the same way as described in the [Webhook](/docs/alerts-management/notification-channel/webhook#configure-programmatically) section.
