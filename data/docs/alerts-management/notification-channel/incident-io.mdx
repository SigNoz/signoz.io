...
<Admonition>
A successful test confirms the URL and token are correct. incident.io accepts events asynchronously, so also check the alert appeared: in incident.io, open your source's **Requests** tab (On-call → Alert routing → your source), which lists every event received, with its outcome, for 7 days.
</Admonition>
...
- Connect your SigNoz source to an alert route to auto-create incidents; see incident.io's <a href="https://docs.incident.io/alerts/getting-started" target="_blank" rel="noopener noreferrer nofollow">Creating incidents automatically via alerts</a>.
...
- Group and route alerts into incidents with <a href="https://docs.incident.io/alerts/getting-started" target="_blank" rel="noopener noreferrer nofollow">alert routes</a>.
- Map SigNoz labels to <a href="https://docs.incident.io/alerts/attributes-and-priorities" target="_blank" rel="noopener noreferrer nofollow">attributes and priorities</a> for routing and escalation.
