...
description: Integrate SigNoz with Incident.io to automatically create incidents from your alerts.
doc_type: howto
---
...
Since this integration uses the Webhook channel, you can configure it programmatically using the same way as described in the [Webhook](https://signoz.io/docs/alerts-management/notification-channel/webhook/#configure-programmatically) section.
