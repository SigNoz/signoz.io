...
The **Title** and **Description** fields support <a href="https://prometheus.io/docs/alerting/latest/notifications/" target="_blank" rel="noopener noreferrer nofollow">Go templates</a>. Microsoft Teams renders the message as an Adaptive Card, which supports a small subset of Markdown: `**bold**`, `_italic_`, lists, and `[label](url)` links. Headers, tables, and images do not render.

<Admonition type="info">
The default message shows the labels and the annotations of each alert. It leaves out the `summary`, `related_logs`, and `related_traces` annotations. To show these values in Microsoft Teams, add them to a custom **Description** template.
</Admonition>

<Figure
  src="/img/docs/ms-teams-new-channel.webp"
  alt="Microsoft Teams notification channel form with a Power Automate Workflow webhook URL, and Title and Description templates."
  caption="A Microsoft Teams notification channel that uses a Workflow webhook URL and custom templates."
/>
...
Make sure that the alert rule routes notifications to this Microsoft Teams channel. See [Routing Policies](https://signoz.io/docs/alerts-management/routing-policy/).
