...
- Ensure that you have a Notification Channel for the alerts.
- To send alerts programmatically using SigNoz Cloud, you need your <YOUR_SIGNOZ_CLOUD_URL> and your <YOUR_API_KEY>.
...
- In SIgNoz, go to `Settings > Notification Channels` to view the list of configured alert channels.
...
- Navigate to `Settings > Notification Channels` and click `+ New Alert Channel`.
...
<Admonition>
You can use [templates](https://prometheus.io/docs/alerting/latest/notifications/) for customizing the title and description.
</Admonition>

![new-notification-channel](/img/docs/new-notification-channel.webp)

**Test Configuration**:
Click `Test` to send an alert to the configured Slack channel. This verifies that SigNoz can communicate with your Slack webhook.
