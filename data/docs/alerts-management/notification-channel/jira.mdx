...
- **An Atlassian account email and API token**: create a token at <a href="https://id.atlassian.com/manage-profile/security/api-tokens" target="_blank" rel="noopener noreferrer nofollow">id.atlassian.com → Security → API tokens</a>. SigNoz authenticates as this account using the email + token (basic auth).
