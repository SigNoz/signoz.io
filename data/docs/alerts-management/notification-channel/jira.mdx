...
date: 2026-08-10
doc_type: howto
title: Configure Jira Cloud Channel
...
<Figure src="/img/docs/jira-new-channel.png" alt="Create a new Jira notification channel." caption="Create a new Jira notification channel." />
...
<Figure src="/img/docs/jira-firing-issue.png" alt="A firing alert delivered as a Jira issue." caption="A firing alert delivered as a Jira issue." />
...
<Figure src="/img/docs/jira-issue-comments.png" alt="Lifecycle comments on a Jira issue." caption="Lifecycle comments on a Jira issue." />
...
<Figure src="/img/docs/jira-resolved-issue.png" alt="A resolved alert transitioned to Done in Jira." caption="A resolved alert transitioned to Done in Jira." />
