...
<Admonition>
The **Message**, **Description**, and **Priority** fields accept <a href="https://prometheus.io/docs/alerting/latest/notifications/" target="_blank" rel="noopener noreferrer nofollow">notification templates</a> for customizing the alert.
</Admonition>
