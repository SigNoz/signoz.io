...
description: Detect when specific groups of resources (hosts, services, regions) stop sending data using SigNoz alerts.
...
- [How to Configure Alerts for Missing Data](https://signoz.io/docs/alerts-management/user-guides/how-to-configure-alerts-for-missing-data/) — detect when data ingestion stops entirely
- [Metrics-based Alerts](https://signoz.io/docs/alerts-management/metrics-based-alerts/) — create threshold-based alerts on metrics
