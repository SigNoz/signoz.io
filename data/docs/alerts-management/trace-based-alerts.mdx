...
title: How to Create Trace-based Alerts
...
A trace-based alert fires when an aggregated trace query result crosses a threshold. Use this alert type to monitor P90/P95 latency, span error rates, or any trace attribute.

## Overview

Create a trace-based alert in three steps: define the trace query, set the alert conditions, and configure severity and notifications.

<Admonition type="info">

**Prerequisites**
- At least one [notification channel](https://signoz.io/docs/setup-alerts-notification/) configured in SigNoz
- Traces being ingested into SigNoz
...
- [Time Aggregation Best Practices](https://signoz.io/docs/alerts-management/user-guides/time-aggregation-best-practices/) — pick the right aggregation for your trace metric
