...
In this step, you use the [Traces Query Builder](/docs/userguide/query-builder/#logs-and-traces-query-builder)
...
- **[Legend Format](/docs/userguide/query-builder/#legend-format)**: An optional field to define the format for the legend in the visual representation of the alert.
...
### Evaluation Window
   ...
   - **Rolling**: Monitors data over a fixed time period that moves forward continuously.
   - **Cumulative**: Monitors data accumulated since a fixed starting point. The window grows over time.
...
<figure data-zoomable align='center'>
    <img src="/img/docs/alerts/alerts-trace-based-2.webp" alt="Set alert conditions"/>
...
<figure data-zoomable align='center'>
    <img src="/img/docs/alerts/alerts-trace-based-3.webp" alt="Notification settings for the alert"/>
...
<figure data-zoomable align='center'>
    <img src="/img/docs/product-features/alerts/traces/external-api-metric.webp" alt="traces builder query for external API latency(p90)"/>
...
<figure data-zoomable align='center'>
    <img src="/img/docs/product-features/alerts/traces/external-api-metric-chart.webp" alt="external API latency(p90) chart"/>
...
<figure data-zoomable align='center'>
    <img src="/img/docs/product-features/alerts/traces/external-api-metric-condition.webp" alt="external API latency(p90) condition"/>
...
<figure data-zoomable align='center'>
    <img src="/img/docs/product-features/alerts/traces/external-api-metric-configuration.webp" alt="external API latency(p90) alert configuration"/>
