...
Set these environment variables through your deployment secret manager or a local `.env` file that is excluded from version control:

```bash
COHERE_API_KEY=<your-cohere-api-key>
OTEL_RESOURCE_ATTRIBUTES=service.name=cohere-service,service.version=1.0.0
...
- `<your-cohere-api-key>`: Your Cohere API key. Do not commit it to source control.
