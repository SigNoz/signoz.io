...
<Admonition type="tip">
  **Also on Vercel?** Forward deployment logs and traces with the [SigNoz integration for Vercel](https://signoz.io/docs/integrations/vercel/). If your agent runs generated code in a sandbox, see [Vercel Sandbox Observability](https://signoz.io/docs/vercel-sandbox-observability/).
</Admonition>
...
<Figure
  src="/img/docs/llm/vercel/vercel-traces-view.webp"
  alt="Traces View"
  caption="Traces of your Vercel AI Application"
/>

If you click on any span, you can see the detailed trace of which it is a part of.

<Figure
  src="/img/docs/llm/vercel/vercel-traces-detailed-view.webp"
  alt="Detailed Traces View"
  caption="Detailed Trace view of your Vercel AI Application"
/>
...
<Figure
  ...
  caption="Vercel AI SDK Dashboard"
/>
