...
![KeyCloak Group Memebership Mapper](/img/docs/oidc-keycloak/keycloak-oidc-group-membership-mapper.webp)
...
Configure these in SigNoz under **Settings** → **Organization Settings** → **Authenticated Domains** → edit your domain → **Claim Mapping** section:
...
1. Ensure you have [set up the groups client scope](#set-up-claim-mappers) and [configured claim mapping](#configure-claim-mapping-in-signoz) for groups
