...
1. Ensure you have [set up the groups client scope](#step-4-set-up-claim-mappers) and [configured claim mapping](#configure-claim-mapping-in-signoz) for groups
