...
Configure these in SigNoz under **Settings** → **Organization Settings** → **Authenticated Domains** → edit your domain → **Attribute Mapping** section:
...
2. Go to **Settings** → **Organization Settings** → **Authenticated Domains**
