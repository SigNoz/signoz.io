...
- **Admin access** to both AWS SSO and SigNoz platforms
...
2. **ACS URL**: Enter your SigNoz instance URL (e.g., `https://signoz.example.com/api/v1/complete/saml`)
   - This is where AWS SSO will send authentication responses
