...
<figure data-zoomable align="center">
  <img src="/img/docs/saml-microsoft-entra/entra-add-group-claim.webp" alt="Group Claims panel in Microsoft Entra ID Attributes & Claims" />
  <figcaption><i>Add a group claim and set the source attribute to Group ID</i></figcaption>
</figure>
...
<figure data-zoomable align="center">
  <img src="/img/docs/saml-microsoft-entra/entra-customize-group-claim-name.webp" alt="Advanced options in the Group Claims panel with a customized group claim name" />
  <figcaption><i>Customize the name of the group claim to groups</i></figcaption>
</figure>
...
4. In the **Role Mapping (Advanced)** section:
   ...
   <figure data-zoomable align="center">
     <img src="/img/docs/saml-microsoft-entra/signoz-role-mapping.webp" alt="Role Mapping section in SigNoz Authenticated Domains settings" />
     <figcaption><i>Map Microsoft Entra ID group object IDs to SigNoz roles</i></figcaption>
   </figure>
