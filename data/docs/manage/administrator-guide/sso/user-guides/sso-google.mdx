...
1. Go to **Settings** → **Organization Settings** → **Authenticated Domains**
...
3. In the **Role Mapping** section, configure the following:
   ...
   - **Use Role Attribute**: Turn **ON** to use a role claim directly from the IDP token instead of group-based mapping. Leave **OFF** for group-based role mapping.
4. Click **Save**
