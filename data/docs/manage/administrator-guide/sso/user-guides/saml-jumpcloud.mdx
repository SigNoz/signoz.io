...
2. **ACS URL**: Enter your SigNoz instance URL (e.g., `https://signoz.example.com`)
   ...
   - Should match your SigNoz instance URL with the path `/api/v1/complete/saml` appended to it. For instance, if your SigNoz instance URL is `https://signoz.example.com`, then the ACS URL should be `https://signoz.example.com/api/v1/complete/saml`.
