...
description: Set up SAML 2.0 SSO between Google Workspace and SigNoz so your team can sign in to SigNoz using their existing Google accounts.
doc_type: tutorial
...
- **Google Workspace account** with Super-Admin access to the <a href="https://admin.google.com" target="_blank" rel="noopener noreferrer nofollow">Google Admin console</a>
...
1. Sign in to the <a href="https://admin.google.com" target="_blank" rel="noopener noreferrer nofollow">Google Admin console</a> as a super admin.
