...
SigNoz uses a secret key, set via the `SIGNOZ_JWT_SECRET` environment variable, to sign and verify all user session tokens. **It is critical to set this secret to ensure the security of your SigNoz instance.**
