...
## Version equal to and earlier 0.84.0
...
For now, email configuration does not adhere to the configuration options outlined in the [Configuration Options](#configuration-options) section. They are slated to be deprecated in the future and moved to the new configuration system. See [Issue#6805](https://github.com/SigNoz/signoz/issues/6805) on Github for updates.
