...
<Admonition title="Available from SigNoz v0.112.0" defaultCollapsed={false}>
...
```
<Admonition title="How the root user works" defaultCollapsed={false}>
...
<Admonition title="Existing installs: organization name must match database" defaultCollapsed={false}>
