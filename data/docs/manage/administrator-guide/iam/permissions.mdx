...
Resource kind: `role` | Selector: role name (for example, `my-custom-role`)
...
Resource kind: `serviceaccount` | Selector: service account ID
...
Resource kind: `factor-api-key` | Selector: API key ID
