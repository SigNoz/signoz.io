...
- A role with the required transactions. See the [Transactions Reference](https://signoz.io/docs/manage/administrator-guide/iam/transactions/) for the detailed transactions required for each service account action.
