...
<Figure
  src="/img/docs/service-account/list.webp"
  alt="Service Accounts list page in SigNoz Settings"
  caption="Service Accounts list page"
/>
...
<Figure
  ...
  alt="Key creation success screen showing the one-time key value"
  caption="Copy the key value before closing this dialog"
/>
...
- [SigNoz Operator](https://signoz.io/docs/manage/signoz-operator/overview/) — Use a service account key to manage SigNoz resources from Kubernetes
