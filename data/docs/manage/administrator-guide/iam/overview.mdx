...
**Scope** — Determines which objects a permission applies to. A permission can cover *all* instances of a resource type, or only *specific* instances selected when configuring the role.
