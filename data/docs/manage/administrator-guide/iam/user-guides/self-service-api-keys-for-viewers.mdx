...
<Figure
  src="/img/docs/iam/viewer-service-account-role.webp"
  alt="The viewer-service-account custom role with Service Accounts attach and read scoped to a single service account ID, and list set to All"
  caption="The viewer-service-account role with attach and read scoped to the service account ID"
/>
