...
<Figure
  src="/img/docs/product-features/invite-team-member/invite-team-member-step2.webp"
  alt="Members page with Invite member button in SigNoz"
  caption="Invite new teammates directly from the Members page."
/>
