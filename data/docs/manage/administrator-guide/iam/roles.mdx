...
<Figure
  src="/img/docs/iam/create-role.webp"
  alt="Create role page showing Name, Description, and the Transaction Groups editor in Interactive mode"
  caption="Create a custom role and configure its Transaction Groups"
/>
...
Interactive mode presents one card per resource, such as **Dashboards**, **Roles**, **Service Accounts**, **API Keys**, and the telemetry resources. Use **Expand all** / **Collapse all** to open every card at once. Within a card, set the scope for each action (relation):
...
<Figure
  src="/img/docs/iam/view-role.webp"
  alt="View role page showing description, timestamps, and Transaction Groups in List mode"
  caption="View role page — Transaction Groups preview"
/>
...
<Figure
  src="/img/docs/iam/edit-role.webp"
  alt="Edit role page with an editable description and Transaction Groups, and a Save changes button"
  caption="Edit a custom role — the name is fixed; the description and Transaction Groups are editable"
/>
