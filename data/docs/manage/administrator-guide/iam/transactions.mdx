...
Telemetry resources support only the `read` relation, but their selectors are more expressive than the instance IDs used by IAM resources. A telemetry selector scopes the grant by **query type** and, optionally, by **ingestion key id**:
