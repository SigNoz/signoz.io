...
We have set up a [Demo React application](https://github.com/SigNoz/frontend-monitoring-examples/tree/main/web-vitals) that demonstrates monitoring Core Web Vitals along with traces using OpenTelemetry and sending them to SigNoz.
