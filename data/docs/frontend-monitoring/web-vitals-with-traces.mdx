...
<Admonition type="info">
  If you have already followed the <a href="/docs/frontend-monitoring/sending-traces">Sending Traces from your frontend application</a> guide, you can skip Steps 1 and 2 below and jump straight to <a href="#step-3-capture-and-export-web-vitals">Step 3</a>.
</Admonition>
