...
description: Set up Core Web Vitals monitoring using OpenTelemetry traces in SigNoz. Capture LCP, INP, CLS, FCP, and TTFB per user session with custom RUM attributes for deep debugging.
...
<Tabs entityName="language">
  <TabItem value="ts" label="TypeScript" default>
    ```ts:instrumentation.ts defaultCollapsed
  ...
  <TabItem value="js" label="JavaScript">
    ```js:instrumentation.js defaultCollapsed
    import { OTLPTraceExporter } from '@opentelemetry/exporter-trace-otlp-http';
    import {
      WebTracerProvider,
      BatchSpanProcessor,
...
This configures the OTel Collector to export traces to SigNoz Cloud using the OTLP/HTTP protocol. Read more about OTel Collector configuration [here](https://signoz.io/docs/opentelemetry-collection-agents/opentelemetry-collector/configuration/).
...
<Tabs entityName="language">
  <TabItem value="ts" label="TypeScript" default>
    ```ts:web-vitals.ts minimap defaultCollapsed
  ...
  <TabItem value="js" label="JavaScript">
    ```js:web-vitals.js minimap defaultCollapsed
...
The captured web vitals can be viewed in the [Traces Explorer](https://signoz.io/docs/userguide/traces/). Each `web-vital` trace contains the 5 web vitals as child spans.
...
<Tabs entityName="language">
  <TabItem value="ts" label="TypeScript" default>
    ```ts:custom-span-processor.ts minimap defaultCollapsed
  ...
  <TabItem value="js" label="JavaScript">
    ```js:custom-span-processor.js minimap defaultCollapsed
    import { UAParser } from 'ua-parser-js';
...
<Figure
  ...
  caption="Web Vitals with custom attributes"
/>
...
<Figure
  ...
  caption="Core Web Vitals Monitoring in SigNoz"
/>
...
<Figure
  ...
  caption="Thresholds provide a visual cue about your application's performance"
/>
