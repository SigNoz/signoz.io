...
description: Learn how to auto-instrument your web app to capture document load traces in SigNoz. Identify slow resources, content delivery delays, and page load bottlenecks.
...
You can create **trace-based alerts** by using the **Create an Alert** button at the bottom of the **Traces** section. Alternatively, you can directly create it from the **Alerts** section. To create and manage trace-based alerts, follow [this guide](https://signoz.io/docs/alerts-management/trace-based-alerts/).
