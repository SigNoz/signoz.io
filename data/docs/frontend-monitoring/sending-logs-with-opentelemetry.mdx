...
<Tabs entityName="logs-dependencies">
  <TabItem value="npm" label="Npm">
    ```sh npm install @opentelemetry/resources npm install @opentelemetry/sdk-logs npm install
    @opentelemetry/exporter-logs-otlp-http npm install @opentelemetry/api-logs ```
  </TabItem>
  <TabItem value="yarn" label="Yarn" default>
    ```sh yarn add @opentelemetry/resources yarn add @opentelemetry/sdk-logs yarn add
    @opentelemetry/exporter-logs-otlp-http yarn add @opentelemetry/api-logs ```
  </TabItem>
</Tabs>
