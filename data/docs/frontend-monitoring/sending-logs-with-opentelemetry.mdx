...
description: Learn how to send frontend application logs to SigNoz using OpenTelemetry. Set up browser-side log collection for complete visibility across your full stack.
---
...
<Tabs entityName="language">
  <TabItem value="ts" label="TypeScript">
    ```ts:utils.ts defaultCollapsed minimap
    import {
      logs,
      SeverityNumber,
      type AnyValueMap,
  ...
  <TabItem value="js" label="JavaScript" default>
    ```js:utils.js defaultCollapsed minimap
    import {
      logs,
      SeverityNumber,
    } from '@opentelemetry/api-logs';
...
The captured logs can then be viewed in the [Logs Explorer](https://signoz.io/docs/logs-management/overview/).
...
<Figure
  ...
  caption="Additional Attributes in Logs"
/>
...
```js:error-tracking.js defaultCollapsed minimap
...
These captured logs can then also be viewed in the [Logs Explorer](https://signoz.io/docs/logs-management/overview/).
