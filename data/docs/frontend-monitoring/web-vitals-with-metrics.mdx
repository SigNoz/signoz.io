...
<Admonition>
  **Already sending frontend metrics?** If you've followed the{' '}
  <a href="/docs/frontend-monitoring/sending-metrics">
    Sending Metrics from your frontend application
  </a>{' '}
  guide, you can skip Steps 1 and 2 below as your instrumentation file is already set up. Jump
  straight to <a href="#step-3-capture-and-export-web-vitals">Step 3</a> to add web vitals capture
