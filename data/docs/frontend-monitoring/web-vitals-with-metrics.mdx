...
description: Set up Core Web Vitals monitoring using OpenTelemetry metrics in SigNoz. Ideal for high-traffic apps needing aggregated histograms, percentiles, and trend-based alerting.
...
<Tabs entityName="language">
  <TabItem value="ts" label="TypeScript" default>
    ```ts:instrumentation.ts defaultCollapsed minimap
    import {
      MeterProvider,
  ...
  <TabItem value="js" label="JavaScript">
    ```js:instrumentation.js defaultCollapsed minimap
    import {
      MeterProvider,
      PeriodicExportingMetricReader,
    } from '@opentelemetry/sdk-metrics';
