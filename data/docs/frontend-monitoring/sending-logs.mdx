...
<Tabs entityName="plans" groupId="logs-instrumentation">
  <TabItem value="cloud" label="SigNoz Cloud" default>
    ...
    - Replace `<<INGESTION_REGION>>` with your SigNoz [ingestion key](https://signoz.io/docs/ingestion/signoz-cloud/keys/)
