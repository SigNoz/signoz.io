...
description: Learn how to instrument your frontend app to send traces to SigNoz using OpenTelemetry. Track user interactions, network latency, and end-to-end request performance.
---
...
<Tabs entityName="language">
  <TabItem value="typescript" label="TypeScript" default>
    ```ts:instrumentation.ts minimap defaultCollapsed
  ...
  <TabItem value="javascript" label="JavaScript">
    ```js:instrumentation.js minimap defaultCollapsed
    import { WebTracerProvider } from '@opentelemetry/sdk-trace-web';
    import { BatchSpanProcessor } from '@opentelemetry/sdk-trace-base';
    import { OTLPTraceExporter } from '@opentelemetry/exporter-trace-otlp-http';
    import { FetchInstrumentation } from '@opentelemetry/instrumentation-fetch';
...
The captured traces can then be viewed in the [Traces Explorer](https://signoz.io/docs/userguide/traces/).

<Figure
  src="/img/guides/2025/frontend-monitoring/sending-traces/viewing-traces-explorer.webp"
  alt="Viewing Network Calls"
  caption="Viewing Network Calls"
/>
...
<Figure
  ...
  caption="Viewing Distributed Traces linking frontend and backend"
/>
...
<Tabs entityName="language">
  <TabItem value="typescript" label="TypeScript">
    ```ts:custom-processor.ts minimap defaultCollapsed
  ...
  <TabItem value="javascript" label="JavaScript" default>
    ```js:custom-processor.js minimap defaultCollapsed
    import { UAParser } from 'ua-parser-js';
...
- [Instrument your NodeJs backend for traces](/docs/instrumentation/javascript/opentelemetry-nodejs/)
- [Instrument your Nextjs backend for traces](/docs/instrumentation/javascript/opentelemetry-nextjs/)
