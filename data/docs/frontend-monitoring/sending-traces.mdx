...
The `instrument.ts` file is required to setup the `OTLPTraceExporter` and `WebTracerProvider` which is used to capture traces within your application and export them to your collector.
