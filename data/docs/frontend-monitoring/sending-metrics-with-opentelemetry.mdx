...
<Tabs entityName="metrics-dependencies">
  <TabItem value="npm" label="Npm">
    ```sh npm install @opentelemetry/resources npm install @opentelemetry/sdk-metrics npm install
    @opentelemetry/exporter-metrics-otlp-http npm install @opentelemetry/api ```
  </TabItem>
  <TabItem value="yarn" label="Yarn" default>
    ```sh yarn add @opentelemetry/resources yarn add @opentelemetry/sdk-metrics yarn add
    @opentelemetry/exporter-metrics-otlp-http yarn add @opentelemetry/api ```
  </TabItem>
</Tabs>
...
<Admonition>
  ...
  config file to allow browser requests from your frontend domain. Also, update the endpoint and remove the ingestion key header as shown in <a href="https://signoz.io/docs/ingestion/cloud-vs-self-hosted#cloud-to-self-hosted">Cloud → Self-Hosted</a>.
