...
description: Learn how to instrument your frontend app to send custom metrics to SigNoz using OpenTelemetry. Set up MeterProvider, install dependencies, and export metrics over HTTP.
---
...
```ts:meter.ts minimap defaultCollapsed
import { metrics } from '@opentelemetry/api'
