...
date: 2026-08-09
title: What's Signoz
description: Start with managed SigNoz Cloud, or choose Self-Hosted SigNoz when your team needs to operate the observability platform and its infrastructure.
---

SigNoz Cloud is the managed path. SigNoz operates platform storage, scaling, upgrades, security, and availability. With Self-Hosted SigNoz, your team operates those parts of the platform in its own environment.
