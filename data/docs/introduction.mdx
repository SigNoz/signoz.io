...
date: 2026-08-09
title: What's Signoz
description: SigNoz Cloud is a managed, OpenTelemetry-native observability platform that unifies traces, metrics, and logs. Use Self-Hosted SigNoz when your team wants to operate the platform and its infrastructure.
---

SigNoz Cloud is fully managed. SigNoz operates platform storage, scaling, upgrades, security, and availability. With Self-Hosted SigNoz, your team operates those parts of the platform in its own environment.
...
[Send Logs](https://signoz.io/docs/logs-management/overview/)
...
[AWS Monitoring](https://signoz.io/docs/aws-monitoring/overview/)

[GCP Monitoring](https://signoz.io/docs/gcp-monitoring/bootstrapping/)

[Host Monitoring](https://signoz.io/docs/infrastructure-monitoring/user-guides/hostmetrics/)

[Kubernetes infra metrics and logs](https://signoz.io/docs/opentelemetry-collection-agents/k8s/k8s-infra/install-k8s-infra/)

[Monitor HTTP Endpoints](https://signoz.io/docs/monitor-http-endpoints/)

[OpenTelemetry Binary usage in a VM](https://signoz.io/docs/opentelemetry-collection-agents/vm/install/)
