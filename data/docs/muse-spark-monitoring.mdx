...
If you already run an [OpenTelemetry Collector](https://signoz.io/docs/opentelemetry-collection-agents/get-started/), point the application at it with `OTEL_EXPORTER_OTLP_ENDPOINT=http://localhost:4318` and configure the Collector's OTLP exporter with your SigNoz endpoint and ingestion key.
