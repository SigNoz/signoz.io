...
meta_title: Jenkins Tracing - Instrument with OpenTelemetry
description: Learn how to instrument Jenkins with the OpenTelemetry plugin and send pipeline traces to SigNoz, using plugin installation, OTel Collector config, and trace visualization.
---
...
<Figure
  ...
  caption="Jenkins OTel plugin configuration for Self-Hosted SigNoz"
/>
...
You can use the [trace explorer](https://signoz.io/docs/userguide/traces/) to filter and analyze your traces.

<Figure
  src="/img/docs/cicd/jenkins/jenkins-traces.webp"
  alt="Jenkins pipelines traces on SigNoz UI"
  caption="Jenkins pipelines traces on SigNoz UI"
/>
