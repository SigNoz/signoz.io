...
meta_title: Jenkins Agent Node Monitoring Guide
description: Monitor Jenkins build agent metrics in SigNoz using the OpenTelemetry Agent Metrics plugin. Learn to configure node exporters and view agent metrics in real-time.
---
...
<Figure
  ...
  caption="Jenkins agent metrics on SigNoz"
/>
...
<Figure
  ...
  caption="Node cpu metrics on SigNoz"
/>
