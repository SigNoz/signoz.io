...
meta_title: Monitor ArgoCD Metrics with OpenTelemetry
description: Learn how to monitor ArgoCD metrics in SigNoz using the OpenTelemetry Prometheus receiver. Includes OTel Collector config and pre-built dashboard setup.
doc_type: howto
---
