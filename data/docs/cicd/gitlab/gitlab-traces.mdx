...
meta_title: Monitor GitLab Pipeline Traces with OTel
description: Collect GitLab CI/CD pipeline traces using the OpenTelemetry GitLab Receiver and send them to SigNoz. Includes webhook setup and pipeline-to-trace conversion.
doc_type: howto
---
...
```yaml:gitlab-otel-collector.yaml minimap defaultCollapsed
apiVersion: v1
kind: Secret
metadata:
...
- [Explore the Traces view](https://signoz.io/docs/userguide/traces/) to filter and analyze pipeline runs.
