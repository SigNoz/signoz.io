...
🐳 If you're using Kubernetes or Linux for hosting SigNoz, consider running a separate OTel Collector for GitHub by following this [link](https://opentelemetry.io/docs/collector/installation/) along with [SigNoz Setup](https://signoz.io/docs/install/).

⚙️ Following setup is based on [DockerCompose](https://signoz.io/docs/install/docker/#install-signoz-using-docker-compose).
</Admonition>
