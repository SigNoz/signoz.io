...
title: How to Set Up Alert Notification Channels
description: Configure notification channels in SigNoz to send alerts to Slack, PagerDuty, MS Teams, email, and other destinations.
doc_type: howto
---
