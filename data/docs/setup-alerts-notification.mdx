...
To configure the appropriate notification channel, navigate to the Alert Channel settings (`Settings -> Notification Channels`). This section contains a list of available channels that you have created.
