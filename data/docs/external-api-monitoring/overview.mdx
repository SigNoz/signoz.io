...
External API Monitoring leverages OpenTelemetry <a href="https://opentelemetry.io/docs/concepts/semantic-conventions/" rel="noopener noreferrer nofollow" target="_blank">semantic conventions</a> to automatically detect and categorize external API calls from your instrumented services. The 
...
4. Here you can view the p99 latency metrics in the Status Code Breakdown table

The Status Code Breakdown table (described in the [Status Code Breakdown](#status-code-breakdown) section above) displays p99 latency for each status code, giving you quick insights into latency patterns.

### Method 2: Using Traces Explorer

For more advanced latency analysis:
...
4. Group by your preferred parameter (e.g., service name, endpoint)
5. Save this view for easier future access

For more information about `kind_string` values and usage, refer to the <a href="https://signoz.io/docs/userguide/writing-clickhouse-traces-query/" rel="noopener noreferrer nofollow" target="_blank">ClickHouse traces query documentation</a> and the <a href="https://opentelemetry.io/docs/specs/otel/trace/api/#spankind" rel="noopener noreferrer nofollow" target="_blank">OpenTelemetry span specifications</a>.

## Related Resources

- <a href="https://www.youtube.com/watch?v=ODUFMrfPdpI" rel="noopener noreferrer nofollow" target="_blank">API Monitoring Launchweek video</a>
- <a href="https://www.youtube.com/watch?v=4NnMcks62YY" rel="noopener noreferrer nofollow" target="_blank">API Monitoring Demo</a>
