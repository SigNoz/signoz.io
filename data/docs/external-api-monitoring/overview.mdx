...
<figure data-zoomable align='center'>
    <img src="/img/docs/external-api-monitoring/external-endpoints-tab.gif" alt="Endpoint(s) Stats Tab"/>
...
<figure data-zoomable align='center'>
    <img src="/img/docs/external-api-monitoring/endpoint-domain-details.gif" alt="Endpoint/Domain Details"/>
