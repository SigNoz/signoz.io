...
description: Reference for calculated fields automatically derived from OpenTelemetry span attributes, including HTTP status codes, URLs, methods, and RPC metadata.
---
