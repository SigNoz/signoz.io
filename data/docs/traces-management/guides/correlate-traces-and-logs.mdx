...
2. Open **Traces** in SigNoz and click any trace to open the [Trace Details](https://signoz.io/docs/userguide/span-details/) page
3. Click any span in the waterfall to open the Span Details panel, then switch to the **Logs** tab — the panel shows context logs for the selected span and includes a link to open them in the [Logs Explorer](https://signoz.io/docs/userguide/logs/)
...
### Span Details "Logs" tab shows no results
