...
Auto-instrumentation is available for these languages - [Java, .NET, Python, Go, Node.js, and PHP](https://signoz.io/docs/instrumentation/) and we should hyperlink to this doc for auto-instrumenting your application.
