...
description: Learn how to scrub PII from traces using the OpenTelemetry Collector transform processor. Remove sensitive attributes like IP addresses before they reach SigNoz.
doc_type: howto
---
...
Set up OTel Collector to send traces to SigNoz if you have not already. The OTel Collector allows you to process, transform, and scrub sensitive data before it reaches SigNoz. Checkout [SigNoz OTel Collector setup guide](https://signoz.io/docs/opentelemetry-collection-agents/get-started/) to get started with OTel Collector.
...
For a full reference on OTTL syntax, contexts, and functions, see [OTTL Reference](https://signoz.io/docs/opentelemetry-collection-agents/opentelemetry-collector/ottl/). Learn more about the transform processor in the <a href="https://github.com/open-telemetry/opentelemetry-collector-contrib/blob/main/processor/transformprocessor/README.md" target="_blank" rel="noopener noreferrer nofollow">upstream README</a>.
