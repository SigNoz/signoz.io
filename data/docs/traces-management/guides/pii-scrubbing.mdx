...
Traces often come with a lot of data, attributes which may include sensitive information, and needs to be treated before they're stored to comply with regulations like GDPR and CCPA. SigNoz simplifies this process by making use of OpenTelemetry's Processors. This guide explains how you can set up an OpenTelemetry Collector to scrub PII data.

## Prerequisites

* [SigNoz Cloud](https://signoz.io/teams/) account
* Traces from an application

## Send application traces to SigNoz

You need to configure OpenTelemetry Collector to send your application's traces to SigNoz. Checkout [this documentation](https://signoz.io/docs/instrumentation/) for detailed instructions to instrument an application.
...
To learn more about the transform processor, checkout [this documentation](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/main/processor/transformprocessor).
