...
2. At the collector with help of processors

### At the application

Dropping spans at the application is often referred to as HEAD sampling because the sampling decision is made at the beginngin of the trace.
...
<Admonition>
Dropping individual spans at the collector can lead to brocken traces.
</Admonition>
