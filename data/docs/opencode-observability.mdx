...
description: Learn how to set up OpenCode observability and monitoring using OpenTelemetry and SigNoz. Track traces, logs, and metrics from AI coding sessions to optimize performance and debug issues.
doc_type: howto
---
...
The steps below walk you through installing and configuring OpenTelemetry for OpenCode to export traces, logs, and metrics to SigNoz.
