...
description: Learn how to monitor OpenCode using OpenTelemetry and SigNoz. Track coding sessions, tool calls, and token usage with real-time traces, logs, and metrics to optimize your AI-assisted development workflow.
doc_type: howto
---
