...
description: Step-by-step guides for upgrading your self-hosted SigNoz installation, including required upgrade stops, release cycles, and the upgrade path tool.
---
