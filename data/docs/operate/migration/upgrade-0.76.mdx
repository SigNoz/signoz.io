...
description: With v0.76.0, we've consolidated multiple services (Query Service, Frontend, and Alertmanager) into a single binary/image called signoz.
---
...
### Upgrading
Follow the standard [upgrade procedure](https://signoz.io/docs/operate/migration/upgrade-standard/#docker-standalone). 
...
### Upgrading
Follow the standard [upgrade procedure](https://signoz.io/docs/operate/migration/upgrade-standard/#docker-swarm-cluster). 
