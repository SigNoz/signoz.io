...
If you don't need to preserve your SQLite data, you can skip the migration steps and directly upgrade the helm release along with deleting the old volumes.
</Admonition>
