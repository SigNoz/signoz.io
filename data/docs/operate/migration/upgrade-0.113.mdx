...
<Admonition title="What changed in v0.113" defaultCollapsed={false}>
...
<Admonition title="Using default Docker Compose files?" defaultCollapsed={false}>
...
<Admonition title="Using the default Helm chart?" defaultCollapsed={false}>
