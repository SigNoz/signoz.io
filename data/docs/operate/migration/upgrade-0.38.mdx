...
If you are using SigNoz version prior to v0.36 please make sure that migration [v0.36](/docs/operate/migration/upgrade-0.36.md) is successful before running this.
