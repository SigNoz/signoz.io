...
<Tabs>
<TabItem value="v0.112+" label="v0.112 and later" default>
...
Starting with v0.112, the `schema-migrator` service is replaced by `telemetrystore-migrator` which uses the `signoz/signoz-otel-collector` image. See the [v0.112 upgrade guide](https://signoz.io/docs/operate/migration/upgrade-0.112/) for migration steps.
</Admonition>

</TabItem>
<TabItem value="before-v0.112" label="Before v0.112">
...
<TabItem value="v0.112+" label="v0.112 and later" default>
   ...
   Starting with v0.112, migrations are built into `signoz-otel-collector`. The separate `signoz-schema-migrator` binary is no longer needed. See the [v0.112 upgrade guide](https://signoz.io/docs/operate/migration/upgrade-0.112/) for details.
