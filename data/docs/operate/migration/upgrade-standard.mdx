...
Starting with v0.113, the `schema-migrator` service is replaced by `telemetrystore-migrator` which uses the `signoz/signoz-otel-collector` image. See the [v0.113 upgrade guide](https://signoz.io/docs/operate/migration/upgrade-0.113/) for migration steps.
</Admonition>
