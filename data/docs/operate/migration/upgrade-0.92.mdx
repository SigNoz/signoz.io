...
SigNoz `v0.92.0` introduces two major improvements that enhance both the user experience and system architecture. 

The release features the new Query Builder v5 (QBv5) with expression-based querying and intelligent auto-completion, providing enhanced user experience with a streamlined interface, improved performance and reliability. Complete documentation is available at the [Query Builder v5 Guide](https://signoz.io/docs/userguide/query-builder-v5/). 

Additionally, SigNoz has migrated to a modernized Cobra CLI structure that simplifies command organization, provides a better help system, and improves maintainability and extensibility (related to [GitHub issue #6805](https://github.com/SigNoz/signoz/issues/6805)).
