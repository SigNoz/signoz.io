...
description: This setup assumes you've installed SigNoz version >=0.60.0 && <v0.64 and have kept it running for at least 15 days (the default retention period).
---
