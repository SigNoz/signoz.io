...
description: With v0.88.0 upgrade, SigNoz is migrating from normalized, underscore-based metric names (such as system_memory_usage) to unnormalized, dot-based metric...
---
