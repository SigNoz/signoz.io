...
SigNoz follows a regular schedule for new releases, with additional bug fixes and security patches as needed.

| Release Type         | Frequency                | Example Versions         | Notes                                                      |
|----------------------|-------------------------|-------------------------|------------------------------------------------------------|
| Minor Release        | Every Wednesday         | v0.87.0, v0.88.0        | New features, improvements, and breaking changes |
| Bug Fix / Patch      | As needed (not scheduled)| v0.87.1, v0.87.2        | Released after minor releases for urgent fixes or security patches |

- **Minor releases** are published weekly, usually every Wednesday.
- **Bug fixes and security patches** are released as necessary and do not follow a fixed timetable.
...
|----------|---------------------|-------------------------------------------------------------------------|------------------------------------------------------------------------------|
| v0.90.1  | July 16, 2025       | Patch release for bug fixes                                             | [GitHub Release](https://github.com/SigNoz/signoz/releases/tag/v0.90.1)      |
| v0.90.0  | July 16, 2025       | Bug fixes and improvements                                              | [GitHub Release](https://github.com/SigNoz/signoz/releases/tag/v0.90.0)      |
| v0.89.0  | July 9, 2025        | Deprecation of Clickhousemetricswrite exporter, bug fixes, improvements | [GitHub Release](https://github.com/SigNoz/signoz/releases/tag/v0.89.0)      |
| v0.88.1  | July 2, 2025        | Patch release for bug fixes                                             | [GitHub Release](https://github.com/SigNoz/signoz/releases/tag/v0.88.1)      |
| v0.88.0  | July 2, 2025        | Dot Metrics Migration, breaking changes to metrics exporter              | [GitHub Release](https://github.com/SigNoz/signoz/releases/tag/v0.88.0)      |
| v0.87.0  | June 11, 2025       | Minor release: new features and improvements                            | [GitHub Release](https://github.com/SigNoz/signoz/releases/tag/v0.87.0)      |

> For a full list of releases, see the [SigNoz Releases](https://github.com/SigNoz/signoz/releases) page or the [changelog page](https://signoz.io/changelog)
