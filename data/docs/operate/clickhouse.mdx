...
date: 2024-06-06
title: ClickHouse
description: Operate and manage the ClickHouse database used by SigNoz, including connecting, scaling persistent volumes, distributed setup, and external instances.
---
