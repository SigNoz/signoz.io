...
meta_title: Collect EC2 Application & Server Logs
description: Discover how to collect EC2 application and server logs by configuring the OpenTelemetry filelog receiver for centralized log analysis.
doc_type: howto
---
...
This guide assumes you have already installed the OpenTelemetry Collector on your EC2 instance. If not, see [Install OpenTelemetry Collector on VM](https://signoz.io/docs/opentelemetry-collection-agents/vm/install/).
</Admonition>
