...
description: Learn to collect EC2 host CPU, memory, disk, and network metrics using the OpenTelemetry Hostmetrics receiver for real-time infrastructure monitoring.
doc_type: howto
---
...
Follow the **[Install OpenTelemetry Collector on VM](https://signoz.io/docs/opentelemetry-collection-agents/vm/install/)** guide.
...
- [Hostmetrics Configuration Guide](https://signoz.io/docs/infrastructure-monitoring/user-guides/hostmetrics/) – Complete hostmetrics setup instructions
