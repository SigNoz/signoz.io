...
description: Learn how to collect Elastic Load Balancer (ELB) logs from AWS S3 and forward them to SigNoz using AWS Lambda for monitoring and visualization.
doc_type: howto
---
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/elb/elb-logs-create_bucket_2.webp" alt="S3 bucket creation form"/>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image"  src="/img/docs/elb/elb-logs-lambda_1.webp" alt="Create Lambda function from AWS Console"/>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/elb/elb-logs-lambda_2.webp" alt="Lambda function creation with Author from scratch selected"/>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/elb/elb-logs-lambda_3.webp" alt="Lambda runtime and role configuration"/>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/elb/elb-logs-lambda_4.webp" alt="Lambda function created successfully"/>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/elb/elb-logs-lambda_5.webp" alt="Lambda function Configuration tab showing Permissions section"/>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/elb/elb-logs-lambda_6.webp" alt="IAM page showing Add permissions dropdown with Attach policies option"/>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/elb/elb-logs-lambda_8.webp" alt="Lambda function console showing Add trigger button"/>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/elb/elb-logs-lambda_9.webp" alt="S3 trigger configuration showing event type selection dropdown"/>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/elb/elb-logs-lambda_10.webp" alt="Lambda function code editor showing the ELB log forwarding code"/>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/elb/elb-logs-lambda_12.webp" alt="SigNoz Logs Explorer showing ELB logs with parsed fields"/>
    <figcaption><i>A sample ELB log line in SigNoz Logs Explorer</i></figcaption>
</figure>

## Next Steps

- [Create alerts](https://signoz.io/docs/alerts/) based on your ELB logs to monitor for errors or unusual traffic patterns
- [Build dashboards](https://signoz.io/docs/userguide/manage-dashboards/) to visualize your load balancer metrics and access patterns
