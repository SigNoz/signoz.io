...
description: Discover how to track SNS published messages, deliveries, and failures using one-click or manual CloudWatch integration for reliable notifications.
doc_type: howto
---
...
```yaml:sns-metrics.yaml defaultCollapsed
region: <aws-region>
metrics:
