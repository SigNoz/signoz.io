...
<Figure
  ...
  alt="SigNoz Traces Explorer filtered on service.name my-microvm-app, listing handle-request and run-user-code spans from a Lambda MicroVM"
  caption="Traces Explorer filtered on the service name you set in Step 3"
/>

<Figure
  src="/img/docs/aws-monitoring/lambda-microvms/microvm-trace-detail.webp"
  alt="SigNoz trace detail view showing a MicroVM span with aws.lambda.microvm.image_name and aws.lambda.microvm.image_version resource attributes"
  caption="Span details for a MicroVM trace, showing the MicroVM resource attributes"
/>
