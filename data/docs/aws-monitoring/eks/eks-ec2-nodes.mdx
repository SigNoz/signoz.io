...
Create an `override-values.yaml` file with EKS-specific configuration:
...
- `<CLUSTER_NAME>`: Name of your EKS cluster or a unique identifier.
...
- `{region}`: Your [SigNoz Cloud region](https://signoz.io/docs/ingestion/signoz-cloud/overview/#endpoint) (e.g., `us`, `eu`, `in`).

For complete installation instructions with all configuration options, see the [K8s-Infra Installation Guide](https://signoz.io/docs/opentelemetry-collection-agents/k8s/k8s-infra/install-k8s-infra/).
...
- [Kubernetes Dashboards](https://signoz.io/docs/dashboards/dashboard-templates/kubernetes-dashboards/) – Import pre-built dashboards for your EKS cluster.
- [Monitor Multiple K8s Clusters](https://signoz.io/docs/opentelemetry-collection-agents/k8s/k8s-infra/user-guides/k8s-infra-multi-cluster/) – Set up monitoring for multiple clusters.
