...
description: Learn to deploy K8s-Infra Helm chart on EKS EC2 nodes to collect pod logs, node metrics, and Kubernetes events for complete cluster visibility.
doc_type: howto
---
