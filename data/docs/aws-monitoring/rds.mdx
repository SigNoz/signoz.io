...
Follow the <a href="https://signoz.io/docs/integrations/aws/aws-rds/" target="_blank" rel="noopener noreferrer">One-Click AWS Integrations Guide</a> to:
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/rds-docs/create_function.webp" alt="Lambda function creation form with Author from scratch option selected"/>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/rds-docs/lambda_function.webp" alt="Newly created Lambda function overview page"/>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/rds-docs/execution_role.webp" alt="Lambda function Configuration tab showing Permissions section"/>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/rds-docs/attach_policy.webp" alt="IAM page showing Add permissions dropdown with Attach policies option"/>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/rds-docs/add_trigger_2.webp" alt="Lambda function console showing Add trigger button"/>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/rds-docs/add_trigger.webp" alt="S3 trigger configuration showing event type selection dropdown"/>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/elb/elb-logs-lambda_10.webp" alt="Lambda function code editor showing the RDS log forwarding code"/>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/elb/elb-logs-lambda_12.webp" alt="SigNoz Logs Explorer showing RDS logs with parsed fields"/>
    <figcaption><i>A sample RDS log line in SigNoz Logs Explorer</i></figcaption>
</figure>
