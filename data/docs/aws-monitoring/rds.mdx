...
Follow the <a href="https://signoz.io/docs/integrations/aws/aws-rds/" rel="noopener noreferrer">One-Click AWS Integrations Guide</a> to:
...
### Option 1: CloudWatch Exporter + PostgreSQL/MySQL Receiver (Recommended)

This approach collects both CloudWatch metrics and native database metrics using OpenTelemetry.

**For PostgreSQL RDS:**
See the complete guide: <a href="https://signoz.io/docs/integrations/aws-rds-postgres/" rel="noopener noreferrer">AWS RDS PostgreSQL Integration</a>

**For MySQL RDS:**
See the complete guide: <a href="https://signoz.io/docs/integrations/aws-rds-mysql/" rel="noopener noreferrer">AWS RDS MySQL Integration</a>
...
For Self-Hosted SigNoz, follow the same steps as above but update the endpoint:

```python
http_url = 'http://<YOUR_SIGNOZ_HOST>:4318/v1/logs'
```

Remove the `signoz-ingestion-key` header as it's not required for self-hosted deployments.
...
- <a href="https://signoz.io/docs/integrations/aws-rds-postgres/" rel="noopener noreferrer">AWS RDS PostgreSQL Integration</a>
- <a href="https://signoz.io/docs/integrations/aws-rds-mysql/" rel="noopener noreferrer">AWS RDS MySQL Integration</a>
