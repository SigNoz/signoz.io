...
description: Learn to track RDS database CPU, connections, IOPS, and logs using one-click or manual CloudWatch Exporter setup for optimal database performance.
doc_type: howto
---
...
Aurora runs as a cluster and reports metrics for the cluster as well as for each instance. Follow [Monitor Amazon Aurora](https://signoz.io/docs/integrations/aws-rds-aurora/) to collect both, together with the Aurora engine metrics.
</Admonition>
...
- [Amazon Aurora Metrics and Logs](https://signoz.io/docs/integrations/aws-rds-aurora/)
