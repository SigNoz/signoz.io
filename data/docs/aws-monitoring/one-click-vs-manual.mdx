...
See the <a href="https://signoz.io/docs/integrations/aws/one-click-aws-integrations/" rel="noopener noreferrer">One-Click AWS Integrations Guide</a> for setup instructions.
...
*Actual AWS bills depend heavily on number of metrics, resolution, enabled logs, and region. Use [AWS Pricing Calculator](https://calculator.aws/) for exact estimates. [View AWS pricing docs](https://aws.amazon.com/pricing/).*
