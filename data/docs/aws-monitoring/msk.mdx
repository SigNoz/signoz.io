...
description: Learn to track MSK Kafka broker health, throughput, and consumer lag via one-click or manual CloudWatch Exporter setup for reliable streaming.
doc_type: howto
---
