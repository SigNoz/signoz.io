...
description: Learn to track DynamoDB capacity, throttling, and latency via one-click or manual CloudWatch Exporter setup to optimize database performance.
doc_type: howto
---
...
```yaml:dynamodb-metrics.yaml defaultCollapsed
region: <aws-region>
metrics:
