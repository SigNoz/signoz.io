...
description: Learn to collect Elastic Load Balancer metrics and S3 access logs using CloudWatch Exporter and Lambda forwarders for complete traffic insights.
doc_type: howto
---
...
```yaml:elb-metrics.yaml defaultCollapsed minimap
region: <aws-region>
metrics:
