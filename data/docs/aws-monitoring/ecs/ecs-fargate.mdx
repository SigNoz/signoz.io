...
meta_title: ECS Fargate Monitoring - Sidecar Setup Guide
description: Learn to deploy OpenTelemetry sidecars in ECS Fargate tasks to collect container metrics, application traces, and logs in serverless workloads.
doc_type: howto
---
