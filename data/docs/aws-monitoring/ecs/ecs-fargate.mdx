...
For complete setup instructions, follow the [ECS Sidecar Installation Guide](https://signoz.io/docs/userguide/collecting-ecs-sidecar-infra/).
...
- **Metrics**: Import the [ECS Container Metrics Dashboard](https://github.com/SigNoz/dashboards/raw/main/ecs-infra-metrics/container-metrics.json)
- **Traces**: Navigate to **Services** tab to see your instrumented applications

## Next Steps

- [ECS Sidecar Installation Guide](https://signoz.io/docs/userguide/collecting-ecs-sidecar-infra/) – Complete sidecar setup instructions
- [Send Traces from Applications](https://signoz.io/docs/userguide/collecting-ecs-sidecar-infra/#send-traces-data-from-applications) – Configure application instrumentation
- [Send Logs from Applications](https://signoz.io/docs/userguide/collecting-ecs-sidecar-infra/#send-logs-data-from-applications) – Configure Fluent Bit log routing
