...
description: Learn to deploy a daemon service across ECS clusters to collect host metrics, container logs, and OTLP telemetry from EC2 and external nodes.
doc_type: howto
---
...
For complete setup instructions, see the [ECS Daemon Service Guide](https://signoz.io/docs/opentelemetry-collection-agents/ecs/ec2/install/).
