...
Replace `<region>` in the URL with your SigNoz Cloud region (`us`, `eu`, or `in`). You can find ingestion details (REGION and SIGNOZ_INGESTION_KEY) in the SigNoz dashboard.
