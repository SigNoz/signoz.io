...
<Admonition type="tip">
**SigNoz Cloud users**: You can also use the <a href="https://signoz.io/docs/integrations/aws/aws-lambda/" target="_blank" rel="noopener noreferrer">One-Click AWS Integration</a> for automated setup with pre-built dashboards. This supports both **Logs and Metrics**. See the <a href="https://signoz.io/docs/aws-monitoring/one-click-vs-manual/" rel="noopener noreferrer">comparison guide</a> to choose the best approach.
</Admonition>
