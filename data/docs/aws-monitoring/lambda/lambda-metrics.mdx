...
description: Learn to collect Lambda metrics like invocations, duration, errors, and throttles via CloudWatch Exporter for serverless performance visibility.
doc_type: howto
---
...
```yaml:lambda-metrics.yaml defaultCollapsed
region: <aws-region>
metrics:
...
- **Monitor Lambda MicroVMs** if you also run Firecracker sandboxes. See [Monitor AWS Lambda MicroVMs](https://signoz.io/docs/aws-monitoring/lambda-microvms/).
