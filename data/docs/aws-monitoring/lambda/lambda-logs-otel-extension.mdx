...
meta_title: AWS Lambda Logs Collection via OTel Collector
description: Learn to send Lambda logs to SigNoz using the OpenTelemetry Collector extension layer for code-free, low-latency log forwarding via Telemetry API.
doc_type: howto
---
