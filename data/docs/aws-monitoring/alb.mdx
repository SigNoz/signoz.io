...
Follow the [One-Click AWS Integrations Guide](https://signoz.io/docs/integrations/aws/aws-alb/) to:
...
See [ELB Logs](https://signoz.io/docs/aws-monitoring/elb-logs/) for the detailed S3 Lambda Forwarder setup.
...
- **Collect access logs** for detailed request analysis. See [ELB Logs](https://signoz.io/docs/aws-monitoring/elb-logs/).
