...
description: Learn to track Application Load Balancer request count, latency, and HTTP errors via one-click or manual CloudWatch setup for better app visibility.
doc_type: howto
---
...
```yaml:alb-metrics.yaml defaultCollapsed minimap
region: <aws-region>
metrics:
