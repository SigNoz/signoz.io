...
description: Discover how to track API latency, errors, and request counts using one-click or manual CloudWatch integration for real-time API performance insights.
doc_type: howto
---
...
```yaml:api-gateway-metrics.yaml defaultCollapsed
region: <aws-region>
metrics:
