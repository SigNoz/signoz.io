...
<Admonition type="warning" title="The ingestion key has no settings key, so the environment variable is the only route" defaultCollapsed="true">
...
<Admonition type="warning" title="Every hook span reports an error, even on a healthy install" defaultCollapsed="true">
...
<Admonition type="warning" title="Do not count tool calls across both tool span names" defaultCollapsed="true">
...
<Admonition type="warning" title="logPrompts writes your prompt text to your backend" defaultCollapsed="true">
