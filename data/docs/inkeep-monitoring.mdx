...
1. Go to **Settings → Service Accounts** and create a new service account.
2. In the **Overview** tab, assign a role — **Viewer** is sufficient for observability.
3. Go to the **Keys** tab and click **Add Key**.
4. Set the expiration field to "No Expiry" to prevent the key from expiring.
...
- Replace `<YOUR_SERVICE_ACCOUNT_KEY>` with your SigNoz API Key.
