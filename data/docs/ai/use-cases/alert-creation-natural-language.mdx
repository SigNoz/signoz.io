...
meta_title: Create Alerts with Natural Language
description: Describe your alerting needs in plain English and let AI assistants generate production-ready SigNoz alerts for new services via the MCP server.
doc_type: howto
---
