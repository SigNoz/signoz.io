...
meta_title: Optimize Dev Performance with AI Traces
description: Profile request paths during development using AI and SigNoz MCP to detect performance overhead in traces before code ever reaches production.
doc_type: howto
---
