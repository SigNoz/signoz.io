...
meta_title: Trace Failing Requests End-to-End with AI
description: Debug a failed request directly from your IDE using AI and SigNoz MCP to get the full trace with span breakdown and error logs without context switching.
doc_type: howto
---
