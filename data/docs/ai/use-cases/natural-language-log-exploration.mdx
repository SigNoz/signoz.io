...
meta_title: Natural Language Log Exploration with AI
description: Search, filter, and analyze SigNoz logs by asking questions in plain English via AI assistants and the MCP server — no query syntax required.
doc_type: howto
---
...
- Make sure your services are sending logs to SigNoz. See [Send Logs to SigNoz](https://signoz.io/docs/userguide/logs_query_builder/) if you haven't set this up.
