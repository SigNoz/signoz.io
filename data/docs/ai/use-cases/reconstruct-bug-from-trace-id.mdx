...
meta_title: Reconstruct Bug from Trace ID with AI
description: Paste a trace ID from a support ticket and get a full request path reconstruction with root cause analysis using AI and the SigNoz MCP server.
doc_type: howto
---
