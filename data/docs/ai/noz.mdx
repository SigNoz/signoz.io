...
- **Noz** is the AI teammate inside the SigNoz UI. Reach for it when you are already in SigNoz and want to explore data, understand a dashboard, or triage an incident without writing queries.
