...
A new conversation opens with starter prompts so you don't have to think of one. These are customized to your SigNoz instance, so they reference the services, alerts, and infrastructure you're actually running. Click any of them to run it instantly:

- *Show me the top errors in the last hour*
- *What services have the highest latency?*
- *Give me an overview of system health*
- *Create a dashboard for my checkout service*
- *Set up an alert when error rate goes above 5%*
