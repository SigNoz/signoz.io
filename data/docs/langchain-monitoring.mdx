...
tags : [SigNoz Cloud]
title: Monitoring LangChain/LangGraph Telemetry with SigNoz
description: Enable telemetry in your LangChain and LangGraph application with OpenTelemetry and send traces, logs, and metrics to SigNoz
---
...
You can instrument your LangChain applications in JavaScript using the [OpenInference LangChain Instrumentor](https://www.npmjs.com/package/@arizeai/openinference-instrumentation-langchain) package.
