...
To get started, check out our example LangChain trip planner agent with OpenTelemetry-based monitoring (via OpenInference). View the full repository [here](https://github.com/SigNoz/langchain-monitoring-demo).
