...
- [OpenCode observability with OpenTelemetry](https://signoz.io/docs/opencode-observability/) - another agent that instruments through a plugin rather than natively
...
- [Grok Build observability with OpenTelemetry](https://signoz.io/docs/grok-build-observability/) - token usage, tool activity, and startup latency from its native exporter
