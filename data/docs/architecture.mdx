...
SigNoz is central nervous system of our observability platform. It is a bundled service that includes:

- **UI**: A statically built ReactJS application that provides intuitive visualization of telemetry data
- **Apiserver**: Interfaces with ClickHouse to query and process observability data
