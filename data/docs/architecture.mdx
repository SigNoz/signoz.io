...
- **OpAMP**: Runs an OpAMP server which dynamically configures log pipelines in the SigNoz OTelcollector. See [OpAMP - Remote Collector Management](https://signoz.io/docs/opentelemetry-collection-agents/opentelemetry-collector/opamp/) for how it works.
