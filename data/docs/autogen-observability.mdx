...
title: AutoGen Observability with SigNoz
description: Observability and monitoring for AutoGen performance and usage with OpenTelemetry instrumentation to send traces, logs, and metrics to SigNoz
---
...
- [AutoGen](https://microsoft.github.io/autogen/stable//index.html) integration
...
> 📌 Note: SystemMetricsInstrumentor provides system metrics (CPU, memory, etc.), and HTTPXClientInstrumentor provides outbound HTTP request metrics such as request duration. If you want to add custom metrics to your AutoGen application, see [Python Custom Metrics](https://signoz.io/opentelemetry/python-custom-metrics/).
