...
<figure data-zoomable align='center'>
    <img src="/img/docs/cost-meter/billing-settings.webp" alt="Settings → Billing page showing per-unit prices for logs, traces, and metrics"/>
    <figcaption><i>Settings → Billing</i></figcaption>
</figure>
