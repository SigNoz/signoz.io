...
3. Move into [Meter Explorer](/docs/cost-meter/meter-explorer/) when you need more detailed breakdowns by service, environment, host, or ingestion key.
4. Set up [Meter Alerts](/docs/cost-meter/alerts/) when you want to monitor a threshold instead of checking the dashboard manually.
