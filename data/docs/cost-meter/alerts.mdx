---
date: 2026-08-06
title: Meter Alerts - Set Up Observability Cost Alerts
description: Set up proactive cost alerts in SigNoz to monitor spend on logs, traces, and metrics. Get notified before budgets are exceeded with service- and signal-level alerting.
doc_type: howto
---
...
- Set the **evaluation window**. You can choose between two modes:
  ...
  <Admonition type="info">
    ...
    The [display timezone](https://signoz.io/docs/manage/timezone/) that you select in the time
    range picker does not change these windows.
  </Admonition>
