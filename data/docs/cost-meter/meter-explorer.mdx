...
<figure data-zoomable align="center">
  <img src="/img/docs/cost-meter/meter-explorer/meter-explorer.webp" alt="Meter Explorer showing log count rate filtered by deployment environment and service name" />
  <figcaption><i>Meter Explorer query interface with filters, aggregation options, and time series chart</i></figcaption>
</figure>
...
<figure data-zoomable align="center">
  <img src="/img/docs/cost-meter/meter-explorer/meter-labels.webp" alt="Metric labels dropdown showing available dimensions for grouping" />
  <figcaption><i>Available metric labels for grouping and filtering meter data</i></figcaption>
</figure>
...
For more details on creating and managing saved views, see the [Saved View documentation](https://signoz.io/docs/product-features/saved-view/#how-to-use-saved-views).
