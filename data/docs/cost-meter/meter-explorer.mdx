...
- Try common queries in the [Meter Examples](https://signoz.io/docs/cost-meter/meter-examples/) guide.
...
- View the [Cost Meter Dashboard](https://signoz.io/docs/cost-meter/working-with-cost-meter/overview/) for a high-level overview of your ingestion costs.
