...
- **Understanding of Metrics**: Familiarity with how metrics work in SigNoz. You can learn more about metrics in our [Metrics Management Guide](https://signoz.io/docs/metrics-management/types-and-aggregation/).
