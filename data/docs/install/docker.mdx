...
<a href="https://github.com/SigNoz/foundry" target="_blank" rel="noopener noreferrer nofollow">Foundry</a> generates the Docker Compose deployment from a single casting file and runs it for you.
