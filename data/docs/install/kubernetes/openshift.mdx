...
### SCCs for the SigNoz Installation

We need to define the following SCC for supporting the running signoz on OC:
...
## (Optional) Add the SCCs for running K8s-Infra (Kubernetes Monitroing)
