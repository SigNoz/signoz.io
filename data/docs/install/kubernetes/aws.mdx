...
import InstallSigNozPart2 from '@/components/shared/install-signoz-k8s-part-2.md'
import VerifyInstallation from '@/components/shared/k8s-verify-installation.md'
import K8sHotrod from '@/components/shared/k8s-hotrod.md'
import NextSteps from '@/components/shared/next-steps.md'
import StorageClass from '@/components/shared/k8s-storageclass.md'
