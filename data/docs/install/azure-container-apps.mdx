...
LOCATION=eastus                    # Choose a supported region
ENV_NAME=signoz
...
<details>
<summary>custom-function.xml</summary>
...
<details>
<summary>signoz-otel-colletor-config.yaml</summary>
```yaml
receivers:
  otlp:
    protocols:
...
```bash
# Upload each file
for file in config.xml users.xml cluster.xml custom-function.xml; do
...
<details>
<summary>zookeeper.yaml</summary>
...
<details>
<summary>clickhouse.yaml</summary>
...
<details>
<summary>sync-migrator.yaml</summary>
...
<details>
<summary>async-migrator.yaml</summary>
