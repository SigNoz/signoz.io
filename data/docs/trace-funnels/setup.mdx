...
- Check the [Trace Explorer](https://signoz.io/docs/apm-and-distributed-tracing/trace-explorer/) to confirm that traces are being ingested correctly
...
Once your application is properly instrumented and you can access Trace Funnels, head to the [Overview section](https://signoz.io/docs/trace-funnels/overview/) to learn how to create and use Trace Funnels.
