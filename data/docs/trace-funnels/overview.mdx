...
You can also add a span to a funnel directly from a trace: open any trace from the [Trace Explorer](https://signoz.io/docs/userguide/traces/), click a span in the waterfall or flame graph, and use the **Add to Funnel** action to add the span to an existing funnel or create a new one. See [Trace Details](https://signoz.io/docs/userguide/span-details/#add-to-funnel) for the in-trace workflow.
