...
- An OpenAI API key with access to Codex (obtainable from the [OpenAI Platform](https://platform.openai.com/api-keys)) or a ChatGPT Plus/Pro/Business/Enterprise subscription
...
Your Codex usage should now automatically emit traces and metrics to SigNoz.
