...
<Tooltip text="Auto-instrumentation" content="An agent or startup hook instruments the libraries you already use, so you write no instrumentation code." link="https://signoz.io/docs/glossary/#auto-instrumentation" /> automatically captures logs from your Python application with trace correlation.
...
```python:otel_logger.py defaultCollapsed minimap
import logging
...
- Correlate logs with [traces](https://signoz.io/docs/instrumentation/opentelemetry-python/) and [metrics](https://signoz.io/docs/metrics-management/send-metrics/applications/opentelemetry-python/) for complete observability
