...
- **otel/trace**: required only if you follow the Correlating Traces and Logs section
...
logger.Warn("rate limit reached", "user_id", "u-123", "limit", 100)
...
Captured logs can be viewed in the [Logs Explorer](https://signoz.io/docs/product-features/logs-explorer/) section.
...
- [Explore logs in SigNoz](https://signoz.io/docs/product-features/logs-explorer/)
