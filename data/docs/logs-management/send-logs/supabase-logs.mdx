...
Supabase Log Drains support only `HTTP/Protobuf`. For self-hosted setups, use your OTLP/HTTP endpoint instead of the SigNoz Cloud ingest URL. OTLP/HTTP endpoints commonly listen on port `4318`. For the standard OTLP/HTTP endpoint format, see
<a
  href="https://github.com/open-telemetry/opentelemetry-collector/blob/main/exporter/otlphttpexporter/README.md"
  target="_blank"
  rel="noopener noreferrer nofollow"
>
  OpenTelemetry Collector OTLP HTTP exporter docs
</a>.
</KeyPointCallout>
