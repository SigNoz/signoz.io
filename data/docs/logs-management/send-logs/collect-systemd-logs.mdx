...
Follow the [installation guide](https://signoz.io/docs/opentelemetry-collection-agents/vm/install/) to install the OpenTelemetry Collector. The <a href="https://github.com/open-telemetry/opentelemetry-collector-contrib/blob/main/receiver/journaldreceiver/README.md" target="_blank" rel="noopener noreferrer nofollow">journald receiver</a> is available in the OpenTelemetry Collector Contrib distribution.
...
- Explore other log collection methods:
  ...
  - [Collect Kubernetes logs](https://signoz.io/docs/userguide/collect_kubernetes_pod_logs/)
