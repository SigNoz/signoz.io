...
<Admonition type="note">
  Currently only application logs (including console.log() output) and system-generated logs are
  supported. For more information please refer to [Cloudflare Workers official OpenTelemetry
  Docs](https://developers.cloudflare.com/workers/observability/exporting-opentelemetry-data/#supported-telemetry-types)
</Admonition>
