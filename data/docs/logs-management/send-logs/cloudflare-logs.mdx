---
date: 2026-08-07
title: Send Cloudflare Logs to SigNoz
meta_title: "Cloudflare Logs to SigNoz: Edge Log Collection"
description: "Learn how to send Cloudflare logs to SigNoz, configure collection, and analyze edge traffic with observability context."
...
Need traces too? See [Monitor Cloudflare Workers Traces and Logs with SigNoz](https://signoz.io/docs/integrations/outposts/cloudflare-workers/).
</Admonition>
...
1. Go to <a href="https://dash.cloudflare.com/?to=/:account/workers-and-pages/observability/pipelines" target="_blank" rel="noopener noreferrer nofollow">Workers Observability</a> in your Cloudflare dashboard
...
For complete configuration options, refer to <a href="https://developers.cloudflare.com/workers/observability/exporting-opentelemetry-data/#enabling-opentelemetry-export-for-your-worker" target="_blank" rel="noopener noreferrer nofollow">Cloudflare's OpenTelemetry documentation</a>.
...
- **Query logs**: Use the [Logs Explorer](https://signoz.io/docs/logs-management/overview/) to search and filter your Worker logs
...
- **Limited log types**: Currently only application logs (including console.log() output) and system-generated logs are supported. For more information please refer to <a href="https://developers.cloudflare.com/workers/observability/exporting-opentelemetry-data/#supported-telemetry-types" target="_blank" rel="noopener noreferrer nofollow">Cloudflare Workers official OpenTelemetry Docs</a>
