...
Need traces too? See [Monitor Cloudflare Workers Traces and Logs with SigNoz](https://signoz.io/docs/integrations/outposts/cloudflare-workers/) for the combined setup.
</Admonition>
