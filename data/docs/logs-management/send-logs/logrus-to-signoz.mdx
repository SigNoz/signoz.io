...
```go:main.go defaultCollapsed minimap
package main
...
Correlate Logrus logs with [OpenTelemetry traces](https://signoz.io/docs/instrumentation/opentelemetry-golang/) by injecting `trace_id` and `span_id` fields into your structured logs.
