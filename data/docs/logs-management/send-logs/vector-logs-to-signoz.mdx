...
<<<<<<< HEAD
`<SOURCE_NAME>`: The name of your <a href="https://vector.dev/docs/reference/configuration/sources/" target="_blank" rel="noopener noreferrer nofollow">Vector source</a> (e.g., docker)
=======
service:
  enabled: false
>>>>>>> origin/main
