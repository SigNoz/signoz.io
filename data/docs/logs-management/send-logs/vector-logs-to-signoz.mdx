...
description: Forward logs from Vector to SigNoz using the OpenTelemetry exporter.
toc_min_heading_level: 3
toc_max_heading_level: 1
---

This guide explains how to forward logs from <a href="https://vector.dev/" target="_blank" rel="noopener noreferrer nofollow">Vector</a> to SigNoz.
