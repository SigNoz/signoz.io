...
This guide explains how to forward logs from <a href="https://vector.dev/" target="_blank" rel="noopener noreferrer nofollow">Vector</a> to SigNoz using Vector's HTTP sink. Vector collects, transforms, and ships logs from various sources (syslog, files, Docker, Kubernetes, and more) directly to SigNoz.
...
Deploy Vector in your Kubernetes cluster using the official <a href="https://vector.dev/docs/setup/installation/package-managers/helm/" target="_blank" rel="noopener noreferrer nofollow">Vector Helm chart</a>. The Helm chart automatically configures a <a href="https://vector.dev/docs/reference/configuration/sources/kubernetes_logs/" target="_blank" rel="noopener noreferrer nofollow">kubernetes_logs</a> source that collects logs from all pods.
