---
date: 2026-08-07
title: Send Vector Logs to SigNoz
meta_title: "Vector Logs to SigNoz: Collector Setup Guide"
doc_type: howto
description: "Learn how to send Vector logs to SigNoz, configure sinks, and route telemetry to your observability stack."
---
...
```yaml:values.yaml defaultCollapsed
role: Agent
...
```yaml:vector.yaml minimap defaultCollapsed
sources:
  system_logs:
    type: file
    include:
...
```yaml:values.yaml minimap defaultCollapsed
role: Agent
...
For more details on querying logs, see the [Logs Explorer documentation](https://signoz.io/docs/userguide/logs_query_builder/).
