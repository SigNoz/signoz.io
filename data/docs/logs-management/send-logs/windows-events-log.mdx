...
Add the OpenTelemetry Collector binary to your Windows VM/machine by following the [OTel binary setup guide](https://signoz.io/docs/opentelemetry-collection-agents/vm/install/).
