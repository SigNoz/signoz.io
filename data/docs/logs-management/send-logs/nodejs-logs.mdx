...
```javascript:logger.js defaultCollapsed
const {
  LoggerProvider,
...
```typescript:logger.ts defaultCollapsed
import {
  LoggerProvider,
  BatchLogRecordProcessor,
...
```javascript:console-instrumentation.js minimap defaultCollapsed
...
```typescript:console-instrumentation.ts minimap defaultCollapsed
...
<Figure
  src="/img/docs/logs-management/send-logs/nodejs-logs.webp"
  alt="Node.js Logs"
  caption="Node.js Logs"
/>

<Figure
  src="/img/docs/logs-management/send-logs/nodejs-logs-detailed-view.webp"
  alt="Node.js Logs Detailed View"
  caption="Node.js Logs Detailed View"
/>
...
- Complete your observability setup by sending [traces](https://signoz.io/docs/instrumentation/javascript/opentelemetry-nodejs/) and [metrics](https://signoz.io/docs/metrics-management/send-metrics/applications/opentelemetry-nodejs/) from your Node.js application.
