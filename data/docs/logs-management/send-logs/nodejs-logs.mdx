---
date: 2026-06-09
title: Send Node.js Logs to SigNoz with OpenTelemetry
meta_title: Send Node.js Logs to SigNoz with OpenTelemetry
id: opentelemetry-nodejs-logs
doc_type: howto
description: "Follow this SigNoz guide for Node.js logging. Set up collection, validate incoming logs, and connect them to search, alerts, and dashboards."
---
...
## Prerequisites for sending Node.js logs
...
## Validate Node.js logs in SigNoz
...
## Optional: Set up the OpenTelemetry Collector
...
## Troubleshooting Node.js log collection
...
## Next steps for Node.js observability
