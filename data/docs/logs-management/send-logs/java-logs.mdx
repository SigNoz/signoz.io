...
<Admonition type="tip" title="Use Infrastructure Collection?">
  If you prefer **Infrastructure-level Collection**, see our guides for [Kubernetes Pod
  Logs](https://signoz.io/docs/userguide/collect_kubernetes_pod_logs/) or [Docker Container
  Logs](https://signoz.io/docs/userguide/collect_docker_logs/).
</Admonition>
