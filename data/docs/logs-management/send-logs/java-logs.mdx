...
public class OpenTelemetryConfig {
    ...
    public static OpenTelemetry init() {
        // Get service name from env var, fallback to default
        String serviceName = System.getenv("OTEL_SERVICE_NAME");
        if (serviceName == null || serviceName.isEmpty()) {
            serviceName = "java-manual-app";
        }
...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        OpenTelemetrySdk sdk = (OpenTelemetrySdk) OpenTelemetryConfig.init();

        // 2. Install the SDK into the Logback appender
