...
Create a class to initialize the OpenTelemetry SDK. This must run before your application starts logging.
...
public class OpenTelemetryConfig {
    ...
    public static OpenTelemetry init() {
        ...
        // Read endpoint/headers from env vars or set directly
        ...
        // Add hook to shutdown SDK
        Runtime.getRuntime().addShutdownHook(new Thread(loggerProvider::shutdown));
...
Add the `OpenTelemetryAppender` to your `logback.xml` or `logback-spring.xml`.
...
Call the initialization in your `main` method:

```java
public static void main(String[] args) {
    OpenTelemetryConfig.init(); // Initialize OTel SDK
...
Set the standard OTel environment variables to point to SigNoz:
