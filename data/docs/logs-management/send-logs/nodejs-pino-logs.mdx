...
<figure data-zoomable align="left">
    <img
        src="/img/docs/logs-management/send-logs/info-logs.png"
...
<figure data-zoomable align="left">
    <img
        src="/img/docs/logs-management/send-logs/warn-logs.png"
        alt="Node.js Pino Logs"
    />
<figcaption>
<i>
...
<figure data-zoomable align="left">
    <img
        src="/img/docs/logs-management/send-logs/error-logs.png"
        alt="Node.js Pino Logs"
    />
<figcaption>
<i>
...
<figure data-zoomable align="left">
    <img
        src="/img/docs/logs-management/send-logs/error-log-details.png"
        alt="Node.js Pino Logs"
    />
<figcaption>
<i>
...
<figure data-zoomable align="left">
    <img
        src="/img/docs/logs-management/send-logs/nodejs-pino-logs.png"
        alt="Node.js Pino Logs"
    />
<figcaption>
<i>
