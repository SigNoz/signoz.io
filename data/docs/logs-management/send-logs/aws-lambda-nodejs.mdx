...
description: Learn how to send traces and logs from AWS Lambda Node.js functions to SigNoz using OpenTelemetry auto-instrumentation.
tags : [SigNoz Cloud]
...
```environment
arn:aws:lambda:<aws_region>:184161586896:layer:opentelemetry-nodejs-0_9_0:4
```
