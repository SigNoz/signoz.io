---
date: 2026-04-05
title: How to Deep Link to Logs Explorer
id: logs-url-for-explorer-page
description: Construct URLs that open the SigNoz Logs Explorer with a pre-filled query, time range, and panel type — useful for bookmarks, alerts, and integrations.
doc_type: howto
---

## Overview

You can construct a URL that opens the SigNoz Logs Explorer with a query and time range already applied. This is useful for sharing specific log views, embedding links in alerts, or bookmarking common queries.

---

This section explains how to generate a URL for the SigNoz Logs Explorer page with predefined filters and a custom time range.
