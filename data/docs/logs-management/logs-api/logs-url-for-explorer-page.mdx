...
description: Generate a direct URL to the SigNoz Logs Explorer with predefined filters and time range.
doc_type: reference
---
...
You can use this <a href="https://meyerweb.com/eric/tools/dencoder/" target="_blank" rel="noopener noreferrer nofollow">tool</a> to encode your parameters.
