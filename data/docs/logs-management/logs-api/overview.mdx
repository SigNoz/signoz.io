...
<Admonition type="tip">
You can link logs and traces to gain deeper insights into request flows and performance issues. For more information, refer to [Guide to link traces to logs](../guides/trace-log.mdx).
</Admonition>
