---
date: 2026-04-05
title: Logs API Payload Reference
id: payload-model
description: Complete schema reference for the SigNoz Logs API JSON payload — top-level fields, compositeQuery, filters, aggregations, and ordering.
doc_type: reference
---
