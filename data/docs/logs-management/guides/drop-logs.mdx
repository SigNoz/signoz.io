...
For Kubernetes environments, you can also configure log exclusion/inclusion using the k8s-infra chart configuration. See our [Kubernetes pod logs collection guide](https://signoz.io/docs/userguide/collect_kubernetes_pod_logs/#excludeincludefilter-logs-collection) for simpler exclude/include options based on namespaces, pods, or containers.
