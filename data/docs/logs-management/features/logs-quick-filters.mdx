...
For the list of default filter attributes and their OpenTelemetry mappings, see the [Available Quick Filters Reference](https://signoz.io/docs/logs-management/features/logs-quick-filters-reference/).
