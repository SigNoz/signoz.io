...
These "connection is draining" errors are expected and occur occasionally as the SigNoz ingestor system automatically scales up and down. The errors indicate temporary connection issues, but they don't result in data loss.
