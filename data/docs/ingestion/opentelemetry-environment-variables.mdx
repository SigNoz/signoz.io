...
To set the same attributes in code or in the OpenTelemetry Collector instead, see [Set Custom Attributes in OpenTelemetry Traces, Logs, Metrics](https://signoz.io/docs/ingestion/set-custom-attributes/).
...
- [Set custom attributes](https://signoz.io/docs/ingestion/set-custom-attributes/) in code or in the Collector when an environment variable is not enough.
