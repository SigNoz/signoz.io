...
Review the [OpenTelemetry environment variables reference](https://signoz.io/docs/ingestion/opentelemetry-environment-variables/) for protocol, endpoint-path, and precedence rules.
...
```yaml:/deploy/docker/otel-collector-config.yaml defaultCollapsed
exporters:
  otlp: # gRPC
...
Use the [OpenTelemetry environment variables reference](https://signoz.io/docs/ingestion/opentelemetry-environment-variables/) for descriptions, defaults, and official OpenTelemetry sources.
