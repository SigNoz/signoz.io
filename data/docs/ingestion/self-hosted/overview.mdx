...
If you are migrating an existing OpenTelemetry setup to SigNoz, see: <a href="https://signoz.io/docs/migration/migrate-from-opentelemetry-to-signoz/" target="_blank" rel="noopener noreferrer">Migrate from existing OpenTelemetry to Self-Hosted SigNoz</a>.
