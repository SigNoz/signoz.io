...
description: Understand the differences between SigNoz Cloud and self-hosted ingestion. Compare endpoints, authentication, TLS, CORS, and learn how to adapt guides across both setups.
...
Review the [OpenTelemetry environment variables reference](https://signoz.io/docs/ingestion/opentelemetry-environment-variables/) for endpoint paths, protocols, headers, and signal-specific overrides.
...
- [OpenTelemetry environment variables](https://signoz.io/docs/ingestion/opentelemetry-environment-variables/)
- [Self-hosted ingestion overview](https://signoz.io/docs/ingestion/self-hosted/overview/)
