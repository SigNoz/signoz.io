...
description: Observability and monitoring for Hugging Face usage and performance with OpenTelemetry instrumentation to send traces, logs, and metrics to SigNoz
doc_type: howto
---

## Overview

This guide walks you through setting up observability and monitoring for Hugging Face using [OpenTelemetry](https://opentelemetry.io/) and exporting traces, logs, and metrics to SigNoz. With this integration, you can observe and track various metrics for your Hugging Face applications and llm usage.
...
- A Hugging Face Account and  API key. You can get the API key from <a href="https://huggingface.co/settings/tokens" target="_blank" rel="noopener noreferrer nofollow">Hugging Face platform</a>


## Monitoring Hugging Face

For more information on getting started with Hugging Face in your Python environment, refer to the [Hugging Face quickstart guide](https://huggingface.co/inference/get-started).
...
### Step 4: Create an example Hugging Face application
...
<Admonition type="important">
  Before running this code, ensure that you have set the environment variable `HF_TOKEN` with your generated Hugging Face API key.
</Admonition>
...
from opentelemetry.exporter.otlp.proto.http.trace_exporter import OTLPSpanExporter
from opentelemetry import trace
from openinference.instrumentation.openai_v2 import OpenAIInstrumentor
import os
...
<Admonition type="important">
   SystemMetricsInstrumentor provides system metrics (CPU, memory, etc.), and HTTPXClientInstrumentor provides outbound HTTP request metrics such as request duration. If you want to add custom metrics to your Hugging Face application, see [Python Custom Metrics](https://signoz.io/opentelemetry/python-custom-metrics/).
</Admonition>
...
### Step 6: Run an example Hugging Face application
...
Your Hugging Face LLM usage should now automatically emit traces, logs, and metrics.

You should be able to view traces in Signoz Cloud under the traces tab:

<Figure
  src="/img/docs/llm/huggingface/huggingface-traces.webp"
  alt="Hugging Face Trace View"
  caption="Hugging Face Trace View"
/>

When you click on a trace in SigNoz, you'll see a detailed view of the trace, including all associated spans, along with their events and attributes.

<Figure
  src="/img/docs/llm/huggingface/huggingface-detailed-traces.webp"
  alt="Hugging Face Detailed Trace View"
  caption="Hugging Face Detailed Trace View"
/>
...
<figure data-zoomable align="center">
  <img src="/img/docs/llm/huggingface/related-logs.webp" alt="Related logs" width="300" />
  <figcaption>
...
<Figure
  src="/img/docs/llm/huggingface/huggingface-logs.webp"
  alt="Hugging Face Logs View"
  caption="Hugging Face Logs View"
/>

When you click on any of these logs in SigNoz, you'll see a detailed view of the log, including attributes:

<Figure
  src="/img/docs/llm/huggingface/huggingface-detailed-logs.webp"
  alt="Hugging Face Detailed Log View"
  caption="Hugging Face Detailed Logs View"
/>

You should be able to see Hugging Face related metrics in Signoz Cloud under the metrics tab:

<Figure
  src="/img/docs/llm/huggingface/huggingface-metrics.webp"
  alt="Hugging Face Metrics View"
  caption="Hugging Face Metrics View"
/>

When you click on any of these metrics in SigNoz, you'll see a detailed view of the metric, including attributes:

<Figure
  src="/img/docs/llm/huggingface/huggingface-detailed-metrics.webp"
  alt="Hugging Face Detailed Metrics View"
  caption="Hugging Face Detailed Metrics View"
/>
...
You can also check out our custom Hugging Face dashboard [here](https://signoz.io/docs/dashboards/dashboard-templates/huggingface-dashboard/) which provides specialized visualizations for monitoring your Hugging Face usage in applications. The dashboard includes pre-built charts specifically tailored for LLM usage, along with import instructions to get started quickly.

<Figure
  src="/img/docs/llm/huggingface/huggingface-dashboard.webp"
  alt="Hugging Face Dashboard"
