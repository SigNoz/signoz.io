...
SigNoz reports the **non-sensitive** information that helps us understand how the community uses SigNoz - such as which versions you’re on, which features matter, and where we should focus on improvements and fixes. It’s the best signal we have for prioritising bug fixes, documentation, and new capabilities.
