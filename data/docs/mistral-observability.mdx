...
description: Observability and monitoring for Mistral usage and performance with OpenTelemetry instrumentation to send traces, logs, and metrics to SigNoz
doc_type: howto
---
...
- A Mistral Account and API key. You can get the API key from <a href="https://admin.mistral.ai/organization/api-keys" target="_blank" rel="noopener noreferrer nofollow">Mistral platform</a>


## Monitoring Mistral AI
...
### Step 4: Create an example Mistral application
...
<Admonition type="important">
  Before running this code, ensure that you have set the environment variable `MISTRAL_API_KEY` with your generated Mistral API key.
</Admonition>
...
<Admonition type="important">
   SystemMetricsInstrumentor provides system metrics (CPU, memory, etc.), and HTTPXClientInstrumentor provides outbound HTTP request metrics such as request duration. If you want to add custom metrics to your Mistral application, see [Python Custom Metrics](https://signoz.io/opentelemetry/python-custom-metrics/).
</Admonition>
...
### Step 5: Run an example Mistral application
...
Your Mistral LLM usage should now automatically emit traces, logs, and metrics.

You should be able to view traces in Signoz Cloud under the traces tab:

<Figure
  src="/img/docs/llm/mistral/mistral-traces.webp"
  alt="Mistral Trace View"
  caption="Mistral Trace View"
/>

When you click on a trace in SigNoz, you'll see a detailed view of the trace, including all associated spans, along with their events and attributes.

<Figure
  src="/img/docs/llm/mistral/mistral-detailed-traces.webp"
  alt="Mistral Detailed Trace View"
  caption="Mistral Detailed Trace View"
/>
...
<figure data-zoomable align="center">
  <img src="/img/docs/llm/mistral/related-logs.webp" alt="Related logs" width="300" />
  <figcaption>
...
<Figure
  src="/img/docs/llm/mistral/mistral-logs.webp"
  alt="Mistral Logs View"
  caption="Mistral Logs View"
/>

When you click on any of these logs in SigNoz, you'll see a detailed view of the log, including attributes:

<Figure
  src="/img/docs/llm/mistral/mistral-detailed-logs.webp"
  alt="Mistral Detailed Log View"
  caption="Mistral Detailed Logs View"
/>

You should be able to see Mistral related metrics in Signoz Cloud under the metrics tab:

<Figure
  src="/img/docs/llm/mistral/mistral-metrics.webp"
  alt="Mistral Metrics View"
  caption="Mistral Metrics View"
/>

When you click on any of these metrics in SigNoz, you'll see a detailed view of the metric, including attributes:

<Figure
  src="/img/docs/llm/mistral/mistral-detailed-metrics.webp"
  alt="Mistral Detailed Metrics View"
  caption="Mistral Detailed Metrics View"
/>
...
You can also check out our custom Mistral dashboard [here](https://signoz.io/docs/dashboards/dashboard-templates/mistral-dashboard/) which provides specialized visualizations for monitoring your Mistral usage in applications. The dashboard includes pre-built charts specifically tailored for LLM usage, along with import instructions to get started quickly.

<Figure
  src="/img/docs/llm/mistral/mistral-dashboard.webp"
