...
description: Explore SigNoz alert types including metrics-based, log-based, trace-based, exceptions-based, and anomaly detection alerts.
id: alerts
---
...
<DocCard
    title="📄️ Routing Policies"
    description="Routing Policies in SigNoz allows you to route notifications dynamically based on labels..."
...
<DocCard
    title="📄️ User Guides"
    description="Guides to help you navigate and utilize the alerting features in SigNoz."
    href="/docs/alerts-management/user-guides/user-guides/"
/>

<DocCard
    title="📄️ Troubleshooting"
    description="Common issues and solutions related to alerts in SigNoz."
    href="/docs/alerts-management/troubleshooting/troubleshooting/"
/>

<DocCard
    title="📄️ Setup Apdex Alert"
    description="Setup alerts to evaluate and monitor your application's Apdex Score."
    href="/docs/alerts-management/apdex-alerts"
/>
