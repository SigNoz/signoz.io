...
See the <a href="https://signoz.io/docs/userguide/query-builder/#functions-for-extended-data-analysis">Time Shift function documentation</a> for more on using functions and formulas.
</Admonition>
