...
SigNoz records the temporality of every data point, so a Counter or Histogram metric can carry both cumulative and delta points. If you change a metric's temporality from cumulative to delta, your queries over the older cumulative data still work.
