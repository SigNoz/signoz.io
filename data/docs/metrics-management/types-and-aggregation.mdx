...
SigNoz records the temporality of every data point, so a Counter metric can carry both cumulative and delta points. If you change a Counter from cumulative to delta, your Query Builder queries over the older cumulative data still work.
