...
SigNoz records the temporality of every data point, so a Sum metric can carry both cumulative and delta points. If you change the temporality of a Sum metric from cumulative to delta, your queries over the older cumulative data still work.
