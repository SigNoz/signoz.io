...
description: Reference for metric types (Counter, Gauge, Histogram) and how SigNoz performs temporal and spatial aggregation.
doc_type: reference
---
...
- [Metrics Explorer](https://signoz.io/docs/metrics-management/metrics-explorer/) — Query and visualize metrics using these aggregation options
- [Metrics Storage](https://signoz.io/docs/metrics-management/data-storage/) — How time series and samples are stored
- [Configure Custom Histogram Buckets](https://signoz.io/docs/metrics-management/configure-custom-buckets/) — Adjust bucket boundaries for Histogram metrics
