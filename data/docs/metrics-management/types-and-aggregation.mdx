...
description: Understand the different metric types supported by SigNoz and how they are aggregated.
doc_type: reference
...
See the [Time Shift function documentation](https://signoz.io/docs/userguide/query-builder-v5/#functions) for details.
</Admonition>
