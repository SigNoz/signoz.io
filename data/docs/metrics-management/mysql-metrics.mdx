...
After configuring the pipeline, run the OpenTelemetry Collector with your configuration:
...
This configuration allows you to monitor both local and remote MySQL instances simultaneously.
