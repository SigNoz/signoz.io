...
OpenTelemetry Collector is required to collect metrics from MySQL. Please refer to this [documentation](/docs/tutorial/opentelemetry-binary-usage-in-virtual-machine/) to setup the agent.
