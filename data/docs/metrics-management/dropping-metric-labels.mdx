...
It is generally recommended avoiding high-cardinality IDs (like `k8s.pod.uid`) in metrics to keep cardinality under control. Users often attempt to remove these IDs to reduce "noise".
