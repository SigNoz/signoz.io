...
You can query metrics in two places in SigNoz:

- **[Metrics Explorer](https://signoz.io/docs/metrics-management/metrics-explorer/)** — Use the Query Builder to quickly explore and visualize metrics.
- **[Dashboards](https://signoz.io/docs/userguide/manage-dashboards/)** — Use the Query Builder, ClickHouse SQL, or PromQL to build persistent panels.
