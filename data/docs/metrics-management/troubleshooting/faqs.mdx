...
- [Troubleshooting Metrics](https://signoz.io/docs/metrics-management/troubleshooting/troubleshooting/) — Symptom-based lookup table for common issues
- [Metric Types and Aggregation](https://signoz.io/docs/metrics-management/types-and-aggregation/) — Temporality, counter, gauge, and histogram reference
- [Metrics Explorer](https://signoz.io/docs/metrics-management/metrics-explorer/) — Explore and debug metrics in the UI
