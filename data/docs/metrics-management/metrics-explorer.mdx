...
When you click on a specific metric, you can access detailed information through three separate sections:
...
The "All Attributes" section is separate from metadata and displays the dimensional structure of the metric:
