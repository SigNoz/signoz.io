...
<figure data-zoomable align="center">
    <img
      ...
      alt="Metrics Explorer summary view showing all ingested metrics and their types"
    />
    <figcaption>
      <i>
        Metrics Explorer summary view showing all ingested metrics and their types
      </i>
    </figcaption>
</figure>
...
<figure data-zoomable align="center">
    <img
      ...
      alt="Detailed metadata view showing comprehensive metric information and labels"
    />
    <figcaption>
      <i>
        Detailed metadata view showing comprehensive metric information and labels
      </i>
    </figcaption>
</figure>
...
<figure data-zoomable align="center">
    <img
      src="/img/docs/metrics-explorer/cardinality-analysis-interface.webp"
      alt="Cardinality analysis interface showing label dimensions and frequency distribution"
    />
    <figcaption>
      <i>
        Cardinality analysis interface showing label dimensions and frequency distribution
      </i>
    </figcaption>
</figure>
...
<figure data-zoomable align="center">
    <img
      ...
      alt="Query playground interface for running ad hoc metric queries and visualizing results"
    />
    <figcaption>
      <i>
        Query playground interface for running ad hoc metric queries and visualizing results
      </i>
    </figcaption>
</figure>
...
<figure data-zoomable align="center">
    <img
      src="/img/docs/metrics-explorer/real-time-visualization-charts.webp"
      alt="Real-time metric visualization with line charts and comparison capabilities"
    />
    <figcaption>
      <i>
        Real-time metric visualization with line charts and comparison capabilities
      </i>
    </figcaption>
</figure>
...
<figure data-zoomable align="center">
    <img
      src="/img/docs/metrics-explorer/one-click-actions-interface.webp"
      alt="One-click actions interface for creating dashboards and alerts from query results"
    />
    <figcaption>
      <i>
        One-click actions interface for creating dashboards and alerts from query results
      </i>
    </figcaption>
</figure>
...
<figure data-zoomable align="center">
    <img
      src="/img/docs/metrics-explorer/activity-timeline-view.webp"
      alt="Activity timeline showing metric ingestion patterns and historical changes"
    />
    <figcaption>
      <i>
        Activity timeline showing metric ingestion patterns and historical changes
      </i>
    </figcaption>
</figure>
...
<figure data-zoomable align="center">
    <img
      src="/img/docs/metrics-explorer/volume-analysis-dashboard.webp"
      alt="Metric volume analysis dashboard showing sample count distribution and trends"
    />
    <figcaption>
      <i>
        Metric volume analysis dashboard showing sample count distribution and trends
      </i>
    </figcaption>
</figure>
...
<figure data-zoomable align="center">
    <img
      src="/img/docs/metrics-explorer/source-attribution-breakdown.webp"
      alt="Source attribution breakdown showing metrics contribution by services and integrations"
    />
    <figcaption>
      <i>
        Source attribution breakdown showing metrics contribution by services and integrations
      </i>
    </figcaption>
</figure>
...
<figure data-zoomable align="center">
    <img
      src="/img/docs/metrics-explorer/performance-insights-monitoring.webp"
      alt="Performance insights dashboard showing ingestion rates and query performance metrics"
    />
    <figcaption>
      <i>
        Performance insights dashboard showing ingestion rates and query performance metrics
      </i>
    </figcaption>
</figure>
...
<figure data-zoomable align="center">
    <img
      src="/img/docs/metrics-explorer/metric-correlation-discovery.webp"
      alt="Metric correlation discovery interface showing related metrics and smart grouping"
    />
    <figcaption>
      <i>
        Metric correlation discovery interface showing related metrics and smart grouping
      </i>
    </figcaption>
</figure>
...
<figure data-zoomable align="center">
    <img
      src="/img/docs/metrics-explorer/cost-optimization-tools.webp"
      alt="Cost optimization tools showing volume analysis and cleanup recommendations"
    />
    <figcaption>
      <i>
        Cost optimization tools showing volume analysis and cleanup recommendations
      </i>
    </figcaption>
</figure>
...
<figure data-zoomable align="center">
    <img
      src="/img/docs/metrics-explorer/integration-workflows-interface.webp"
      alt="Integration workflows interface for dashboard creation and alert configuration"
    />
    <figcaption>
      <i>
        Integration workflows interface for dashboard creation and alert configuration
      </i>
    </figcaption>
</figure>
