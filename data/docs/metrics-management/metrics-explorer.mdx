...
**Dashboard usage**: The panel shows which dashboards reference this metric (e.g., "1 dashboard"). Clicking the dashboard badge takes you directly to that dashboard, making it easy to see where a metric is being used across your monitoring setup.
