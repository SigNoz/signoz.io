...
id: metrics-explorer
description: Explore, query, and visualize all metrics flowing into SigNoz without building dashboards first.
...
- [Metric Types and Aggregation](https://signoz.io/docs/metrics-management/types-and-aggregation/) — Understand how Counters, Gauges, and Histograms are aggregated
- [Manage Dashboards](https://signoz.io/docs/userguide/manage-dashboards/) — Add Explorer queries to persistent dashboards
- [Metrics-Based Alerts](https://signoz.io/docs/alerts-management/metrics-based-alerts/) — Create alerts from Metrics Explorer queries
- [Metrics Query API](https://signoz.io/docs/metrics-management/query-range-api/) — Query metrics programmatically
