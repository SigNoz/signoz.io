...
[JFR-based (Java Flight Recorder) metrics](https://docs.oracle.com/en/java/javase/17/jfapi/introduction.htm) can provide deeper runtime insights with lower overhead. JFR captures detailed GC events, memory allocation patterns, thread contention, and CPU profiling data that aren't available through standard JMX/MBeans alone.
</KeyPointCallout>
