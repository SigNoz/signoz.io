...
Setting `OTEL_TRACES_EXPORTER="none"` and `OTEL_LOGS_EXPORTER="none"` disables trace and log export since this guide focuses on metrics only. If you want traces, see the [Python traces instrumentation guide](https://signoz.io/docs/instrumentation/opentelemetry-python/).
</KeyPointCallout>
