...
- [JVM Metrics](https://signoz.io/docs/metrics-management/send-metrics/applications/opentelemetry-java/jvm-metrics/) for Spring Boot applications using Micrometer
