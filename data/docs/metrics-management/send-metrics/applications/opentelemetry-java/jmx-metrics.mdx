---
date: 2026-08-07
title: Collect JMX Metrics with the OpenTelemetry Collector
meta_title: Collect JMX Metrics with OpenTelemetry
...
- <a href="https://github.com/open-telemetry/opentelemetry-java#requirements" target="_blank" rel="noopener noreferrer nofollow">A Java application compatible with OpenTelemetry Java</a> and JMX enabled
...
The example above disables SSL and authentication for simplicity. For production environments, enable authentication and SSL. See the <a href="https://docs.oracle.com/javase/8/docs/technotes/guides/management/agent.html" target="_blank" rel="noopener noreferrer nofollow">JMX security documentation</a> for details.
</Admonition>
...
- <a href="https://github.com/SigNoz/dashboards/tree/main/jmx" target="_blank" rel="noopener noreferrer nofollow">JMX Dashboard Templates</a> for pre-built visualizations
- [Creating custom dashboards](https://signoz.io/docs/userguide/manage-dashboards/) to build your own metric panels
