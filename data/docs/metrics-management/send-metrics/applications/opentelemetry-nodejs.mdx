...
- Complete your observability setup by sending [traces](https://signoz.io/docs/instrumentation/javascript/opentelemetry-nodejs/) and [logs](https://signoz.io/docs/logs-management/send-logs/nodejs-logs/) from your Node.js application.
