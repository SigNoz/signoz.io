...
## Next Steps
- For detailed instructions on configuring Kubernetes infrastructure metrics using the k8s-infra Helm chart, see the [K8s Metrics Configuration Guide](/docs/userguide/k8s-metrics).
