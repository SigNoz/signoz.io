...
This guide details how to set up the OpenTelemetry Collector in the SigNoz K8s-infra chart. It covers the configuration of telemetry data collection and methods for gathering data from your Kubernetes cluster.

To install K8s-Infra in your Kubernetes cluster, please check out the [k8s-infra Installation guide](/docs/tutorial/kubernetes-infra-metrics)
