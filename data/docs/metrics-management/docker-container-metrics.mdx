...
OpenTelemetry Collector is required to collect metrics from Docker containers. Please refer to this [documentation](/docs/tutorial/opentelemetry-binary-usage-in-virtual-machine/) to setup the agent.
