...
This document explains how to monitor Docker container Metrics using OTel Collector and SigNoz.
...
OpenTelemetry Collector is required to collect metrics from Docker containers. Please refer to this [documentation](https://signoz.io/docs/opentelemetry-collection-agents/docker/install/) to setup the agent.

## Collecting Docker metrics

You will need to configure the <a href="https://github.com/open-telemetry/opentelemetry-collector-contrib/blob/main/receiver/dockerstatsreceiver/README.md" target="_blank" rel="noopener noreferrer nofollow">`docker_stats` OpenTelemetry receiver</a> for collecting Docker metrics. The receiver queries the local Docker daemon's container stats API for all desired running containers on a configured interval.

### Configuring the receiver

Edit the OTel Collector config file to configure the `docker_stats` receiver as shown below:

```yaml {2-23} defaultCollapsed
receivers:
  docker_stats:
...
The receiver also supports additional parameters like `initial_delay`, `collection_interval`, `timeout` and others. For more details, refer to the <a href="https://github.com/open-telemetry/opentelemetry-collector-contrib/blob/main/receiver/dockerstatsreceiver/README.md#configuration" target="_blank" rel="noopener noreferrer nofollow">official receiver documentation</a>.
...
You can use the pre-configured dashboard for Docker metrics or [create your own custom dashboard](https://signoz.io/docs/userguide/manage-dashboards/#steps-to-create-a-custom-dashboard). To use the pre-configured dashboard, download the dashboard JSON from <a href="https://github.com/SigNoz/dashboards/blob/main/container-metrics/docker/container-metrics-by-host.json" target="_blank" rel="noopener noreferrer nofollow">here</a> and import it to SigNoz by clicking Dashboards → New dashboard → Import JSON:

<Figure
  src="/img/docs/dashboards/dashboard-templates/docker-container-metrics.webp"
  alt="Docker Container Metrics Dashboard"
...
<Figure
  src="/img/docs/metrics/docker/cpu_percent.webp"
  alt="CPU Usage"
  caption="CPU Usage Panel"
/>
...
<Figure
  src="/img/docs/metrics/docker/memory_percent.webp"
  alt="Memory Usage"
  caption="Memory Usage Panel"
/>
...
<Figure
  src="/img/docs/metrics/docker/memory_limits.webp"
  alt="Memory Limits"
  caption="Memory Limits Panel"
/>
...
<Figure
  src="/img/docs/metrics/docker/network_bytes.webp"
  alt="Network Bytes"
  caption="Network Bytes Panels"
/>
...
<Figure
  src="/img/docs/metrics/docker/network_packets_dropped.webp"
  alt="Network Packets Dropped"
  caption="Network Packets Dropped Panels"
/>
...
<Figure
  src="/img/docs/metrics/docker/block_io.webp"
  alt="Block IO"
  caption="Block IO Panel"
/>

You can find the full list of metrics collected by the `docker_stats` receiver and available for querying in dashboards in the <a href="https://github.com/open-telemetry/opentelemetry-collector-contrib/blob/main/receiver/dockerstatsreceiver/documentation.md" target="_blank" rel="noopener noreferrer nofollow">official receiver documentation</a>.
