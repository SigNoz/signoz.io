...
OpenTelemetry Collector is required to collect metrics from Docker containers. Please refer to this [documentation](https://signoz.io/docs/collection-agents/docker/install/) to setup the agent.
