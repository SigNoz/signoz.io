---
date: 2026-04-06
title: How to Monitor Docker Container Metrics
id: docker-container-metrics
description: Collect Docker container metrics using the OpenTelemetry Collector docker_stats receiver and visualize them in SigNoz.
doc_type: howto
---

This document explains how to monitor Docker container metrics using the OTel Collector and SigNoz.
...
- [Metrics Explorer](https://signoz.io/docs/metrics-management/metrics-explorer/) — Query and filter the collected container metrics
- [Manage Dashboards](https://signoz.io/docs/userguide/manage-dashboards/) — Create custom dashboards for container observability
- [OpenTelemetry Receivers](https://signoz.io/docs/userguide/otel-metrics-receivers/) — Collect metrics from other infrastructure components
