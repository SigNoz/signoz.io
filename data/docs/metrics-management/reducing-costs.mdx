...
Switching a metric to delta does not break the data that SigNoz already stored. SigNoz reads the older cumulative points and the newer delta points together, so your existing queries still work. See [Temporality of Metrics](https://signoz.io/docs/metrics-management/types-and-aggregation/#temporality-of-metrics).
