...
id: data-storage
description: Reference for how metrics are reported, structured, and stored in the SigNoz ClickHouse backend.
doc_type: reference
---
...
- [Metric Types and Aggregation](https://signoz.io/docs/metrics-management/types-and-aggregation/) — How time series values are aggregated at query time
- [Reduce Metrics Costs](https://signoz.io/docs/metrics-management/reducing-costs/) — How cardinality and sample count affect billing
- [Metrics Query API](https://signoz.io/docs/metrics-management/query-range-api/) — API reference for querying metrics
