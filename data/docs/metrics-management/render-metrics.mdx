...
See the [Render Dashboard](https://signoz.io/docs/dashboards/dashboard-templates/render-dashboard) for details, or import the dashboard JSON directly from the dashboard page.
