...
description: Learn how to configure custom histogram buckets using OpenTelemetry SDK views.
doc_type: howto
---
...
The following example uses the [OpenTelemetry Python SDK](https://signoz.io/docs/instrumentation/opentelemetry-python/) to configure custom histogram buckets:
...
[Go](https://signoz.io/docs/instrumentation/opentelemetry-golang/) |
[Java](https://signoz.io/docs/instrumentation/java/opentelemetry-java/) |
[JavaScript/Node.js](https://signoz.io/docs/instrumentation/javascript/opentelemetry-nodejs/) |
[.NET](https://signoz.io/docs/instrumentation/opentelemetry-dotnet/) |
[Ruby](https://signoz.io/docs/instrumentation/opentelemetry-ruby/) |
[Rust](https://signoz.io/docs/instrumentation/opentelemetry-rust/)
</Admonition>
