...
You can use the pre-configured dashboard for Fly metrics or [create your own custom dashboard](https://signoz.io/docs/userguide/manage-dashboards/#steps-to-create-a-custom-dashboard). To use the pre-configured dashboard, download the dashboard JSON from [here](https://github.com/SigNoz/dashboards/blob/main/fly/fly-prometheus-v1.json) and import it to SigNoz by clicking Dashboards → New dashboard → Import JSON:
