...
description: Observability and monitoring for Qwen usage and performance with OpenTelemetry instrumentation to send traces, logs, and metrics to SigNoz
doc_type: howto
---
...
- An Alibaba Cloud Account, Model Studio account, and API key. You can get the API key from <a href="https://modelstudio.console.alibabacloud.com/?tab=playground#/api-key" target="_blank" rel="noopener noreferrer nofollow">Model Studio platform</a>
...
### Step 4: Create an example Qwen application
...
<Admonition type="important">
  Before running this code, ensure that you have set the environment variable `DASHSCOPE_API_KEY` with your generated Qwen API key(from Model Studio).
</Admonition>
...
<Admonition type="important">
   SystemMetricsInstrumentor provides system metrics (CPU, memory, etc.), and HTTPXClientInstrumentor provides outbound HTTP request metrics such as request duration. If you want to add custom metrics to your Qwen application, see [Python Custom Metrics](https://signoz.io/opentelemetry/python-custom-metrics/).
</Admonition>
...
### Step 5: Run an example Qwen application
...
Your Qwen LLM usage should now automatically emit traces, logs, and metrics.

You should be able to view traces in SigNoz Cloud under the traces tab:

<Figure
  src="/img/docs/llm/qwen/qwen-traces.webp"
  alt="Qwen Trace View"
  caption="Qwen Trace View"
/>

When you click on a trace in SigNoz, you'll see a detailed view of the trace, including all associated spans, along with their events and attributes.

<Figure
  src="/img/docs/llm/qwen/qwen-detailed-traces.webp"
  alt="Qwen Detailed Trace View"
  caption="Qwen Detailed Trace View"
/>
...
<figure data-zoomable align="center">
  <img src="/img/docs/llm/qwen/related-logs.webp" alt="Related logs" width="300" />
  <figcaption>
...
<Figure
  src="/img/docs/llm/qwen/qwen-logs.webp"
  alt="Qwen Logs View"
  caption="Qwen Logs View"
/>

When you click on any of these logs in SigNoz, you'll see a detailed view of the log, including attributes:

<Figure
  src="/img/docs/llm/qwen/qwen-detailed-logs.webp"
  alt="Qwen Detailed Log View"
  caption="Qwen Detailed Logs View"
/>

You should be able to see Qwen related metrics in SigNoz Cloud under the metrics tab:

<Figure
  src="/img/docs/llm/qwen/qwen-metrics.webp"
  alt="Qwen Metrics View"
  caption="Qwen Metrics View"
/>

When you click on any of these metrics in SigNoz, you'll see a detailed view of the metric, including attributes:

<Figure
  src="/img/docs/llm/qwen/qwen-detailed-metrics.webp"
  alt="Qwen Detailed Metrics View"
  caption="Qwen Detailed Metrics View"
/>
...
You can also check out our custom Qwen dashboard [here](https://signoz.io/docs/dashboards/dashboard-templates/qwen-dashboard/) which provides specialized visualizations for monitoring your Qwen usage in applications. The dashboard includes pre-built charts specifically tailored for LLM usage, along with import instructions to get started quickly.

<Figure
  src="/img/docs/llm/qwen/qwen-dashboard.webp"
  alt="Qwen Dashboard"
