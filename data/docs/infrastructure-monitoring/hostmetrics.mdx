...
4. Note that it is also advisable to collect `host.id` (see [Hosts Monitoring](https://signoz.io/docs/infrastructure-monitoring/user-guides/telemetry-data-requirements/#hosts-monitoring)).
