...
Install cert-manager in your cluster and configure the OpenTelemetry Collector to scrape <a href="https://cert-manager.io/docs/devops-tips/prometheus-metrics/" target="_blank" rel="noopener noreferrer">cert-manager Prometheus metrics</a>.
