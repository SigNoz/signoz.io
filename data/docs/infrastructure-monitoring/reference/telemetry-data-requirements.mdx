...
- **Setup**:
  ...
  - [Configure the Processors](https://signoz.io/docs/infrastructure-monitoring/user-guides/hostmetrics/#configure-the-processors) for `host.name` / `host.id` enrichment.
