...
The simplest way to get started is using the [`k8s-infra`](https://signoz.io/docs/tutorial/kubernetes-infra-metrics/) Helm chart, which automatically:
