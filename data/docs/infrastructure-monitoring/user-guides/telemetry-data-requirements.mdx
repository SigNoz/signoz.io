...
3. **Confirm data sources**: Ensure both cluster-level and kubelet scrape jobs are enabled.
4. **Look for platform warnings**: On AWS, confirm security groups/roles allow kubelet scraping. For Fargate-only clusters, document the limitation for stakeholders.
