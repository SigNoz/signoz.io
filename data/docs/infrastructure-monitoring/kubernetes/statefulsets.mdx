---
date: 2026-08-03
title: "Kubernetes StatefulSets Monitoring: Availability and Usage"
description: Monitor Kubernetes StatefulSet availability and resource usage in SigNoz, covering available vs desired pods with CPU and memory utilization percentages.
...
- [Pods](https://signoz.io/docs/infrastructure-monitoring/kubernetes/pods/) and [Volumes](https://signoz.io/docs/infrastructure-monitoring/kubernetes/volumes/): drill into individual replicas or the PVCs they claim.
