...
- Plots three series: the StatefulSet's total **CPU Usage** in cores, the sum of containers' **CPU Requests**, and the sum of containers' **CPU Limits**. Usage approaching Limits means the kernel is throttling the StatefulSet's CPU; Usage well below Requests means the StatefulSet is reserving more capacity than it consumes.
