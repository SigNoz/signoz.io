...
date: 2026-07-03
title: Containers
description: Monitor individual Kubernetes container CPU, memory, restarts, and readiness in SigNoz — request/limit utilization, kubectl-style status, and correlated logs and traces.
