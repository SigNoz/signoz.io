---
date: 2026-08-03
title: "Kubernetes DaemonSets Monitoring: Rollout and Resource Usage"
description: Monitor Kubernetes DaemonSet rollout status and resource usage in SigNoz, covering available vs desired nodes with CPU and memory metrics.
...
- [Nodes](https://signoz.io/docs/infrastructure-monitoring/kubernetes/nodes/) and [Pods](https://signoz.io/docs/infrastructure-monitoring/kubernetes/pods/): see the nodes this DaemonSet runs on or drill into individual pods.
