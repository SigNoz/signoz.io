...
To collect host metrics from virtual machines (VMs), you need to [run OTel collector](https://signoz.io/docs/tutorial/kubernetes-infra-metrics/) on each VM and 
