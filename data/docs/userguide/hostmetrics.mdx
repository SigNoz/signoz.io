...
- OpenTelemetry Collector installed on your host. Follow the [OpenTelemetry Collector Installation Guide](https://signoz.io/docs/opentelemetry-collection-agents/get-started/) if you haven't set it up yet.
