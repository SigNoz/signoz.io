...
Use this <a href = "https://github.com/SigNoz/dashboards/blob/main/hostmetrics/hostmetrics.json" rel="noopener noreferrer nofollow" target="_blank" >GitHub Link</a> to download/copy the `hostmetrics.json` file. 

{/* The structure of the JSON file is shown below.
...
<figure data-zoomable align='center'>
    ...
    <figcaption><i>Structure of hostmetrics.json</i></figcaption>
</figure> */}
...
Upload/paste your `hostmetrics.json` data and click on **Load JSON** button
...
<figure data-zoomable align='center'>
    <img src="/img/hostmetrics-json.webp" alt="The structure of JSON file for the  Hostmetrics Dashboard for SigNoz UI"/>
    <figcaption><i>Structure of hostmetrics.json</i></figcaption>
</figure> */}
