...
- [Set Up Notification Channels](https://signoz.io/docs/setup-alerts-notification/) — configure Slack, PagerDuty, MS Teams, and more
- [Routing Policies](https://signoz.io/docs/alerts-management/routing-policy/) — route alerts to different channels based on labels
- [Planned Maintenance](https://signoz.io/docs/alerts-management/planned-maintenance/) — suppress alerts during maintenance windows
- [Alert History](https://signoz.io/docs/alerts-management/alerts-history/) — analyze alert patterns over time
