...
<Figure
  src="/img/docs/product-features/alerts/alerts-alert-rules-tab.gif"
  alt="A gif explaining the Alerts Rules Tab in SigNoz"
  caption="Features of Alert Rules Tab"
/>
...
<Figure
  src="/img/docs/product-features/alerts/alerts-triggered-tab.gif"
  alt="A gif explaining the Triggered Alerts Tab in SigNoz"
  caption="Features of Triggered Alerts Tab"
/>
...
For an infrastructure-as-code approach, you can also use the [Terraform provider](https://signoz.io/docs/alerts-management/terraform-provider-signoz/). If you run Kubernetes, the [SigNoz Operator](https://signoz.io/docs/manage/signoz-operator/overview/) manages alert rules as custom resources.
