...
description: Learn how to view and manage alert rules and triggered alerts in SigNoz.
title: Alerts 
---

The Alerts page in SigNoz has two main views — **Alert Rules** for managing your configured alert rules, and **Triggered Alerts** for seeing which alerts are currently firing.
