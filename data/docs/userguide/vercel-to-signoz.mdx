...
<Admonition type="tip">
  **Want a one-click setup?** Install the [SigNoz integration from the Vercel Marketplace](https://signoz.io/docs/integrations/vercel/). It creates the drains for you automatically. Drains do not carry Vercel Sandbox activity. To trace the code your agents run, see [Vercel Sandbox Observability](https://signoz.io/docs/vercel-sandbox-observability/).
</Admonition>
