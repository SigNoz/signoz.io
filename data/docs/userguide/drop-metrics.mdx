...
<Admonition type="info" title="Dropping labels does not reduce sample count" defaultCollapsed="true">
If you are trying to drop specific labels (attributes) to reduce cardinality, removing them may not work as expected and does not reduce ingest volume. See [Dropping Metric Labels](https://signoz.io/docs/metrics-management/dropping-metric-labels/) for details.
</Admonition>
...
- [Understanding Metrics Billing and Reducing Costs](https://signoz.io/docs/metrics-management/reducing-costs/): how cardinality maps to your bill
