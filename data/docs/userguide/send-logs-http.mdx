...
`<IP>` is the address of the system where your collector is running. To know more details about `<IP>`, checkout this [troubleshooting guide](https://signoz.io/docs/ingestion/self-hosted/overview/#endpoints).
