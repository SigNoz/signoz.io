...
3. Select the **Edit** button at the far right, and then enter the following information:
   ...
   2. _(Optional)_ Add one ore more tags by selecting the **New Tag** button.
...
1. In the dashboard configuration section, select **Publish**.
2. To allow viewers to change the time range on the public dashboard, toggle the **Enable time range** option.
3. Choose the **Default time range** that the public dashboard should use.
...
4. Click the **Publish Dashboard** button to enable public sharing.
5. A publicly shareable link will be generated, which you can use to provide public access to the dashboard.

## Disable Public Sharing

1. Navigate to the dashboard configuration section and select **Publish**.
2. To disable public sharing for the dashboard, click the **Revoke** button.
