...
5. Populate the following fields:
    ...
    5. _(Optional)_ **Legend Colors**: Open the **Legend Colors** section on the right-hand side of the panel editor to customize colors for individual series. Click a legend item to pick a new color.
