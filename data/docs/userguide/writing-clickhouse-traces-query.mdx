...
title: ClickHouse Queries for Traces
id: writing-clickhouse-traces-query
description: Write ClickHouse SQL queries against SigNoz traces data to build custom dashboard panels and alerts — schema reference, query patterns, and examples.
---
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/product-features/query-builder/clickhouse-query-editor.webp" alt="ClickHouse Query editor in SigNoz Dashboards"/>
    <figcaption><i>ClickHouse Query editor in SigNoz Dashboards</i></figcaption>
</figure>
