...
- **Visualize the Entire Trace:** Render large traces seamlessly using synchronized <Tooltip text="flame graphs" content="A visualization of a trace that shows each span as a horizontal bar positioned by start time and sized by duration." link="https://signoz.io/docs/glossary/#flamegraph" /> and waterfall charts.
...
- **Trace:** A <Tooltip text="trace" content="The full record of one request's path through a system: a tree of spans connected by parent-child relationships." link="https://signoz.io/docs/glossary/#trace" /> represents the complete path a request takes through your system, helping you understand its flow across various components and services.
- **Span:** <Tooltip text="Spans" content="A single operation within a trace: an HTTP handler, a database query, or a queue publish." link="https://signoz.io/docs/glossary/#span" /> are the building blocks of a trace, representing individual units of work performed by an application or service during the request's lifecycle. Key components of a span include:
  ...
  - **Span Events:** A <Tooltip text="span event" content="A timestamped annotation on a span, for things that happen at a moment rather than over a duration." link="https://signoz.io/docs/glossary/#span-event" /> is a structured log message that records an important event at a specific timestamp during the span's execution.
