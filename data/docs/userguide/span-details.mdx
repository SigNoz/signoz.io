...
**Scroll and Jump:**  
Use the up and down arrows to scroll through the spans or directly jump to a specific span (e.g., "Flat SP 1524") for a more focused analysis.
...
<figure data-zoomable align='center'>
    ...
    <figcaption><i>Resize Span names and Jump through spans</i></figcaption>
</figure>

The Trace Detail feature in SigNoz empowers you to effortlessly navigate, analyze, and debug complex traces across your systems and provides you with the insights 
necessary to debug issues, optimize performance, and understand your system's behavior in real time.
