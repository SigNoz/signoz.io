...
#### Span Percentile:
  When you view a span’s details, you can see its percentile compared to other spans from the same service over the last one hour (for example, p50, p90, p95, p99). 
  ...
  <figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/apm-and-distributed-tracing/span-percentile.png" alt="Span Percentile"/>
  ...
  <figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/apm-and-distributed-tracing/span-percentile-details.png" alt="Span Percentile Details"/>
  ...
  <figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/apm-and-distributed-tracing/span-percentile-custom.png" alt="Span Percentile With Custom Attribute"/>
