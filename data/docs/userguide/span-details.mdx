...
The Colour by submenu lets you customize how spans are colored in the flame graph and waterfall views. Choose an attribute like `service.name` or `host.name` to visually group spans by that dimension.
