...
```yaml:envoy.yaml defaultCollapsed
stats_sinks:
...
For detailed instructions on deploying the OTel Collector on Kubernetes, including configuration examples and best practices, refer to the [Kubernetes OpenTelemetry Collector Guide](https://signoz.io/docs/opentelemetry-collection-agents/k8s/k8s-infra/install-k8s-infra/).
...
```yaml:envoy-monitoring-stack.yaml minimap defaultCollapsed
apiVersion: apps/v1
kind: Deployment
metadata:
  name: httpbin
...
<Figure
  src="/img/docs/envoy-metrics.webp"
  alt="Envoy Metrics"
  caption="Envoy Metrics"
/>

<Figure
  src="/img/docs/envoy-metrics-detailed.webp"
  alt="Envoy Metrics - Detailed View"
  caption="Envoy Metrics - Detailed View"
/>

## Next Steps

- **Use Pre-built Dashboard**: Visualize your Envoy metrics using the [Envoy Proxy Dashboard](https://signoz.io/docs/dashboards/dashboard-templates/envoy-dashboard/).
