...
2. **OTEL_EXPORTER_OTLP_HEADERS**:
   Set this to `signoz-access-token=<SIGNOZ_INGESTION_KEY>`, where `<SIGNOZ_INGESTION_KEY>` is your [ingestion key](https://signoz.io/docs/ingestion/signoz-cloud/keys/).
