...
* The value of `OTEL_EXPORTER_OTLP_HEADERS` environment variable will be `signoz-ingestion-key=<SIGNOZ_INGESTION_KEY>` where `<SIGNOZ_INGESTION_KEY>` is your ingestion key
