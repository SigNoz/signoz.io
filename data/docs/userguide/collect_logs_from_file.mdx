...
<Admonition title="Collecting from custom file paths" defaultCollapsed="true">
...
<Admonition title="Storage extension for production deployments" defaultCollapsed="true">
