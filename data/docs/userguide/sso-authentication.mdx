...
Back in the domain list, toggle **Enforce SSO**. From now on, all the users with user name format `<user>@your-email-domain.com` will be forced to log in through Google.
