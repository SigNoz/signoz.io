...
title: Metrics ClickHouse Query Guide
description: Learn SigNoz metrics table schema and write ClickHouse queries for request rate, error rate, and p99 latency using the samples and time series tables.
---
