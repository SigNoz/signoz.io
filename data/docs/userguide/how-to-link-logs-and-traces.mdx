---
date: 2025-07-01
title: How to Link Logs and Traces in SigNoz
id: how-to-link-logs-and-traces
...
- Your logs contain trace IDs in the message body or custom attributes
...
4. Click **"View Logs"** - you should now see correlated logs
