...
title: Send AWS CloudWatch Logs to SigNoz
meta_title: Send AWS CloudWatch Logs to SigNoz
description: "Follow this SigNoz guide for AWS and CloudWatch logs. Set up collection, validate incoming logs, and connect them to search, alerts, and dashboards."
doc_type: howto
---
...
For detailed instructions on parsing timestamps, see the [Timestamp Parser documentation](https://signoz.io/docs/logs-pipelines/guides/timestamp-parsing/).
