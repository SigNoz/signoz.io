...
description: Send Fluent Bit logs to SigNoz using the OpenTelemetry Collector.
...
Follow this [guide](https://signoz.io/docs/opentelemetry-collection-agents/vm/install/).
...
4. **Update FluentBit configuration:**
    ...
    [OUTPUT]
      ...
      Port          24224
    ```
    Replace `<otel-collector-host>` with the host where the OpenTelemetry Collector is running. For more info, check the [troubleshooting guide](/docs/setup/docker/troubleshooting/faq/#signoz-otel-collector-address-grid).
