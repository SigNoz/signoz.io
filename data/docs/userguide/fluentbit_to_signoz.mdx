...
4. **Update FluentBit configuration:**
    ...
    [OUTPUT]
      ...
      Port          24224
    ```
    Replace `<otel-collector-host>` with the host where the OpenTelemetry Collector is running. For more info, check the [troubleshooting guide](https://signoz.io/docs/ingestion/self-hosted/overview/#endpoints).
