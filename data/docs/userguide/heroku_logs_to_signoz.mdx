...
description: Stream application logs from Heroku to SigNoz using HTTPS drains. This guide covers setup for both Cloud and Self-Hosted SigNoz instances.
...
Modify the [`docker-compose-minimal.yaml`](https://github.com/SigNoz/signoz/blob/main/deploy/docker/docker-compose.yaml) file to expose port `8081` for receiving logs:
...
Refer to the [troubleshooting guide](https://signoz.io/docs/setup/docker/troubleshooting/faq/#signoz-otel-collector-address-grid) for finding the correct SigNoz host address.
