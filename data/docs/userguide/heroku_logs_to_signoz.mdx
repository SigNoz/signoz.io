...
Once the drain is added, verify the logs in the **SigNoz UI** in the Logs tab.
...
Refer to the [troubleshooting guide](/docs/install/troubleshooting#signoz-otel-collector-address-grid) for finding the correct SigNoz host address.
