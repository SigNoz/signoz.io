---
date: 2026-03-31
title: How to Query Logs
id: logs_query_builder
description: Search, filter, aggregate, and compare logs using the SigNoz Logs Query Builder.
doc_type: howto
---

## Overview

The Logs Query Builder lets you search and analyze logs with attribute filtering, aggregations, groupings, and multi-query comparisons — all without writing SQL. Results update live and can be pinned to dashboards or turned into alerts.

:::info Prerequisites
- Logs are flowing into SigNoz.
- Go to **Logs → Logs Explorer** to access the Query Builder.
:::

---

The sections below walk through the key capabilities of the Query Builder.
...
- [Logs Explorer Overview](/docs/logs-management/logs-explorer/overview)
