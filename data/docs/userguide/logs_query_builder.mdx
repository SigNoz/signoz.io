...
Just like search, the [Query Builder](https://signoz.io/docs/userguide/query-builder/) also allows you to filter your logs data based on different attributes using operators. The Query Builder provides you with additional powerful features like aggregation, grouping etc. on your data.
...
You can copy a direct link to a particular log line, which can be shared with anyone who has access to the same [SigNoz](https://signoz.io/) instance.
