...
<figure data-zoomable align='center'>
    <img src="/img/docs/logs-management/ui/logs-list-view.webp" alt="List View in Logs Explorer"/>
    <figcaption><i>List View in Logs Explorer</i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img src="/img/docs/logs-management/ui/logs-frequency-chart.webp" alt="Frequency chart in List View showing log distribution by severity"/>
    <figcaption><i>Frequency chart showing log volume over time, grouped by severity text</i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img src="/img/docs/logs-management/ui/logs-list-view-settings.webp" alt="List View Settings in Logs Explorer"/>
    <figcaption><i>List View settings showing Format, Font Size, Max Lines Per Row, and Columns options</i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img src="/img/docs/logs-management/ui/logs-show-in-context.webp" alt="Show in Context feature in List View"/>
    <figcaption><i>Show in Context feature showing surrounding log entries</i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img src="/img/docs/logs-management/ui/logs-copy-link.webp" alt="Copy Link feature in List View"/>
    <figcaption><i>Copy Link feature for sharing a specific log line</i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img src="/img/docs/logs-management/ui/logs-timeseries-view.webp" alt="Time Series View in Logs Explorer"/>
    <figcaption><i>Time Series View in Logs Explorer</i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img src="/img/docs/logs-management/ui/logs-table-view.webp" alt="Table View in Logs Explorer"/>
...
<figure data-zoomable align='center'>
    <img src="/img/docs/logs-management/ui/logs-detail-view.webp" alt="Log Details Panel in Logs Explorer"/>
...
<figure data-zoomable align='center'>
    <img src="/img/docs/logs-management/ui/logs-detail-body.webp" alt="Log Body in Overview section of Log Details"/>
    <figcaption><i>Log Body in the Overview section showing body content with Wrap text toggle</i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img src="/img/docs/logs-management/ui/logs-detail-search-attribute.webp" alt="Search for an attribute in Log Details"/>
    <figcaption><i>Search for a specific attribute in the Log Details panel</i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img src="/img/docs/logs-management/ui/logs-detail-overview-actions.webp" alt="Quick actions on attribute values in Log Details"/>
...
<figure data-zoomable align='center'>
    <img src="/img/docs/logs-management/ui/logs-detail-json.webp" alt="JSON tab in Log Details panel"/>
    <figcaption><i>JSON tab showing the complete log in JSON format with Copy Log option</i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img src="/img/docs/logs-management/ui/logs-detail-context.webp" alt="Context tab in Log Details panel"/>
    <figcaption><i>Context tab showing surrounding log entries for debugging</i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img src="/img/docs/logs-management/ui/logs-detail-metrics.webp" alt="Metrics tab in Log Details panel"/>
    <figcaption><i>Metrics tab showing CPU and Memory usage for the associated node and pod</i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img src="/img/docs/logs-management/ui/logs-live-view.webp" alt="Live View in Logs Explorer"/>
    <figcaption><i>Live View streaming logs in real time</i></figcaption>
</figure>
