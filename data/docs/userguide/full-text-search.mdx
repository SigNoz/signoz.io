...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/product-features/query-builder/full-text-search-quoted.webp" alt="Quoted full-text search in SigNoz Logs Explorer"/>
    <figcaption><i>Quoted full-text search in the Logs Explorer</i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/product-features/query-builder/full-text-search-unquoted.webp" alt="Unquoted full-text search in SigNoz Logs Explorer"/>
    <figcaption><i>Unquoted full-text search in the Logs Explorer</i></figcaption>
</figure>
