...
PromQL queries are only supported in **Dashboards**. To write a PromQL query, go to **Dashboards**, create a new dashboard or open an existing one, add a new panel, and select the **PromQL** tab.
</Admonition>

<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/product-features/query-builder/promql-query-editor.webp" alt="PromQL Query editor in SigNoz Dashboards"/>
    <figcaption><i>PromQL Query editor in SigNoz Dashboards</i></figcaption>
</figure>
