...
title: Operators Reference - List of all Search Operators in Signoz
description: Complete reference for all SigNoz search operators including comparison, string matching, range, set, regex, and EXISTS operators with practical examples.
---
