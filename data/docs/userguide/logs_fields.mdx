...
By default whenever you receive a log from a non OTLP receivers it will be stored directly in the body and you won't be able to filter logs based on fields/attributes. Opentelemetry provides different ways to parse attributes from your logs using different [operators](https://signoz.io/docs/logs-pipelines/processors/) that the available. These parsed attributes are referred to as fields in signoz.
