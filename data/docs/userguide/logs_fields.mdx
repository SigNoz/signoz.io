...
If you take a look in the SigNoz repository, you’ll find the configuration for the collector in <a href="https://github.com/SigNoz/signoz/blob/main/deploy/docker/otel-collector-config.yaml" target="_blank" rel="noopener noreferrer nofollow">/deploy/docker/otel-collector-config.yaml</a> You can edit this file to filter what logs are being stored after being received by the collector.
