...
<figure data-zoomable align='center'>
    <img src="/img/docs/dashboards/variables/variable-configuration.webp" alt="Variable configuration panel in SigNoz"/>
    <figcaption><i>Variable configuration — set the name, type, default value, and select panels to apply the variable to.</i></figcaption>
</figure>
...
Once you've created variables, you can reference them in Query Builder, ClickHouse SQL, and PromQL queries using `$var` syntax. See [Using Variables in Queries](https://signoz.io/docs/dashboards/using-variables-in-queries/) for full syntax and examples.
