...
You can choose **any receiver** available in the <a href="https://opentelemetry.io/ecosystem/registry/?component=receiver" target="_blank" rel="noopener noreferrer">OpenTelemetry Registry</a>; this example uses RabbitMQ, but the pattern is the same for other services.
...
> **Note**: You can find the configuration settings for any service in the <a href="https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/main/receiver" target="_blank" rel="noopener noreferrer">OpenTelemetry Collector Contrib repository</a>.
