...
4. **Update FluentD Configuration**
   ...
   ```
   Replace `<otel-collector-host>` with the host where the OpenTelemetry collector is running. For troubleshooting, check [here](https://signoz.io/docs/ingestion/self-hosted/overview/#endpoints).
