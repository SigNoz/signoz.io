...
<figure data-zoomable align='center'>
    <img src="/img/docs/product-features/query-builder/query-builder-filtering-spans.gif" alt="A gif explaining the Filtering feature in SigNoz Query Builder"/>
...
<figure data-zoomable align='center'>
    <img src="/img/docs/product-features/query-builder/most-frequently-added-products.gif" alt="A gif explaining the count aggregation feature in SigNoz Query Builder"/>
...
<figure data-zoomable align='center'>
    <img src="/img/docs/product-features/query-builder/bulk-quantity-buyers.gif" alt="A gif explaining the sum aggregation feature in SigNoz Query Builder"/>
...
<figure data-zoomable align='center'>
    <img src="/img/docs/product-features/query-builder/cart-additions-over-one-day.gif" alt="A gif explaining the count aggregation feature in SigNoz Query Builder"/>
    <figcaption><i>Example showing the count aggregation feature of SigNoz Query Builder</i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img src="/img/docs/product-features/query-builder/per-product-avg-quantity.gif" alt="A gif explaining the avg aggregation feature in SigNoz Query Builder"/>
...
<figure data-zoomable align='center'>
    <img src="/img/docs/product-features/query-builder/show-order-by.gif" alt="A gif explaining the order by feature in SigNoz Query Builder"/>
...
Create meaningful chart labels using template variables:

**Basic Format**: `{{service.name}}`

**Descriptive Format**: `Service: {{service.name}} - Avg: {{avg(duration)}}ms`
...
<figure data-zoomable align='center'>
    <img src="/img/docs/product-features/query-builder/error-rate-percentage.gif" alt="A gif explaining the Formula feature in SigNoz Query Builder"/>
...
<figure data-zoomable align='center'>
    <img src="/img/docs/product-features/query-builder/sla-monitoring-with-duration.gif" alt="A gif explaining the Formula feature in SigNoz Query Builder"/>
    <figcaption><i>Example showing the Formula feature feature of SigNoz Query Builder</i></figcaption>
</figure>
