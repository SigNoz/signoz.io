...
title: Search Syntax Guide - Filter Logs, Traces & Metrics
description: Learn SigNoz search syntax to filter logs, traces, and metrics. Understand field comparisons, boolean operators, and common query pitfalls with practical examples.
---
