...
title: "Log Search Syntax: Query, Filter, and Analyze Logs in SigNoz"
meta_title: "Log Search Syntax - Query, Filter, and Analyze Logs in SigNoz"
description: "Follow this SigNoz guide for Log search syntax and querying. Set up collection, validate incoming logs, and connect them to search, alerts, and dashboards."
---
...
- **[Full-Text Search Guide](https://signoz.io/docs/userguide/full-text-search/)** - How to search text content in logs
- **[Functions Reference](https://signoz.io/docs/userguide/functions-reference/)** - Array functions for JSON searches
