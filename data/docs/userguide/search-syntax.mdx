...
title: Log Search Syntax and Querying in SigNoz
meta_title: "Log Search Syntax & Querying"
description: "Learn how to query logs in SigNoz using search syntax, operators, fields, and examples for faster log investigation."
---
...
To search the log body without naming a field, type what you're looking for:
...
To search every field of a log record instead of just the body, use `search()`:
...
- **[Operators Reference](https://signoz.io/docs/userguide/operators-reference/)** - Complete list of operators and their behavior
- **[Full-Text Search Guide](https://signoz.io/docs/userguide/full-text-search/)** - How to search every field of a log record with `search()`
- **[Free-Text Log Search Guide](https://signoz.io/docs/userguide/free-text-search/)** - How to search log body content with phrases and regex
- **[Functions Reference](https://signoz.io/docs/userguide/functions-reference/)** - `search()`, token matching, and array functions
- **[Field Context & Data Types](https://signoz.io/docs/userguide/field-context-data-types/)** - Understanding contexts and type specification
- **[Troubleshooting Guide](https://signoz.io/docs/userguide/search-troubleshooting/)** - Common errors and how to fix them
- **[Advanced Examples](https://signoz.io/docs/userguide/search-advanced-examples/)** - Complex query patterns and use cases
