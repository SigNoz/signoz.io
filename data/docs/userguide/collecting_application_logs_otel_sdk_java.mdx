...
description: Learn how to collect and send application logs from your Java application to SigNoz using the OpenTelemetry Java agent
...
- Instrument your Java application with [traces](https://signoz.io/docs/instrumentation/java/opentelemetry-java/) and [metrics](https://signoz.io/docs/metrics-management/send-metrics/applications/opentelemetry-java/) for complete observability
