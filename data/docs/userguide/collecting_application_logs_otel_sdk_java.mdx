...
- Replace `{region}` with the appropriate region for your cloud account:
...
### Example with Experimental Attributes
...
## Sending Logs to SigNoz Hosted Locally
