...
description: If you use Logstash to collect logs in your stack, this tutorial will help you send logs from Logstash to SigNoz.
...
1. **Add OpenTelemetry Collector Binary**
   ...
   Add the OpenTelemetry collector binary to your VM by following this [guide](https://signoz.io/docs/opentelemetry-collection-agents/vm/install/).
