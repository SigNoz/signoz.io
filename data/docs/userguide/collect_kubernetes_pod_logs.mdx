...
## Collect Kubernetes Pod Logs in SigNoz

<Tabs>
<TabItem value="Cloud" label="SigNoz Cloud" default>
To collect logs from your kubernetes cluster, you will need to deploy k8s-infra chart. Please follow the guide <a href = "/docs/tutorial/kubernetes-infra-metrics/" rel="noopener noreferrer nofollow" target="_blank" >here</a>. 
Log collection of pods from all namespaces is enabled by default except for pods in `kube-system` and `hotrod`. To modify the log collection mechanism, please follow the guides below.


- [Disable automatic pod logs collection](#disable-automatic-pod-logs-collection)
- [Filter/Exclude logs collection](#filterexcludeinclude-logs-collection)
...
### Filter/Exclude/Include Logs Collection
