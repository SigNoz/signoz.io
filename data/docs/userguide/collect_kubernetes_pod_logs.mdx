...
For more advanced log filtering options and additional ways to drop logs using OpenTelemetry processors, see our [guide to drop logs](https://signoz.io/docs/logs-management/guides/drop-logs/).
