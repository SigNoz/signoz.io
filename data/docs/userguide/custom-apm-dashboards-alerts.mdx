...
<Figure
  src="/img/docs/dashboards/templates/apm-metrics.png"
  alt="APM Metrics dashboard"
...
<Figure
  src="/img/docs/dashboards/templates/http-api-monitoring.png"
  alt="HTTP API Monitoring Dashboard"
  caption="HTTP API Monitoring Dashboard"
/>
...
<Figure
  src="/img/docs/dashboards/templates/db-calls-monitoring.png"
  alt="DB Calls Monitoring Dashboard"
...
<Figure
  src="/img/docs/apm-and-distributed-tracing/key-operations-dashboard.webp"
  alt="Key Operations dashboard showing latency, error rate, and request rate per operation"
  caption="Key Operations Dashboard"
/>
