...
For details on database call metrics and required span attributes, see [Database Calls](/docs/apm-and-distributed-tracing/database-calls).

### External Calls in SigNoz

For details on external call metrics and required span attributes, see [External Calls](/docs/apm-and-distributed-tracing/external-calls).
