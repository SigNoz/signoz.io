...
<figure data-zoomable align='center'>
    <img src="/img/docs/apm-and-distributed-tracing/services-refresh-interval.webp" alt="Refresh interval options including Auto Refresh with intervals from 5 seconds to 1 day"/>
    <figcaption><i>Refresh Interval — set auto refresh frequency</i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img src="/img/docs/apm-and-distributed-tracing/services-share.webp" alt="Share panel showing Enable absolute time toggle and Copy page link button"/>
    <figcaption><i>Share — copy the current page link to share with your team</i></figcaption>
</figure>
