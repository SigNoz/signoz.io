...
1. **[Install Guide](/docs/collection-agents/ecs/ec2/install/)**: Set up the daemon service infrastructure
2. **[Configure Guide](/docs/collection-agents/ecs/ec2/configure/)**: Customize collection settings and verify data flow
