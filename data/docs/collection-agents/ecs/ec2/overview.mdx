...
> **Note for Fargate Users**: If you're using Fargate launch type, this daemon service approach won't work. Instead, check out the [ECS Sidecar documentation](https://signoz.io/docs/userguide/collecting-ecs-sidecar-infra/) for Fargate-compatible collection methods.
...
You can use this daemon service with either deployment option:

### SigNoz Cloud
- Fully managed SigNoz service
- Requires ingestion key for authentication
- Regional endpoints for data forwarding
- No infrastructure management needed

### Self-Hosted SigNoz
- Self-managed SigNoz installation
- Direct connection to your SigNoz instance
...
1. **[Install Guide](./install.md)**: Set up the daemon service infrastructure
2. **[Configure Guide](./configure.md)**: Customize collection settings and verify data flow

The installation process involves downloading CloudFormation templates and setting up the OpenTelemetry Collector configuration, while configuration covers customizing what data gets collected and ensuring everything works properly.