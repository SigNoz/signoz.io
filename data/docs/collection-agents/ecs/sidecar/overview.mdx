...
date: 2025-08-19
id: overview
title: ECS Sidecar Collection Agent - Overview
description: View metrics, traces and logs for your ECS infrastructure using sidecar containers
---

## What is ECS Sidecar Collection?

This documentation explains how to collect metrics, traces, and logs from your Amazon ECS (Elastic Container Service) infrastructure using a sidecar container approach. The sidecar method involves deploying an additional container (the "sidecar") that runs in each application container of your ECS cluster to collect telemetry data and forward it to SigNoz.
