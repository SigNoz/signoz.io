...
date: 2025-08-19
id: install
title: ECS Sidecar Collection Agent - Install
description: Install and deploy the sidecar container for ECS infrastructure monitoring
---
This guide walks you through installing the sidecar container to collect metrics, traces, and logs from your ECS infrastructure.

## Prerequisites Check

Before starting, verify you have:
- ECS cluster with any launch type (**Fargate**, **EC2**, or **External**)
