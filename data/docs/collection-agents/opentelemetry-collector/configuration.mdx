...
The service section defines pipelines that connect components with each other. Each pipeline defines the flow of data through receivers, processors, and exporters.
...
### 2. Place memory_limiter at the beginning
