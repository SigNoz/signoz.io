...
<figure data-zoomable align='center'>
    <img src="/img/docs/apm-and-distributed-tracing/key-operations-entrypoint-spans.webp" alt="Key Operations table with Entry Point Spans toggle enabled"/>
    <figcaption><i>Key Operations — Entry Point Spans toggle filters to service entry-point spans only</i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img src="/img/docs/apm-and-distributed-tracing/view-magnified-graph.webp" alt="Magnified graph view opened via the 3-dot menu on a metric chart"/>
    <figcaption><i>Click the 3-dot menu → View to open a magnified graph</i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img src="/img/docs/apm-and-distributed-tracing/filter-series.webp" alt="Filter Series search bar inside a magnified metric graph"/>
    <figcaption><i>Filter Series — narrow the displayed series in a metric graph</i></figcaption>
</figure>
...
You can also import the <a href="https://github.com/SigNoz/dashboards/tree/main/key-operations" target="_blank" rel="noopener noreferrer nofollow">Key Operations Dashboard</a> for a ready-made view of your service's key operations.
