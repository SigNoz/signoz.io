...
You can also import the <a href="https://github.com/SigNoz/dashboards/blob/main/apm/apm-metrics.json" target="_blank" rel="noopener noreferrer nofollow">APM Metrics Dashboard</a> for a ready-made view of your application performance metrics.

<figure data-zoomable align='center'>
    <img src="/img/docs/apm-and-distributed-tracing/apm-dashboard.webp" alt="APM Metrics Dashboard showing latency, error rate, and request rate"/>
