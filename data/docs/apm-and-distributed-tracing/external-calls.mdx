...
<figure data-zoomable align='center'>
    <img src="/img/docs/apm-and-distributed-tracing/external-calls-metrics.webp" alt="External Metrics tab showing error percentage, average duration, RPS by address, and duration by address"/>
    <figcaption><i>External Metrics — error rate, latency, and throughput by address</i></figcaption>
</figure>
