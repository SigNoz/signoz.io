...
Import the <a href="https://github.com/SigNoz/dashboards/blob/main/apm/db-calls-monitoring.json" target="_blank" rel="noopener noreferrer nofollow">DB Calls Monitoring Dashboard</a> for a ready-made view of database call metrics.
