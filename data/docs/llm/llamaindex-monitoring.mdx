...
To get started, check out our example LlamaIndex RAG Q&A bot, complete with OpenTelemetry-based monitoring (via OpenInference). View the full repository [here](insert link to repo).
...
**Step 5:** Instrument LlamaIndex using OpenInference and the configured Tracer Provider
