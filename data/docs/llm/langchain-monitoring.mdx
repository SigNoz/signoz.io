...
To get started, check out our example LangChain agent with OpenTelemetry-based monitoring (via OpenInference). View the full repository [here](insert link to repo).
