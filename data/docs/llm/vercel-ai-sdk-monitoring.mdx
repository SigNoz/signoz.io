...
![Terminal output showing OpenTelemetry initialization](/img/docs/llm/vercel/vercel-run-output.webp)
...
![Traces View](/img/docs/llm/vercel/vercel-traces-view.webp)

![Detailed Traces View](/img/docs/llm/vercel/vercel-traces-detailed-view.webp)