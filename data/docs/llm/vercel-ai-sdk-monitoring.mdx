# Integrating Vercel AI SDK Telemetry with SigNoz
...
![Terminal output showing OpenTelemetry initialization](../../../public/img/docs/llm/vercel/vercel-run-output.webp)
...
The Vercel AI SDK uses [OpenTelemetry](https://opentelemetry.io/) to collect telemetry data. OpenTelemetry is an open-source observability framework designed to provide standardized instrumentation for collecting telemetry data.
...
Your Vercel AI SDK commands should now automatically emit traces, spans, and events according to [here](https://ai-sdk.dev/docs/ai-sdk-core/telemetry#collected-data). 

Finally, you should be able to view this data in Signoz Cloud under the traces tab:

![Traces View](../../../public/img/docs/llm/vercel/vercel-traces-view.webp)

![Detailed Traces View](../../../public/img/docs/llm/vercel/vercel-traces-detailed-view.webp)