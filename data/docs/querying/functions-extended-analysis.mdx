...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/product-features/query-builder/metrics-functions-dropdown.webp" alt="Functions available in the Metrics Query Builder"/>
    <figcaption><i>Functions available in the Metrics Query Builder</i></figcaption>
</figure>
