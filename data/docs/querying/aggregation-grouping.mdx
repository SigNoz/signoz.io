...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/product-features/query-builder/percentile-functions-dropdown.webp" alt="Percentile aggregation functions available in SigNoz Query Builder"/>
    <figcaption><i>Percentile aggregation functions available in the Query Builder</i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/product-features/query-builder/rate-functions-dropdown.webp" alt="Rate aggregation functions available in SigNoz Query Builder"/>
    <figcaption><i>Rate aggregation functions available in the Query Builder</i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/product-features/query-builder/query-builder-group-by.webp" alt="Group by feature in SigNoz Query Builder showing data grouped by service.name and deployment.environment"/>
