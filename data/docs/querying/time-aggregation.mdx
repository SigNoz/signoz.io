...
<figure data-zoomable align='center'>
    <img src="/img/docs/querying/time-aggregation-step-interval.webp" alt="Step interval dropdown in the SigNoz Query Builder showing available interval options"/>
    <figcaption><i>The step interval dropdown in the Query Builder. The default is <b>Auto</b>, which calculates the best interval for the current time range.</i></figcaption>
</figure>
