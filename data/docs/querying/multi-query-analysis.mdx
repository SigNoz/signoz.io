...
Trace operators let you combine multiple trace queries to analyze parent-child span relationships within a trace. Trace matching is available in the Traces Explorer across **Trace View**, **List View**, **Table View**, and **Time Series** views.
