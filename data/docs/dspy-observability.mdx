...
description: Set up DSPy observability and monitoring with OpenTelemetry and SigNoz. Trace module, chain, and tool calls, model requests, latency, and errors from your DSPy programs.
doc_type: howto
---
...
## DSPy Observability with OpenTelemetry
