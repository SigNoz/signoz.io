...
<YouTube id="IaSXcmdkB1Y" mute="false" />
...
<figure data-zoomable align="center">
  <img src="/img/docs/llm/openai/openai-traces.webp" alt="OpenAI monitoring traces in SigNoz showing span details and token usage" />
  <figcaption>
    <i>OpenAI request traces in SigNoz</i>
  </figcaption>
</figure>

<figure data-zoomable align="center">
  <img src="/img/docs/llm/openai/openai-logs.webp" alt="OpenAI application logs captured in SigNoz via OpenTelemetry" />
  <figcaption>
    <i>OpenAI API logs in SigNoz</i>
  </figcaption>
</figure>

<figure data-zoomable align="center">
  <img src="/img/docs/llm/openai/openai-metrics.webp" alt="OpenAI monitoring metrics in SigNoz showing token usage and latency" />
  <figcaption>
    <i>OpenAI API metrics in SigNoz</i>
  </figcaption>
</figure>
