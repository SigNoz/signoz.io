...
<Figure
  src="/img/docs/llm/openai/openai-traces.webp"
  alt="OpenAI monitoring traces in SigNoz showing span details and token usage"
  caption="OpenAI request traces in SigNoz"
/>

<Figure
  src="/img/docs/llm/openai/openai-logs.webp"
  alt="OpenAI application logs captured in SigNoz via OpenTelemetry"
  caption="OpenAI API logs in SigNoz"
/>

<Figure
  src="/img/docs/llm/openai/openai-metrics.webp"
  alt="OpenAI monitoring metrics in SigNoz showing token usage and latency"
  caption="OpenAI API metrics in SigNoz"
/>
