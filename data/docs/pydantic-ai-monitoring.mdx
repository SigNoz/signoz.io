---
date: 2025-10-16
id: pydantic-ai-monitoring-with-opentelemetry
tags : [SigNoz Cloud, Pydantic AI, OpenTelemtry, Monitoring, Observability]
title: Monitoring Pydantic AI with SigNoz
description: Monitor Pydantic AI performance and usage with OpenTelemetry instrumentation and send traces, logs, and metrics to SigNoz
---

## Overview

This guide walks you through setting up monitoring for Pydantic AI API using [OpenTelemetry](https://opentelemetry.io/) and exporting logs, traces, and metrics to SigNoz. With this integration, you can observe model and agent performance, capture request/response details, and track system-level metrics in SigNoz, giving you real-time visibility into latency, error rates, and usage trends for your Pydantic AI applications.
...
<Figure src="/img/docs/llm/pydantic/pydantic-traces.webp" alt="Pydantic Trace View" caption="Pydantic AI Trace View" />

When you click on a trace in SigNoz, you'll see a detailed view of the trace, including all associated spans, along with their events and attributes.

<Figure src="/img/docs/llm/pydantic/pydantic-detailed-traces.webp" alt="Pydantic Detailed Trace View" caption="Pydantic AI Detailed Trace View" />
...
<Figure src="/img/docs/llm/pydantic/pydantic-logs.webp" alt="Pydantic Logs View" caption="Pydantic AI Logs View" />

When you click on any of these logs in SigNoz, you'll see a detailed view of the log, including attributes:

<Figure src="/img/docs/llm/pydantic/pydantic-detailed-logs.webp" alt="Pydantic Detailed Log View" caption="Pydantic AI Detailed Logs View" />

You should be able to see Pydantic related metrics in Signoz Cloud under the metrics tab:

<Figure src="/img/docs/llm/pydantic/pydantic-metrics.webp" alt="Pydantic Metrics View" caption="Pydantic AI Metrics View" />

When you click on any of these metrics in SigNoz, you'll see a detailed view of the metric, including attributes:

<Figure src="/img/docs/llm/pydantic/pydantic-detailed-metrics.webp" alt="Pydantic Detailed Metrics View" caption="Pydantic AI Detailed Metrics View" />
...
<Figure src="/img/docs/llm/pydantic/pydantic-dashboard.webp" alt="Pydantic Dashboard" caption="Pydantic AI Dashboard Template" />