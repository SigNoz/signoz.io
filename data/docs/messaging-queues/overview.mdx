...
meta_title: Messaging Queues Monitoring Overview
hide_table_of_contents: false
description: Learn how SigNoz Cloud monitors Kafka and Celery queues by correlating messaging metrics with OpenTelemetry traces; Self-Hosted SigNoz is also supported.
---

The **Messaging Queues feature** in **SigNoz Cloud** provides visibility into distributed systems built on **Kafka** or **Celery**. The same feature is available in **Self-Hosted SigNoz**. While other tools focus solely on native broker or queue metrics, both editions correlate those metrics with traces in real time using <a href="https://opentelemetry.io/docs/specs/semconv/" target="_blank" rel="noopener noreferrer nofollow">OpenTelemetry semantic conventions</a>.
...
With SigNoz Cloud or Self-Hosted SigNoz, you get **both**:
...
- [Kafka](https://signoz.io/docs/messaging-queues/kafka-overview/)
- [Celery](https://signoz.io/docs/messaging-queues/celery-overview/)
