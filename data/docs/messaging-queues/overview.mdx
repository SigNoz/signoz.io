...
description: Discover how SigNoz monitors Kafka and Celery queues by correlating native messaging metrics with OpenTelemetry traces for full visibility into distributed message flows.
---
