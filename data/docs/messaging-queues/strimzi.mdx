...
date: 2026-05-27
title: Strimzi
meta_title: Monitor Strimzi Kafka on Kubernetes with OTel
description: Learn how to monitor Strimzi Kafka on Kubernetes using OpenTelemetry and SigNoz. Set up operator, metrics collection, OTel Collector deployment, and trace visualization.
tags : [SigNoz Cloud]
