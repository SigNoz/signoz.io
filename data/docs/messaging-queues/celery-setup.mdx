...
description: This documentation provides a comprehensive, ready-to-use guide to set up metrics collection for Celery using OpenTelemetry and SigNoz.
id: celery-setup
...
<a href="https://docs.celeryq.dev/en/stable/index.html" rel="noopener noreferrer nofollow" target="_blank">Celery</a> is a distributed task queue, written in Python, that allows 
...
We are using Redis Queue in this example. However, you can choose any of the <a href="https://docs.celeryq.dev/en/main/getting-started/backends-and-brokers/index.html#broker-overview" rel="noopener noreferrer nofollow" target="_blank">supported brokers </a> for the Celery setup.
</Admonition>
...
While using celery, you can optionally enable flower metrics collection. You can read about flower in the <a href="https://flower.readthedocs.io/en/latest/" rel="noopener noreferrer nofollow" target="_blank">official docs </a>.
...
For more information, refer to the <a href="https://docs.celeryq.dev/en/latest/userguide/configuration.html#worker-send-task-events" rel="noopener noreferrer nofollow" target="_blank"> Celery configuration documentation </a> and <a href="https://docs.celeryq.dev/en/stable/userguide/monitoring.html#worker-online" rel="noopener noreferrer nofollow" target="_blank"> monitoring guide </a>.
