...
For more information, refer to the [Celery configuration documentation](https://docs.celeryq.dev/en/latest/userguide/configuration.html#worker-send-task-events) and [monitoring guide](https://docs.celeryq.dev/en/stable/userguide/monitoring.html#worker-online).
