...
<a href="https://docs.celeryq.dev/en/stable/index.html">Celery</a> is a distributed task queue, written in Python, that allows 
...
We are using Redis Queue in this example. However, you can choose any of the <a href="https://docs.celeryq.dev/en/main/getting-started/backends-and-brokers/index.html#broker-overview">supported brokers </a> for the Celery setup.
</Admonition>
...
While using celery, you can optionally enable flower metrics collection. You can read about flower in the <a href="https://flower.readthedocs.io/en/latest/">official docs </a>.
...
For more information, refer to the <a href="https://docs.celeryq.dev/en/latest/userguide/configuration.html#worker-send-task-events"> Celery configuration documentation </a> and <a href="https://docs.celeryq.dev/en/stable/userguide/monitoring.html#worker-online"> monitoring guide </a>.
