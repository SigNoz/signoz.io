...
meta_title: Monitor Amazon MSK with OpenTelemetry
description: Learn how to monitor Amazon MSK using OpenTelemetry and SigNoz. Set up your MSK cluster, OTel Collector config, Java producer-consumer instrumentation, and trace visualization.
tags : [SigNoz Cloud]
...
<Figure
  ...
  caption="MSK Monitoring Settings"
/>
...
You can [follow this doc](https://signoz.io/docs/opentelemetry-collection-agents/vm/install/) to download the binary for your Operating System.
