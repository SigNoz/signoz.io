...
meta_title: Kafka Monitoring Overview - Lag, Latency & Metrics
description: Explore SigNoz's Kafka monitoring dashboard. Track consumer lag, producer latency, partition throughput, and drop rates with correlated trace data for fast bottleneck detection.
