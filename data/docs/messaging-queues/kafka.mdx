...
<Tabs>
<TabItem value="Local" label="Local/VM" default>
...
download the binary for you particular Operating System.
...
The config file ets up the OpenTelemetry Collector to gather Kafka and JVM metrics from multiple brokers(2 brokers in the above config) via Kafka metrics scraping 
