...
description: Learn how to monitor self-hosted Kafka using OpenTelemetry and SigNoz. Set up Kafka, Java OTel agent, producer-consumer instrumentation, and metrics and trace visualization.
