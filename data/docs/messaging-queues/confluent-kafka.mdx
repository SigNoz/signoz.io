...
<Figure
  ...
  caption="Select Cloud Resource Management"
/>
...
Install and configure OpenTelemetry for scraping the metrics from Confluent Cloud. Follow [OpenTelemetry Binary Usage in Virtual Machine](https://signoz.io/docs/opentelemetry-collection-agents/vm/install/) guide for detailed instructions.
...
<Figure
  ...
  caption="Viewing OpenTelemetry Collector Logs"
/>
...
<Figure
  ...
  caption="Sample Metric from Confluent Cloud"
/>
...
<Figure
  ...
  caption="Confluent Self-Managed"
/>
...
<Figure
  ...
  caption="TAR installation download"
/>
...
Download the OpenTelemetry Collector Contrib binary. You can [follow this doc](https://signoz.io/docs/opentelemetry-collection-agents/vm/install/) to 
...
<Figure
  ...
  caption="Messaging Queues tab in SigNoz"
/>
