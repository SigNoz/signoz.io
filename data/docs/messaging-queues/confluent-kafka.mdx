...
description: {/* This documentation provides a comprehensive, ready-to-use guide to set up metrics collection for Confluent Kafka using OpenTelemetry and SigNoz.
