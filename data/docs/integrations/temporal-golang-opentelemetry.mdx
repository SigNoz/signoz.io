...
description: We have published a helloworld Temporal application instrumented with OpenTelemetry in the temporal-golang-opentelemetry sample repository .
---
...
<Tabs>
    ...
    <TabItem value="via-collector" label="Via Collector">
        ...
        1. For VM  => follow the [OpenTelemetry binary usage guide for virtual machines](https://signoz.io/docs/opentelemetry-collection-agents/vm/install/)
