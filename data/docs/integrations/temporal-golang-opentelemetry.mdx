...
### Step 3: Changes in temporal worker and temporal client code 

Add the below code to the start of your worker code
```
...
You should be able to see incoming temporal sdk metrics at **Metrics Explorer** page at SigNoz. Once you see them coming, go to Dashboards -> Import Dashboard.
