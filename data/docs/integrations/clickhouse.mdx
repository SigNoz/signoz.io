...
description: This integration helps you monitor key Clickhouse metrics and logs, view them with an out-of-the-box dashboard, and collect query logs for better queryi...
---
...
2. An OpenTelemetry (OTEL) Collector with access to the Clickhouse server
   - [Install the SigNoz OTEL Collector](https://signoz.io/docs/opentelemetry-collection-agents/vm/install/) (v0.88.0 or newer, v0.88.23+ for query log collection) if not done already 
