...
The MongoDB Atlas receiver collects OpenTelemetry data from MongoDB Atlas, including database performance metrics, operational data, 
audit logs, process metrics and system events.
