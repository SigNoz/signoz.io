...
This integration helps you monitor key MongoDB Atlas metrics and logs, view them with an out-of-the-box dashboard, and parse MongoDB Atlas logs for better querying and aggregation.

The MongoDB Atlas receiver collects OpenTelemetry data from MongoDB Atlas, including database performance metrics, operational data, audit logs, process metrics and system events.
...
Download JSON from [link](https://github.com/SigNoz/dashboards/blob/main/mongodb-atlas/mongodb-atlas-otlp-v1.json).
...
| [mongodbatlas.process.cache.io](http://mongodbatlas.process.cache.io)     | Gauge | Bytes                | Cache throughput (per second)                                                                           |
...
| [mongodbatlas.process.network.io](http://mongodbatlas.process.network.io) | Gauge | Bytes/s              | Network IO                                                                                              |
...
<figure data-zoomable align='center'>
    <img src="/img/docs/integrations/mongodb-atlas/hdetailed-log.webp" alt="MongoDB Atlas Detailed Log"/>
