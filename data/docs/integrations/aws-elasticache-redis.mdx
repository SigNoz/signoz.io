...
export SIGNOZ_INGESTION_KEY="<SIGNOZ_INGESTION_KEY>"
```
...
- `<SIGNOZ_INGESTION_KEY>`: Your SigNoz ingestion key from [Settings > Ingestion Settings](https://signoz.io/docs/ingestion/signoz-cloud/keys/)
