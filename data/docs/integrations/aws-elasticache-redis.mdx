...
<Admonition type="tip">
**SigNoz Cloud users**: You can also use the [One-Click AWS Integration](https://signoz.io/docs/integrations/aws/aws-elasticache/) for automated setup with pre-built dashboards.
</Admonition>
