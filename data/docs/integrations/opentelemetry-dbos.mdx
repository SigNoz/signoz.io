...
title: DBOS OpenTelemetry Instrumentation Guide
description: Instrument your DBOS application with OpenTelemetry and send traces and logs to SigNoz. Automatic tracing for workflows, FastAPI, and Flask requests.
doc_type: howto
---
...
- Build [dashboards](https://signoz.io/docs/dashboards/dashboard-templates/overview/) to monitor DBOS workflow activity.
