...
Tested with Python 3.14 and DBOS version 2.17.0.
...
Set the ingestion key in your shell before you start the application. DBOS reads OTLP authentication headers from this variable at runtime:
...
it reaches SigNoz. Follow the [Switch to Collector](https://signoz.io/docs/ingestion/cloud-vs-self-hosted/#cloud-to-self-hosted)
