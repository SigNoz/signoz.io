...
- An **OpenTelemetry Collector** installed and reachable  
  - [Install OpenTelemetry Collector if not already installed](https://signoz.io/docs/opentelemetry-collection-agents/get-started/)
...
![Supabase Metrics](/img/docs/supabase-signoz-metrics.webp)
