---
date: 2026-08-03
title: Monitor GCP Cloud SQL for PostgreSQL Metrics
description: Collect Cloud SQL for PostgreSQL metrics in SigNoz. Add the metrics to your OpenTelemetry Collector and view them on a pre-built dashboard.
doc_type: howto
