...
This integration helps you to collect key Redis metrics and logs, view them with an out-of-the-box dashboard, and 
...
2. An OpenTelemetry (OTEL) Collector with access to the Redis server
   - [Install the OTEL Collector](https://signoz.io/docs/tutorial/opentelemetry-binary-usage-in-virtual-machine/) if not already done (v0.88.0 or newer)
...
<figure data-zoomable align='center'>
    <img src="/img/docs/integrations/redis-integration-search.webp" alt="Search for Redis in Integrations tab"/>
...
<figure data-zoomable align='center'>
    <img src="/img/docs/integrations/redis-integration-connect.webp" alt="Connect Redis"/>
...
<figure data-zoomable align='center'>
    <img src="/img/docs/integrations/redis-integration-listening.webp" alt="Listening for data from Redis"/>
...
differnet Redis metrics.

<figure data-zoomable align='center'>
    <img src="/img/docs/integrations/redis-integration-dashboard.webp" alt="Dashboard for monitoring Redis Metrics"/>
...
<figure data-zoomable align='center'>
    <img src="/img/docs/integrations/redis-integration-data-collected.webp" alt="Log attributes and metrics details for Redis"/>
...
| redis_cpu_time                                | Sum    | s      | System CPU consumed by the Redis server in seconds since server start            |
...
| redis_cmd_latency                             | Gauge  | s      | Command execution latency                                                        |
...
| redis_latest_fork                             | Gauge  | µs     | Duration of the latest fork operation in microseconds                            |
...
| redis_uptime                                  | Sum    | s      | Number of seconds since Redis server start                                       |
...
| redis_db_avg_ttl                              | Gauge  | ms     | Average keyspace keys TTL                                                        |
