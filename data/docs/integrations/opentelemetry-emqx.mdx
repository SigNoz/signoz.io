...
<a href="https://www.emqx.com/en/products/emqx" target="_blank" rel="noopener noreferrer nofollow">EMQX</a> is an MQTT broker. It moves messages between publishers and subscribers. EMQX also has an OpenTelemetry exporter built in. Point that exporter at SigNoz, and every node sends its telemetry over OTLP. You do not need an SDK or a scrape target.
...
services:
  emqx:
    ...
    environment:
      ...
      EMQX_OPENTELEMETRY__LOGS__LEVEL: "warning"
```
