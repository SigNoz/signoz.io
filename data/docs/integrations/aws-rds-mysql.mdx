...
This integration helps you monitor key AWS RDS (MySQL) metrics and logs, view them with an out-of-the-box dashboard, and parse MySQL logs for better querying and aggregation.
...
3. An OpenTelemetry (OTEL) Collector (v0.88.0+):
   - [Install the OTEL Collector](https://signoz.io/docs/tutorial/opentelemetry-binary-usage-in-virtual-machine/) if not already done
...
differnet AWS RDS (MySQL) metrics.
