...
Once you're done with setting up PostgresSQL for collecting metrics and logs, head over to the intergrations tab in SigNoz and search for the PostgresSQL integration.

<figure data-zoomable align='center'>
    <img src="/img/docs/integrations/postgres/postgres-integration-search.webp" alt="Search for PostgresSQL in Integrations tab"/>
    <figcaption><i>Search for PostgresSQL in Integrations tab</i></figcaption>
</figure>

Click on the `Connect PostgresSQL` Button, and select **I have already configured**, this will start listening for data from your PostgresSQL instance. 
To stop this, you can select the `Remove from SigNoz` button.

<figure data-zoomable align='center'>
    <img src="/img/docs/integrations/postgres/postgres-integration-connect.webp" alt="Connect PostgresSQL"/>
    <figcaption><i>Connect PostgresSQL</i></figcaption>
</figure>

&nbsp;

<figure data-zoomable align='center'>
    <img src="/img/docs/integrations/postgres/postgres-integration-listening.webp" alt="Listening for data from PostgresSQL"/>
    <figcaption><i>Listening for data from PostgresSQL</i></figcaption>
</figure>



## PostgresSQL dashboard
Once SigNoz has started listening to your PostgresSQL data, head over to the Dashboards tab and search for Postgres, this will show you a newly created dashboard which shows
differnet PostgresSQL metrics.

<figure data-zoomable align='center'>
    <img src="/img/docs/integrations/postgres/postgres-integration-dashboard.webp" alt="Dashboard for monitoring PostgresSQL Metrics"/>
    <figcaption><i>Dashboard for monitoring PostgresSQL Metrics</i></figcaption>
</figure>
...
When you switch to the **Data Collected** tab of your PostgresSQL Integrations, it shows you details about the different logs attributes and the metrics types that you
can monitor for your PostgresSQL instance. The tables below gives you a list of the different logs attributes and metrics available.

<figure data-zoomable align='center'>
    <img src="/img/docs/integrations/postgres/postgres-integration-data-collected.webp" alt="Log attributes and metrics details for PostgresSQL"/>
    <figcaption><i>Log attributes and metrics details for PostgresSQL</i></figcaption>
</figure>
