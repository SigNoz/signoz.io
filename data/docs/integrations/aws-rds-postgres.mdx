...
<Admonition type="info" title="Running Aurora PostgreSQL instead of RDS PostgreSQL?" defaultCollapsed="true">
...
3. **OpenTelemetry Collector**: 
  - [Install an OTEL Collector](https://signoz.io/docs/opentelemetry-collection-agents/vm/install/) (v0.88.0+) if not already done.
...
Visit http://localhost:9106/metrics and confirm the `aws_rds_*` metrics are available.
...
Verify these values:
- `<postgres-server-endpoint>`: The hostname and port of your PostgreSQL RDS instance (e.g., `mydb.xxxx.us-east-1.rds.amazonaws.com:5432`)
...
<figure data-zoomable align='center'>
    <img src="/img/docs/integrations/aws-rds-postgres/aws-rds-postgres-integration-listening.webp" alt="Listening for data from AWS RDS PostgreSQL"/>
