...
This integration helps you monitor key AWS RDS PostgreSQL metrics and logs, view them with an out-of-the-box dashboard, 
...
## Collecting RDS PostgreSQL Logs
...
## Connect AWS RDS (PostgresSQL)

Once you're done with setting up AWS RDS (PostgresSQL) for collecting metrics and logs, head over to the intergrations tab 
in SigNoz and search for the AWS RDS (PostgresSQL) integration.

<figure data-zoomable align='center'>
    <img src="/img/docs/integrations/aws-rds-postgres/aws-rds-postgres-integration-search.webp" alt="Search for AWS RDS (PostgresSQL) in Integrations tab"/>
    <figcaption><i>Search for AWS RDS (PostgresSQL) in Integrations tab</i></figcaption>
</figure>

Click on the `Connect AWS RDS (PostgresSQL)` Button, and select **I have already configured**, this will start listening for data from your AWS RDS (PostgresSQL) instance. 
To stop this, you can select the `Remove from SigNoz` button.

<figure data-zoomable align='center'>
    <img src="/img/docs/integrations/aws-rds-postgres/aws-rds-postgres-integration-connect.webp" alt="Connect AWS RDS (PostgresSQL)"/>
    <figcaption><i>Connect AWS RDS (PostgresSQL)</i></figcaption>
</figure>

&nbsp;

<figure data-zoomable align='center'>
    <img src="/img/docs/integrations/aws-rds-postgres/aws-rds-postgres-integration-listening.webp" alt="Listening for data from RedAWS RDS (PostgresSQL)is"/>
    <figcaption><i>Listening for data from AWS RDS (PostgresSQL)</i></figcaption>
</figure>



## AWS RDS (PostgresSQL) dashboard
Once SigNoz has started listening to your AWS RDS (PostgresSQL) data, head over to the Dashboards tab and search for postgres, this will show you two newly created dashboard which shows
differnet AWS RDS (PostgresSQL) metrics.

<figure data-zoomable align='center'>
    <img src="/img/docs/integrations/aws-rds-postgres/aws-rds-postgres-integration-dashboard.webp" alt="Dashboard for monitoring AWS RDS (PostgresSQL) Metrics"/>
    <figcaption><i>Dashboards for monitoring AWS RDS (PostgresSQL) Metrics</i></figcaption>
</figure>
...
When you switch to the **Data Collected** tab of your AWS RDS (PostgresSQL) Integrations, it shows you details about the different logs attributes and the metrics types that you
can monitor for your AWS RDS (PostgresSQL) instance. The tables below gives you a list of the different logs attributes and metrics available.

<figure data-zoomable align='center'>
    <img src="/img/docs/integrations/aws-rds-postgres/aws-rds-postgres-integration-data-collected.webp" alt="Log attributes and metrics details for AWS RDS (PostgresSQL)"/>
    <figcaption><i>Log attributes and metrics details for AWS RDS (PostgresSQL)</i></figcaption>
</figure>

### AWS RDS (PostgresSQL) log attributes
