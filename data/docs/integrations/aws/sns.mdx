...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/integrations/aws/sns-dashboard.webp" alt="AWS SNS Integration Overview in SigNoz"/>
    <figcaption><i>Monitor SNS with SigNoz</i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/integrations/aws/sns-dashboard.webp" alt="AWS SNS Overview Dashboard"/>
    <figcaption><i>AWS SNS Overview Dashboard</i></figcaption>
</figure>
