...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/integrations/ecs/one-click-aws/ecs-overview-dashboard.webp" alt="AWS ECS Overview Dashboard"/>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/integrations/ecs/one-click-aws/ecs-container-insights.webp" alt="ECS Container Insights Dashboard"/>
