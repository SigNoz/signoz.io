...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/integrations/one-click-aws/ecs/ecs-integration-overview.webp" alt="ECS Integration Overview in SigNoz"/>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/integrations/one-click-aws/ecs/ecs-overview-dashboard.webp" alt="AWS ECS Overview Dashboard"/>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/integrations/one-click-aws/ecs/ecs-container-insights.webp" alt="ECS Container Insights Dashboard"/>
