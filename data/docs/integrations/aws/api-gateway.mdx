...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/integrations/aws/api-gateway-dashboard.webp" alt="AWS API Gateway Integration Overview in SigNoz"/>
    <figcaption><i>Monitor API Gateway with SigNoz</i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/integrations/aws/api-gateway-dashboard.webp" alt="AWS API Gateway Overview Dashboard"/>
    <figcaption><i>AWS API Gateway Overview Dashboard</i></figcaption>
</figure>
