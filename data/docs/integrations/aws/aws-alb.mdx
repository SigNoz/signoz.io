...
description: Monitor Application Load Balancers with SigNoz using One-Click AWS Integration. Collect key ALB metrics and view them with an out of the box dashboard.
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/integrations/aws/alb-dashboard.webp" alt="AWS ALB Integration Overview in SigNoz"/>
    <figcaption><i>Monitor Application Load Balancer with SigNoz</i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/integrations/aws/alb-dashboard.webp" alt="AWS ALB Overview Dashboard"/>
    <figcaption><i>AWS ALB Overview Dashboard</i></figcaption>
</figure>
