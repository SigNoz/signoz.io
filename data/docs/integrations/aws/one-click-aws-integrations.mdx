...
The **SigNoz One-Click AWS Integration** automates the collection of metrics and logs from your AWS infrastructure. Using CloudFormation and an intelligent AutoDiscovery agent, it provisions the necessary AWS resources (IAM roles, Firehose streams, CloudWatch subscriptions) to stream telemetry data directly to SigNoz.
