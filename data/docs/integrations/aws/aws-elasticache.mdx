...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/integrations/aws/elasticache-dashboard.webp" alt="AWS ElastiCache Integration Overview in SigNoz"/>
    <figcaption><i>Monitor ElastiCache with SigNoz</i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/integrations/aws/elasticache-dashboard.webp" alt="AWS ElastiCache Overview Dashboard"/>
    <figcaption><i>AWS ElastiCache Overview Dashboard</i></figcaption>
</figure>
