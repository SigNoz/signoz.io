---
date: YYYY-MM-DD
id: [service-name]-integration
title: AWS [Service Name] Integration
---

# AWS [Service Name] Integration
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/integrations/aws-[service-name]/[service-name]-integration-overview.webp" alt="[Service Name] Integration Overview in SigNoz"/>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/integrations/aws-[service-name]/[service-name]-overview-dashboard.webp" alt="AWS [Service Name] Overview Dashboard"/>
...
<figure data-zoomable align='center'>
    <img className="box-shadowed-image" src="/img/docs/integrations/aws-[service-name]/[service-name]-[enhanced-feature].webp" alt="[Service Name] [Enhanced Feature] Dashboard"/>
