...
<Figure
  src="/img/docs/integrations/azure/azure-redis-enable.webp"
  alt="SigNoz Azure integration panel showing Redis with Log Collection and Metric Collection toggles enabled"
  caption="Enable log and metric collection for Azure Cache for Redis in the SigNoz UI"
...
<Figure
  src="/img/docs/integrations/azure/azure-redis-dashboard.webp"
  alt="SigNoz dashboard showing Azure Cache for Redis metrics including CPU, cache hits, memory, operations, and connected clients"
  caption="Azure Cache for Redis dashboard in SigNoz"
  className="box-shadowed-image"
/>
