...
description: Monitor Azure CDN FrontDoor, Blob Storage, and Virtual Machines with SigNoz One-Click Azure Integration. Connect your subscription and SigNoz handles the rest.
doc_type: howto
tags: [SigNoz Cloud]
---
...
- **Limited Azure service coverage**: Azure CDN FrontDoor, Azure Blob Storage, and Azure Virtual Machines are currently supported. More services will be added in future releases.
