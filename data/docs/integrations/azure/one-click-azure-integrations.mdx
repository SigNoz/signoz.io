...
description: Monitor Azure CDN FrontDoor, Blob Storage, and AKS with SigNoz One-Click Azure Integration. Connect your Azure subscription and SigNoz deploys the monitoring infrastructure for you.
doc_type: howto
tags: [SigNoz Cloud]
---
...
- **Supported services**: Azure CDN FrontDoor, Azure Blob Storage, and Azure Kubernetes Service (AKS). More services will be added in future releases.
