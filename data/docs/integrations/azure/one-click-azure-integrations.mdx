...
description: Monitor Azure services with SigNoz One-Click Azure Integration. Supports CDN FrontDoor, Blob Storage, Virtual Machines, Container Apps, App Services, and AKS. Connect your Azure subscription and SigNoz deploys the monitoring infrastructure for you.
doc_type: howto
tags: [SigNoz Cloud]
---
...
- **Six Azure services are currently supported**: Azure CDN FrontDoor, Azure Blob Storage, Azure Virtual Machines, Azure Container Apps, Azure App Services, and Azure Kubernetes Service (AKS). More services will be added in future releases.
