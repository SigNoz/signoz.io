...
The agent deploys the necessary Event Hubs and diagnostic settings in the background. Data starts flowing within a few minutes.
...
The integration includes a pre-built Blob Storage dashboard.
