...
Download the dashboard JSON from [Temporal Cloud Metrics](https://raw.githubusercontent.com/SigNoz/dashboards/main/temporal.io/Temporal%20Cloud%20Metrics.json).
