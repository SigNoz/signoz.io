...
<Admonition type="info">
  You can start this integration from SigNoz onboarding. Open **New source** (or **Get Started → Add your first data source**), then select **Temporal Cloud Metrics** from the **Metrics** category. You can also type "Temporal Cloud Metrics" or "OpenMetrics" in the search bar to jump straight to it. The in-product flow walks through the same collector setup covered below.
</Admonition>

<Figure
  src="/img/docs/integrations/temporal/cloud-metrics/onboarding-metrics-category.webp"
  alt="Temporal Cloud Metrics card in the Metrics category of the SigNoz onboarding Add Data Source grid"
  caption="Find Temporal Cloud Metrics under the Metrics category in SigNoz onboarding"
/>
