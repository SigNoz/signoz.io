...
- An OpenTelemetry Collector installed in your infrastructure:
  - [VM / binary install](https://signoz.io/docs/opentelemetry-collection-agents/vm/install/)
  - [Kubernetes install](https://signoz.io/docs/tutorial/kubernetes-infra-metrics/)
...
Download the dashboard JSON from [Temporal Cloud Metrics](https://raw.githubusercontent.com/SigNoz/dashboards/main/temporal.io/Temporal%20Cloud%20Metrics.json). The dashboard includes panels for workflow success rate, service request counts, latency percentiles, and worker poll metrics.
