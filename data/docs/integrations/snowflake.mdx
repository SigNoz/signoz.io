...
2. An OpenTelemetry (OTEL) Collector with access to Snowflake
   ...
   - Ensure the OTEL collector has access to Snowflake for metrics collection


## Collecting Snowflake Metrics
...
You can find more details about SigNoz ingestion keys and regions [here](https://signoz.io/docs/ingestion/signoz-cloud/overview/)
...
Once SigNoz has started listening to the Snowflake data, head over to the `Dashboards` tab and search for Snowflake, this will show you a newly created dashboard which shows
different Snowflake metrics.

<figure data-zoomable align='center'>
    <img src="/img/docs/integrations/snowflake/snowflake-integration-dashboard.webp" alt="Dashboard for monitoring Snowflake Metrics"/>
    <figcaption><i>Dashboard for monitoring Snowflake Metrics</i></figcaption>
</figure>

### Dashboard asset

You can also import the dashboard.
