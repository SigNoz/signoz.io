---
date: 2026-03-12
description: This integration helps you to monitor key Snowflake metrics, and view them with an out-of-the-box dashboard.
...
2. An OpenTelemetry (OTEL) Collector with access to Snowflake
   - [Install the OTEL Collector](https://signoz.io/docs/opentelemetry-collection-agents/vm/install/)(v0.88.0 or newer) if not done already 
...
```yaml:snowflake-metrics-collection-config.yaml minimap defaultCollapsed
receivers:
  snowflake:
...
<Figure
  src="/img/docs/integrations/snowflake/billing-and-credit-usage.webp"
  alt="Snowflake Billing and Credit Usage Metrics"
  caption="Snowflake Billing and Credit Usage Metrics"
/>

<Figure
  src="/img/docs/integrations/snowflake/query-metrics-1.webp"
  alt="Snowflake Query Metrics"
  caption="Snowflake Query Metrics"
/>

<Figure
  src="/img/docs/integrations/snowflake/query-metrics-2.webp"
  alt="Snowflake Query Metrics (contd.)"
  caption="Snowflake Query Metrics (contd.)"
/>

<Figure
  src="/img/docs/integrations/snowflake/storage-metrics.webp"
  alt="Snowflake Storage Metrics"
  caption="Snowflake Storage Metrics"
/>

<Figure
  src="/img/docs/integrations/snowflake/other-metrics.webp"
