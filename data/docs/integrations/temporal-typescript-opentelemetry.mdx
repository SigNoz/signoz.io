...
See Step 1 and Step 6. Make sure environment variables are exported, then run `npm run start` to start the worker, and `npm run workflow` to start a workflow execution.
...
See Step 1 and Step 6. Make sure environment variables are exported in PowerShell, then run `npm run start` to start the worker, and `npm run workflow` to start a workflow execution.
