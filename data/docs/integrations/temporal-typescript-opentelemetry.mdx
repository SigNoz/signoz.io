...
2. **View Metrics**:
   - Go to **Dashboards** and import the <a href="https://github.com/SigNoz/dashboards/blob/main/temporal.io/Temporal%20SDK%20Metrics%20-%20typescript.json" target="_blank" rel="noopener noreferrer nofollow">Temporal SDK Metrics dashboard</a>
