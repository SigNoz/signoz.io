...
Alternatively, reduce the verbosity of Temporal's internal runtime logging (which can contribute additional metric dimensions) by adjusting the filter in `Runtime.install()`:
