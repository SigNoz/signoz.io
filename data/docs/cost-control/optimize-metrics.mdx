...
**SDK metrics:** raise `OTEL_METRIC_EXPORT_INTERVAL` (milliseconds, default `60000`):

```bash
export OTEL_METRIC_EXPORT_INTERVAL=60000
```

**Collector receivers** (for example `hostmetrics`): raise `collection_interval` in the receiver config:
