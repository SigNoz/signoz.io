...
title: OpenRouter Observability - Monitor LLM Costs & Performance
description: Setup OpenRouter observability with OpenTelemetry and SigNoz. Monitor LLM API routing, track traces, and analyze usage across multiple models.
doc_type: howto
---
