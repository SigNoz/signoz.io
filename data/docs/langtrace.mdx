...
- For this example: An OpenAI API key. You can get it from <a href="https://platform.openai.com/settings/organization/api-keys" target="_blank" rel="noopener noreferrer nofollow">xAi platform</a>
