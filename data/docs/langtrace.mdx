---
date: 2026-01-27
id: signoz-with-langtrace
title: Monitor LLM Usage with Langtrace and SigNoz
description: Monitoring and observability for LLM/AI usage and performance with Langtrace instrumentation to send traces to SigNoz
doc_type: howto
---
...
- Python 3.10+ with `langtrace-python-sdk` installed
...
For more information on getting started with Langtrace in your Python environment, refer to the [Langtrace Quickstart Guide](https://docs.langtrace.ai/quickstart).
For more information on integrating SigNoz with Langtrace, refer to the [Langtrace SigNoz Guide](https://docs.langtrace.ai/supported-integrations/observability-tools/signoz).
...
<Admonition type="important">
  For this guide example, we are using OpenAI, but you can use any <a href="https://docs.langtrace.ai/supported-integrations/llm-tools/" target="_blank" rel="noopener noreferrer nofollow">LLM provider</a> or <a href="https://docs.langtrace.ai/supported-integrations/llm-frameworks/" target="_blank" rel="noopener noreferrer nofollow">LLM framework</a> supported by Langtrace.
</Admonition>
...
<Figure
  src="/img/docs/llm/langtrace/langtrace-traces.webp"
  alt="Langtrace Trace View"
  caption="Langtrace Trace View"
/>

When you click on a trace in SigNoz, you'll see a detailed view of the trace, including all associated spans, along with their events and attributes.

<Figure
  src="/img/docs/llm/langtrace/langtrace-detailed-traces.webp"
  alt="Langtrace Detailed Trace View"
  caption="Langtrace Detailed Trace View"
/>
