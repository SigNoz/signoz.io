...
meta_title: Azure Functions Logging - EventHub Setup
description: Learn to export Azure Functions logs to SigNoz via EventHub and Diagnostic Settings for centralized serverless function log monitoring.
