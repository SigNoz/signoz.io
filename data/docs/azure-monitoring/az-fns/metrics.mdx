...
meta_title: Azure Functions Metrics Setup Guide
description: Learn to collect Azure Functions invocations, execution time, and resource metrics in SigNoz using the OpenTelemetry Collector with Azure Monitor.
...
<Figure
  ...
  caption="Time Series Panel for Function's Total Requests"
/>
