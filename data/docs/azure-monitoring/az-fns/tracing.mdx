...
meta_title: Azure Functions Tracing - APM Setup Guide
description: Learn to enable distributed tracing for Azure Functions in SigNoz using OpenTelemetry SDKs and the Central Collector for serverless observability.
