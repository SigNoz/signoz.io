...
meta_title: Azure MySQL Flexible Server Monitoring
description: Learn to monitor Azure MySQL Flexible Server with SigNoz by streaming metrics and logs via EventHub and Diagnostic Settings to the Central Collector.
