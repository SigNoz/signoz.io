...
meta_title: Azure VM Host Metrics & Logging Setup
description: Learn to send Azure VM host metrics, logs, and application traces to SigNoz by configuring the OpenTelemetry Collector with hostmetrics and filelog.
...
Follow the [OpenTelemetry SigNoz document](https://signoz.io/docs/opentelemetry-collection-agents/vm/install/) to install the OpenTelemetry Collector. 
