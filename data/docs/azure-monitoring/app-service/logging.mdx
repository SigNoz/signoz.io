...
meta_title: Azure App Service Logging - EventHub Export
description: Learn to export Azure App Service HTTP, console, application, and audit logs to SigNoz via EventHub and Diagnostic Settings for centralized monitoring.
...
3. Click on "Add Diagnostic Setting"
    ...
    <Figure
      ...
      caption="App Service Diagnostic Settings"
    />
4. Select the desired log categories to export:
    ...
    <Figure
      ...
      caption="App Service Diagnostic Configuration"
    />
