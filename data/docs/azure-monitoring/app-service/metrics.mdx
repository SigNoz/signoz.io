...
meta_title: Azure App Service Metrics - CPU & Memory Setup
description: Learn to collect Azure App Service CPU, memory, and data throughput metrics in SigNoz using the OpenTelemetry Collector with Azure Monitor.
...
<Figure
  ...
  caption="Time Series Panel for App Service Memory Usage"
/>
