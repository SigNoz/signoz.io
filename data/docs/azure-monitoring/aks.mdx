...
meta_title: Azure AKS Monitoring - Metrics, Logs & Traces
description: Learn to send AKS metrics, logs, and application traces to SigNoz using the OpenTelemetry Collector and k8s-infra Helm chart for Kubernetes observability.
