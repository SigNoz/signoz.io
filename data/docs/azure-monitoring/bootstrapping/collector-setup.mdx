...
meta_title: Azure Central Collector Setup Guide
description: Learn to deploy a centralized OpenTelemetry Collector on AKS or Azure VM to collect Azure Monitor metrics and EventHub logs for SigNoz.
---
...
3. [EventHub Setup](https://signoz.io/docs/azure-monitoring/bootstrapping/data-ingestion/)
...
2. **Prepare the `otel-collector-values.yaml` Configuration**
    ...
    If you haven't created the logs Event Hub, you can create one by following the steps in the [Azure Event Hubs documentation](https://signoz.io/docs/azure-monitoring/bootstrapping/data-ingestion/).
...
<Figure
  ...
  caption="DNS label for collector"
/>
