...
meta_title: Azure EventHub Streaming Ingestion Setup
description: Learn to set up Azure Event Hubs namespace and stream logs to SigNoz via the OpenTelemetry Collector for real-time log ingestion at scale.
---
...
- Add a new receiver to [Central Collector Setup](https://signoz.io/docs/azure-monitoring/bootstrapping/collector-setup/)
...
) available in SigNoz [Logs explorer](https://signoz.io/docs/userguide/logs_query_builder/).

Just [filter](https://signoz.io/docs/userguide/query-builder-v5/#filtering) using `source_type= azureeventhub` in the search filter bar.
