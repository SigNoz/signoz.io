...
meta_title: Azure Blob Storage Audit Logs Setup
description: Learn to export Azure Blob Storage audit logs to SigNoz using EventHub and Diagnostic Settings for security monitoring and access tracking.
...
<Figure
  ...
  caption="Blob Storage Diagnostic Settings"
/>
