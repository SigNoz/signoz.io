...
meta_title: Azure Blob Storage Metrics Setup Guide
description: Learn to collect Azure Blob Storage request count, latency, and capacity metrics in SigNoz using the OpenTelemetry Collector with Azure Monitor.
...
<Figure
  ...
  caption="Time Series Panel for Blob Storage Total Ingress"
/>
