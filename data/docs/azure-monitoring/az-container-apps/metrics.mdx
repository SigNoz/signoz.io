...
meta_title: Azure Container Apps Metrics Setup
description: Learn to collect Azure Container Apps CPU, memory, and request metrics in SigNoz using the OpenTelemetry Collector with Azure Monitor.
...
<Figure
  ...
  caption="Time Series Panel for Container Replica Count"
/>
