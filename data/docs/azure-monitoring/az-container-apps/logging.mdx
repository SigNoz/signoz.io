...
meta_title: Azure Container Apps Logging Setup
description: Learn to export Azure Container Apps console and system logs to SigNoz via EventHub and Diagnostic Settings for centralized log analysis.
...
5. Select the desired log categories to export:
    ...
    <Figure
      ...
      caption="Container Apps Environment Diagnostic Configuration"
    />
