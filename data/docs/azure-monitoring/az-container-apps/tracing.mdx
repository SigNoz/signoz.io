...
meta_title: Azure Container Apps Tracing - APM Setup Guide
description: Learn to enable distributed tracing for Azure Container Apps in SigNoz using OpenTelemetry SDKs and the Central Collector for application performance.
