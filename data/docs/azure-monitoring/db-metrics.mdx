...
meta_title: Azure SQL Database Metrics Setup
description: Learn to collect Azure SQL Database CPU, memory, and storage metrics in SigNoz using the OpenTelemetry Collector with the Azure Monitor exporter.
