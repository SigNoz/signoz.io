...
<Figure src="/img/docs/llm/bedrock/bedrock-traces.webp" alt="Bedrock Trace View" caption="Amazon Bedrock Trace View" />

When you click on a trace in SigNoz, you'll see a detailed view of the trace, including all associated spans, along with their events and attributes.

<Figure src="/img/docs/llm/bedrock/bedrock-detailed-traces.webp" alt="Bedrock Detailed Trace View" caption="Amazon Bedrock Detailed Trace View" />
...
<Figure src="/img/docs/llm/bedrock/bedrock-logs.webp" alt="Bedrock Logs View" caption="Amazon Bedrock Logs View" />

When you click on any of these logs in SigNoz, you'll see a detailed view of the log, including attributes:

<Figure src="/img/docs/llm/bedrock/bedrock-detailed-logs.webp" alt="Bedrock Detailed Log View" caption="Amazon Bedrock Detailed Logs View" />

You should be able to see Bedrock related metrics in Signoz Cloud under the metrics tab:

<Figure src="/img/docs/llm/bedrock/bedrock-metrics.webp" alt="Bedrock Metrics View" caption="Amazon Bedrock Metrics View" />

When you click on any of these metrics in SigNoz, you'll see a detailed view of the metric, including attributes:
<Figure src="/img/docs/llm/bedrock/bedrock-detailed-metrics.webp" alt="Bedrock Detailed Metrics View" caption="Amazon Bedrock Detailed Metrics View" />
...
<Figure src="/img/docs/llm/bedrock/bedrock-dashboard.webp" alt="Bedrock Dashboard" caption="Amazon Bedrock Dashboard Template" />