...
title: Amazon Bedrock Monitoring & Observability with OpenTelemetry
description: Monitoring and observability for Amazon Bedrock usage and performance with OpenTelemetry instrumentation to send traces, logs, and metrics to SigNoz
---
