---
date: 2025-07-18
title: Configure K8s-Infra OtelCollectors
id: k8s-infra-otel-config
---

This guide explains how to configure the OpenTelemetry Collectors deployed by the SigNoz K8s-Infra Helm chart. You'll learn how to set up telemetry data collection and enable the collection of metrics, logs, and traces from your Kubernetes cluster.

To install K8s-Infra in your Kubernetes cluster, please check out the [k8s-infra Installation guide](/docs/telemetry-ingestion-deployment/k8s/k8s-infra/install-k8s-infra)
...
## Essential Presets
SigNoz allows you to use the presets in the k8s-infra Helm chart to easily configure OtelCollector.
