...
This quickstart starts a multi-service <a href="https://github.com/SigNoz/opentelemetry-demo-lite" target="_blank" rel="noopener noreferrer nofollow">OpenTelemetry Demo</a> app and sends traces, logs, and metrics to your SigNoz Cloud workspace. No code changes are required.
...
- Your workspace region and ingestion key from **Settings** > **Ingestion Settings**
- Outbound HTTPS access to `ingest.<region>.signoz.cloud` on port `443`
