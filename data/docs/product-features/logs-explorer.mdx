...
description: Learn how to search, filter, and analyze logs in SigNoz Logs Explorer using list, time series, table, and log details views.
...
Exports from the Logs Explorer are limited to 50,000 rows. To export larger datasets, use the [Logs API](https://signoz.io/docs/logs-management/logs-api/search-logs/) with pagination to programmatically retrieve logs in batches.
