...
<Figure
  src="/img/docs/llm/gemini/gemini-trace-view.webp"
  alt="Gemini trace view"
  caption="Gemini trace view in SigNoz"
/>

When you click on a trace in SigNoz, you'll see a detailed view of the trace, including all associated spans, along with their events and attributes.

<Figure
  src="/img/docs/llm/gemini/gemini-detailed-trace-view.webp"
  alt="Gemini detailed trace view"
  caption="Detailed trace view for Gemini"
/>
...
<Figure
  src="/img/docs/llm/gemini/gemini-logs-view.webp"
  alt="Gemini logs view"
  caption="Gemini logs view in SigNoz"
/>

When you click on any of these logs in SigNoz, you'll see a detailed view of the log, including attributes:

<Figure
  src="/img/docs/llm/gemini/gemini-log-1.webp"
  alt="Gemini log details"
  caption="Detailed log view"
/>

You should be able to see Gemini metrics in Signoz Cloud under the metrics tab:

<Figure
  src="/img/docs/llm/gemini/gemini-metrics.webp"
  alt="Gemini metrics"
  caption="Gemini metrics in SigNoz"
/>

When you click on any of these metrics in SigNoz, you'll see a detailed view of the metric, including attributes:

<Figure
  src="/img/docs/llm/gemini/gemini-detailed-metric.webp"
  alt="Gemini detailed metric"
  caption="Detailed metric view for Gemini"
/>
...
<Figure
  src="/img/docs/llm/gemini/gemini-dashboard.webp"
