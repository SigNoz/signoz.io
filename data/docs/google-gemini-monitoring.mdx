...
description: Monitoring and observability for Google Gemini API performance and usage with OpenTelemetry instrumentation to send traces, logs, and metrics to SigNoz
---
