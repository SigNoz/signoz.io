...
description: Enable telemetry in your Claude Code usage with OpenTelemetry and send logs and metrics to SigNoz
---
...
<figure data-zoomable align='center'>
    ...
    <figcaption><i>Logs View of your Claude Code Activity</i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    ...
    <figcaption><i>Detailed Logs View of claude_code.user_prompt</i></figcaption>
</figure>

<figure data-zoomable align='center'>
    <img src="/img/docs/llm/claude/claude-logs-detailed-1.webp" alt="Detailed Logs View 2"/>
    <figcaption><i>Detailed Logs View of claude_code.api_request</i></figcaption>
</figure>

<figure data-zoomable align='center'>
    <img src="/img/docs/llm/claude/claude-logs-detailed-2.webp" alt="Detailed Logs View 3"/>
    <figcaption><i>Detailed Logs View of claude_code.tool_decision</i></figcaption>
</figure>

<figure data-zoomable align='center'>
    <img src="/img/docs/llm/claude/claude-logs-detailed-3.webp" alt="Detailed Logs View 4"/>
    <figcaption><i>Detailed Logs View of claude_code.tool_result</i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    ...
    <figcaption><i>Metrics View of your Claude Code Activity</i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    ...
    <figcaption><i>Detailed Metrics View of your Claude Code Activity</i></figcaption>
</figure>

## Dashboard

You can also check out our custom Claude Code dashboard [here](/docs/dashboards/dashboard-templates/claude-code-dashboard/) which provides specialized visualizations for monitoring your Claude Code usage. The dashboard includes pre-built charts specifically tailored for LLM usage, along with import instructions to get started quickly.
