...
description: Instrument Google Cloud Run applications with OpenTelemetry to send traces and APM data to SigNoz Cloud.
...
<Figure
  ...
  caption="Cloud Run Traces in SigNoz Cloud"
/>
