...
description: Collect Google Cloud Run metrics in SigNoz using Google Cloud Monitoring and the OpenTelemetry Collector.
...
**Step 1:** Install and configure OpenTelemetry for scraping the metrics from Google Cloud Run. Follow [OpenTelemetry Binary Usage in Virtual Machine](https://signoz.io/docs/opentelemetry-collection-agents/vm/install/) guide for detailed instructions.
...
<Figure
  ...
  caption="GCP Cloud Run dashboard"
/>
