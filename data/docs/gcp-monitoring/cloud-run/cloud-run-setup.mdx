...
description: Create and deploy a sample application on Google Cloud Run with Docker and Artifact Registry for monitoring with SigNoz.
...
```html:views/index.html minimap defaultCollapsed
<!DOCTYPE html>
<html lang="en">
<body>
...
<Figure
  ...
  caption="Artifact Registry Landing Page"
/>
...
<Figure
  ...
  caption="Create Artifact Registry"
/>
...
<Figure
  ...
  caption="Deploy image to Cloud Run"
/>
...
<Figure
  ...
  caption="Create Cloud Run Service"
/>
...
<Figure
  ...
  caption="Successfully deployed Cloud Run Service"
/>
