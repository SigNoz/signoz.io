...
description: Send Google Cloud Run logs to SigNoz via Pub/Sub, Log Router, and the OpenTelemetry Collector on Compute Engine.
...
<Figure
  ...
  caption="Cloud Run Logs in SigNoz Cloud"
/>
