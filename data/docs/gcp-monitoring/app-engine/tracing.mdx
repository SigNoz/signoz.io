...
description: Instrument Google App Engine applications with OpenTelemetry to send traces and APM data to SigNoz.
...
<Figure
  ...
  caption="App Engine Traces in SigNoz Cloud"
/>
