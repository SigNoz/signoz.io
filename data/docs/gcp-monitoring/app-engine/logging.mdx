...
description: Send Google App Engine logs to SigNoz via Pub/Sub, Log Router, and the OpenTelemetry Collector on a Compute Engine instance.
...
<Figure
  ...
  caption="App Engine Logs in SigNoz Cloud"
/>
