...
<Tabs tabGroupId="protocol-cloud" defaultTab="pub-sub" tabIdArray={['pub-sub', 'http']}>
<TabItem value="pub-sub" label="Using Pub/Sub (Recommended)" default tabId="pub-sub">
...
<TabItem value="http" label="Using HTTP" tabId="http">
{/* **Here's a quick summary of what we will be doing in this guide**
...
<Tabs tabGroupId="protocol-self-host" defaultTab="pub-sub" tabIdArray={['pub-sub', 'http']}>
<TabItem value="pub-sub" label="Using Pub/Sub (Recommended)" default tabId="pub-sub">
