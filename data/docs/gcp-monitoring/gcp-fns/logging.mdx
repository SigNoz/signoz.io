...
<Tabs entityName="plans" tabGroupId="parent-tabs" defaultTab="p1" tabIdArray={['p1', 'p2']}>
<TabItem value="p1" label="SigNoz Cloud" default tabId="p1">


<Tabs tabGroupId="child-tabs" defaultTab="c1" tabIdArray={['c1', 'c2']}>
<TabItem value="c1" label="Using Pub/Sub (Recommended)" default tabId="c1">
...
<TabItem value="c2" label="Using HTTP" tabId="c2">
{/* **Here's a quick summary of what we will be doing in this guide**
...
<TabItem value='self-host' label='Self-Host' tabId="p2">
