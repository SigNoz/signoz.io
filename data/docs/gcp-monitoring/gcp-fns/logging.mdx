...
If you want to use Self-Host SigNoz: For installation and configuration for Logs, check [official documentation by SigNoz](https://signoz.io/docs/userguide/send-logs-http/#send-logs-to-self-hosted-signoz)
</Admonition>
