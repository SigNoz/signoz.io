...
You can use your self-hosted Signoz instance, to understand how to configure it, check the [official documentation](https://signoz.io/docs/userguide/send-logs-http/#send-logs-to-self-hosted-signoz)
</Admonition>
...
<figure data-zoomable align="left">
    <img
        src="/img/docs/gcp-monitoring/cloud-function.webp"
...
<figure data-zoomable align="left">
    <img
        src="/img/docs/gcp-monitoring/create-function.webp"
...
Only add `SIGNOZ_HTTP_URL` if you are using Self-Host SigNoz. The SigNoz endpoint would be http://&lt;signoz-host-ip>:8082 in case of Self-Host installation, however, the URL can be different based on how you have set up the infrastructure.
</Admonition>

Add `SIGNOZ_ACCESS_TOKEN` and `SIGNOZ_HTTP_URL` with the **Ingestion Key** and **Ingestion URL** respectively, obtained in the prerequisites.

<figure data-zoomable align="left">
    <img
        src="/img/docs/gcp-monitoring/runtime-variables.webp"
...
<figure data-zoomable align="left">
    <img
        src="/img/docs/gcp-monitoring/entrypoint.webp"
...
<figure data-zoomable align="left">
    <img
        src="/img/docs/gcp-monitoring/deploying-function.webp"
...
<figure data-zoomable align="left">
    <img
        src="/img/docs/gcp-monitoring/cloud-function-url.webp"
...
<figure data-zoomable align="left">
    <img
        src="/img/docs/gcp-monitoring/function-logs.webp"
...
Go to your SigNoz UI, and navigate to the SigNoz dashboard.

<Admonition type="note">
The default SigNoz dashboard endpoint would be `http://<signoz-host-ip>:3301` in case of Self-Host installation, however, the URL can be different based on how you have set up the infrastructure.
</Admonition>

Click on the **Logs** section to view the logs.

<Admonition type="info">
If you have multiple applications already sending logs to SigNoz, you can check by adding `resource-type`, `resource-name`, and `resource-region` filters in the Search filters field. Put the values that we used in the payload in the `write_log` function of our Cloud Function.
</Admonition>

<figure data-zoomable align="left">
    <img
        src="/img/docs/gcp-monitoring/signoz-dashboard.webp"
...
* If you are using SigNoz Cloud Account, check and mention the correct URL of the SigNoz Cloud account and the Ingestion(token) key.
* If you are using SigNoz Self-Host, check and mention the correct URL of the SigNoz Self-Host, OTEL configuration, and routing.
