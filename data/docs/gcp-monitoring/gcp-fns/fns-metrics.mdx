...
date: 2024-07-20
id: fns-metrics
title: Metrics from Cloud Functions.
...
**Step 1:** Install [`telegraf`](https://github.com/influxdata/telegraf) which will collect metrics from Google Cloud Monitoring for Cloud Function, see the [available metrics for Cloud Function](https://cloud.google.com/monitoring/api/metrics_gcp#gcp-cloudfunctions). The installation process for the respective operating system can be found in official [documentation](https://docs.influxdata.com/telegraf/v1/install/).

After successful installation, the `telegraf` status should be active and running.

<figure data-zoomable align="left">
    <img
        src="/img/docs/gcp-monitoring/fns-metrics/telegraf-status.webp"
...
<figure data-zoomable align="left">
    <img
        src="/img/docs/gcp-monitoring/fns-metrics/new-panel.webp"
...
<figure data-zoomable align="left">
    <img
        src="/img/docs/gcp-monitoring/fns-metrics/plot-metrics-signoz-cloud.webp"
        alt="Plot metrics"
    />
<figcaption>
<i>
...
[[outputs.opentelemetry]]
  ...
  #   service_address = "<endpoint-otel>:4317"
```
...
<figure data-zoomable align="left">
    <img
        src="/img/docs/gcp-monitoring/fns-metrics/plot-metrics-signoz-self-host.webp"
        alt="Plot metrics"
    />
<figcaption>
<i>
