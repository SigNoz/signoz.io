...
description: Collect Google Cloud Functions metrics in SigNoz using Google Cloud Monitoring and the OpenTelemetry Collector.
...
<Figure
  ...
  caption="GCP Cloud Function dashboard"
/>
