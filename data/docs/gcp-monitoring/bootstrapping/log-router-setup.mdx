...
description: Create a GCP Log Router sink to route logs from Cloud Logging to a Pub/Sub topic for forwarding to SigNoz.
---
...
<Figure
  ...
  caption="Provide Sink Destination"
/>
...
<Figure
  ...
  caption="Provide Log Filter Rules"
/>
