...
description: Send application traces from Google Kubernetes Engine (GKE) to SigNoz using OpenTelemetry and Kubernetes-native deployment steps.
...
<Figure
  ...
  caption="Traces in SigNoz Dashboard"
/> */}
...
<Figure
  ...
  alt="Traces in SigNoz Dashboard"
  caption="Traces in SigNoz Dashboard (self-hosted on GKE Cluster)"
/>
...
<Figure
  ...
  alt="Traces in SigNoz Dashboard"
  caption="Traces in SigNoz Dashboard (self-hosted on a VM)"
/>
