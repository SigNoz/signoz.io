...
description: Send Google Compute Engine application traces to SigNoz using OpenTelemetry instrumentation and collector setup.
...
Please refer to our [SigNoz Tutorials](https://signoz.io/docs/instrumentation/) or [Blog](https://signoz.io/resource-center/blog/) to find information on how to instrument your application like Spring, FastAPI, NextJS, Langchain, Node.js, Flask, Django, etc. with OpenTelemetry.
...
`<your-ingestion-key>` is the API token provided by SigNoz. You can find your ingestion key from SigNoz cloud account [ingestion settings](https://signoz.io/docs/ingestion/signoz-cloud/overview/#ingestion-key).
