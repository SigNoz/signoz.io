...
description: Send Google Compute Engine logs to SigNoz via Pub/Sub, Log Router, and the OpenTelemetry Collector.
...
<Figure
  ...
  caption="Edit Compute Engine Instance"
/>
...
<Figure
  ...
  caption="Add New Disk to Compute Engine"
/>
...
<Figure
  ...
  caption="Compute Engine Logs in SigNoz Cloud"
/>
