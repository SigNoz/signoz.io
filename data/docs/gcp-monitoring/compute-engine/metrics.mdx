...
description: Collect Google Compute Engine metrics in SigNoz using Google Cloud Monitoring and the OpenTelemetry Collector.
...
<Figure
  ...
  caption="GCP Compute Engine Dashboard"
/>
