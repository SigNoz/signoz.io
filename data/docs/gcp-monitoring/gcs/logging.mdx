...
description: Enable Google Cloud Storage audit logs and send them to SigNoz via Pub/Sub, Log Router, and the OpenTelemetry Collector.
...
<Figure
  ...
  caption="Search for Google Cloud Storage in Data Access Audit Logs Configuration"
/>
...
<Figure
  ...
  caption="Enable Data Write Audit Logs"
/>
...
<Figure
  ...
  caption="Cloud Storage Logs in SigNoz Cloud"
/>
