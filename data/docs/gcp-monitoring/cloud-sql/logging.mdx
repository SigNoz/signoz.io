...
description: Send Google Cloud SQL logs to SigNoz via Pub/Sub, Log Router, and the OpenTelemetry Collector on Compute Engine.
...
<Figure
  ...
  caption="Cloud SQL Logs in SigNoz Cloud"
/>
