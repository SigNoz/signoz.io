...
title: VPC Metrics
description: Collect Serverless VPC Access Connector metrics in SigNoz using Google Cloud Monitoring and the OpenTelemetry Collector.
...
**Step 1:** Install and configure OpenTelemetry for scraping the metrics from GCP Serverless VPC Access Connector. Follow [OpenTelemetry Binary Usage in Virtual Machine](https://signoz.io/docs/opentelemetry-collection-agents/vm/install/) guide for detailed instructions.
...
<Figure
  ...
  caption="GCP Serverless VPC Access dashboard"
/>
