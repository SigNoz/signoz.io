...
date: 2026-04-01
title: VPC Logging
description: Send GCP Serverless VPC Access Connector flow logs to SigNoz by enabling flow logs and routing via Pub/Sub and the OpenTelemetry Collector.
...
<Figure
  ...
  caption="Enter into VPC network"
/>
...
<Figure
  ...
  caption="Navigate to Subnets tab"
/>
