...
id: configure-k8s-infra
description: Configure the SigNoz K8s-Infra OpenTelemetry collection agent for collecting metrics, logs, and traces from your Kubernetes cluster.
---
