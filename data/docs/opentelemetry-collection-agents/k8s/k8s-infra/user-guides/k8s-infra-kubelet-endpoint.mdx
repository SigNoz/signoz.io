...
4. If Pods or Nodes still do not show up correctly on the Infrastructure page, review the [Telemetry Data Requirements for Infrastructure Monitoring](https://signoz.io/docs/infrastructure-monitoring/reference/telemetry-data-requirements/) to verify that required attributes and metrics are present.
...
1. **[K8s-Infra Overview](/docs/opentelemetry-collection-agents/k8s/k8s-infra/overview/)**
2. **[Configure K8s-Infra](/docs/opentelemetry-collection-agents/k8s/k8s-infra/configure-k8s-infra/)**
