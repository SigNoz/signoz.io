...
- A SigNoz backend (SigNoz Cloud or self-hosted) to receive OpenTelemetry data
  **[K8s-infra OpenTelemetry collection agent](https://signoz.io/docs/opentelemetry-collection-agents/k8s/k8s-infra/install-k8s-infra/)** installed in your GKE Autopilot cluster
...
The k8s-infra Helm chart also enables `k8s.container.cpu_request_utilization`, `k8s.container.cpu_limit_utilization`, `k8s.container.memory_request_utilization`, and `k8s.container.memory_limit_utilization` by default (see [Configure K8s-Infra](https://signoz.io/docs/opentelemetry-collection-agents/k8s/k8s-infra/configure-k8s-infra/#4-kubernetes-metrics-collection)). They power the Containers view's utilization columns and need the same restricted RBAC access as the pod-level `{request|limit}_utilization` metrics above. Disable them on GKE Autopilot too.
</Admonition>
...
1. **[K8s-Infra Overview](https://signoz.io/docs/opentelemetry-collection-agents/k8s/k8s-infra/overview/)**
2. **[Configure K8s-Infra](https://signoz.io/docs/opentelemetry-collection-agents/k8s/k8s-infra/configure-k8s-infra/)**
3. **[Telemetry Data Requirements for Infrastructure Monitoring](https://signoz.io/docs/infrastructure-monitoring/reference/telemetry-data-requirements/)**
