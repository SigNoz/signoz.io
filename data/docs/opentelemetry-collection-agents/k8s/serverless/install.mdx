...
description: Set up the OpenTelemetry Collector sidecar for EKS Fargate to collect telemetry for SigNoz.
---
...
- Install the `k8s-infra` Helm chart to enable cluster-level collection functionality. (See: [K8s-Infra - Install](/docs/opentelemetry-collection-agents/k8s/k8s-infra/install-k8s-infra/))
...
- [Configure Fargate log routing and Collector receivers](/docs/opentelemetry-collection-agents/k8s/serverless/configure/)
