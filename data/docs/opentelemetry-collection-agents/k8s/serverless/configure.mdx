...
description: Configure OpenTelemetry Collector on AWS EKS Fargate to collect logs, metrics, and traces. Includes steps for Fluent Bit log router setup and IAM permissions.
id: configure
---
