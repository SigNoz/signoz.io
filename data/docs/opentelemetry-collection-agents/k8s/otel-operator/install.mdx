...
[Go to the Configure Guide →](/docs/opentelemetry-collection-agents/k8s/otel-operator/configure/)
</Admonition>


## Next Step
- [Configure Otel Operator OtelCollectors](/docs/opentelemetry-collection-agents/k8s/otel-operator/configure/)
- [Learn more about Otel-Operator](/docs/opentelemetry-collection-agents/k8s/otel-operator/overview/)
