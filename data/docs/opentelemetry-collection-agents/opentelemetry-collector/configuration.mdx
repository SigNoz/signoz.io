...
description: Learn how to configure the OpenTelemetry Collector: receivers, processors, exporters, extensions, and service pipelines to collect, process, and export telemetry data.
doc_type: reference
---
...
This guide covers each configuration component in detail and includes best practices for production deployments. For background on why you might use a Collector, see [Why use the OpenTelemetry Collector?](https://signoz.io/docs/opentelemetry-collection-agents/opentelemetry-collector/why-to-use-collector/).
