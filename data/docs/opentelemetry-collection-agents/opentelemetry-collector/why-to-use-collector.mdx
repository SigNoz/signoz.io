...
- [Install Collection Agents](https://signoz.io/docs/opentelemetry-collection-agents/get-started/)
- [Configure OTel Collector](https://signoz.io/docs/opentelemetry-collection-agents/opentelemetry-collector/configuration/)
- [Sending data to SigNoz](https://signoz.io/docs/instrumentation/)
