...
title: Configure TLS Encryption for the OpenTelemetry Collector
description: Secure your OpenTelemetry Collector with TLS. Configure encrypted receivers, exporter connections, and mutual TLS (mTLS) for bidirectional authentication.
doc_type: howto
---
