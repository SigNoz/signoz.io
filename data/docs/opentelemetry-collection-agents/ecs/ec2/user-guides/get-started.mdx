...
id: get-started
description: Monitor Amazon ECS on EC2 with OpenTelemetry Collector as a daemon to send metrics, logs, and traces to SigNoz
---
...
Learn the concepts in the [ECS EC2 - Overview](/docs/opentelemetry-collection-agents/ecs/ec2/overview/).
...
- Follow [ECS EC2 - Install](/docs/opentelemetry-collection-agents/ecs/ec2/install/)
...
- Follow [ECS EC2 - Configure](/docs/opentelemetry-collection-agents/ecs/ec2/configure/)
...
1. [ECS EC2 - Overview](/docs/opentelemetry-collection-agents/ecs/ec2/overview/)
2. [ECS EC2 - Install](/docs/opentelemetry-collection-agents/ecs/ec2/install/)
3. [ECS EC2 - Configure](/docs/opentelemetry-collection-agents/ecs/ec2/configure/)
