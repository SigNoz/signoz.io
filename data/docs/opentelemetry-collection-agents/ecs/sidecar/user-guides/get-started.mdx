...
description: Monitor Amazon ECS Fargate using the OpenTelemetry Collector as a sidecar container to send metrics, logs, and traces to SigNoz
---
...
Learn the concepts in the [ECS Sidecar - Overview](/docs/opentelemetry-collection-agents/ecs/sidecar/overview/).
...
- Follow [ECS Sidecar - Install](/docs/opentelemetry-collection-agents/ecs/sidecar/install/)
...
- Follow [ECS Sidecar - Configure](/docs/opentelemetry-collection-agents/ecs/sidecar/configure/)
...
1. [ECS Sidecar - Overview](/docs/opentelemetry-collection-agents/ecs/sidecar/overview/)
2. [ECS Sidecar - Install](/docs/opentelemetry-collection-agents/ecs/sidecar/install/)
3. [ECS Sidecar - Configure](/docs/opentelemetry-collection-agents/ecs/sidecar/configure/)
