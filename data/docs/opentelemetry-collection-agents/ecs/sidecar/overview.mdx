...
- [Install Sidecar Collection Agent in your ECS Cluster](/docs/opentelemetry-collection-agents/ecs/sidecar/install/)
- [Configure Sidecar Collection Agent in your ECS Cluster](/docs/opentelemetry-collection-agents/ecs/sidecar/configure/)
