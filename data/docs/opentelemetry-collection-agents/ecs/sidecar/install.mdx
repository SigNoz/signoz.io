...
<Figure
  src="/img/docs/ecs-docs/ecs-otelcol-sidecar-config-ssm.webp"
  alt="otelcol-sidecar parameter in AWS Parameter Store"
  caption="OTel Collector config in AWS Parameter Store"
/>
...
<Admonition>
Replace `<IP of machine hosting SigNoz>` with the address of [SigNoz OTelCollector](https://signoz.io/docs/setup/docker/troubleshooting/faq/#signoz-otel-collector-address-grid).
...
- [Configure the Sidecar Collection Agent in your ECS Cluster ](/docs/opentelemetry-collection-agents/ecs/sidecar/configure/)
- [Learn more about Collection from Serverless](/docs/opentelemetry-collection-agents/ecs/sidecar/overview/)
