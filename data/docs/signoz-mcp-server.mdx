...
To configure the MCP server, you'll need a SigNoz API key. Follow these steps to obtain it:
...
5. Copy the generated API key for use in your MCP configuration

> 📌 Note: Keep your API key secure and never commit it to version control. Use environment variables or secure configuration management practices.
>
