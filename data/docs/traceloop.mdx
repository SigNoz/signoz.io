---
date: 2026-01-20
id: signoz-with-traceloop
title: Monitor LLM Usage with traceloop(OpenLLMetry) and SigNoz
description: Monitoring and observability for LLM/AI usage and performance with traceloop instrumentation to send traces to SigNoz
doc_type: howto
---
...
- Python 3.10+ with `traceloop-sdk` installed
...
<Admonition type="important">
  For this guide example, we are using OpenAI, but you can use any <a href="https://www.traceloop.com/docs/openllmetry/tracing/supported" target="_blank" rel="noopener noreferrer nofollow">LLM provider/framework</a> supported by traceloop.
</Admonition>
...
<Figure
  src="/img/docs/llm/traceloop/traceloop-traces.webp"
  alt="Traceloop Trace View"
  caption="Traceloop Trace View"
/>

When you click on a trace in SigNoz, you'll see a detailed view of the trace, including all associated spans, along with their events and attributes.

<Figure
  src="/img/docs/llm/traceloop/traceloop-detailed-traces.webp"
  alt="Traceloop Detailed Trace View"
  caption="Traceloop Detailed Trace View"
/>
