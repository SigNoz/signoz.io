...
- OpenTelemetry Collector deployed in your cluster (see the [Istio Metrics](/docs/istio/istio-metrics) guide)

## 1. Configure OpenTelemetry Collector for Traces

If you've already set up the OpenTelemetry Collector for metrics as described in the [Istio Metrics](/docs/istio/istio-metrics) guide, you might already have traces configured. Let's ensure your collector is properly configured for trace collection:
