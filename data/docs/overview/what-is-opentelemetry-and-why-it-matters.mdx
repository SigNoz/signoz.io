...
Without data from inside your running application, you are guessing. You need **telemetry**: the signals that tell you what your app is doing, where it spends time, and when it fails.
