...
<Figure
  ...
  alt="OpenClaw traces in SigNoz showing LLM application activity"
  caption="OpenClaw traces in SigNoz: monitor LLM application spans"
/>
...
<Figure
  ...
  alt="OpenClaw detailed trace view in SigNoz with spans, events, and attributes"
  caption="OpenClaw detailed trace in SigNoz: spans, events, and attributes per LLM request"
/>
...
<Figure
  ...
  alt="OpenClaw metrics in SigNoz showing LLM usage and performance data"
  caption="OpenClaw metrics in SigNoz: track LLM usage, latency, and performance"
/>
...
<Figure
  ...
  alt="OpenClaw detailed metric view in SigNoz with metric attributes and time series"
  caption="OpenClaw detailed metric in SigNoz: metric attributes and time series data"
/>
...
<Figure
  ...
  alt="OpenClaw observability dashboard in SigNoz with pre-built charts for LLM applications"
  caption="OpenClaw dashboard template in SigNoz: pre-built charts for monitoring LLM usage"
/>
