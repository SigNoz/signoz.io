...
<Figure src="/img/docs/llm/deepseek/deepseek-traces.webp" alt="DeepSeek Trace View" caption="DeepSeek API Trace View" />

When you click on a trace in SigNoz, you'll see a detailed view of the trace, including all associated spans, along with their events and attributes.

<Figure src="/img/docs/llm/deepseek/deepseek-detailed-traces.webp" alt="DeepSeek Detailed Trace View" caption="DeepSeek API Detailed Trace View" />
...
<Figure src="/img/docs/llm/deepseek/deepseek-log.webp" alt="DeepSeek Logs View" caption="DeepSeek API Logs View" />

When you click on any of these logs in SigNoz, you'll see a detailed view of the log, including attributes:

<Figure src="/img/docs/llm/deepseek/deepseek-detailed-log.webp" alt="DeepSeek Detailed Log View" caption="DeepSeek API Detailed Logs View" />

You should be able to see DeepSeek related metrics in Signoz Cloud under the metrics tab:

<Figure src="/img/docs/llm/deepseek/deepseek-metrics.webp" alt="DeepSeek Metrics View" caption="DeepSeek API Metrics View" />

When you click on any of these metrics in SigNoz, you'll see a detailed view of the metric, including attributes:

<Figure src="/img/docs/llm/deepseek/deepseek-detailed-metrics.webp" alt="DeepSeek Detailed Metrics View" caption="DeepSeek API Detailed Metrics View" />
...
<Figure src="/img/docs/llm/deepseek/deepseek-dashboard.webp" alt="DeepSeek Dashboard" caption="DeepSeek API Dashboard Template" />