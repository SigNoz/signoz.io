...
> 📌 Note: HostMetrics provides system-level metrics (CPU, memory, disk, network, etc.), and HttpInstrumentation provides outbound HTTP request metrics such as request duration. These are not DeepSeek-specific metrics. DeepSeek does not expose metrics as part of their SDK. If you want to add custom metrics to your DeepSeek application, see [JavaScript Custom Metrics](https://signoz.io/opentelemetry/javascript-custom-metrics/).
>
