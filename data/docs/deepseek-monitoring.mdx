...
description: Monitoring and observability for DeepSeek API usage and performance with OpenTelemetry instrumentation to send traces, logs, and metrics to SigNoz
---
...
- `<your_ingestion_key>`: Your SigNoz [ingestion key](https://signoz.io/docs/ingestion/signoz-cloud/keys/)
