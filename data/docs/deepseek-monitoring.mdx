...
The DeepSeek API uses an API format compatible with OpenAI. By modifying the configuration, you can use the OpenAI SDK or softwares compatible with the OpenAI API to access the DeepSeek API. To read more about this, you can read the [DeepSeek API Docs](https://api-docs.deepseek.com/)
