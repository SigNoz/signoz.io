...
description: Learn how to instrument your Ruby application with OpenTelemetry and send telemetry data to SigNoz

doc_type: howto
---
This guide shows you how to instrument your Ruby application with OpenTelemetry and send traces to SigNoz. The `opentelemetry-instrumentation-all` gem provides automatic instrumentation for 53+ popular Ruby libraries.
