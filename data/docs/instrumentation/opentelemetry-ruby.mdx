---
date: 2026-08-07
title: Ruby OpenTelemetry Instrumentation Guide
meta_title: Ruby OpenTelemetry Instrumentation Guide
description: Instrument your Ruby application with OpenTelemetry and send traces to SigNoz. Supports Rails, Sinatra, Sidekiq, Redis, PostgreSQL, and 53+ libraries.
doc_type: howto
---
...
## Prerequisites
- <a href="https://rubygems.org/gems/opentelemetry-instrumentation-all" target="_blank" rel="noopener noreferrer nofollow">Ruby 3.2+</a>
- Bundler installed
...
<Admonition type="tip" title="Skip instrumentation in development">
...
<Tabs variant="pill">
    ...
    <TabItem value="background-jobs" label="Background Jobs">
        <Tabs variant="pill">
            <TabItem value="sidekiq" label="Sidekiq" default>
            ...
            <TabItem value="resque" label="Resque">
    ...
    <TabItem value="databases-caches" label="Databases & Caches">
        <Tabs variant="pill">
            <TabItem value="redis" label="Redis" default>
...
- For a hands-on walkthrough, our [Ruby OpenTelemetry tutorial](https://signoz.io/blog/opentelemetry-ruby/) covers Rails and Sinatra setup with worked examples.
