...
meta_title: Instrument Flutter Apps with OpenTelemetry
description: Learn how to set up OpenTelemetry instrumentation in your Flutter (Android/iOS) app and send traces to SigNoz. Covers tracer setup, span creation, and ingestion configuration.
doc_type: howto
---
