...
meta_title: Instrument Android Java Apps with OpenTelemetry
description: Learn how to instrument your Android Java app with OpenTelemetry and send traces to SigNoz. Covers dependencies, network config, tracer initialization, and span creation.
doc_type: howto
---
...
- <a href="https://developer.android.com/studio/write/java8-support" target="_blank" rel="noopener noreferrer nofollow">Java 8+ for Android</a>.
...
```java:app/src/main/java/com/example/androidjavademo/OpenTelemetryUtil.java minimap defaultCollapsed
