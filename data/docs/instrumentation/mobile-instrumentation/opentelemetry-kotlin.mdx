...
meta_title: Instrument Android Kotlin Apps with OpenTelemetry
description: Learn how to instrument your Android Kotlin app with OpenTelemetry and send traces to SigNoz Cloud or self-hosted deployments. Covers setup, tracer config, and span creation.
doc_type: howto
---
...
```kotlin:app/src/main/java/com/example/androidkotlindemo/OpenTelemetryUtil.kt minimap defaultCollapsed
...
```kotlin:app/src/main/java/com/example/androidkotlindemo/MainActivity.kt defaultCollapsed
fun parentSpan() {
...
- Explore your mobile traces in the [Trace Explorer](https://signoz.io/docs/userguide/traces/).
