...
meta_title: Instrument iOS SwiftUI Apps with OpenTelemetry
description: Learn how to instrument your SwiftUI iOS app with OpenTelemetry and send traces to SigNoz Cloud or self-hosted deployments. Covers SDK setup, tracer init, and span creation.
doc_type: howto
---
...
```swift:OpentelemetrySetup.swift defaultCollapsed minimap
...
```swift:ContentView.swift defaultCollapsed
