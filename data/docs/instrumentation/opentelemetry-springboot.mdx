...
You can also instrument your Spring Boot application using [OpenTelemetry Annotations](/docs/instrumentation/manual-instrumentation/java/opentelemetry-java-annotations/).
