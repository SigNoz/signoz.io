...
This document contains instructions on how to set up OpenTelemetry instrumentation in your Quarkus applications. OpenTelemetry, also known as OTel for short, is an open source observability framework that helps generate and collect telemetry data (traces, metrics, and logs) from your Quarkus application.
...
- A Quarkus application sending traces, metrics, and logs to SigNoz
- Real-time visibility into your application's performance
- Ability to troubleshoot issues using distributed tracing
- Monitoring dashboards for your application metrics

Let's understand how to install and run OpenTelemetry in your Quarkus application.
...
# Ingestion key for authentication
...
## Send Traces, Metrics, and Logs to SigNoz Cloud
Quarkus Extensions and the libraries they provide, are directly instrumented, use of OpenTelemetry Agent is not required not recommended.
...
## Send Traces, Metrics, and Logs to Self-Hosted SigNoz
