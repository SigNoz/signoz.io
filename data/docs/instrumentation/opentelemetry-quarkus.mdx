...
You can also instrument your Quarkus application using [OpenTelemetry Annotations](/docs/instrumentation/manual-instrumentation/java/opentelemetry-java-annotations/).
