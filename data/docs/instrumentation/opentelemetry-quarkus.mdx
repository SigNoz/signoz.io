...
**Note:** By default, Java auto-instrumentation does not create spans for user-defined functions. In such scenarios, we can use annotations to quickly create spans for user-defined functions with minimal code change. You can instrument your Quarkus application following this [guide on annotations](/docs/instrumentation/manual-instrumentation/java/annotations/).
