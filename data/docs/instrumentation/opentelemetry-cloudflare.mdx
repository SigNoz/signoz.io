---
date: 2026-08-07
title: Cloudflare Workers OpenTelemetry Guide
meta_title: Cloudflare Workers OpenTelemetry Guide
description: Instrument Cloudflare Workers with OpenTelemetry and send traces to SigNoz. Supports both official Cloudflare export and community SDK integration methods.
...
- `<region>`: Your SigNoz [region](https://signoz.io/docs/ingestion/signoz-cloud/overview/#endpoint)
- `<your-ingestion-key>`: Your SigNoz [ingestion key](https://signoz.io/docs/ingestion/signoz-cloud/keys/)
- `<service-name>`: A descriptive name for your service (e.g., `my-worker`).
