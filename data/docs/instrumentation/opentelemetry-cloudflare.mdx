...
```bash
mkdir cloudflare-project && cd cloudflare-project
```

**Step 2: Initialize a new Wrangler project.**

```bash
npx wrangler init
```

Provide appropriate values to all the prompts that show up. 
...
**Step 5: Configure tracer in Cloudflare Workers project**
