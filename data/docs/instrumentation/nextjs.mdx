...
- [Send traces directly to SigNoz Cloud](#send-traces-directly-to-signoz-cloud)
  ...
  - [OpenTelemetry instrument (only works for nodejs runtime)](#send-traces-directly-to-signoz-cloud---OpenTelemetry-instrument)
- [Send traces via OTel Collector binary](#send-traces-via-otel-collector-binary) (recommended)
  - [Using vercel otel](#send-traces-via-otel-collector-binary---Using-vercel-otel) (recommended)
  - [OpenTelemetry instrument (only works for nodejs runtime)](#send-traces-via-otel-collector-binary---OpenTelemetry-instrument)
