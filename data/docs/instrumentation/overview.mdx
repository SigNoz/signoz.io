...
<Figure
  src="/img/docs/instrumentation/apm-traces-workflow.gif"
  alt="APM traces workflow: Services list → Application Details → context menu → Traces Explorer"
  caption="APM traces workflow — from Services list to Traces Explorer"
/>
