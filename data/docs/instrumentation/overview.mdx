...
- [Set Custom Attributes](https://signoz.io/docs/ingestion/set-custom-attributes/) — Add attributes and resource attributes to traces, logs, and metrics in the SDK or the Collector.
