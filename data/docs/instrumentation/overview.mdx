...
- **APM/Services**: Monitor every service with [latency percentiles, error rates, requests per second, and Apdex scores](https://signoz.io/docs/userguide/metrics/) — plus [database call](https://signoz.io/docs/apm-and-distributed-tracing/database-calls/) and [external call](https://signoz.io/docs/apm-and-distributed-tracing/external-calls/) breakdowns.
