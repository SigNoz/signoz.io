...
const exporterOptions = {
  url: process.env.OTEL_EXPORTER_OTLP_ENDPOINT || 'https://ingest.{region}.signoz.cloud:443/v1/traces',
}
...
<figure data-zoomable align='center'>
    <img src="/img/docs/express_instrumentation.webp" alt="All in one auto instrumentation library - identifies and instruments packages used by your NestJavaScript application"/>
