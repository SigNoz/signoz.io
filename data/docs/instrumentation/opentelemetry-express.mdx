...
Internally, it calls the specific auto-instrumentation library for components used in the application. You can see the complete list [here](https://github.com/open-telemetry/opentelemetry-js-contrib/tree/main/packages/auto-instrumentations-node#supported-instrumentations).
...
Express doesn’t include structured logging out of the box, but popular libraries like Winston and Pino make it easy to add structured logging.
