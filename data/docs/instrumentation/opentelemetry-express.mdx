...
export OTEL_EXPORTER_OTLP_HEADERS="signoz-ingestion-key=<SIGNOZ_ACCESS_TOKEN>"
...
const exporterOptions = {
  url: 'https://ingest.{region}.signoz.cloud:443/v1/traces',
  headers: { 'signoz-ingestion-key': process.env.SIGNOZ_INGESTION_KEY }, // Use if you are using SigNoz Cloud
}
// highlight-end
