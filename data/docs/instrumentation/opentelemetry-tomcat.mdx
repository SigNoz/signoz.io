...
You can also instrument your Tomcat application using [OpenTelemetry Annotations](/docs/instrumentation/manual-instrumentation/java/opentelemetry-java-annotations/).
