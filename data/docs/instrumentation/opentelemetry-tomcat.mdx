...
Include trace_id and span_id in log messages to link logs and traces. For more information, refer to [Java OpenTelemetry Instrumentation](opentelemetry-java.mdx#link-logs-and-traces).
