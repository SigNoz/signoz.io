...
date: 2026-06-09
id: php
title: OpenTelemetry PHP Instrumentation Guide
meta_title: OpenTelemetry PHP Instrumentation Guide
description: "Learn how to instrument PHP with OpenTelemetry, collect traces, metrics, and logs, and send telemetry data to SigNoz for debugging and monitoring."
doc_type: howto
---
