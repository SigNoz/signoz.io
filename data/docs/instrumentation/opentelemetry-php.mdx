...
- [PHP 8.1+](https://packagist.org/packages/open-telemetry/exporter-otlp)
...
2. Check your [PHP version meets the 8.1+ requirement](https://packagist.org/packages/open-telemetry/exporter-otlp): `php -v`
