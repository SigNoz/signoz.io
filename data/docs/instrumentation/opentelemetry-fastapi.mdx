...
<Admonition>
    Include trace_id and span_id in log messages to link logs and traces. For more information, refer to [Python OpenTelemetry Instrumentation](opentelemetry-python.mdx#link-logs-and-traces).
</Admonition>
