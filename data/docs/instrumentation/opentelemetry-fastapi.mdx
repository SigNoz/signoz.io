...
<Tabs>
<TabItem value="sdk" label="Quickstart" default>

If you're new to OpenTelemetry and SigNoz, we would suggest you to try this quickstart way of sending your traces using the OpenTelemetry SDKs in.
...
<TabItem value="collector" label="Collector (Recommended)" default>

If you plan on using SigNoz for more than just traces, we would suggest you try follow the steps below to setup collector.
