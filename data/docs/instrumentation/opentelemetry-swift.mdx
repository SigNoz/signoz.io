---
date: 2026-08-07
title: Swift OpenTelemetry Instrumentation Guide
description: Instrument your Swift application with OpenTelemetry and send traces to SigNoz. Setup guide using Swift Package Manager with gRPC exporter configuration.
doc_type: howto
---
...
```swift defaultCollapsed minimap
import Foundation
import GRPC
import NIO
import NIOSSL
...
- Create [Custom Dashboards](https://signoz.io/docs/userguide/manage-dashboards/) to monitor application health.
