...
You should see span output from `StdoutSpanExporter` in your terminal, similar to:

```
SpanData: name=doWork kind=SpanKind.client ...
```
...
We have included a sample Swift application at our <a href="https://github.com/SigNoz/OpenTelemetry-swift-example/" target="_blank" rel="noopener noreferrer nofollow">Sample Swift App GitHub Repo</a>.
