...
You can also instrument your Java application using [OpenTelemetry Annotations](/docs/instrumentation/manual-instrumentation/java/opentelemetry-java-annotations/).
