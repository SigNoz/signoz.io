...
RUN wget -O /opt/jboss/opentelemetry-javaagent.jar \
    https://github.com/open-telemetry/opentelemetry-java-instrumentation/releases/latest/download/opentelemetry-javaagent.jar

# -------- Step 2: Deploy Application --------
# Copy your application WAR or EAR file into JBoss deployments
COPY app.war /opt/jboss-eap-7.1/standalone/deployments/
...
-Dotel.exporter.otlp.headers=\"signoz-ingestion-key=<your-ingestion-key>\" \
-Dotel.resource.attributes=\"service.name=<service_name>\""' \
>> /opt/jboss-eap-7.1/bin/standalone.conf

# -------- Step 4: Expose JBoss Ports --------
EXPOSE 8080 9990

# -------- Step 5: Start JBoss --------
# Optional: redirect logs to nohup.out (like in docs)
CMD ["/bin/sh", "-c", "/opt/jboss-eap-7.1/bin/standalone.sh > /opt/jboss-eap-7.1/bin/nohup.out 2>&1"]
```
...
CMD sh -c "/otelcol-contrib --config=/etc/otelcol-contrib/config.yaml & \
           /opt/jboss-eap-7.1/bin/standalone.sh -b 0.0.0.0"
```
