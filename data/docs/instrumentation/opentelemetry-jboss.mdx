...
You can also instrument your JBoss application using [OpenTelemetry Annotations](/docs/instrumentation/manual-instrumentation/java/opentelemetry-java-annotations/).
