...
<KeyPointCallout title="Works for both SigNoz Cloud and Self-Hosted">
...
- Review [manual instrumentation patterns for Java](https://signoz.io/docs/instrumentation/manual-instrumentation/java/annotations) and [JavaScript](https://signoz.io/docs/instrumentation/manual-instrumentation/javascript/opentelemetry-nodejs) if you work across multiple runtimes.
