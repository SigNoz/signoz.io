...
date: 2025-09-23
id: java-annotations
title: Java OpenTelemetry Instrumentation using Annotations
description: Learn how to instrument your Java application with OpenTelemetry using annotations and send telemetry data to SigNoz.
hide_table_of_contents: true
---

import GetHelp from '@/components/shared/get-help.md'

This document helps you get started with OpenTelemetry using annotations in a Java application and view your application traces in SigNoz.
...
**Step 1:** Download OTel Java agent binary
