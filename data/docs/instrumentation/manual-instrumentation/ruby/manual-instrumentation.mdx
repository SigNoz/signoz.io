...
- Finish the core Ruby setup in the [Ruby on Rails OpenTelemetry instrumentation guide](https://signoz.io/docs/instrumentation/opentelemetry-ruby-on-rails/) so exporters, tracer provider, and SDK are configured.
