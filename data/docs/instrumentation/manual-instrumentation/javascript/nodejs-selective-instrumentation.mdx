...
- The `@opentelemetry/instrumentation-http` package is installed.
...
Examples for using auto-instrumentation with environment variables for SigNoz Cloud and Self-Hosted are given below.
