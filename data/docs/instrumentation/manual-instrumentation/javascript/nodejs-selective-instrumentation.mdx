...
You can also enable/disable libraries programmatically in your application code, modify your exisiting `instrumentation.js` or `instrumentation.ts` where you have initialized OpenTelemetry SDK.
