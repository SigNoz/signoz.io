...
const exporterOptions = {
  ...
  headers: { 'signoz-ingestion-key': 'SIGNOZ_INGESTION_KEY' }, // Set if you are using SigNoz Cloud
}
...
- [Send traces directly to SigNoz Cloud](#send-traces-directly-to-signoz-cloud---using-vercel-otel)
