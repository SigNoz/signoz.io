...
See [Framework instrumentation](#framework-instrumentation) below for library-specific integrations.
...
See [Framework instrumentation](#framework-instrumentation) below before you build your final image.
...
See [Framework instrumentation](#framework-instrumentation) below before you build the final image.
