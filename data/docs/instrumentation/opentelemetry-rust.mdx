---
date: 2026-07-15
title: Rust OpenTelemetry Instrumentation Guide
description: Instrument your Rust application with OpenTelemetry and send traces to SigNoz. Supports Axum, Actix Web, reqwest, and tonic with auto and manual instrumentation.
doc_type: howto
---
...
<Tabs variant="pill" className="mb-8">
    <TabItem value="tracing-category" label="Tracing" default>
        <Tabs variant="pill" className="mb-8">
            <TabItem value="tracing" label="Core tracing" default>
    ...
    <TabItem value="http-clients" label="HTTP Clients">
        <Tabs variant="pill" className="mb-8">
            <TabItem value="reqwest" label="Reqwest" default>
