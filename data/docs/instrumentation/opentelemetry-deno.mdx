---
date: 2026-08-27
title: Deno OpenTelemetry Instrumentation Guide
description: Instrument your Deno application with built-in OpenTelemetry support. Send traces, metrics, and logs to SigNoz with zero external dependencies.
doc_type: howto
---
...
- [Set up alerts for your Deno service](https://signoz.io/docs/alerts/)
