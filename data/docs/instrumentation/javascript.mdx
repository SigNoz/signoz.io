...
- [Send traces directly to SigNoz Cloud](#send-traces-directly-to-signoz-cloud)
  ...
  - [Manual Instrumentation](#send-traces-directly-to-signoz-cloud---manual-instrumentation)
- [Send traces via OTel Collector binary](#send-traces-via-otel-collector-binary) (recommended)
  - [Automatic Instrumentation](#send-traces-via-otel-collector-binary---automatic-instrumentation) (recommended)
  - [Manual Instrumentation](#send-traces-via-otel-collector-binary---manual-instrumentation)
...
#### Send traces directly to SigNoz Cloud - Manual Instrumentation
...
#### Send traces via OTel Collector binary - Manual Instrumentation
...
- [Send traces directly to SigNoz Cloud](#send-traces-directly-to-signoz-cloud)
  - [Automatic Instrumentation](#send-traces-directly-to-signoz-cloud---automatic-instrumentation-recommended-3) (recommended)
  - [Manual Instrumentation](#send-traces-directly-to-signoz-cloud---manual-instrumentation-1)
- [Send traces via OTel Collector binary](#send-traces-via-otel-collector-binary) (recommended)
  - [Automatic Instrumentation](#send-traces-via-otel-collector-binary---automatic-instrumentation-1) (recommended)
  - [Manual Instrumentation](#send-traces-via-otel-collector-binary---manual-instrumentation-1)
