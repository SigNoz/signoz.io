...
description: Setup OpenTelemetry instrumentation in your C++ application using Bazel. Send distributed traces to SigNoz for real-time observability and debugging.
...
OTel Collector binary helps to collect logs, hostmetrics, resource and infra attributes. You can find instructions to install OTel Collector binary [here](https://signoz.io/docs/opentelemetry-collection-agents/vm/install/) in your VM.
