...
title: OpenTelemetry C++ Instrumentation
meta_title: OpenTelemetry C++ Instrumentation Guide
description: Learn how to instrument C++ applications with OpenTelemetry using Bazel. Configure the OTLP HTTP exporter and send traces to SigNoz for monitoring.
