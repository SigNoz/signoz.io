...
- [Supported .NET version](https://dotnet.microsoft.com/en-us/platform/support/policy#supported-versions) or [.NET Framework 4.6.2+](https://opentelemetry.io/docs/zero-code/dotnet/#compatibility).
