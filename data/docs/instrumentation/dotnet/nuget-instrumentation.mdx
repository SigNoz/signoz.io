---
date: 2026-08-07
title: How to Manually Instrument .NET Apps using NuGet
description: Setup OpenTelemetry in .NET using NuGet packages and Program.cs configuration. Get full control over tracing for ASP.NET Core, HTTP, SQL, and gRPC.
...
The examples above use HTTP export. If you need gRPC export, set the protocol explicitly:
