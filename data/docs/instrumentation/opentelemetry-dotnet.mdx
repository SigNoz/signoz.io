---
date: 2026-08-27
title: .NET OpenTelemetry Instrumentation Guide
description: Learn how to instrument your .NET app with OpenTelemetry zero-code auto-instrumentation, sending traces to SigNoz from VMs, Kubernetes, or Docker.
doc_type: howto
---
...
OTEL_RESOURCE_ATTRIBUTES=deployment.environment=production,service.version=<service-version> \
dotnet run
```
...
- name: OTEL_RESOURCE_ATTRIBUTES
  value: 'deployment.environment=production,service.version=<service-version>'
```
...
ENV OTEL_RESOURCE_ATTRIBUTES="deployment.environment=production,service.version=<service-version>"
...
- [.NET OpenTelemetry tutorial](https://signoz.io/blog/opentelemetry-dotnet/), for a code-first walkthrough with manual instrumentation examples.
