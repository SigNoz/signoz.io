...
description: Learn how to instrument your .NET application with OpenTelemetry zero-code auto-instrumentation. Send traces to SigNoz from VMs, Kubernetes, Docker, and Windows.
doc_type: howto
---
