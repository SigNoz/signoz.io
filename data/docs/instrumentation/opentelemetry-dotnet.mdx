...
- [Automatic code-level instrumentation](https://signoz.io/docs/instrumentation/dotnet/automatic-instrumentation/) to add OpenTelemetry via NuGet packages and configure in Program.cs
