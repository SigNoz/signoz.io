...
description: Learn how to instrument Apache Tomcat with the OpenTelemetry Java agent using setenv.sh configuration. Send traces to SigNoz for real-time monitoring.
doc_type: howto
---
...
- <a href="https://github.com/open-telemetry/opentelemetry-java-instrumentation/blob/main/docs/supported-libraries.md#application-servers" target="_blank" rel="noopener noreferrer nofollow">Supported Tomcat version</a>
