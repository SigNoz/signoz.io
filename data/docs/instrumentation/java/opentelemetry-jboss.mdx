---
date: 2026-08-26
title: JBoss & WildFly OpenTelemetry Setup Guide
description: Learn how to instrument JBoss EAP and WildFly with the OpenTelemetry Java agent. Configure standalone.conf and send traces to SigNoz for better debugging.
doc_type: howto
---
...
- <a href="https://github.com/open-telemetry/opentelemetry-java-instrumentation" target="_blank" rel="noopener noreferrer nofollow">Java 8+</a>
- <a href="https://github.com/open-telemetry/opentelemetry-java-instrumentation/blob/main/docs/supported-libraries.md#application-servers" target="_blank" rel="noopener noreferrer nofollow">Supported WildFly version</a> or compatible JBoss EAP
...
Verify these values:
- `<my-app>.war`: Your application WAR file name.
- `<service-name>`: A descriptive name for your service (e.g., `jboss-app`).
- `<service-version>` (optional): Your release version, image tag, or git SHA (e.g., `1.4.2`, `a01dbef8`).
- `<region>`: Your [SigNoz Cloud region](https://signoz.io/docs/ingestion/signoz-cloud/overview/#endpoint).
- `<your-ingestion-key>`: Your SigNoz [ingestion key](https://signoz.io/docs/ingestion/signoz-cloud/keys/).
