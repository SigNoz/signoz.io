...
- Send [metrics](https://signoz.io/docs/metrics-management/send-metrics/applications/opentelemetry-java/) and [logs](https://signoz.io/docs/userguide/collecting_application_logs_otel_sdk_java/) from your Java application for complete observability
