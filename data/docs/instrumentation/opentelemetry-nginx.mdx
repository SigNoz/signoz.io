---
date: 2026-08-07
title: NGINX OpenTelemetry Instrumentation Guide
description: Setup OpenTelemetry instrumentation for NGINX web servers. Send traces, metrics, and logs to SigNoz for real-time monitoring and performance insights.
