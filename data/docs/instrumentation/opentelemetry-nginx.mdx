...
**Step 1 : Install nginx-otel-module module for NGINX**
...
**Step 2: Configure NGINX with nginx-otel-module module**
...
**Step 4: Restart NGINX and wait for traces to get generated**
...
**Step 2 : Install nginx-otel-module module for NGINX**

```bash
apt-get update && apt-get install -y nginx-otel-module
```

**Step 3: Configure NGINX with nginx-otel-module module**
...
**Step 5: Restart NGINX and wait for traces to get generated**
...
**Step 1: Create Dockerfile with OpenTelemetry NGINX module**
...
**Step 2: Create the `opentelemetry_module.conf` configuration file**

This configuration enables OpenTelemetry and exports traces directly to SigNoz Cloud
