...
The `composer.json` file should now include the packages you just installed. It should look something like the code snipped below both in the case of a new composer project and existing, with an existing project having additional dependencies and configurations.
...
You can also refer to the [penTelemetry Binary Usage in Virtual Machine](https://signoz.io/docs/tutorial/opentelemetry-binary-usage-in-virtual-machine/) documentation for more information.
