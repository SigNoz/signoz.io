...
To install the OpenTelemetry collector, run the following command:
...
<Admonition type="info">
A quick note on some of these values:
- `<service-name>` is the name of the service, which is used to identify your service in SigNoz.
