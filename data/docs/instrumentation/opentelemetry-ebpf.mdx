...
```yaml:obi-daemonset.yaml minimap defaultCollapsed
apiVersion: v1
kind: ServiceAccount
metadata:
  name: obi
...
- Use the [OpenTelemetry Injector](https://signoz.io/docs/instrumentation/opentelemetry-injector/) for Java, Node.js, .NET, and Python services on a Linux host. It starts the full language agent, which reports more than protocol-level probes.
