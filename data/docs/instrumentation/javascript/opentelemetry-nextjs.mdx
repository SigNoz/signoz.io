...
description: Learn how to instrument your Next.js app with OpenTelemetry using @vercel/otel package. Trace server and edge runtime requests and send data to SigNoz.
doc_type: howto
---
...
- <a href="https://nextjs.org/docs" target="_blank" rel="noopener noreferrer nofollow">Next.js with App Router or Pages Router</a>
...
```dockerfile:Dockerfile defaultCollapsed minimap
