...
- Node.js 18.19.0+ (or Node.js 20.6.0+) application instrumented with OpenTelemetry (see [Node.js instrumentation guide](https://signoz.io/docs/instrumentation/javascript/opentelemetry-nodejs/))
