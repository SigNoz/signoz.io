...
<Admonition type="tip" title="Using self-hosted SigNoz or local collector?">
For self-hosted SigNoz, set the URL to your SigNoz instance endpoint (e.g., `http://your-signoz-host:4318/v1/traces`) and remove the `headers` block.
</Admonition>
...
- `<service_name>`: A descriptive name for your app (e.g., `my-react-native-app`).

### Step 3. Initialize the tracer in your app

Import and use the hook in your main entry point:
