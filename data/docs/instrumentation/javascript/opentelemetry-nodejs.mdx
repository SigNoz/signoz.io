...
date: 2026-06-09
id: nodejs
title: OpenTelemetry Node.js Instrumentation
meta_title: OpenTelemetry Node.js Instrumentation Guide
description: Learn how to instrument your Node.js or NestJS app with OpenTelemetry. Send traces to SigNoz using auto or manual instrumentation for faster debugging.
doc_type: howto
---
