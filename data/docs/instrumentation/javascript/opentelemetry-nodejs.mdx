...
- For framework-specific walkthroughs, see our guides on [instrumenting Express applications](https://signoz.io/blog/opentelemetry-express/) and [NestJS applications](https://signoz.io/blog/opentelemetry-nestjs/), which build on the base setup above.
