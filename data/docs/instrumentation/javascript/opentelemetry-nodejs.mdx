...
- [Send logs from Node.js](https://signoz.io/docs/logs-management/send-logs/nodejs-logs/) with automatic trace correlation
- [Create custom APM dashboards and alerts](https://signoz.io/docs/userguide/custom-apm-dashboards-alerts/)
