...
- Use the [OpenTelemetry Injector](https://signoz.io/docs/instrumentation/opentelemetry-injector/) to start this agent with no change to the application, when one Linux host runs several services
