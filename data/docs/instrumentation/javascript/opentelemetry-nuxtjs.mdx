...
Use the [OpenTelemetry Operator](https://signoz.io/docs/opentelemetry-collection-agents/k8s/otel-operator/overview/) to inject instrumentation into your Nuxt.js pods.
...
If you only need to instrument specific frameworks, you can install individual instrumentation packages instead of the full auto-instrumentation bundle:
