...
- [Python 3.9+](https://pypi.org/project/opentelemetry-distro/)
- A SigNoz Cloud account or self-hosted SigNoz instance

Tested with [Python 3.11](https://docs.python.org/3.11/) and OpenTelemetry Python SDK [v1.27.0](https://pypi.org/project/opentelemetry-sdk/1.27.0/).
