...
This guide shows you how to instrument your Python application with OpenTelemetry and send traces to SigNoz. The <Tooltip text="auto-instrumentation" content="An agent or startup hook instruments the libraries you already use, so you write no instrumentation code." link="https://signoz.io/docs/glossary/#auto-instrumentation" /> approach works with Django, Flask, FastAPI, Falcon, Celery, and most Python libraries out of the box.
