...
See the [Framework instrumentation](#framework-instrumentation) section below for framework-specific run commands.
...
- [Add manual instrumentation](https://signoz.io/docs/instrumentation/manual-instrumentation/python/manual-instrumentation) for custom spans and attributes
