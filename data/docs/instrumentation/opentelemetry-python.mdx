...
<Admonition title="Why explicitly disable metrics?" defaultCollapsed="true">
...
>
    <LibraryTab value="django" label="Django" category="web">
        ...
        <Admonition title="For Docker users" defaultCollapsed="true">
        ```dockerfile
    ...
    <LibraryTab value="celery" label="Celery" category="worker">
        ...
        <Admonition title="Celery with prefork workers (advanced)" defaultCollapsed="true">
...
<Admonition title="Why do some setups need extra config?" defaultCollapsed="true">
