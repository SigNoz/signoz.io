...
If you see JSON span output in your terminal but traces don't appear in SigNoz, the usual causes are missing context propagation or an exporter misconfiguration. Our deeper walkthrough on [troubleshooting Python OpenTelemetry tracing](https://signoz.io/blog/troubleshooting-python-with-opentelemetry-tracing/) covers these failure modes step by step.
