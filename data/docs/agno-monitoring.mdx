...
title: Agno Monitoring with SigNoz
description: Monitoring and observability for Agno performance and usage with OpenTelemetry instrumentation to send traces, logs, and metrics to SigNoz
doc_type: howto
---
...
For more detailed info on instrumenting your Agno applications with OpenTelemetry click <a href="https://pypi.org/project/openinference-instrumentation-agno/" target="_blank" rel="noopener noreferrer nofollow">here</a>.
...
- Replace `<your_run_command>` with the actual command you would use to run your application. In this case we would use: `opentelemetry-instrument python main.py`
