...
description: Monitoring and observability for Pipecat usage and performance with OpenTelemetry instrumentation to send traces, logs, and metrics to SigNoz
doc_type: tutorial
---
