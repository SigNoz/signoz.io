...
You can follow [Parsing Logs with Regex](https://signoz.io/docs/logs-pipelines/guides/regex/) guide for more details.
...
You can follow [Parsing Logs with Grok](https://signoz.io/docs/logs-pipelines/guides/grok/) guide for more details.
