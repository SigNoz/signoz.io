...
If your logs include timestamps in non-standard fields or embedded within the message, this guide will show you how to extract and parse the timestamp information into the standard OpenTelemetry `timestamp` field using SigNoz Logs [Pipelines](https://signoz.io/docs/logs-pipelines/introduction/#pipelines).
...
You can learn more about timestamp strptime format in the <a href="https://github.com/open-telemetry/opentelemetry-collector-contrib/blob/main/pkg/stanza/docs/types/timestamp.md#strptime-and-gotime" target="_blank" rel="noopener noreferrer nofollow">strptime format guide</a>.
...
<Figure
  ...
  caption="Pipeline with all the processors"
/>
...
<Figure
  src="/img/docs/logs-management/logs-pipelines/timestamp-guide-step9.webp"
