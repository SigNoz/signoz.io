...
<img className="box-shadowed-image" src="/img/docs/logs-managements/logs-pipelines/resource-guide-step1.webp" alt="Converting to Structured Attributes"/>
...
<figure data-zoomable align='center'>
<img className="box-shadowed-image" src="/img/docs/logs-managements/logs-pipelines/resource-guide-step2.webp" alt="Extracting Log field to body"/>
...
<figure data-zoomable align='center'>
<img className="box-shadowed-image" src="/img/docs/logs-managements/logs-pipelines/resource-guide-step3.webp" alt="Map Container Name to Service Name"/>
