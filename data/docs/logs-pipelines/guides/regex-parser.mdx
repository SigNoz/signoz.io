...
<Figure
  src="/img/docs/logs-management/logs-pipelines/regex-parsing-pipeline-step2.webp"
...
Now after creating the pipeline, you can configure the regex parser.
...
After deploying the pipeline, the final output will look like this:
...
- Test patterns with [regex101](https://regex101.com/) (select Go flavor)
