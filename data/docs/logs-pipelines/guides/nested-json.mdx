...
<figure data-zoomable align='center'>
<img className="box-shadowed-image" src="/img/docs/logs-management/logs-pipelines/nested-json-guide-step2.webp" alt="Normalize Attributes to String"/>
...
<figure data-zoomable align='center'>
<img className="box-shadowed-image" src="/img/docs/logs-management/logs-pipelines/nested-json-guide-step3.webp" alt="Parse Metadata Attributes to Structured Fields"/>
...
<figure data-zoomable align='center'>
<img className="box-shadowed-image" src="/img/docs/logs-management/logs-pipelines/nested-json-guide-step4.webp" alt="Extract Image Name to Attributes"/>
