...
date: 2026-06-09
id: introduction
description: "Follow this SigNoz guide for Log pipelines and processing. Set up collection, validate incoming logs, and connect them to search, alerts, and dashboards."
title: "Log Pipelines in SigNoz: Process, Transform, and Route Logs"
meta_title: "Log Pipelines in SigNoz: Process, Transform, and Route Logs"
