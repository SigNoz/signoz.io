...
- `--metrics.otlp=true`
- `--metrics.otlp.grpc=true`
- `--metrics.otlp.grpc.endpoint=<SigNoz OtelCollector IP>:4317`
...
- `--tracing.otlp=true`
- `--tracing.otlp.grpc=true`
- `--tracing.otlp.grpc.endpoint=<SigNoz OtelCollector IP>:4317`
...
services:
  reverse-proxy:
    ...
    command:
      ...
      - --metrics.otlp.grpc=true
      - --metrics.otlp.grpc.insecure=true
      - --metrics.otlp.grpc.endpoint=signoz:4317
      - --tracing.otlp=true
      - --tracing.otlp.grpc=true
      - --tracing.otlp.grpc.insecure=true
      - --tracing.otlp.grpc.endpoint=signoz:4317
    ports:
      - "80:80"
      - "8080:8080"
    volumes:
