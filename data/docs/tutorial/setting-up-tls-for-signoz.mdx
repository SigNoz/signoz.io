...
To secure the OTel Collector itself at the component level (receiver and exporter TLS, mTLS), see [Enable TLS for OpenTelemetry Collector](https://signoz.io/docs/opentelemetry-collection-agents/opentelemetry-collector/tls-configuration/).
