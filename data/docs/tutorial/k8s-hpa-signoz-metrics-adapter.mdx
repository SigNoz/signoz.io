...
A non-zero value confirms end-to-end connectivity between the HPA, adapter, and SigNoz.
...
- [Build a dashboard](https://signoz.io/docs/dashboards/manage-dashboards/) to visualize the metrics you are scaling on
- [Create alerts](https://signoz.io/docs/alerts/alerts-management/) on the same metrics to get notified when scaling events occur
