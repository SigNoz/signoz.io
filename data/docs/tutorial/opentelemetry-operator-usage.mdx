...
import OtelOperatorOTLPEndpoint from '@/components/shared/otel-operator-otlp-endpoint.md'
import OtelOperatorAutoInstrumentation from '@/components/shared/otel-operator-auto-instrumentation.md'
