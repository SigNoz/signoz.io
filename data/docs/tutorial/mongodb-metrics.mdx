...
[signoz/otel-collector-config.yaml](https://github.com/SigNoz/signoz/blob/main/deploy/docker/otel-collector-config.yaml)
...
Create new panels in [Dashboard section](/docs/userguide/manage-dashboards/) of SigNoz and add the following queries for example. 
