...
### Q. How to view your past billing history and invoices

<details>

<summary> Toggle for answer </summary>

To access your billing history and view past invoices, follow these steps:

Navigate from Setting (in the sidebar)
1. Settings
2. Account settings
3. Billing
4. Click on the "Manage Billing" section.
5. Scroll down to view your past invoices.

**Note:** If you only see the current month's billing information at first, make sure to scroll down within the Manage Billing section to locate your historical invoices and billing records.
...
SigNoz supports all the exporters that are listed on the <a href="https://prometheus.io/docs/instrumenting/exporters/" rel="noopener noreferrer nofollow" target="_blank">Exporters and Integrations</a> page of the Prometheus documentation. If you have a running Prometheus instance and you expose metrics in Prometheus, then you can scrape them in SigNoz by [configuring Prometheus receivers](https://signoz.io/docs/metrics-management/send-metrics/#enable-a-prometheus-receiver).
...
<Figure
  src="/img/blog/common/trace_filter_apply_aggregates.webp"
  alt="Use advanced filters and aggregates to analyze span data"
  caption="Analyze your spans with advanced filters and aggregates"
/>
...
<Figure
  ...
  alt="Traces visualized with Flamegraphs and Gantt Charts"
  caption="Traces represented as Flamegraphs and Gantt charts in SigNoz"
/>
...
Try SigNoz on your macOS or Linux system by following the [Docker Standalone installation guide](https://signoz.io/docs/install/docker/).
...
Yes, SigNoz can monitor resource utilization metrics at the node and pod level from your Kubernetes cluster. You can enable it by following the set of instructions [here](https://signoz.io/docs/opentelemetry-collection-agents/k8s/k8s-infra/install-k8s-infra/#steps-to-export-k8s-metrics-to-signoz).
...
You need to follow our [migration guides](https://signoz.io/docs/operate/upgrade/) to upgrade SigNoz correctly.
