...
 configured and received is part of the service list. You can read more about it from our [docs](https://signoz.io/docs/userguide/metrics/#how-services-and-red-metrics-are-determined).
