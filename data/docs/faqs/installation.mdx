...
Refer here: [Migration Docs](https://signoz.io/docs/operate/upgrade/)
...
Check this [section](https://signoz.io/docs/metrics-management/send-metrics/#enable-a-specific-metric-receiver) in the docs for more information.
