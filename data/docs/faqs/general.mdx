...
A. For self‑hosted, change retention in Settings → Workspace (applies only to newly ingested data).
...
Retention changes affect pricing. See [Configure Retention Periods for Logs, Traces and Metrics](https://signoz.io/docs/userguide/retention-period/) for how to request a change and estimate your new bill.
...
### Q. How do I change the login email on my account?

A. The login email on an existing account cannot be edited directly. To switch to a different email while preserving your existing dashboards and settings, [invite the new email address](https://signoz.io/docs/manage/administrator-guide/iam/invite-team-member/) to your current workspace, log in with the new email, and optionally remove the old user from the workspace.
