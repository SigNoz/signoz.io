...
- `<your-ingestion-key>`: Your ingestion key from [Settings → Ingestion Settings](https://signoz.io/docs/ingestion/signoz-cloud/keys/)
...
See [Collecting Application Logs Using OTEL Java Agent](https://signoz.io/docs/logs-management/send-logs/java-logs/) for Logback/Log4j configuration options.
...
See [Python Logs Auto-Instrumentation](https://signoz.io/docs/logs-management/send-logs/python-logs/) for details.
...
- [Explore Logs Explorer features](https://signoz.io/docs/userguide/logs_query_builder/) for analysis
