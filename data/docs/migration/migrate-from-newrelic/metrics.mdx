...
| Language | Remove                 | Add                                                                                  |
| -------- | ---------------------- | ------------------------------------------------------------------------------------ |
| Java     | `newrelic.jar` agent   | [OTel Java Agent](https://signoz.io/docs/instrumentation/java/opentelemetry-java/)        |
| Node.js  | `newrelic` npm package | [OTel Node.js SDK](https://signoz.io/docs/instrumentation/javascript/opentelemetry-nodejs/)     |
...
Follow the **[Host Metrics Collection Guide](https://signoz.io/docs/infrastructure-monitoring/user-guides/hostmetrics/)** to set up the collector and enable the `hostmetrics` receiver. This guide covers installation, configuration, and verification.
