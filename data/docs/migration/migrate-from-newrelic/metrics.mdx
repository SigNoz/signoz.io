---
date: 2025-05-12
id: migrate-from-newrelic-metrics
...
### 2. Using Prometheus Receiver for Existing Exporters
...
### 4. Monitoring Infrastructure Metrics

For infrastructure metrics previously collected by New Relic Infrastructure:

1. Configure the OpenTelemetry [Host Metrics Receiver](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/main/receiver/hostmetricsreceiver):
...
3. Choose aggregation functions and filters
4. Group by relevant dimensions
5. Run the query to visualize the results
