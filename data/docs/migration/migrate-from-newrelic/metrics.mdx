...
| Go       | `go-agent`             | [OTel Go SDK](https://signoz.io/docs/instrumentation/opentelemetry-golang/)          |
| Ruby     | `newrelic_rpm` gem     | [OTel Ruby SDK](https://signoz.io/docs/instrumentation/opentelemetry-ruby-on-rails/) |
...
Follow the **[Host Metrics Collection Guide](https://signoz.io/docs/userguide/hostmetrics/)** to set up the collector and enable the `hostmetrics` receiver. This guide covers installation, configuration, and verification.
...
<Figure
  src="/img/docs/migration/metrics-explorer.webp"
  alt="SigNoz Metrics Explorer showing list of available metrics"
  caption="SigNoz Metrics Explorer interface"
/>
