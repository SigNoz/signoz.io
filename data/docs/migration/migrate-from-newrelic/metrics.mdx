...
Follow the **[Host Metrics Collection Guide](https://signoz.io/docs/infrastructure-monitoring/hostmetrics/)** to set up the collector and enable the `hostmetrics` receiver. This guide covers installation, configuration, and verification.
