...
If you manage Datadog configuration with Terraform, use the [SigNoz Terraform Provider](https://registry.terraform.io/providers/SigNoz/signoz/latest/docs) to manage:
