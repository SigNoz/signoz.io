...
Follow the **[Host Metrics Collection Guide](https://signoz.io/docs/userguide/hostmetrics/)** to set up the collector and enable the `hostmetrics` receiver. This guide covers installation, configuration, and verification for both VMs and Kubernetes.
