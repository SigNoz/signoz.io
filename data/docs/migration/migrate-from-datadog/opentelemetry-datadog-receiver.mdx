...
title: Using the OpenTelemetry Datadog Receiver
meta_title: OpenTelemetry Datadog Receiver Setup
description: Use the OpenTelemetry Datadog Receiver to bridge Datadog Agent traffic into SigNoz, a practical step when migrating from Datadog to OpenTelemetry.
doc_type: howto
---
