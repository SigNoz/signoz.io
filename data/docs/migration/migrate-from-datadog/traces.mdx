...
For detailed configuration options, see [Java Instrumentation](https://signoz.io/docs/instrumentation/java/opentelemetry-java/).
...
For detailed configuration, see [Node.js Instrumentation](https://signoz.io/docs/instrumentation/javascript/opentelemetry-nodejs/).
...
For detailed configuration, see [Ruby Instrumentation](https://signoz.io/docs/instrumentation/opentelemetry-ruby/).
