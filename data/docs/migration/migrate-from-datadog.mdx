...
You can continue using DogStatsD for custom metrics by configuring a DataDog receiver in SigNoz.

**Using DataDog Receiver:**
   - Configure the DataDog receiver in the OpenTelemetry Collector to accept DogStatsD metrics.
   - Refer to this guide for assistance: [Translate DataDog Metrics into OTLP](https://grafana.com/blog/2024/06/18/translate-datadog-metrics-into-otlp-with-the-opentelemetry-collector-and-grafana-alloy/).
...
1. **Configure DataDog Receiver:**
   - Update the OpenTelemetry Collector configuration to include the DataDog receiver for traces.
