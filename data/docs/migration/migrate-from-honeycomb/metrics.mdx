...
- **High-cardinality native**: Unlimited dimensional data support
...
- **ClickHouse storage**: Time-series storage with compression
...
| **Cardinality** | Unlimited | High-cardinality with aggregations supported |
...
**Important**: While SigNoz supports high-cardinality data, follow these practices:
...
- [ ] Design label schema (avoid high-cardinality)
...
4. **Use Exemplars**: Store high-cardinality data as exemplars, not labels
