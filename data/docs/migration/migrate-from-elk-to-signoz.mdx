...
- **[Migrate Metrics](/docs/migration/migrate-from-elk/metrics)**: Transition your Metricbeat modules and infrastructure metrics to OpenTelemetry and SigNoz.

- **[Migrate Traces/APM](/docs/migration/migrate-from-elk/traces)**: Replace Elastic APM agents with OpenTelemetry instrumentation for distributed tracing/APM.

- **[Migrate Logs](/docs/migration/migrate-from-elk/logs)**: Configure log collection using OpenTelemetry Collector or FluentBit to send logs to SigNoz.

- **[Migrate Dashboards](/docs/migration/migrate-from-elk/dashboards)**: Recreate your Kibana dashboards in SigNoz using our powerful query builder and visualization options.

- **[Migrate Alerts](/docs/migration/migrate-from-elk/alerts)**: Set up alerts in SigNoz to match your existing Kibana or ElastAlert rules.