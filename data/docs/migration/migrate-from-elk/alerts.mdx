...
* **SigNoz:**  
  ...
  * **Notification Channels:** Configured in the UI (Settings \-\> Alert Channels), supporting Slack, Email, Webhook, PagerDuty, Opsgenie, Incident.io, Rootly, Zenduty, and Microsoft Teams.
