...
## **Migrating Alerts: From ELK Stack to SigNoz**
...
*   **[Metrics-based alerts](/docs/alerts-management/metrics-based-alerts/)**: Monitor metric values (thresholds, rates using PromQL or ClickHouse Query).
*   **[Trace-based alerts](/docs/alerts-management/trace-based-alerts/)**: Alert on trace metrics like latency or error rates (ClickHouse Query).
*   **[Log-based alerts](/docs/alerts-management/log-based-alerts/)**: Create alerts based on log patterns or frequencies (ClickHouse Query).
*   **[Anomaly-based alerts](/docs/alerts-management/anomaly-based-alerts/)**: Trigger alerts when metrics deviate from normal patterns (PromQL).
*   **[Exceptions-based alerts](/docs/alerts-management/exceptions-based-alerts/)**: Alert on application exceptions (ClickHouse Query).
