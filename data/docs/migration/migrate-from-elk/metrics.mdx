...
**Migration:**
Follow the **[Host Metrics Collection Guide](https://signoz.io/docs/infrastructure-monitoring/user-guides/hostmetrics/)** to set up the OpenTelemetry Collector with the `hostmetrics` receiver. This guide provides connection details and configuration examples.
