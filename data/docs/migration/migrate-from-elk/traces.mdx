...
See [Java Instrumentation](https://signoz.io/docs/instrumentation/java/opentelemetry-java/) for details.
...
See [Node.js Instrumentation](https://signoz.io/docs/instrumentation/javascript/opentelemetry-nodejs/) for details.
