...
<Figure
  src="/img/docs/dashboards/overview/share-page-link-v2.webp"
...
3. Select the globe icon at the top right of the page to open the share popover.
4. Turn on the **Include variables** toggle, then select **Copy page link**.

The popover offers two toggles above **Copy page link**:

- **Enable absolute time**: share the time range as fixed start and end timestamps instead of the relative window. With it on, the recipient sees exactly the window you were looking at; with it off, the link carries the relative range (for example, `Last 30 minutes`) and resolves against the time they open it.
- **Include variables**: carry your current variable selections into the link.
