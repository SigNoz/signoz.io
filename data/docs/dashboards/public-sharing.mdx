...
- **Permission**: `update` on the dashboard you want to publish. The SigNoz-Admin and SigNoz-Editor roles hold it for every dashboard, and a custom role can grant it per dashboard. See the [Transactions Reference](https://signoz.io/docs/manage/administrator-guide/iam/reference/transactions/#dashboard)
...
- **Permission**: publishing needs `update` on that dashboard. Ask an admin to publish it, or to grant your role `update` on it. See [Restrict Dashboard Access](https://signoz.io/docs/manage/administrator-guide/iam/user-guides/restrict-dashboard-access/).
</Admonition>
