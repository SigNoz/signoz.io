...
2. Click **Add Context Link** to open the context link editor.
3. Configure the link:
   ...
   - **URL parameters** (optional): Click **Add URL parameter** to manage query parameters as key-value rows. Each row adds a `key=value` pair to the URL.
4. Click **Save**.
