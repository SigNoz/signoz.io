...
Dashboards in SigNoz let you interact with data through [panels](https://signoz.io/docs/userguide/manage-panels/) built in the [Query Builder](https://signoz.io/docs/userguide/query-builder-v5/), where context menus 
