...
description: Learn how interactive dashboards in SigNoz help you drill down, correlate signals, and troubleshoot faster using context menus, cross filtering, and navigation to Logs and Traces.
...
<figure data-zoomable align='center'>
    <img src="/img/docs/dashboards/interactivity/cross-panel-sync-config.webp" width="80%" alt="Dashboard Configuration panel with Cross-Panel Sync set to Crosshair mode"/>
    <figcaption><i>Cross-Panel Sync settings in Dashboard Configuration.</i></figcaption>
</figure>
