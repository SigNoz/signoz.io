...
Dashboards in SigNoz let you interact with data through [panels](https://signoz.io/docs/dashboards/panels/overview/) built in the [Query Builder](https://signoz.io/docs/userguide/query-builder-v5/), where context menus 
