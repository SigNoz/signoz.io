...
<Figure
  ...
  alt="Context link editor with Label, URL, and a key-value URL parameter row"
  caption="Authoring a context link in the editor, with a URL parameter row derived from the URL."
/>
...
<Figure
  ...
  alt="Context link editor showing the URL validation error on an invalid ftp URL"
  caption="An invalid URL is flagged and blocks saving until it is corrected."
/>
...
<Figure
  src="/img/docs/dashboards/interactivity/context-links-variables.webp"
  alt="Variable autocomplete popover listing global timestamp variables in the URL field"
  caption="Typing {{ opens the variable autocomplete, here showing the global timestamp variables."
/>
...
<Figure
  src="/img/docs/dashboards/interactivity/context-links-list.webp"
  alt="Saved context link shown as a compact row with edit and delete buttons on hover"
  caption="Saved links render as a compact list with per-row edit and delete actions."
/>
...
<Figure
  src="/img/docs/userguide/manage-dashboards/create-alert-panel-menu.webp"
  alt="Panel three-dot menu showing the Create Alerts option with a bell icon"
  caption="Open the panel's three-dot menu and select Create Alerts to seed an alert from the panel query."
/>
...
<Figure
  src="/img/docs/userguide/manage-dashboards/create-alert-seeded-builder.webp"
  alt="SigNoz alert builder pre-loaded with a panel query and its unit applied"
  caption="The alert builder opens in a new tab with the panel query plotted and its formatting unit applied."
/>
