...
<Figure
  src="/img/docs/dashboards/interactivity/create-context-links.png"
  alt="Configuring a Context Link with label, URL template, and query parameters"
  caption="Configuring a Context Link with label, URL template, and query parameters"
/>
