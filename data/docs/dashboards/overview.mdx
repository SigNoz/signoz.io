...
The dashboards experience is being redesigned. When the `use_dashboard_v2` feature flag is
enabled, the same `/dashboards` route serves a refreshed list page, a sticky detail-view toolbar,
a tabbed settings drawer (Overview, Variables, Publish), and a full-page
[panel editor](https://signoz.io/docs/dashboards/panel-editor/). The URLs and core concepts are
...
- [Panel editor](https://signoz.io/docs/dashboards/panel-editor/) — Build and configure a panel in the full-page editor: live preview, query builder, and a config pane with axes, legend, formatting, thresholds, and more.
