...
- **[Find the dashboard you want](https://signoz.io/docs/userguide/manage-dashboards/#saved-views)**: open on a views rail, filter the list with a query such as `tags CONTAINS 'prod' AND updated_at > -7d`, pin what you use daily, and save any filter combination as a view your team can share.
