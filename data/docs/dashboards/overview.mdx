...
<Figure
  src="/img/docs/dashboards/overview/dashboards-overview-v2.gif"
...
- **[Manage dashboards from Kubernetes](https://signoz.io/docs/manage/signoz-operator/overview/)**: declare dashboards as custom resources with the SigNoz Operator and deploy them with `kubectl` or your GitOps tool.
...
- [SigNoz Operator](https://signoz.io/docs/manage/signoz-operator/overview/): manage dashboards as Kubernetes custom resources.
...
- [Dashboard access control](https://signoz.io/docs/manage/administrator-guide/iam/user-guides/restrict-dashboard-access/): scope a custom role to specific dashboards.
