...
- Use dashboard templates from the <a href="https://github.com/SigNoz/dashboards" target="_blank" rel="noopener noreferrer nofollow">SigNoz Dashboards repository</a>

## Prerequisites

- Terraform
  - version of Terraform runtime: <a href="https://github.com/hashicorp/terraform/releases/tag/v0.13.0" target="_blank" rel="noopener noreferrer nofollow">v0.13.0</a> or later
  - version of Signoz provider: <a href="https://github.com/SigNoz/terraform-provider-signoz/releases/tag/v0.0.4" target="_blank" rel="noopener noreferrer nofollow">0.0.4</a> or later
- SigNoz Instance (any of the following)
  - SigNoz Enterprise
  - SigNoz Cloud
  - Self-hosted Community Edition (<a href="https://github.com/SigNoz/signoz/releases/tag/v0.85.0" target="_blank" rel="noopener noreferrer nofollow">v0.85.0</a> or later)
...
- **`<SIGNOZ-API-KEY>`**: Your SigNoz API key. See [Service Accounts](https://signoz.io/docs/manage/administrator-guide/iam/service-accounts/) to create one.
...
- And many more at [SigNoz Dashboards](https://signoz.io/docs/dashboards/dashboard-templates/overview/)
...
- Explore <a href="https://github.com/SigNoz/dashboards" target="_blank" rel="noopener noreferrer nofollow">dashboard templates</a> for common monitoring scenarios
...
- <a href="https://github.com/SigNoz/dashboards" target="_blank" rel="noopener noreferrer nofollow">Dashboard Templates Repository</a>
- <a href="https://registry.terraform.io/providers/SigNoz/signoz/latest/docs/resources/dashboard" target="_blank" rel="noopener noreferrer nofollow">Terraform Provider Documentation</a>
- <a href="https://developer.hashicorp.com/terraform/cloud-docs/recommended-practices" target="_blank" rel="noopener noreferrer nofollow">Terraform Best Practices</a>
