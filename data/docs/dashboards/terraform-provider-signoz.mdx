...
terraform {
 ...
 provider "signoz" {
   ...
   access_token = "<YOUR_SERVICE_ACCOUNT_KEY>"
 }
```

- **`<SIGNOZ-ENDPOINT>`**: Endpoint URL of your SigNoz instance
- **`<YOUR_SERVICE_ACCOUNT_KEY>`**: Your SigNoz service account key — see [Service Accounts](https://signoz.io/docs/manage/administrator-guide/iam/service-accounts/) to create one
