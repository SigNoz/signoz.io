...
- **JSON editor:** the **Apply** button is blocked and this message is shown: `"image" must be an /assets/Icons/<name> or /assets/Logos/<name> path, or a base64 image data URI`.
