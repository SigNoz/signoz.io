...
- **Layouts must satisfy the grid rules.** See [Dashboard layout constraints](https://signoz.io/docs/dashboards/dashboard-layout-constraints/) for the bounds, overlap rules, and error messages.
</Admonition>
