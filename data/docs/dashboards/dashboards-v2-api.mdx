---
date: 2026-07-08
title: Dashboards V2 API & Rollout Guide
description: Migrate to the redesigned SigNoz Dashboards experience and use the V2 Dashboards API — schema, endpoints, pagination, query DSL, and partial (PATCH) updates.
doc_type: howto
---

SigNoz is rolling out a redesigned **Dashboards** experience. Everything you rely on today — your dashboards, queries, variables, and panels — continues to work exactly as it does now. This release keeps all of that intact and adds a set of improvements that make dashboards easier to find, organize, and manage at scale.
...
- Dashboards will be migrated in the week of 15th July.
...
The LCRUD APIs for dashboards all now get a V2 variant:
...
Updating the filter in a query inside a dashboard:
...
--data '[
    {
        "op": "replace",
        "path": "/spec/panels/<panel-name>/spec/queries/0/spec/plugin/spec/filter/expression",
