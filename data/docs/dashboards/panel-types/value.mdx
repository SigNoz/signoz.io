...
- Choose the metric, APM, or log to display
    - Metric: see the [query builder documentation](/docs/userguide/query-builder#metrics-query-builder) to configure metric query
    - Log: see the [query builder documentation](/docs/userguide/query-builder#logs-and-traces-query-builder) to configure log query
    - Trace: see the [query builder documentation](/docs/userguide/query-builder#logs-and-traces-query-builder) to configure trace query
