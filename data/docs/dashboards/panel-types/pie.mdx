...
<Figure
  src="/img/docs/dashboards/panel-types/pie-chart-v2.webp"
...
- **Search series**: When the legend has more slices than fit in the space reserved for it, a search box and a **Showing N of M series** readout appear above the list. Type part of a label to filter the list in real time; the count updates to match the visible results.
