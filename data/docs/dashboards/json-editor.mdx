...
The JSON editor lets you edit a dashboard's full specification as raw JSON, without going through the dashboard API. A dashboard spec has two parts that must stay in sync:
