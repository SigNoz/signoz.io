...
<Admonition type="info">
  To use this dashboard, configure Kong Gateway to send metrics to SigNoz using the [OpenTelemetry plugin](https://docs.konghq.com/hub/kong-inc/opentelemetry/).
</Admonition>
...
- Set up [alerts](/docs/alerts/) to notify you of high upstream latency or error rates.
- Use [Query Builder](/docs/product-features/query-builder) to explore your Kong metrics in detail.
