...
<Admonition type="note">
  To use this dashboard, configure the OpenTelemetry Collector to scrape cert-manager Prometheus metrics and send them to SigNoz. Follow the [Cert-Manager Metrics](https://signoz.io/docs/infrastructure-monitoring/user-guides/cert-manager/) guide to get started.
</Admonition>
