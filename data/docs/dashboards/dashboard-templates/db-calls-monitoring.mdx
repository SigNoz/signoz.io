...
- **DB Transaction Rate Chart**: Shows database transaction rate over time (req/s)

#### Error Metrics
- **DB Error Rate Chart**: Shows database error percentage over time
...
- **service.name**: Filter by specific service names making database calls (supports single selection)
