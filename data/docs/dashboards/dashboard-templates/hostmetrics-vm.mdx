...
To use this dashboard, you need to set up the data source and send telemetry to SigNoz. Follow the [Host Metrics](https://signoz.io/docs/infrastructure-monitoring/user-guides/hostmetrics/) guide to get started. 
</Admonition>
