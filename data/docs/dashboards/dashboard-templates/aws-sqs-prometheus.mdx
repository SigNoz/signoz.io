...
To use this dashboard, you need to set up the data source and send telemetry to SigNoz. This dashboard uses metrics from a third-party [SQS exporter](https://github.com/jmal98/sqs-exporter). You can collect these metrics using the **Prometheus** receiver. Follow the [Prometheus Metrics](https://signoz.io/docs/userguide/prometheus-metrics/) guide to get started.
</Admonition>
