...
- Monitor **Message Status Overview** for complete queue state visibility
- Track **Visible Messages** to understand immediate processing demand
- Watch **In-Flight Messages** to monitor consumer processing efficiency

### Performance Optimization
- High **Visible Message** counts may indicate need for more consumers
- Elevated **In-Flight Messages** might suggest slow processing or consumer issues
- **Delayed Messages** help plan for future capacity requirements

### Capacity Planning
- Use **Regional Filtering** to understand geographic distribution
- Monitor **Environment-specific** patterns for deployment planning
- Track **Multi-Queue Patterns** for resource allocation

### Troubleshooting Guidelines
- **High Visible Messages**: Scale up consumers or optimize processing
- **High In-Flight Messages**: Investigate consumer performance or timeout settings
- **Unexpected Delayed Messages**: Review message scheduling and timing logic

### Alerting Recommendations
- **Visible Messages** > threshold - Consider scaling consumers
- **In-Flight Messages** > processing capacity - Investigate consumer health
- **Message Age** (if available) > SLA - Alert on processing delays
- **Queue Depth** trending upward - Plan for capacity scaling

## Integration Notes

### Prometheus Exporter Setup
- Deploy the SQS exporter in your AWS environment
- Configure appropriate IAM permissions for SQS access
- Ensure metrics are scraped by your Prometheus instance
- Verify metric labels match dashboard variable queries

### Multi-Environment Deployment
- Tag your SQS exporters with `deployment.environment` labels
- Use consistent naming conventions across environments
- Configure region-specific exporter deployments for better coverage
