...
<Admonition type="note">
  To use this dashboard, ensure you are collecting Kubernetes events. [Learn how to configure Kubernetes events collection](https://signoz.io/docs/opentelemetry-collection-agents/k8s/k8s-infra/configure-k8s-infra/#7-kubernetes-events).
</Admonition>
