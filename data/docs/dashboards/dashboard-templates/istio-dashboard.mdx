...
<Admonition type="note">
  This dashboard collects Istio metrics via Prometheus. You need the Prometheus receiver configured in your OpenTelemetry Collector to scrape Istio's metrics endpoint. See [Send Prometheus Metrics](https://signoz.io/docs/userguide/prometheus-metrics) to set that up.
</Admonition>
