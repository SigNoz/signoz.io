...
- **Response times**: p50/p90/p99 latency per ingress resource
...
- **Ingress Percentile Response Times**: Shows p50, p90, and p99 end-to-end request duration for the selected ingress over time
