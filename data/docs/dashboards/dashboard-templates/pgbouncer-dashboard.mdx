---
date: 2026-06-23
id: pgbouncer-dashboard
title: PgBouncer Metrics Dashboard
description: Monitor PgBouncer connection-pool health in SigNoz including client and server pool states, query and transaction throughput, client wait times, network traffic, and per-database connections.
