...
To use this dashboard, you need to instrument your Flask application using <a href="https://github.com/rycus86/prometheus_flask_exporter" target="_blank" rel="noopener noreferrer nofollow">prometheus-flask-exporter</a>. You can collect these metrics using the **Prometheus** receiver. Follow the [Prometheus Metrics](https://signoz.io/docs/userguide/prometheus-metrics/) guide to get started.
</Admonition>
