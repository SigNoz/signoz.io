...
- **Total Credits Used**: Reported total credits used across your account over the last 24 hour window.
- **Overall credits used**: Another aggregate view of the reported total credits used across the account.
...
## Related Dashboards
- [ClickHouse](https://signoz.io/docs/dashboards/dashboard-templates/clickhouse-monitoring)
- [Cost Meter](https://signoz.io/docs/dashboards/dashboard-templates/cost-meter)
