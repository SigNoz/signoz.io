...
<Admonition type="info">
  To use this dashboard, you need to configure the OpenTelemetry Collector to collect Kafka metrics using the <a href="https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/main/receiver/kafkametricsreceiver" target="_blank" rel="noopener noreferrer">kafkametricsreceiver</a>. Follow the [Kafka Integration](https://signoz.io/docs/messaging-queues/kafka) guide to get started.
</Admonition>
