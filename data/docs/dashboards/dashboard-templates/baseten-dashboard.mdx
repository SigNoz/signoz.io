...
<Admonition type="info">
  Before using this dashboard, instrument your Baseten applications with OpenTelemetry and configure export to SigNoz. See the [Baseten observability guide](https://signoz.io/docs/baseten-monitoring) for complete setup instructions.
</Admonition>


This dashboard offers a clear view into Baseten usage and performance. It highlights key metrics such as model distribution, error rates, request volumes, and latency trends. Teams can also track detailed records of errors, to better understand adoption patterns and optimize reliability and efficiency.

## Dashboard Preview

<Figure
  src="/img/docs/dashboards/dashboard-templates/baseten-dashboard.webp"
