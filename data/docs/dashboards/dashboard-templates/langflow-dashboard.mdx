...
description: Monitor Langflow flows and agents with an emphasis on LLM usage, including token consumption, per-model breakdown, call latency, tool calls, agent/flow runs, and errors for complete AI application observability.
