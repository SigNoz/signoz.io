...
<Admonition type="info">
  Before using this dashboard, instrument your Hugging Face applications with OpenTelemetry and configure export to SigNoz. See the [OpenClaw observability guide](https://signoz.io/docs/openclaw-monitoring) for complete setup instructions.
</Admonition>
