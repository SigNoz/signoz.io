...
This dashboard provides an overview for the Kubernetes pods for deployments, daemonsets, statefulset, replicasets and pods count by phase using <a href="https://github.com/open-telemetry/opentelemetry-collector-contrib/blob/main/receiver/k8sclusterreceiver/README.md" target="_blank" rel="noopener noreferrer nofollow">`k8sclusterreceiver`</a>.
