...
- Learn how to set up: [Web Vitals Monitoring with Metrics](/docs/frontend-monitoring/opentelemetry-web-vitals/-with-metrics/)
...
- Learn how to set up: [Web Vitals Monitoring with Traces](/docs/frontend-monitoring/opentelemetry-web-vitals/-with-traces/)
...
- [OpenTelemetry Web Vitals Overview](/docs/frontend-monitoring/opentelemetry-web-vitals/)
