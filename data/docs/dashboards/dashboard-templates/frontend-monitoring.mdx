...
- Learn how to set up: [Web Vitals Monitoring with Metrics](https://signoz.io/docs/frontend-monitoring/web-vitals-with-metrics)
...
- Learn how to set up: [Web Vitals Monitoring with Traces](https://signoz.io/docs/frontend-monitoring/web-vitals-with-traces)
...
Learn more about choosing the right approach: [Web Vitals Overview](https://signoz.io/docs/frontend-monitoring/opentelemetry-web-vitals)
...
- [OpenTelemetry Web Vitals Overview](https://signoz.io/docs/frontend-monitoring/web-vitals)
