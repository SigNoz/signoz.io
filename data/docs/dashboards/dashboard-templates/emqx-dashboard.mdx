...
- Send the data this dashboard reads with the [Monitor EMQX with OpenTelemetry](https://signoz.io/docs/integrations/opentelemetry-emqx/) guide.
- Explore individual broker metrics in the [Metrics Explorer](https://signoz.io/docs/metrics-management/metrics-explorer/).
