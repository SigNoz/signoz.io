...
<Admonition type="info">
  Before using this dashboard, ensure you have instrumented your Pydantic AI applications with OpenTelemetry. See the [Pydantic AI observability guide](https://signoz.io/docs/pydantic-ai-observability/) for complete setup instructions.
</Admonition>
