...
- **Analyze Model Adoption**: Understand which Semantic Kernel model variants are being used most often to track preferences and measure adoption of newer releases.
...
- **Model Distribution**: Shows which Semantic Kernel model variants are being called most often, helping track preferences and measure adoption across different models.
