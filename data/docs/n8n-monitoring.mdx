...
This setup uses the [n8n-opentelemetry execution poller](https://github.com/SigNoz/n8n-opentelemetry) - a lightweight service that polls n8n's API for workflow executions and exports telemetry data to SigNoz via OpenTelemetry.
