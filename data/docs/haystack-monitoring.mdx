...
description: Observability and monitoring for Haystack usage and performance with OpenTelemetry instrumentation to send traces, logs, and metrics to SigNoz
doc_type: howto
---

## Overview

This guide walks you through setting up observability and monitoring for Haystack using [OpenTelemetry](https://opentelemetry.io/) and exporting traces, logs, and metrics to SigNoz. With this integration, you can observe and track various metrics for your Haystack applications and llm usage.
...
- A OpenAI API key. You can get it from <a href="https://platform.openai.com/settings/organization/api-keys" target="_blank" rel="noopener noreferrer nofollow">OpenAI platform</a>
...
<Admonition type="important">
   SystemMetricsInstrumentor provides system metrics (CPU, memory, etc.), and HTTPXClientInstrumentor provides outbound HTTP request metrics such as request duration. If you want to add custom metrics to your Haystack application, see [Python Custom Metrics](https://signoz.io/opentelemetry/python-custom-metrics/).
</Admonition>
...
### Step 6: Run an example Haystack application
...
<Figure
  src="/img/docs/llm/haystack/haystack-traces.webp"
  alt="Haystack Trace View"
  caption="Haystack Trace View"
/>

When you click on a trace in SigNoz, you'll see a detailed view of the trace, including all associated spans, along with their events and attributes.

<Figure
  src="/img/docs/llm/haystack/haystack-detailed-traces.webp"
  alt="Haystack Detailed Trace View"
  caption="Haystack Detailed Trace View"
/>
...
<figure data-zoomable align="center">
  <img src="/img/docs/llm/haystack/related-logs.webp" alt="Related logs" width="300" />
  <figcaption>
...
<Figure
  src="/img/docs/llm/haystack/haystack-logs.webp"
  alt="Haystack Logs View"
  caption="Haystack Logs View"
/>

When you click on any of these logs in SigNoz, you'll see a detailed view of the log, including attributes:

<Figure
  src="/img/docs/llm/haystack/haystack-detailed-logs.webp"
  alt="Haystack Detailed Log View"
  caption="Haystack Detailed Logs View"
/>

You should be able to see Haystack related metrics in Signoz Cloud under the metrics tab:

<Figure
  src="/img/docs/llm/haystack/haystack-metrics.webp"
  alt="Haystack Metrics View"
  caption="Haystack Metrics View"
/>

When you click on any of these metrics in SigNoz, you'll see a detailed view of the metric, including attributes:

<Figure
  src="/img/docs/llm/haystack/haystack-detailed-metrics.webp"
  alt="Haystack Detailed Metrics View"
  caption="Haystack Detailed Metrics View"
/>
...
You can also check out our custom Haystack dashboard [here](https://signoz.io/docs/dashboards/dashboard-templates/haystack-dashboard/) which provides specialized visualizations for monitoring your Haystack usage in applications. The dashboard includes pre-built charts specifically tailored for LLM usage, along with import instructions to get started quickly.

<Figure
  src="/img/docs/llm/haystack/haystack-dashboard.webp"
  alt="Haystack Dashboard"
