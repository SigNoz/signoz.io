  ...
  return (
    <div title="SigNoz vs Datadog">
      <ComparisonLayout>
        ...
        <GetStarted withHackerNews withMigrationSupport data={COMPARISON_DATA.MIGRATION_SUPPORT} />
      </ComparisonLayout>
    </div>
  )
}
  ...
  REASONS: [
    {
      ...
      DESC: (
        <>
          ...
          lock-in. SigNoz is built to support OpenTelemetry from Day 1. However, Datadog does not
          support OTel as its primary data format, and it even tried to{' '}
          <Link
    ...
    },
    {
      ...
      DESC: (
        <>
          Datadog’s custom metrics pricing is insane. It charges $0.05 per custom metric. You can
          end up with unpredictable bills, and custom metrics pricing can constitute up to 52% of
          your bill for a large engineering team. SigNoz does not treat custom metrics differently
          and charges only $0.1 per million samples.{' '}
          <Link
    ...
    },
    {
      ...
      DESC: (
        <>
          You can host SigNoz in your own cloud. We also provide managed services. It’s perfect for
