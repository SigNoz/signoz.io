  ...
  REASONS: [
    {
      ...
      DESC: (
        <>
          ...
          lock-in. SigNoz is built to support OpenTelemetry from Day 1. New Relic treats OTel data
    ...
    },
    {
      ...
      DESC: (
        <>
          ...
          monitoring tool for debugging. At SigNoz, we don’t charge based on user seats. New Relic’s
