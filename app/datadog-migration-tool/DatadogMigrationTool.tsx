...
const RequestEarlyAccessButton: React.FC<{ className?: string }> = ({ className = '' }) => {
  ...
  return (
    <div className={`relative z-[1] mx-2 max-w-7xl ${className}`}>
...
const Header: React.FC = () => {
  return (
    <header className="relative !mx-auto mt-16 !w-[100vw] max-w-7xl md:!w-[80vw]">
      {/* Border decorations */}
      <div className="absolute bottom-0 left-[12px] right-[12px] top-0 z-[0] border !border-b-0 !border-t-0 border-dashed border-signoz_slate-400 md:left-[24px] md:right-[24px]" />

      {/* Main content */}
      <div className="relative !mx-auto flex !w-[100vw] max-w-7xl flex-col items-center border !border-b-0 border-dashed border-signoz_slate-400 px-2 pb-4 pt-12 text-center md:!w-[80vw] md:px-5 md:pt-[4rem]">
      ...
      {/* Buttons */}
      <RequestEarlyAccessButton className="!mx-auto !w-[100vw] max-w-7xl border !border-b-0 !border-t-0 border-dashed border-signoz_slate-400 pb-12 pt-4 md:mx-5 md:!w-[80vw]" />
