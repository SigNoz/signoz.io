...
export const LLM_COMPARISON_TABLE_ROWS: ComparisonTableRow[] = [
  {
    feature: 'LLM Tracing',
    vendors: {
      signoz: { support: 'check', text: 'Full traces with OpenTelemetry' },
      langfuse: { support: 'check', text: 'OpenTelemetry-based' },
      langsmith: { support: 'check', text: 'Async distributed tracing' },
      braintrust: { support: 'check', text: 'Request-level tracing' },
    },
  },
  {
    feature: 'Production Alerts',
    vendors: {
      signoz: { support: 'check', text: 'Any metric' },
      langfuse: { support: 'cross', text: 'No alerting' },
      langsmith: { support: 'check', text: 'LLM metrics only' },
      braintrust: { support: 'check', text: 'LLM metrics only' },
    },
  },
  {
    feature: 'Prompt Management',
    vendors: {
      signoz: { support: 'check', text: 'Via integrations' },
      langfuse: { support: 'check', text: 'Version control with caching' },
      langsmith: { support: 'check', text: 'A/B testing built-in' },
      braintrust: { support: 'check', text: 'Side-by-side comparison' },
    },
  },
  {
    ...
    vendors: {
      signoz: { support: 'check', text: 'Via integrations' },
      langfuse: { support: 'check', text: 'LLM-as-judge, custom evals' },
      langsmith: { support: 'check', text: 'Built-in evaluators' },
      braintrust: { support: 'check', text: 'Dataset/task/scorer framework' },
    },
  },
  {
    feature: 'Infra Correlation',
    vendors: {
      signoz: { support: 'check', text: 'Metrics, logs, traces together' },
      langfuse: { support: 'cross', text: 'LLM-only' },
      langsmith: { support: 'cross', text: 'LLM-only' },
      braintrust: { support: 'cross', text: 'LLM-only' },
    },
  },
  {
    feature: 'Application Correlation',
    vendors: {
      signoz: { support: 'check', text: 'Cross-service tracing' },
      langfuse: { support: 'cross', text: '' },
      langsmith: { support: 'cross', text: '' },
      braintrust: { support: 'cross', text: '' },
    },
  },
  {
    feature: 'Kubernetes/Docker Monitoring',
    vendors: {
      signoz: { support: 'check', text: 'Native support' },
      langfuse: { support: 'cross', text: '' },
      langsmith: { support: 'cross', text: '' },
      braintrust: { support: 'cross', text: '' },
    },
  },
  {
    ...
    vendors: {
      signoz: { support: 'check', text: 'Built-in' },
      langfuse: { support: 'cross', text: '' },
      langsmith: { support: 'cross', text: '' },
      braintrust: { support: 'cross', text: '' },
    },
  },
  {
    feature: 'Dashboards',
    vendors: {
      signoz: { support: 'check', text: 'Advanced query builder' },
      langfuse: { support: 'check', text: 'Limited presets' },
      langsmith: { support: 'check', text: 'Limited presets' },
      braintrust: { support: 'check', text: 'Basic charts' },
    },
  },
]
