...
function VerifyEmail() {
  ...
  return (
    <div className="welcome-container mx-auto flex min-h-[96vh] max-w-[520px] flex-col items-center justify-center py-32">
      <Mail className="text-primary" size={56} />
      <div className="mt-[28px] text-xl"> First, let's verify your email </div>

      <div className="bg-l3-background mt-[28px] rounded-[6px] border border-[#1D212D] p-[24px] text-sm">
        Check your email for the next steps. If you don't see the email, check your spam folder or
        try resending the verification email.
      </div>

      {submitFailed && (
        <div className="text-danger-foreground mt-[28px] flex w-full items-center justify-center gap-2 text-center text-xs">
      ...
      {submitSuccess && (
        <div className="text-callout-success-title mt-[28px] flex w-full items-center justify-center gap-2 text-center text-xs">
      ...
      <div className="flex w-full flex-col">
        <TrackingButton
          type="submit"
          className={`bg-l3-background mt-[28px] flex h-[40px] w-full items-center justify-center gap-4 rounded-full px-[16px] py-[8px] ${
        ...
        <TrackingLink
          ...
          className="bg-l3-background mt-[12px] flex h-[40px] w-full items-center justify-center gap-4 rounded-full px-[16px] py-[8px]"
