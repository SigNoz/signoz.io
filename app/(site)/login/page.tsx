                            ...
                            >
                              ...
                              {tenant.state !== TenantState.DELETED && (
                                <a
                                  ...
                                  target="_blank"
                                  className="shrink-0 rounded-sm bg-signoz_robin-500 px-3 py-1.5 text-xs font-medium text-white transition-opacity hover:opacity-90" rel="noreferrer"
                                >
                                  Login
                                </a>
                              )}
          ...
          <section className="b mb-6 grid grid-cols-2 items-center gap-4 self-stretch rounded-md border border-signoz_slate-400 bg-signoz_ink-400 p-4 max-md:w-full max-md:max-w-full md:flex md:flex-wrap md:p-2">
            {trustBadges.map((badge, index) => (
              ...
              >
                ...
                {badge.url ? (
                  <a href={badge.url} className="flex items-center gap-2" target="_blank" rel="noreferrer">
