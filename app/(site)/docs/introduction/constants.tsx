...
export const SEND_DATA_CARDS: CardData[] = [
  {
    ...
    icon: <LucideDraftingCompass size={24} className="text-foreground" />,
  ...
  },
  {
    ...
    icon: <LucideScrollText size={24} className="text-foreground" />,
  ...
  },
  {
    ...
    icon: <LucideChartNoAxesColumn size={24} className="text-foreground" />,
  ...
  },
  {
    ...
    icon: <Puzzle size={24} className="text-foreground" />,
...
export const EXPLORE_SIGNOZ_CARDS: CardData[] = [
  {
    ...
    icon: <LucideBoxes size={24} className="text-foreground" />,
  ...
  },
  {
    ...
    icon: <TriangleAlert size={24} className="text-foreground" />,
  ...
  },
  {
    ...
    icon: <Waypoints size={24} className="text-foreground" />,
  ...
  },
  {
    ...
    icon: <Bug size={24} className="text-foreground" />,
  ...
  },
  {
    ...
    icon: <ListFilter size={24} className="text-foreground" />,
...
export const MIGRATE_CARDS: CardData[] = [
  {
    ...
    icon: <BookText size={24} className="text-foreground" />,
...
export const SECURITY_CARDS: CardData[] = [
  {
    ...
    icon: <Lock size={24} className="text-foreground" />,
  ...
  },
  {
    ...
    icon: <Settings size={24} className="text-foreground" />,
  ...
  },
  {
    ...
    icon: <ShieldCheck size={24} className="text-foreground" />,
...
export const TROUBLESHOOTING_ROW_CARDS: CardData[] = [
  {
    ...
    icon: <HelpCircle size={24} className="text-foreground" />,
    clickName: 'FAQ Card',
  },
  {
    ...
    icon: <SiSlack className="text-muted-foreground h-6 w-6" />,
  ...
  },
  {
    ...
    icon: <SiGithub className="text-muted-foreground h-6 w-6" />,
...
export const RESOURCES_ROW_CARDS: CardData[] = [
  {
    ...
    href: '/dashboards/',
    icon: <FileArchive size={24} className="text-foreground" />,
  ...
  },
  {
    ...
    href: '/changelog/',
    icon: <HeartPulse size={24} className="text-foreground" />,
...
export const SELF_HOST_CARDS: CardData[] = [
  {
    ...
    icon: <SiDocker className="text-foreground h-6 w-6" />,
  ...
  },
  {
    ...
    icon: <SiLinux className="text-foreground h-6 w-6" />,
  ...
  },
  {
    ...
    icon: <SiKubernetes className="text-foreground h-6 w-6" />,
