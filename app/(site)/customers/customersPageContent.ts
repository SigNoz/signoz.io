...
export const FEATURED_VIDEOS: CustomerVideo[] = [
  {
    company: 'Kernel',
    videoId: '0ZrTqonLE-I',
...
export const QUOTE_CAROUSEL: QuoteSlide[] = [
  {
    segments: [
      {
...
export const PROOF_WALL_QUOTES: ProofQuote[] = [
  {
...
export const PROOF_WALL_LOGOS: ProofLogo[] = [
  {
    imageSrc: '/img/homepage/customer-logos/alien-intelligence.webp',
    name: 'Alien Intelligence',
  },
