...
export default function StartUpsHero({ startUpsData }: StartUpsHeroProps) {
  return (
    <section
      className="hero-pattern relative overflow-hidden pt-32 pb-16"
      style={{
        backgroundImage:
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        <div className="grid items-center gap-12 md:grid-cols-2 lg:gap-16">
          ...
          <div className="max-w-xl">
            ...
            <h2 className="text-l1-foreground mb-8 text-xl md:text-2xl">{startUpsData.DESC}</h2>

            <div className="border-border mb-8 inline-flex flex-col rounded-lg border bg-[#1c1c21]/60 p-4 backdrop-blur-sm">
              <div className="flex items-center">
                <div className="text-l1-foreground mr-3 text-lg font-medium">Now Starts at</div>
                <div className="flex items-center">
                  <span className="text-muted-foreground mr-2 line-through opacity-70">
                    {startUpsData.PRICE.originalPrice}
                  </span>
                  <span className="text-accent-primary text-2xl font-bold">
                    {startUpsData.PRICE.discountedPrice}
                  </span>
                  <span className="text-muted-foreground ml-1">/ {startUpsData.PRICE.period}</span>
                </div>
              </div>
              <div className="text-l1-foreground/80 mt-2 text-sm">
          ...
          <div className="border-border rounded-xl border bg-[rgb(244_242_250)] p-6 shadow-xl backdrop-blur-sm">
            <HeroForm
