...
const Header = () => {
  return (
    <header className="relative !mx-auto mt-16 !w-[100vw] md:!w-[80vw]">
      ...
      <div className="section-container border-border !mx-auto !mt-0 -mb-[9rem] !w-[90vw] border !border-t-0 !border-b-0 border-none max-sm:-mb-[3rem] md:!w-[80vw] md:border-dashed">
        <div className="mx-[-28px] w-100">
