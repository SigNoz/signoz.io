    ...
    <>
      <section className="flex w-full flex-col items-start px-20 pt-12 font-medium max-md:max-w-full max-md:px-5">
        ...
        >
            ...
            <div className="mt-10 flex max-w-full flex-col">
              <div className="mt-10 flex flex-col justify-between gap-6 sm:flex-row">
                ...
                <div className="flex flex-row items-center gap-4 px-6">
                  <div className="bg-success-background inline-block h-3 w-3 rounded-sm" />
                  <div className="text-muted-foreground pr-2 font-mono text-lg uppercase max-md:max-w-full sm:text-xl">
                    ONLINE — WORLDWIDE, Sep 08, 9AM PT
                  </div>
                </div>
              </div>
              <h1 className="border-l2-border/50 text-l1-foreground mt-8 max-w-full border-b-2 border-dashed px-6 text-5xl font-medium uppercase max-md:max-w-full max-md:text-4xl">
                Launch Week{' '}
                <span className="launch-week-counter bg-danger-background text-foreground rounded">
                  5
                </span>
              </h1>
            </div>
            <div className="border-l2-border/50 text-muted-foreground z-10 mt-11 self-stretch border-b-2 border-dashed px-6 font-mono text-base leading-8 font-medium max-md:mt-10 max-md:max-w-full">
          ...
          <div className="border-l2-border/50 flex flex-col justify-between border-t border-b-2 border-dashed px-6 py-6 sm:flex-row">
            <div className="flex flex-col justify-between gap-4 sm:pr-4">
              <div className="text-muted-foreground text-base uppercase">Monday ⎯ Sep 08</div>
          ...
          <div className="border-l2-border/50 flex flex-col justify-between border-t border-b-2 border-dashed px-6 py-6 sm:flex-row">
            <div className="flex flex-col justify-between gap-4 sm:pr-4">
              <div className="text-muted-foreground text-base uppercase">Tuesday ⎯ Sep 09</div>
              <div className="flex flex-col gap-2">
                <Link
          ...
          <div className="border-l2-border/50 flex flex-col justify-between border-t border-b-2 border-dashed px-6 py-6 sm:flex-row">
            <div className="flex flex-col justify-between gap-4 sm:pr-4">
              <div className="text-muted-foreground text-base uppercase">Wednesday ⎯ Sep 10</div>
              <div className="flex flex-col gap-2">
                <Link
          ...
          <div className="border-l2-border/50 flex flex-col justify-between border-t border-b-2 border-dashed px-6 py-6 sm:flex-row">
            <div className="flex flex-col justify-between gap-4 sm:pr-4">
              <div className="text-muted-foreground text-base uppercase">Thursday ⎯ Sep 11</div>
              <div className="flex flex-col gap-2">
                <Link
          ...
          <div className="border-l2-border/50 flex flex-col justify-between border-t border-b-2 border-dashed px-6 py-6 sm:flex-row">
            <div className="flex flex-col justify-between gap-4 sm:pr-4">
              <div className="text-muted-foreground text-base uppercase">FRIDAY ⎯ Sep 12</div>
              <div className="flex flex-col gap-2">
                <Link
          ...
          {[
            ...
            <div
              key={index}
              className="border-l2-border/50 flex flex-grow items-center justify-between border-b-2 border-dashed px-6 py-2"
            >
              <div className="text-muted-foreground w-[32%] font-mono text-sm font-medium uppercase sm:text-base">
                {day}
              </div>
          ...
          {/* <div className="mb-20 mt-12 flex flex-col gap-7 px-6">
            <div className="self-stretch font-mono uppercase text-muted-foreground">
