...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'Connect SigNoz to your coding agents (e.g. Claude Code, Cursor) and debug production issues without leaving your dev environment. Traces, logs, metrics, service topology, and your actual codebase — all in one place. Or use our AI Assistant out-of-the-box. No AI SRE required.',
