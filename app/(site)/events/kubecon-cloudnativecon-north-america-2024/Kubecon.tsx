            ...
            >
              ...
              <div className="group flex flex-col justify-between">
                <div>
                  ...
                  <div className="flex flex-col gap-5">
                    <div className="flex flex-row items-center gap-3">
                      <img src="/img/speakers/Haardik.jpg" className="h-10 w-10 rounded-full"></img>
                      <div className="flex flex-col">
          ...
          <div className="flex flex-col-reverse justify-between border-b  border-dashed border-signoz_slate-100 px-6 py-6 sm:flex-row">
            ...
            >
              ...
              <div className="group flex flex-col justify-between">
                <div>
                  <div className="mb-2 text-base font-medium">
                    Orchestrating Scalable DAGs on Argo Workflows Using Fabric8s
                  </div>
                  <div className="py-2.5 text-sm font-bold italic">Speakers</div>

                  <div className="flex flex-col gap-5">
                    <div className="flex flex-row items-center gap-3">
                      <img src="/img/speakers/Shivay.jpg" className="h-10 w-10 rounded-full"></img>
                      <div className="flex flex-col">
              ...
              <div className="group flex flex-col justify-between">
                <div>
                  ...
                  <div className="flex flex-col gap-5">
                    <div className="flex flex-row items-center gap-3">
                      <img
                        src="/img/speakers/Jonathan.jpg"
                        className="h-10 w-10 rounded-full"
                      ></img>
                      <div className="flex flex-col">
                        <div className="text-sm font-bold">Jonathan Perry</div>
                        <div className="text-xs">
                          Founder & CEO <br /> PerfPod
                        </div>
                      </div>
                    </div>
            ...
            >
              ...
              <div className="group flex flex-col justify-between">
                <div>
                  ...
                  <div className="py-2.5 text-sm font-bold italic">Host</div>
          ...
          <div className="flex flex-col-reverse justify-between border-b  border-dashed border-signoz_slate-100 px-6 py-6 sm:flex-row">
            ...
            >
              ...
              <div className="group flex flex-col justify-between">
                <div>
                  <div className="mb-2 text-base font-medium">
                    Run Away from Alerts, Into Observability!
                  </div>
                  <div className="py-2.5 text-sm font-bold italic">Host</div>
          ...
          <div className="bg-[url('/img/background_blur/Ellipse_206.webp')] bg-[length:110%] bg-[center_top_calc(-250px)] bg-no-repeat">
            ...
            <div className="relative flex items-center justify-center">
              <img
                ...
                alt="SigNoz dashboard with application performance metrics - Kubecon North America 2024"
