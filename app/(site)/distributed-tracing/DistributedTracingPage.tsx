...
const Header: React.FC = () => {
  return (
    <FeaturePageHeader
      ...
      description={
        <>
          Aggregate and analyze millions of spans with fast loads and smooth navigation. <br />{' '}
          Correlate traces with logs and metrics to find root cause in distributed systems.
        </>
      }
