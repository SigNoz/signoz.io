...
<Figure src="/public/img/guides/2024/06/kubernetes-deployments-1.webp" alt="d" caption="" />
...
<Figure src="/public/img/guides/2024/06/kubernetes-deployments-2.webp" alt="*How a Deployment works*" caption="*How a Deployment works*" /><br></br>
...
<Figure src="/public/img/guides/2024/06/kubernetes-deployments-3.webp" alt="*Recreate deployment strategy*" caption="*Recreate deployment strategy*" /><br></br>Example:
...
<Figure src="/public/img/guides/2024/06/kubernetes-deployments-4.webp" alt="*Rolling update deployment strategy*" caption="*Rolling update deployment strategy*" /><br></br>Example:
...
<Figure src="/public/img/guides/2024/06/kubernetes-deployments-5.webp" alt="*Blue/Green deployment strategy*" caption="*Blue/Green deployment strategy*" /><br></br>Example:
...
<Figure src="/public/img/guides/2024/06/kubernetes-deployments-6.webp" alt="*Canary deployment strategy*" caption="*Canary deployment strategy*" /><br></br>Example:
