...
test('per-release markdown points at the public .md convention', () => {
  assert.match(
    markdown,
    /- Per-release markdown: https:\/\/signoz\.io\/api-reference\/<release>\.md \(a release tag, e\.g\. `v0\.110\.0`, or `latest`\)/
  )
})
