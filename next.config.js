...
const ContentSecurityPolicy = `
  default-src 'self';
  script-src 'self' 'unsafe-eval' 'unsafe-inline' giscus.app https://www.googletagmanager.com https://js.hsforms.net https://f.vimeocdn.com blob:;
    ...
    async redirects() {
      return [
        ...
        },
        {
          ...
          destination: '/resource-center/api_reference/',
          permanent: true,
        },
        {
