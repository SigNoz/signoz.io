...
const ContentSecurityPolicy = `
  default-src 'self';
  script-src 'self' 'unsafe-eval' 'unsafe-inline' giscus.app https://www.googletagmanager.com https://js.hsforms.net https://f.vimeocdn.com https://embed.lu.ma https://www.clarity.ms https://scripts.clarity.ms https://*.contentsquare.net http://*.contentsquare.net https://www.chatbase.co https://static.reo.dev;
  style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://embed.lu.ma;
  img-src * blob: data:;
  media-src *;
  connect-src * https://api.reo.dev https://www.clarity.ms https://scripts.clarity.ms;
  font-src * 'self';
