          ...
          <div className="grid-rows-[auto_1fr] divide-y divide-gray-200 pb-8 dark:divide-gray-700 xl:grid xl:grid-cols-4 xl:gap-x-6 xl:divide-y-0">
            ...
            <div className="post-toc">
              {toc.map((tocItem: tocItemProps) => {
                return (
                  <div className="post-toc-item" key={tocItem.url}>
                    <a data-level={tocItem.level} href={tocItem.url} className="line-clamp-2">
                      {tocItem.value}
                    </a>
                  </div>
                )
            ...
            <footer>
              <div className="text-sm font-medium leading-5 dark:divide-gray-700 xl:col-start-1 xl:row-start-2 xl:divide-y">
                {tags && (
