...
4. **Run your application**<br></br>
    ...
    :::note
     Don’t run app in reloader/hot-reload mode as it breaks instrumentation. For example, if you use `export Falcon_ENV=development`, it enables the reloader mode which breaks OpenTelemetry isntrumentation.
    :::
