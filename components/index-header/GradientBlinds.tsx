...
function prepStops(stops?: string[]) {
  ...
  const arr = base.slice(0, MAX_COLORS).map(hexToRGB)
...
`
    ...
    const resize = () => {
      ...
      if (firstResizeRef.current) {
        ...
        const cx = gl.drawingBufferWidth * initialSpotlightPosition.x
        const cy = gl.drawingBufferHeight * initialSpotlightPosition.y
