...
export const CUSTOMER_STORY_LOGOS: CustomerStoryLogo[] = [
  ...
  { name: 'Black Forest Labs', logoSrc: `${LOGO_PATH}/blackforestlabs.svg` },
  { name: 'Blaxel', logoSrc: `${LOGO_PATH}/blaxel.svg` },
  { name: 'Cisco', logoSrc: `${LIVE_LOGO_SVG}/cisco.svg`, showName: true },
  { name: 'Comcast', logoSrc: `${LOGO_PATH}/comcast.svg` },
  { name: 'Eltropy', logoSrc: '/svgs/icons/eltropy.svg', width: 180 },
  { name: 'Fero', logoSrc: `${LOGO_PATH}/fero.svg` },
  ...
  { name: 'Formstack', logoSrc: `${LIVE_LOGO_SVG}/formstack.svg`, width: 120 },
  ...
  { name: 'Kognitos', logoSrc: '/svgs/icons/kognitos.svg', width: 135 },
  ...
  { name: 'Lovart', logoSrc: `${LOGO_PATH}/lovart.svg` },
  { name: 'Moneyhub', logoSrc: `${LIVE_LOGO_IMG}/moneyhub.webp`, showName: true },
  { name: 'NetApp', logoSrc: `${LOGO_PATH}/netApp.svg` },
  ...
  { name: 'Salesforce', logoSrc: `${LOGO_PATH}/salesforce.svg` },
  ...
  { name: 'StructureFlow', logoSrc: `${LIVE_LOGO_SVG}/structureflow.svg`, width: 125 },
