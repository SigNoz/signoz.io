...
export default function HalfBadge({
  ...
  const content = (
    <>
      ...
      <span className="inline-flex h-[22px] items-center gap-1.5 rounded-[0_999px_999px_0] border border-[var(--l3-border)] bg-[var(--l3-background)] py-0 pl-3 pr-3.5 text-xs font-medium text-[var(--l2-foreground)]">
        {children}
