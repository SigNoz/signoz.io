  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        'border border-[var(--l2-border)] bg-[var(--l3-background)] text-[var(--l1-foreground)] ring-offset-2 ring-offset-[var(--l3-background)] transition-all duration-200 hover:bg-[var(--l3-background-hover)] focus:border-[var(--accent-primary)] focus:ring-2 focus:ring-[var(--accent-primary)]',
        className
      )}
      {...props}
    >
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          'bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 relative z-50 max-h-[300px] min-w-[8rem] select-none overflow-hidden rounded-md border shadow-md',
          position === 'popper' &&
