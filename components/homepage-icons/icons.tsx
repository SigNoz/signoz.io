...
export const ArrowRightSolid = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="20" height="20" className='fill-signoz_robin-500'>
      <path d="M0 256a256 256 0 1 0 512 0A256 256 0 1 0 0 256zM281 385c-9.4 9.4-24.6 9.4-33.9 0s-9.4-24.6 0-33.9l71-71L136 280c-13.3 0-24-10.7-24-24s10.7-24 24-24l182.1 0-71-71c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0L393 239c9.4 9.4 9.4 24.6 0 33.9L281 385z" />
    </svg>
  )
}

export const CircleCheckSolid = ({ color = 'signoz_robin-500' }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="20" height="20" className={`fill-${color}`}>
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 20 20" fill="none">
      <g clip-path="url(#clip0_2663_8479)">
        ...
        <path d="M10 5.83472H10.0083" stroke="#121317" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
      </g>
      <defs>
...
export const CheckSolid = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="15" height="15" className='fill-signoz_robin-500'>
...
export const CrossSolid = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 16" fill="none">
      <path d="M11.25 4.25L3.75 11.75M3.75 4.25L11.25 11.75" stroke="#E5484D" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" />
    </svg>
  )
}
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15" fill="none">
      <g clip-path="url(#clip0_2605_7148)">
        ...
        <path d="M3.75 3.75H3.75625" stroke="#0B0C0E" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M3.75 11.25H3.75625" stroke="#0B0C0E" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" />
      </g>
      <defs>
