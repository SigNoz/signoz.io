  ...
  return (
    <>
      <section
        className={cn(
          isHomepageRedesign
            ? 'relative left-1/2 mx-auto w-[calc(100dvw-8px)] max-w-none -translate-x-1/2 overflow-hidden border-y border-signoz_slate-400/35 px-5 sm:px-6 lg:px-20 min-[1441px]:max-w-8xl min-[1441px]:px-0'
