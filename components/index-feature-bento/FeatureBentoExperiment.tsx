...
function FeatureCard({ feature }: { feature: BentoFeature }) {
  ...
  return (
    <CustomLink
      ...
      className={`group relative flex min-h-[326px] flex-col justify-between overflow-hidden border border-signoz_slate-400/20 bg-[#07090d] no-underline transition-colors [--box-padding:16px] focus:outline-none focus-visible:ring-2 focus-visible:ring-signoz_robin-500/70 ${
...
function EnterpriseReadyStrip() {
  ...
  return (
    <div className="mt-20 border-y border-signoz_slate-400/35">
      <div className="grid gap-0 md:grid-cols-[0.82fr_1fr_1fr]">
        <div className="flex items-center border-b border-signoz_slate-400/35 py-8 md:border-b-0 md:pr-8">
          <div>
            ...
            <h3 className="m-0 mt-3 max-w-[280px] text-[28px] font-medium leading-tight tracking-[-0.5px] text-signoz_vanilla-100">
        ...
        {compliances.map(({ Logo, description, label }, index) => (
          <div
            key={label}
            className={`flex min-h-[220px] flex-col justify-between py-8 md:px-12 ${
              index === 0 ? 'md:border-x' : ''
          ...
          >
            ...
            <div>
              ...
              <p className="m-0 mt-3 max-w-[320px] text-xl font-medium leading-8 tracking-[-0.2px] text-signoz_vanilla-100">
                {description}
              </p>
            </div>
          </div>
