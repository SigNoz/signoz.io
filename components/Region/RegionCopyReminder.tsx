...
const codeClass = 'rounded bg-muted px-1 py-0.5 text-xs font-semibold'
  ...
  return (
    <div
      ...
      className={cn(
        ...
        'fixed top-5 left-1/2 z-[200] w-[380px] max-w-[calc(100vw-2rem)] -translate-x-1/2',
        'border-primary bg-card rounded-lg border px-4 py-3',
        'text-l1-foreground text-sm leading-relaxed shadow-[0_8px_30px_rgba(0,0,0,0.45)]'
      )}
    >
      {isPlaceholder ? (
        <p className="m-0">
      ...
      <Link
        ...
        prefetch={false}
        className="text-accent-primary mt-2 inline-block text-xs font-medium hover:underline"
      >
