  ...
  return (
      <div className="w-full bg-indigo-500 flex items-center justify-center py-2">
          <div className="w-full flex justify-between items-center px-4 md:justify-center">
              <Link href="/events/kubecon-cloudnativecon-europe-2025/" className="text-base font-medium text-white leading-5">
              We're at KubeCon Europe -  Meet us at booth S631. Check more details 🚀
              </Link>
