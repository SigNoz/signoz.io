        ...
        <div className="flex flex-col">
          <div>
            ...
            <ul className="list-['—_'] pl-5 ">
              <li className='text-signoz_vanilla-400 text-base font-normal leading-9 mb-2 w-[45rem]'>&nbsp;Store your data in the US, EU or India region depending on your needs.</li>
              <li className='text-signoz_vanilla-400 text-base font-normal leading-9 w-[45rem]'>&nbsp;You can self-host SigNoz or opt for our managed self-hosted offerings to have complete   adherence to data privacy and regulation laws.</li>
            </ul>
          </div>
          <div className="h-[206px] w-auto bg-signoz_ink-400"></div>
