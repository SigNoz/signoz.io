...
export default function InlineCTA({
  ...
  return (
    <div className="my-8 flex flex-col items-start gap-3.5 rounded-2xl border border-signoz_robin-500/20 bg-gradient-to-br from-signoz_slate-500 via-[#1a2340] to-[#1e1a35] px-6 py-5 sm:flex-row sm:items-center sm:justify-between sm:gap-5 sm:px-7">
