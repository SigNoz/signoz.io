...
export default function InlineCTA({
  ...
  return (
    <div className="not-prose my-8 flex flex-col items-start gap-3.5 rounded-2xl border border-[color-mix(in_srgb,var(--accent-primary)_20%,transparent)] bg-gradient-to-br from-signoz_slate-500 via-[#1a2340] to-[#1e1a35] px-6 py-5 sm:flex-row sm:items-center sm:justify-between sm:gap-5 sm:px-7">
