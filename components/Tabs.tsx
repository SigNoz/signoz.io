...
const Tabs = ({ children, entityName, tabGroupId, defaultTab, tabIdArray }) => {
  const [activeTabFromHook, setActiveTabFromHook] = useTabState(tabGroupId, defaultTab, tabIdArray)
