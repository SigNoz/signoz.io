...
const PricingCTA: React.FC = () => {
  return (
    <div className="my-8 mx-auto max-w-4xl">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden p-6 sm:p-8">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-0 mt-0">Tired of Unpredictable Pricing with DataDog?</h2>
        <div className="flex flex-col sm:flex-row items-center">
          <div className="flex-1 flex flex-col justify-center mb-3 sm:mb-0 sm:mr-6">
            ...
            <div className="flex justify-start">
              ...
              >
                Estimate Your Monthly Bill with SigNoz &rarr;
              </Link>
            </div>
          </div>
