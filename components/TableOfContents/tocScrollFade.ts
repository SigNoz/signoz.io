...
export const ARTICLE_TOC_RAIL_CLASS =
  'sticky top-[80px] box-border hidden h-[calc(100vh-80px)] max-h-[calc(100vh-80px)] w-80 min-w-80 max-w-80 flex-[0_0_320px] flex-col self-start overflow-hidden px-4 py-2 lg:flex'

/** Left nav rail for otel hub — matches right-rail sticky height. */
export const ARTICLE_SIDENAV_STICKY_CLASS =
  'docs-sidebar sticky top-[80px] flex max-h-[calc(100vh-80px)] w-full flex-col overflow-hidden py-4 text-white'
