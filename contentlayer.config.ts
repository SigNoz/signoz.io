  ...
  computedFields: {
    ...
    structuredData: {
      ...
      resolve: (doc) => ({
        ...
        datePublished: doc.published_date || doc.date || '2025-06-06', // Setting it Jun 06, 2025 as date metadata doesn't exist for docs, TODO: add date to all existing doc files
        dateModified:
