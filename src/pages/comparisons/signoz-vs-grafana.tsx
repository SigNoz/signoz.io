  ...
  REASONS_QNA: [
    {
      ...
      reasonDesc: (
        <>
          <p>
            Grafana started as a data visualization tool. It slowly evolved into
            a tool that can take data from multiple data sources for
            visualization.
          </p>
          <p>
          ...
          <p>
            SigNoz is a single application that provides logs, metrics and
            traces under a single pane of glass. Ingestion, storage, and
            querying of signals are optimized for ease of use and intelligent
            out-of-box correlation between the three signals. There is less
      ...
      reasonDesc: (
        <>
          <p>
            ...
            only Kubernetes being more active. Using an open source standard
            like OpenTelemetry for generating telemetry signals frees you from
            vendor lock-in. SigNoz is built to support OpenTelemetry from Day 1.
          </p>
          <p>
      ...
      reasonDesc: (
        <>
          ...
          <p>
            ...
            for Loki for ingestion, querying, and storage:
          </p>
          <ul>
            <li>
