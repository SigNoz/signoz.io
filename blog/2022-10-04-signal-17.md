...
Welcome back to our monthly product updates - SigNal! So happy to share with everyone that we were trending on the first page of [Hacker news](https://news.ycombinator.com/item?id=33049046) over the weekend, and the whole team was so upbeat about it.
...
For example, you can define a variable for different namespaces in the same cluster and then use just a single graph to monitor all namespaces in the single graph. Check out the PR [here](https://github.com/SigNoz/engineering-pod/issues/695).

### Search with Trace ID

Observability data is often humongous, and some of our users have traces with hundreds of spans. To make navigating their tracing data easier, we have introduced a search component for Trace ID. You can use any Trace ID to list down all the spans related to that trace. Check out the PR [here](https://github.com/SigNoz/signoz/pull/1551).
...
We have enabled support for more span attributes such as arrays (ex: `user.ids:["id1", "id2"]`). Using these span attributes, application owners can get more context out of their tracing data. Check out the PR [here](https://github.com/SigNoz/signoz-otel-collector/pull/14).
...
[Grouping spans by custom tags](https://github.com/SigNoz/signoz/issues/1571)

[Dashboards for span queries](https://github.com/SigNoz/signoz/issues/1572)
...
We were trending on [Hacker News](https://news.ycombinator.com/item?id=33049046) over the weekend. Our post ended up with 480+ points and 100+ comments. Seeing people so interested in what we’re building is a great feeling.
...
[Ankit Nayan](https://www.linkedin.com/in/ankitnayan/), our CTO and co-founder presented a talk at the 19th Open Source India Conference held in Bengaluru. Ankit talked about the journey of building SigNoz and shared learnings about the open source ecosystem.
...
Pranay, our CEO and co-founder participated in a panel discussion on building business around open source projects. Along with Pranay, the panel had [Abhishek](https://www.linkedin.com/in/abhisheknayak/), co-founder at [Appsmith](https://www.appsmith.com/) and [Pranav](https://www.linkedin.com/in/pranavrajs/), co-founder at [Chatwoot](https://www.chatwoot.com/). You can check out the entire discussion here:
...
[Instasafe](https://instasafe.com/), a company that provides zero trust application and network access products for remote teams uses SigNoz to maintain high uptime and to monitor their APIs. Check out the full customer story [here](https://signoz.io/case-study/instasafe/).
...
Blip provides self-service subscription-based digital ad space across 1000’s of digital billboards in the US and Canada. Blip used SigNoz to improve their issue resolution time by 14x. Nate Bohman, Senior DevOps Engineer at Blip shared some [great insights](https://signoz.io/case-study/blip/) on how they are using observability to solve hard engineering issues.
